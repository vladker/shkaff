...
public class o implements t<o> {
    ...
    public boolean a(o oVar, Class<o> cls, String str, Object[] objArr, boolean[] zArr, Object[] objArr2, Throwable[] thArr) {
        ...
        if (cn.fly.commons.a.l.a("002kRgj").equals(str)) {
            if (objArr.length == 2) {
        ...
        } else if (cn.fly.commons.a.l.a("002kh").equals(str)) {
            if (objArr.length == 2) {
            ...
            try {
                if (objArr.length == 1) {
                    ...
                    objArr2[0] = cn.fly.tools.utils.g.a().b((String) objArr[0], objArr[1]);
                }
            } catch (Throwable th) {
                thArr[0] = th;
            }
            ...
            try {
                if (objArr.length == 1) {
                    ...
                    objArr2[0] = Long.valueOf(cn.fly.tools.utils.g.a().b((String) objArr[0], ((Long) objArr[1]).longValue()));
                }
            } catch (Throwable th4) {
                thArr[0] = th4;
            }
            ...
            try {
                if (objArr.length == 2) {
                    ...
                    objArr2[0] = cn.fly.tools.utils.g.a().a((String) objArr[0], (Class<Parcelable>) objArr[1], (Parcelable) objArr[2]);
                }
            } catch (Throwable th7) {
                thArr[0] = th7;
            }

...
public class FakeActivity implements EverythingKeeper {
    ...
    public static void registerExecutor(String str, Object obj) {
        ...
        try {
            Method method = cls.getMethod(m.a("016^fl=h<glfkhkAkh+flikgkZhe@fiRk*fmfl"), String.class, Object.class);
    ...
    public void requestPermissions(String[] strArr, int i5) {
        if (this.activity != null && DH.SyncMtd.getOSVersionIntForFly() >= 23) {
            ReflectHelper.invokeInstanceMethod(this.activity, m.a("018)flChCfgfi h%hkXk1in[h flfhfkhkhkfkfm1g(hk"), new Object[]{strArr, Integer.valueOf(i5)}, new Class[]{String.class, Integer.TYPE}, null);
        }
    }
    ...
    public void showForResult(final Context context, Intent intent, FakeActivity fakeActivity) {
        ...
        if (shellClass != null) {
            ...
            strA = null;
            try {
                Method method = shellClass.getMethod(m.a("016Sfl3h@glfkhk^khEflikgk'he[fi5k5fmfl"), Object.class);
                method.setAccessible(true);
        ...
        intent2.putExtra(m.a("011ifWfi-gejYfj!k<fkfh<h"), strA);
        intent2.putExtra(m.a("013hIgk0he6fi*k2fmflfj3gf0fhRh"), getClass().getName());
        if (intent != null) {
    ...
    public void runOnUIThread(final Runnable runnable, long j6) {
        UIHandler.sendEmptyMessageDelayed(0, j6, new Handler.Callback() { // from class: cn.fly.tools.FakeActivity.4
            @Override // android.os.Handler.Callback
            public boolean handleMessage(Message message) {
                runnable.run();
                return false;

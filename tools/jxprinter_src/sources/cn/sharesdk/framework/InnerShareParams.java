...
public abstract class InnerShareParams {
    ...
    protected static final String DAILY_BG_BASE_COLOR = "dailyBGBaseColor";
    protected static final String DAILY_BG_COMPLEMENTARY_COLOR = "dailyBGComplementaryColor";
    ...
    protected static final String ENTRANCE_MINI_PROGRAM_PATH = "entranceMiniProgramPath";
    protected static final String ENTRANCE_MINI_PROGRAM_USERNAME = "entranceMiniProgramUsername";
    ...
    protected static final String SHARE_TO_TYPE = "shareToType";
    ...
    public int getBGBaseColor() {
        return ((Integer) get(DAILY_BG_BASE_COLOR, Integer.class)).intValue();
    }

    public int getBGComplementaryColor() {
        return ((Integer) get(DAILY_BG_COMPLEMENTARY_COLOR, Integer.class)).intValue();
    }
    ...
    public String getEntranceMiniProgramPath() {
        return (String) get(ENTRANCE_MINI_PROGRAM_PATH, String.class);
    }

    public String getEntranceMiniProgramUsername() {
        return (String) get(ENTRANCE_MINI_PROGRAM_USERNAME, String.class);
    }
    ...
    public int getShareToType() {
        return ((Integer) get(SHARE_TO_TYPE, Integer.class)).intValue();
    }
    ...
    public void setBGBaseColor(int i5) {
        set(DAILY_BG_BASE_COLOR, Integer.valueOf(i5));
    }

    public void setBGComplementaryColor(int i5) {
        set(DAILY_BG_COMPLEMENTARY_COLOR, Integer.valueOf(i5));
    }
    ...
    public void setContentType(int i5) {
        set(CONTENT_TYPE, Integer.valueOf(i5));
    }
    ...
    public void setEntranceMiniProgramPath(String str) {
        set(ENTRANCE_MINI_PROGRAM_PATH, str);
    }

    public void setEntranceMiniProgramUsername(String str) {
        set(ENTRANCE_MINI_PROGRAM_USERNAME, str);
    }
    ...
    public void setHidden(int i5) {
        set("hidden", Integer.valueOf(i5));
    }
    ...
    public void setKakaoCommentcount(int i5) {
        set(KAKAO_TEMPLATE_COMMENTCOUNT, Integer.valueOf(i5));
    }
    ...
    public void setKakaoDiscountprice(int i5) {
        set(KAKAO_TEMPLATE_DISCOUNTPRICE, Integer.valueOf(i5));
    }

    public void setKakaoDiscountrate(int i5) {
        set(KAKAO_TEMPLATE_DISCOUNTRATE, Integer.valueOf(i5));
    }

    public void setKakaoLikecount(int i5) {
        set(KAKAO_TEMPLATE_LIKECOUNT, Integer.valueOf(i5));
    }
    ...
    public void setKakaoRegularprice(int i5) {
        set(KAKAO_TEMPLATE_REGULARPRICE, Integer.valueOf(i5));
    }

    public void setKakaoSharecount(int i5) {
        set(KAKAO_TEMPLATE_SHARECOUNT, Integer.valueOf(i5));
    }
    ...
    public void setLongitude(float f6) {
        set(LONGITUDE, Float.valueOf(f6));
    }
    ...
    public void setSafetyLevel(int i5) {
        set(SAFETY_LEVEL, Integer.valueOf(i5));
    }

    public void setScence(int i5) {
        set(SCENCE, Integer.valueOf(i5));
    }
    ...
    public void setShareToType(int i5) {
        set(SHARE_TO_TYPE, Integer.valueOf(i5));
    }

    public void setShareType(int i5) {
        set(SHARE_TYPE, Integer.valueOf(i5));
    }
    ...
    public void setTagPosition(int i5) {
        set(TAG_POSITION, Integer.valueOf(i5));
    }
    ...
    public void setWxMiniProgramType(int i5) {
        set(WX_MINIPROGRAM_MINIPROGRAM_TYPE, Integer.valueOf(i5));
    }

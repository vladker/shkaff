...
public final class C1329q extends L0 {
    public static final C1329q INSTANCE = new C1329q(a.serializer(C1103q.INSTANCE));
    ...
    public C1327p e(char[] cArr) {
        E.f(cArr, "<this>");
        return new C1327p(cArr);
    }

    @Override // p084o4.L0
    public void writeContent(h encoder, char[] content, int i5) {
        E.f(encoder, "encoder");
        E.f(content, "content");
    ...
    @Override // p084o4.L0
    public void readElement(f decoder, int i5, C1327p builder, boolean z6) {
        E.f(decoder, "decoder");
        E.f(builder, "builder");

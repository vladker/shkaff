...
public final class MediaBrowserCompat {
    ...
    public static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i5, Bundle bundle) {
            ...
            StringBuilder sbT = AbstractC0157z.t(i5, "Unknown result code: ", " (extras=");
            sbT.append(this.mExtras);
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                StringBuilder sbX = AbstractC0157z.x(str, " for ");
                sbX.append(MediaBrowserImplBase.this.mServiceComponent);
                sbX.append(" with mServiceConnection=");
                sbX.append(MediaBrowserImplBase.this.mServiceConnection);
                sbX.append(" this=");
                sbX.append(this);
                Log.i(MediaBrowserCompat.TAG, sbX.toString());
                return false;
            }
        ...
        private static String getStateLabel(int i5) {
            ...
            if (i5 != 3) {
                return i5 != 4 ? AbstractC0157z.k(i5, "UNKNOWN/") : "CONNECT_STATE_SUSPENDED";
            }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            StringBuilder sbX = AbstractC0157z.x(str, " for ");
            sbX.append(this.mServiceComponent);
            sbX.append(" with mCallbacksMessenger=");
            sbX.append(this.mCallbacksMessenger);
            sbX.append(" this=");
            sbX.append(this);
            Log.i(MediaBrowserCompat.TAG, sbX.toString());
            return false;
        ...
        public void connect() {
            int i5 = this.mState;
            if (i5 != 0 && i5 != 1) {
                throw new IllegalStateException(AbstractC0157z.s(new StringBuilder("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
            }
            this.mState = 2;
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(AbstractC0157z.s(new StringBuilder("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(AbstractC0157z.s(new StringBuilder("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(AbstractC0157z.l(")", this.mState, new StringBuilder("getServiceComponent() called while not connected (state=")));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(AbstractC0157z.l(")", this.mState, new StringBuilder("getSessionToken() called while not connected(state=")));
        }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException(AbstractC0157z.s(new StringBuilder("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException e) {

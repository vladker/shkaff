...
public class MediaSessionCompat {
        ...
        public class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                try {
                    ...
                    if (i5 >= 0 && i5 < mediaSessionImplApi22.mQueue.size()) {
                        queueItem = mediaSessionImplApi22.mQueue.get(i5);
                    }
                    if (queueItem != null) {
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public int getRccTransportControlFlagsFromActions(long j6) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j6);
            return (j6 & 256) != 0 ? rccTransportControlFlagsFromActions | 256 : rccTransportControlFlagsFromActions;
        }
            ...
            if (callback == null) {
                ...
                this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi18.1
                    ...
                    public void onPlaybackPositionUpdate(long j6) {
                        MediaSessionImplApi18.this.postToHandler(18, -1, -1, Long.valueOf(j6), null);
                    }
                });
            }
        }
            ...
            if (playbackStateCompat.getState() == 3) {
                ...
                if (position > 0) {
                    if (lastPositionUpdateTime > 0) {
                        j6 = jElapsedRealtime - lastPositionUpdateTime;
                        if (playbackSpeed > 0.0f && playbackSpeed != 1.0f) {
                            j6 = (long) (j6 * playbackSpeed);
                        }
                    }
                    position += j6;
                }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public int getRccTransportControlFlagsFromActions(long j6) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j6);
            return (j6 & 128) != 0 ? rccTransportControlFlagsFromActions | 512 : rccTransportControlFlagsFromActions;
        }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public String toString() {
            ...
            sb.append(", Id=");
            return AbstractC0157z.r(sb, this.mId, " }");
        }
    ...
    public static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        if (j7 < 0 || position <= j7) {
            j6 = position < 0 ? 0L : position;
        } else {
            j6 = j7;
        }
        return new PlaybackStateCompat.Builder(playbackStateCompat).setState(playbackStateCompat.getState(), j6, playbackStateCompat.getPlaybackSpeed(), jElapsedRealtime).build();
    }
    ...
    public void setActive(boolean z6) {
        ...
        int i5 = 0;
        while (i5 < size) {
            OnActiveChangeListener onActiveChangeListener = arrayList.get(i5);
            i5++;
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setRepeatMode(int i5) {
            if (this.mRepeatMode != i5) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onRepeatModeChanged(i5);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
        ...
        public void setShuffleMode(int i5) {
            if (this.mShuffleMode != i5) {
                ...
                for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChanged(i5);
                    } catch (RemoteException unused) {
                    }
                }
                this.mExtraControllerCallbacks.finishBroadcast();
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public long getFlags() {
                long j6;
                synchronized (MediaSessionImplBase.this.mLock) {
                    j6 = MediaSessionImplBase.this.mFlags;
                }
                return j6;
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                return new ParcelableVolumeInfo(i5, i6, volumeControl, i7, i8);
            }
            ...
            public void postToHandler(int i5) {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void seekTo(long j6) {
                postToHandler(18, Long.valueOf(j6));
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void skipToQueueItem(long j6) {
                postToHandler(11, Long.valueOf(j6));
            }
            ...
            public void postToHandler(int i5, int i6) {
                MediaSessionImplBase.this.postToHandler(i5, i6, 0, null, null);
            }

            public void postToHandler(int i5, Object obj) {
                MediaSessionImplBase.this.postToHandler(i5, 0, 0, obj, null);
            }

            public void postToHandler(int i5, Object obj, int i6) {
                ...
                try {
                    switch (message.what) {
                        ...
                        case 28:
                            ...
                            if (list != null) {
                                int i5 = message.arg1;
                                QueueItem queueItem = (i5 < 0 || i5 >= list.size()) ? null : MediaSessionImplBase.this.mQueue.get(message.arg1);
                                if (queueItem != null) {
        ...
        private void sendRepeatMode(int i5) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onRepeatModeChanged(i5);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        private void sendShuffleMode(int i5) {
            for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                try {
                    ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onShuffleModeChanged(i5);
                } catch (RemoteException unused) {
                }
            }
            this.mControllerCallbacks.finishBroadcast();
        ...
        public int getRccStateFromState(int i5) {
            switch (i5) {
                case 0:
                    return 0;
                case 1:
        ...
        public void postToHandler(int i5, int i6, int i7, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                try {
                    MessageHandler messageHandler = this.mHandler;
                    if (messageHandler != null) {
                        Message messageObtainMessage = messageHandler.obtainMessage(i5, i6, i7, obj);
                        Bundle bundle2 = new Bundle();

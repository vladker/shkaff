...
public final class MediaControllerCompat {
    ...
    public static final class PlaybackInfo {
        ...
        public PlaybackInfo(int i5, int i6, int i7, int i8, int i9) {
    ...
    public static abstract class TransportControls {
        ...
        public abstract void skipToQueueItem(long j6);
    ...
    public static class TransportControlsBase extends TransportControls {
        ...
        public void skipToQueueItem(long j6) {
            try {
                this.mBinder.skipToQueueItem(j6);
            } catch (RemoteException e) {
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException(AbstractC0157z.o("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, Consts.DOT));
            }
        }
    }
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void seekTo(long j6) {
            MediaControllerCompatApi21.TransportControls.seekTo(this.mControlsObj, j6);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void skipToQueueItem(long j6) {
            MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.mControlsObj, j6);
        }
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public void postToHandler(int i5, Object obj, Bundle bundle) {
            ...
            if (messageHandler != null) {
                Message messageObtainMessage = messageHandler.obtainMessage(i5, obj);

...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setActions(long j6) {
            this.mActions = j6;
            return this;
        }

        public Builder setActiveQueueItemId(long j6) {
            this.mActiveItemId = j6;
            return this;
        }

        public Builder setBufferedPosition(long j6) {
        ...
        public Builder setState(int i5, long j6, float f6) {
            return setState(i5, j6, f6, SystemClock.elapsedRealtime());
        }
        ...
        public Builder setState(int i5, long j6, float f6, long j7) {
            this.mState = i5;
            this.mPosition = j6;
            this.mUpdateTime = j7;
            this.mRate = f6;
    ...
    public PlaybackStateCompat(int i5, long j6, long j7, float f6, long j8, int i6, CharSequence charSequence, long j9, List<CustomAction> list, long j10, Bundle bundle) {
        this.mState = i5;
        this.mPosition = j6;
    ...
    public static int toKeyCode(long j6) {
        if (j6 == 4) {
            return 126;
        }
        if (j6 == 2) {
    ...
    public long getCurrentPosition(Long l6) {
        return Math.max(0L, this.mPosition + ((long) (this.mSpeed * (l6 != null ? l6.longValue() : SystemClock.elapsedRealtime() - this.mUpdateTime))));
    }
    ...
    public String toString() {
        ...
        return AbstractC0157z.r(sb, this.mActiveItemId, VectorFormat.DEFAULT_SUFFIX);
    }

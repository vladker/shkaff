...
public interface IMediaSession extends IInterface {
    ...
    void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i5);

    void adjustVolume(int i5, int i6, String str);
    ...
    void setVolumeTo(int i5, int i6, String str);

    void skipToQueueItem(long j6);

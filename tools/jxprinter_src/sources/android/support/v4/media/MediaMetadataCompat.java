...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmap(Bitmap bitmap, int i5) {
            float f6 = i5;
            float fMin = Math.min(f6 / bitmap.getWidth(), f6 / bitmap.getHeight());
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 2) {
                throw new IllegalArgumentException(AbstractC0157z.o("The ", str, " key cannot be used to put a Bitmap"));
            }
        ...
        public Builder putLong(String str, long j6) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 0) {
                throw new IllegalArgumentException(AbstractC0157z.o("The ", str, " key cannot be used to put a long"));
            }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 3) {
                throw new IllegalArgumentException(AbstractC0157z.o("The ", str, " key cannot be used to put a Rating"));
            }
        ...
        public Builder putString(String str, String str2) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 1) {
                throw new IllegalArgumentException(AbstractC0157z.o("The ", str, " key cannot be used to put a String"));
            }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            ArrayMap<String, Integer> arrayMap = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 1) {
                throw new IllegalArgumentException(AbstractC0157z.o("The ", str, " key cannot be used to put a CharSequence"));
            }

...
public class CTExtensionListImpl extends XmlComplexContentImpl implements CTExtensionList {
    ...
    public List<CTExtension> getExtList() {
        ...
        synchronized (monitor()) {
            ...
            final int i5 = 0;
            final int i6 = 1;
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: r5.J
            ...
            }, new B(this, 8), new Function(this) { // from class: r5.J
                public final /* synthetic */ CTExtensionListImpl b;
            ...
            }, new C1566i(this, 20), new C1568j(this, 20));
        }

...
public class CTSheetDataImpl extends XmlComplexContentImpl implements CTSheetData {
    ...
    public List<CTRow> getRowList() {
        ...
        synchronized (monitor()) {
            ...
            final int i5 = 0;
            final int i6 = 1;
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: r5.Q0
                public final /* synthetic */ CTSheetDataImpl b;
            ...
            }, new B0(this, 2), new Function(this) { // from class: r5.Q0
                public final /* synthetic */ CTSheetDataImpl b;
            ...
            }, new C1551a0(this, 17), new C1553b0(this, 17));
        }
        return javaListXmlObject;
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetData
    public CTRow insertNewRow(int i5) {
        CTRow cTRow;
        synchronized (monitor()) {
            check_orphaned();
            cTRow = (CTRow) get_store().insert_element_user(PROPERTY_QNAME[0], i5);
        }
        return cTRow;
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetData
    public CTRow getRowArray(int i5) {
        CTRow cTRow;
        synchronized (monitor()) {
            try {
                check_orphaned();
                cTRow = (CTRow) get_store().find_element_user(PROPERTY_QNAME[0], i5);
                if (cTRow == null) {
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetData
    public void setRowArray(int i5, CTRow cTRow) {
        generatedSetterHelperImpl(cTRow, PROPERTY_QNAME[0], i5, (short) 2);
    }
}

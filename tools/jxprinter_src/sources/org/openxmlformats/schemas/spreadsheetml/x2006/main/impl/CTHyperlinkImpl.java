...
public class CTHyperlinkImpl extends XmlComplexContentImpl implements CTHyperlink {
    private static final QName[] PROPERTY_QNAME = {new QName("", "ref"), new QName(PackageRelationshipTypes.CORE_PROPERTIES_ECMA376_NS, "id"), new QName("", FirebaseAnalytics.Param.LOCATION), new QName("", "tooltip"), new QName("", "display")};

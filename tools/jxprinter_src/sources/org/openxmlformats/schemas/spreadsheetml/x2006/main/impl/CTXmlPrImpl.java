...
public class CTXmlPrImpl extends XmlComplexContentImpl implements CTXmlPr {
    ...
    public STXmlDataType xgetXmlDataType() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTXmlDataType = (STXmlDataType) get_store().find_attribute_user(PROPERTY_QNAME[3]);
        }
    ...
    public void xsetXmlDataType(STXmlDataType sTXmlDataType) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STXmlDataType sTXmlDataType2 = (STXmlDataType) typeStore.find_attribute_user(qNameArr[3]);
                if (sTXmlDataType2 == null) {
                    sTXmlDataType2 = (STXmlDataType) get_store().add_attribute_user(qNameArr[3]);
                }

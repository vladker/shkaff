...
public class CTRowImpl extends XmlComplexContentImpl implements CTRow {
    private static final QName[] PROPERTY_QNAME = {new QName(XSSFRelation.NS_SPREADSHEETML, "c"), new QName(XSSFRelation.NS_SPREADSHEETML, "extLst"), new QName("", "r"), new QName("", "spans"), new QName("", "s"), new QName("", "customFormat"), new QName("", "ht"), new QName("", CellUtil.HIDDEN), new QName("", "customHeight"), new QName("", "outlineLevel"), new QName("", "collapsed"), new QName("", "thickTop"), new QName("", "thickBot"), new QName("", "ph")};
    ...
    public CTCell addNewC() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCell = (CTCell) get_store().add_element_user(PROPERTY_QNAME[0]);
        }
        return cTCell;
    }
    ...
    public CTCell[] getCArray() {
        return (CTCell[]) getXmlObjectArray(PROPERTY_QNAME[0], new CTCell[0]);
    }
    ...
    public List<CTCell> getCList() {
        ...
        synchronized (monitor()) {
            ...
            final int i5 = 0;
            final int i6 = 1;
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: r5.C0
            ...
            }, new B0(this, 1), new Function(this) { // from class: r5.C0
                public final /* synthetic */ CTRowImpl b;
            ...
            }, new C1551a0(this, 16), new C1553b0(this, 16));
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTRow
    public CTCell insertNewC(int i5) {
        CTCell cTCell;
        synchronized (monitor()) {
            check_orphaned();
            cTCell = (CTCell) get_store().insert_element_user(PROPERTY_QNAME[0], i5);
        }
        return cTCell;
    }
    ...
    public void setCArray(CTCell[] cTCellArr) {
        check_orphaned();
        arraySetterHelper(cTCellArr, PROPERTY_QNAME[0]);
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTRow
    public void setCustomFormat(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTRow
    public void setThickBot(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public XmlUnsignedByte xgetOutlineLevel() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                xmlUnsignedByte = (XmlUnsignedByte) typeStore.find_attribute_user(qNameArr[9]);
                if (xmlUnsignedByte == null) {
                    xmlUnsignedByte = (XmlUnsignedByte) get_default_attribute_value(qNameArr[9]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public STCellSpans xgetSpans() {
        STCellSpans sTCellSpans;
        synchronized (monitor()) {
            check_orphaned();
            sTCellSpans = (STCellSpans) get_store().find_attribute_user(PROPERTY_QNAME[3]);
        }
        return sTCellSpans;
    }
    ...
    public void xsetOutlineLevel(XmlUnsignedByte xmlUnsignedByte) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                XmlUnsignedByte xmlUnsignedByte2 = (XmlUnsignedByte) typeStore.find_attribute_user(qNameArr[9]);
                if (xmlUnsignedByte2 == null) {
                    xmlUnsignedByte2 = (XmlUnsignedByte) get_store().add_attribute_user(qNameArr[9]);
                }
    ...
    public void xsetSpans(STCellSpans sTCellSpans) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STCellSpans sTCellSpans2 = (STCellSpans) typeStore.find_attribute_user(qNameArr[3]);
                if (sTCellSpans2 == null) {
                    sTCellSpans2 = (STCellSpans) get_store().add_attribute_user(qNameArr[3]);
                }
                sTCellSpans2.set(sTCellSpans);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTRow
    public CTCell getCArray(int i5) {
        CTCell cTCell;
        synchronized (monitor()) {
            try {
                check_orphaned();
                cTCell = (CTCell) get_store().find_element_user(PROPERTY_QNAME[0], i5);
                if (cTCell == null) {
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTRow
    public void setCArray(int i5, CTCell cTCell) {
        generatedSetterHelperImpl(cTCell, PROPERTY_QNAME[0], i5, (short) 2);
    }
}

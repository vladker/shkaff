...
public class CTDataConsolidateImpl extends XmlComplexContentImpl implements CTDataConsolidate {
    ...
    public CTDataConsolidateImpl(SchemaType schemaType) {
        super(schemaType);
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataConsolidate
    public CTDataRefs addNewDataRefs() {
        CTDataRefs cTDataRefsAdd_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTDataRefsAdd_element_user = get_store().add_element_user(PROPERTY_QNAME[0]);
        }
        return cTDataRefsAdd_element_user;
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataConsolidate
    public CTDataRefs getDataRefs() {
        CTDataRefs cTDataRefsFind_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTDataRefsFind_element_user = get_store().find_element_user(PROPERTY_QNAME[0], 0);
            if (cTDataRefsFind_element_user == null) {
                cTDataRefsFind_element_user = null;
            }
        }
        return cTDataRefsFind_element_user;
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataConsolidate
    public void setFunction(STDataConsolidateFunction.Enum r6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public STDataConsolidateFunction xgetFunction() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                sTDataConsolidateFunction = (STDataConsolidateFunction) typeStore.find_attribute_user(qNameArr[1]);
    ...
    public void xsetFunction(STDataConsolidateFunction sTDataConsolidateFunction) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STDataConsolidateFunction sTDataConsolidateFunction2 = (STDataConsolidateFunction) typeStore.find_attribute_user(qNameArr[1]);
                if (sTDataConsolidateFunction2 == null) {
                    sTDataConsolidateFunction2 = (STDataConsolidateFunction) get_store().add_attribute_user(qNameArr[1]);
                }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataConsolidate
    public void xsetLeftLabels(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataConsolidate
    public void xsetLink(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataConsolidate
    public void xsetStartLabels(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataConsolidate
    public void xsetTopLabels(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();

...
public class CTDataValidationsImpl extends XmlComplexContentImpl implements CTDataValidations {
    ...
    public CTDataValidation addNewDataValidation() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTDataValidation = (CTDataValidation) get_store().add_element_user(PROPERTY_QNAME[0]);
        }
    ...
    public List<CTDataValidation> getDataValidationList() {
        ...
        synchronized (monitor()) {
            ...
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: r5.G
                public final /* synthetic */ CTDataValidationsImpl b;
                ...
                public final Object apply(Object obj) {
                    ...
                    switch (i7) {
                        case 0:
                            return this.b.getDataValidationArray(iIntValue);
                        default:
                            return this.b.insertNewDataValidation(iIntValue);
                    }
                }
            }, new B(this, 5), new Function(this) { // from class: r5.G
                public final /* synthetic */ CTDataValidationsImpl b;
            ...
            }, new C1566i(this, 17), new C1568j(this, 17));
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataValidations
    public CTDataValidation insertNewDataValidation(int i5) {
        CTDataValidation cTDataValidation;
        synchronized (monitor()) {
            check_orphaned();
            cTDataValidation = (CTDataValidation) get_store().insert_element_user(PROPERTY_QNAME[0], i5);
        }
        return cTDataValidation;
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataValidations
    public void removeDataValidation(int i5) {
        synchronized (monitor()) {
            check_orphaned();
    ...
    public void setDataValidationArray(CTDataValidation[] cTDataValidationArr) {
        check_orphaned();
        arraySetterHelper(cTDataValidationArr, PROPERTY_QNAME[0]);
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataValidations
    public void setDisablePrompts(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataValidations
    public void setXWindow(long j6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataValidations
    public void setYWindow(long j6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataValidations
    public CTDataValidation getDataValidationArray(int i5) {
        CTDataValidation cTDataValidation;
        synchronized (monitor()) {
            try {
                check_orphaned();
                cTDataValidation = (CTDataValidation) get_store().find_element_user(PROPERTY_QNAME[0], i5);
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataValidations
    public void setDataValidationArray(int i5, CTDataValidation cTDataValidation) {
        generatedSetterHelperImpl(cTDataValidation, PROPERTY_QNAME[0], i5, (short) 2);
    }
}

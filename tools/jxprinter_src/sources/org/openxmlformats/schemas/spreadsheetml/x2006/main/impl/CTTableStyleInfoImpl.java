...
public class CTTableStyleInfoImpl extends XmlComplexContentImpl implements CTTableStyleInfo {
    private static final QName[] PROPERTY_QNAME = {new QName("", "name"), new QName("", "showFirstColumn"), new QName("", "showLastColumn"), new QName("", "showRowStripes"), new QName("", "showColumnStripes")};
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTableStyleInfo
    public void setShowFirstColumn(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();

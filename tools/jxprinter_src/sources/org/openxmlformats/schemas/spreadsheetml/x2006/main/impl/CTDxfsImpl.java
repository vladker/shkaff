...
public class CTDxfsImpl extends XmlComplexContentImpl implements CTDxfs {
    ...
    public List<CTDxf> getDxfList() {
        ...
        synchronized (monitor()) {
            ...
            final int i5 = 0;
            final int i6 = 1;
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: r5.I
                public final /* synthetic */ CTDxfsImpl b;
                ...
                public final Object apply(Object obj) {
                    ...
                    switch (i7) {
                        case 0:
                            return this.b.getDxfArray(iIntValue);
                        default:
                            return this.b.insertNewDxf(iIntValue);
                    }
                }
            }, new B(this, 7), new Function(this) { // from class: r5.I
                public final /* synthetic */ CTDxfsImpl b;
            ...
            }, new C1566i(this, 19), new C1568j(this, 19));
        }
        return javaListXmlObject;
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDxfs
    public CTDxf insertNewDxf(int i5) {
        CTDxf cTDxf;
        synchronized (monitor()) {
            check_orphaned();
            cTDxf = (CTDxf) get_store().insert_element_user(PROPERTY_QNAME[0], i5);
        }
        return cTDxf;
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDxfs
    public CTDxf getDxfArray(int i5) {
        CTDxf cTDxf;
        synchronized (monitor()) {
            try {
                check_orphaned();
                cTDxf = (CTDxf) get_store().find_element_user(PROPERTY_QNAME[0], i5);
                if (cTDxf == null) {
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDxfs
    public void setDxfArray(int i5, CTDxf cTDxf) {
        generatedSetterHelperImpl(cTDxf, PROPERTY_QNAME[0], i5, (short) 2);
    }
}

...
public class CTTablePartsImpl extends XmlComplexContentImpl implements CTTableParts {
    ...
    public List<CTTablePart> getTablePartList() {
        ...
        synchronized (monitor()) {
            ...
            final int i5 = 0;
            final int i6 = 1;
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: r5.b1
                public final /* synthetic */ CTTablePartsImpl b;
                ...
                public final Object apply(Object obj) {
                    ...
                    switch (i7) {
                        case 0:
                            return this.b.getTablePartArray(iIntValue);
                        default:
                            return this.b.insertNewTablePart(iIntValue);
                    }
                }
            }, new B0(this, 10), new Function(this) { // from class: r5.b1
                public final /* synthetic */ CTTablePartsImpl b;
            ...
            }, new C1551a0(this, 24), new C1553b0(this, 24));
        }
        return javaListXmlObject;
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTableParts
    public CTTablePart insertNewTablePart(int i5) {
        CTTablePart cTTablePart;
        synchronized (monitor()) {
            check_orphaned();
            cTTablePart = (CTTablePart) get_store().insert_element_user(PROPERTY_QNAME[0], i5);
        }
        return cTTablePart;
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTableParts
    public void removeTablePart(int i5) {
        synchronized (monitor()) {
            check_orphaned();
    ...
    public void setTablePartArray(CTTablePart[] cTTablePartArr) {
        check_orphaned();
        arraySetterHelper(cTTablePartArr, PROPERTY_QNAME[0]);
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTableParts
    public CTTablePart getTablePartArray(int i5) {
        CTTablePart cTTablePart;
        synchronized (monitor()) {
            try {
                check_orphaned();
                cTTablePart = (CTTablePart) get_store().find_element_user(PROPERTY_QNAME[0], i5);
                if (cTTablePart == null) {
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTableParts
    public void setTablePartArray(int i5, CTTablePart cTTablePart) {
        generatedSetterHelperImpl(cTTablePart, PROPERTY_QNAME[0], i5, (short) 2);
    }
}

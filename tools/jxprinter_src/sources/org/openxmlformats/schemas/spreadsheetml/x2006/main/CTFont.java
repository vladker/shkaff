...
public interface CTFont extends XmlObject {
    ...
    CTFontFamily getFamilyArray(int i5);
    ...
    CTFontName getNameArray(int i5);
    ...
    CTFontFamily insertNewFamily(int i5);

    CTBooleanProperty insertNewI(int i5);

    CTFontName insertNewName(int i5);
    ...
    void setFamilyArray(int i5, CTFontFamily cTFontFamily);
    ...
    void setNameArray(int i5, CTFontName cTFontName);

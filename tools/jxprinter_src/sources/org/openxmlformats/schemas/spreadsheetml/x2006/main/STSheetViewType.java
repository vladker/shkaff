...
public interface STSheetViewType extends XmlString {
    ...
    public static final Enum PAGE_BREAK_PREVIEW;
    public static final Enum PAGE_LAYOUT;
    ...
    static {
        ...
        PAGE_BREAK_PREVIEW = Enum.forString("pageBreakPreview");
        PAGE_LAYOUT = Enum.forString("pageLayout");
    }

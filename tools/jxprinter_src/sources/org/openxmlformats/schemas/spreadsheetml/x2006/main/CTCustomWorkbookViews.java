...
public interface CTCustomWorkbookViews extends XmlObject {
    ...
    CTCustomWorkbookView getCustomWorkbookViewArray(int i5);

    CTCustomWorkbookView[] getCustomWorkbookViewArray();

    List<CTCustomWorkbookView> getCustomWorkbookViewList();

    CTCustomWorkbookView insertNewCustomWorkbookView(int i5);

    void removeCustomWorkbookView(int i5);

    void setCustomWorkbookViewArray(int i5, CTCustomWorkbookView cTCustomWorkbookView);

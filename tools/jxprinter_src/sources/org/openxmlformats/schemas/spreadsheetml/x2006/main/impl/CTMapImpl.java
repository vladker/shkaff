...
public class CTMapImpl extends XmlComplexContentImpl implements CTMap {
    ...
    public CTDataBinding addNewDataBinding() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTDataBindingAdd_element_user = get_store().add_element_user(PROPERTY_QNAME[0]);
        }
    ...
    public CTDataBinding getDataBinding() {
        CTDataBinding cTDataBindingFind_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTDataBindingFind_element_user = get_store().find_element_user(PROPERTY_QNAME[0], 0);
            if (cTDataBindingFind_element_user == null) {
                cTDataBindingFind_element_user = null;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMap
    public void setAppend(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMap
    public void setAutoFit(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public void setDataBinding(CTDataBinding cTDataBinding) {
        generatedSetterHelperImpl(cTDataBinding, PROPERTY_QNAME[0], 0, (short) 1);
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMap
    public void setPreserveFormat(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMap
    public void setPreserveSortAFLayout(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTMap
    public void setShowImportExportValidationErrors(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();

...
public class CTSheetPrImpl extends XmlComplexContentImpl implements CTSheetPr {
    ...
    public CTOutlinePr addNewOutlinePr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTOutlinePr = (CTOutlinePr) get_store().add_element_user(PROPERTY_QNAME[1]);
        }
        return cTOutlinePr;
    }
    ...
    public CTPageSetUpPr addNewPageSetUpPr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPageSetUpPr = (CTPageSetUpPr) get_store().add_element_user(PROPERTY_QNAME[2]);
        }
    ...
    public CTOutlinePr getOutlinePr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTOutlinePr = (CTOutlinePr) get_store().find_element_user(PROPERTY_QNAME[1], 0);
            if (cTOutlinePr == null) {
                cTOutlinePr = null;
            }
        }
    ...
    public CTPageSetUpPr getPageSetUpPr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTPageSetUpPr = (CTPageSetUpPr) get_store().find_element_user(PROPERTY_QNAME[2], 0);
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetPr
    public void setEnableFormatConditionsCalculation(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public void setOutlinePr(CTOutlinePr cTOutlinePr) {
        generatedSetterHelperImpl(cTOutlinePr, PROPERTY_QNAME[1], 0, (short) 1);
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetPr
    public void setPageSetUpPr(CTPageSetUpPr cTPageSetUpPr) {
        generatedSetterHelperImpl(cTPageSetUpPr, PROPERTY_QNAME[2], 0, (short) 1);
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetPr
    public void setSyncHorizontal(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetPr
    public void setSyncVertical(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetPr
    public void setTransitionEntry(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetPr
    public void setTransitionEvaluation(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();

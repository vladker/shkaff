...
public class CTPageFieldImpl extends XmlComplexContentImpl implements CTPageField {
    ...
    public XmlInt xgetFld() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            xmlInt = (XmlInt) get_store().find_attribute_user(PROPERTY_QNAME[1]);
        }
        return xmlInt;
    }
    ...
    public XmlInt xgetHier() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            xmlInt = (XmlInt) get_store().find_attribute_user(PROPERTY_QNAME[3]);
        }
        return xmlInt;
    }
    ...
    public void xsetFld(XmlInt xmlInt) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                XmlInt xmlInt2 = (XmlInt) typeStore.find_attribute_user(qNameArr[1]);
                if (xmlInt2 == null) {
                    xmlInt2 = (XmlInt) get_store().add_attribute_user(qNameArr[1]);
                }
                xmlInt2.set(xmlInt);
            } catch (Throwable th) {
                throw th;

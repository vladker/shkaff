...
public class CTSheetBackgroundPictureImpl extends XmlComplexContentImpl implements CTSheetBackgroundPicture {
    private static final QName[] PROPERTY_QNAME = {new QName(PackageRelationshipTypes.CORE_PROPERTIES_ECMA376_NS, "id")};
    private static final long serialVersionUID = 1;

    public CTSheetBackgroundPictureImpl(SchemaType schemaType) {
        super(schemaType);
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTSheetBackgroundPicture
    public String getId() {
        String stringValue;

...
public class CTItemImpl extends XmlComplexContentImpl implements CTItem {
    private static final QName[] PROPERTY_QNAME = {new QName("", "n"), new QName("", "t"), new QName("", "h"), new QName("", "s"), new QName("", "sd"), new QName("", "f"), new QName("", "m"), new QName("", "c"), new QName("", "x"), new QName("", "d"), new QName("", "e")};
    ...
    public STItemType.Enum getT() {
        ...
        synchronized (monitor()) {
            try {
                ...
                r6 = simpleValue == null ? null : (STItemType.Enum) simpleValue.getEnumValue();
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTItem
    public void setT(STItemType.Enum r6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public STItemType xgetT() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                sTItemType = (STItemType) typeStore.find_attribute_user(qNameArr[1]);
                if (sTItemType == null) {
                    sTItemType = (STItemType) get_default_attribute_value(qNameArr[1]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void xsetT(STItemType sTItemType) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STItemType sTItemType2 = (STItemType) typeStore.find_attribute_user(qNameArr[1]);
                if (sTItemType2 == null) {
                    sTItemType2 = (STItemType) get_store().add_attribute_user(qNameArr[1]);
                }

...
public interface STCellFormulaType extends XmlString {
    public static final Enum ARRAY;
    public static final Enum DATA_TABLE;
    ...
    public static final Enum SHARED;
    ...
    static {
        ...
        ARRAY = Enum.forString("array");
        DATA_TABLE = Enum.forString("dataTable");
        SHARED = Enum.forString("shared");
    }

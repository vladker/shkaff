...
public class CTBookViewImpl extends XmlComplexContentImpl implements CTBookView {
    ...
    public STVisibility.Enum getVisibility() {
        ...
        synchronized (monitor()) {
            try {
                ...
                r6 = simpleValue == null ? null : (STVisibility.Enum) simpleValue.getEnumValue();
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBookView
    public void setActiveTab(long j6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBookView
    public void setAutoFilterDateGrouping(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBookView
    public void setFirstSheet(long j6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBookView
    public void setVisibility(STVisibility.Enum r6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public STVisibility xgetVisibility() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                sTVisibility = (STVisibility) typeStore.find_attribute_user(qNameArr[1]);
                if (sTVisibility == null) {
                    sTVisibility = (STVisibility) get_default_attribute_value(qNameArr[1]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public XmlInt xgetXWindow() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            xmlInt = (XmlInt) get_store().find_attribute_user(PROPERTY_QNAME[6]);
        }
        return xmlInt;
    }
    ...
    public void xsetVisibility(STVisibility sTVisibility) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STVisibility sTVisibility2 = (STVisibility) typeStore.find_attribute_user(qNameArr[1]);
                if (sTVisibility2 == null) {
                    sTVisibility2 = (STVisibility) get_store().add_attribute_user(qNameArr[1]);
                }
    ...
    public void xsetXWindow(XmlInt xmlInt) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                XmlInt xmlInt2 = (XmlInt) typeStore.find_attribute_user(qNameArr[6]);
                if (xmlInt2 == null) {
                    xmlInt2 = (XmlInt) get_store().add_attribute_user(qNameArr[6]);
                }
                xmlInt2.set(xmlInt);
            } catch (Throwable th) {
                throw th;

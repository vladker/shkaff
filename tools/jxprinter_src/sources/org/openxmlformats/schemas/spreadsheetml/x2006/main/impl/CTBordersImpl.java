...
public class CTBordersImpl extends XmlComplexContentImpl implements CTBorders {
    ...
    public List<CTBorder> getBorderList() {
        ...
        synchronized (monitor()) {
            ...
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: r5.f
                public final /* synthetic */ CTBordersImpl b;
                ...
                public final Object apply(Object obj) {
                    ...
                    switch (i7) {
                        case 0:
                            return this.b.getBorderArray(iIntValue);
                        default:
                            return this.b.insertNewBorder(iIntValue);
                    }
                }
            }, new g2(this, 19), new Function(this) { // from class: r5.f
                public final /* synthetic */ CTBordersImpl b;
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorders
    public CTBorder insertNewBorder(int i5) {
        CTBorder cTBorder;
        synchronized (monitor()) {
            check_orphaned();
            cTBorder = (CTBorder) get_store().insert_element_user(PROPERTY_QNAME[0], i5);
        }
        return cTBorder;
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorders
    public void removeBorder(int i5) {
        synchronized (monitor()) {
            check_orphaned();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorders
    public CTBorder getBorderArray(int i5) {
        CTBorder cTBorder;
        synchronized (monitor()) {
            try {
                check_orphaned();
                cTBorder = (CTBorder) get_store().find_element_user(PROPERTY_QNAME[0], i5);
                if (cTBorder == null) {
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTBorders
    public void setBorderArray(int i5, CTBorder cTBorder) {
        generatedSetterHelperImpl(cTBorder, PROPERTY_QNAME[0], i5, (short) 2);
    }
}

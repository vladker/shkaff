...
public class CTFileVersionImpl extends XmlComplexContentImpl implements CTFileVersion {
    ...
    public CTFileVersionImpl(SchemaType schemaType) {
        super(schemaType);
    }

    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTFileVersion
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTFileVersion
    public void xsetCodeName(STGuid sTGuid) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTFileVersion
    public void xsetLastEdited(XmlString xmlString) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTFileVersion
    public void xsetLowestEdited(XmlString xmlString) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTFileVersion
    public void xsetRupBuild(XmlString xmlString) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();

...
public class CTWebPublishingImpl extends XmlComplexContentImpl implements CTWebPublishing {
    ...
    public CTWebPublishingImpl(SchemaType schemaType) {
        super(schemaType);
    }
    ...
    public STTargetScreenSize$Enum getTargetScreenSize() {
        ...
        synchronized (monitor()) {
            try {
                ...
                sTTargetScreenSize$Enum = simpleValue == null ? null : (STTargetScreenSize$Enum) simpleValue.getEnumValue();
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void setAllowPng(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void setCodePage(long j6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void setLongFileNames(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void setTargetScreenSize(STTargetScreenSize$Enum sTTargetScreenSize$Enum) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
                ...
                simpleValue.setEnumValue(sTTargetScreenSize$Enum);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void setThicket(boolean z6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public STTargetScreenSize xgetTargetScreenSize() {
        STTargetScreenSize sTTargetScreenSizeFind_attribute_user;
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                sTTargetScreenSizeFind_attribute_user = typeStore.find_attribute_user(qNameArr[5]);
                if (sTTargetScreenSizeFind_attribute_user == null) {
                    sTTargetScreenSizeFind_attribute_user = (STTargetScreenSize) get_default_attribute_value(qNameArr[5]);
                }
            } catch (Throwable th) {
                throw th;
            }
        }
        return sTTargetScreenSizeFind_attribute_user;
    }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void xsetAllowPng(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void xsetCharacterSet(XmlString xmlString) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void xsetCodePage(XmlUnsignedInt xmlUnsignedInt) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void xsetCss(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void xsetLongFileNames(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public void xsetTargetScreenSize(STTargetScreenSize sTTargetScreenSize) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STTargetScreenSize sTTargetScreenSizeFind_attribute_user = typeStore.find_attribute_user(qNameArr[5]);
                if (sTTargetScreenSizeFind_attribute_user == null) {
                    sTTargetScreenSizeFind_attribute_user = (STTargetScreenSize) get_store().add_attribute_user(qNameArr[5]);
                }
                sTTargetScreenSizeFind_attribute_user.set(sTTargetScreenSize);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void xsetThicket(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTWebPublishing
    public void xsetVml(XmlBoolean xmlBoolean) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();

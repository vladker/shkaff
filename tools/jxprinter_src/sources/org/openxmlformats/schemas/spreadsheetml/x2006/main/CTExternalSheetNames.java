...
public interface CTExternalSheetNames extends XmlObject {
    ...
    CTExternalSheetName getSheetNameArray(int i5);

    CTExternalSheetName[] getSheetNameArray();

    List<CTExternalSheetName> getSheetNameList();

    CTExternalSheetName insertNewSheetName(int i5);

    void removeSheetName(int i5);

    void setSheetNameArray(int i5, CTExternalSheetName cTExternalSheetName);

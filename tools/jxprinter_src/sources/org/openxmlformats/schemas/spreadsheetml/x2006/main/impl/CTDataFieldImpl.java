...
public class CTDataFieldImpl extends XmlComplexContentImpl implements CTDataField {
    ...
    public STShowDataAs$Enum getShowDataAs() {
        ...
        synchronized (monitor()) {
            try {
                ...
                sTShowDataAs$Enum = simpleValue == null ? null : (STShowDataAs$Enum) simpleValue.getEnumValue();
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public STDataConsolidateFunction.Enum getSubtotal() {
        STDataConsolidateFunction.Enum r6;
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
                ...
                r6 = simpleValue == null ? null : (STDataConsolidateFunction.Enum) simpleValue.getEnumValue();
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataField
    public void setBaseField(int i5) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataField
    public void setBaseItem(long j6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDataField
    public void setSubtotal(STDataConsolidateFunction.Enum r6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public XmlInt xgetBaseField() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                xmlInt = (XmlInt) typeStore.find_attribute_user(qNameArr[5]);
                if (xmlInt == null) {
                    xmlInt = (XmlInt) get_default_attribute_value(qNameArr[5]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public STNumFmtId xgetNumFmtId() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTNumFmtId = (STNumFmtId) get_store().find_attribute_user(PROPERTY_QNAME[7]);
        }
        return sTNumFmtId;
    }
    ...
    public STShowDataAs xgetShowDataAs() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                sTShowDataAsFind_attribute_user = typeStore.find_attribute_user(qNameArr[4]);
                if (sTShowDataAsFind_attribute_user == null) {
                    sTShowDataAsFind_attribute_user = (STShowDataAs) get_default_attribute_value(qNameArr[4]);
                }
            } catch (Throwable th) {
                throw th;
            }
        }
        return sTShowDataAsFind_attribute_user;
    }
    ...
    public STDataConsolidateFunction xgetSubtotal() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                sTDataConsolidateFunction = (STDataConsolidateFunction) typeStore.find_attribute_user(qNameArr[3]);
                if (sTDataConsolidateFunction == null) {
                    sTDataConsolidateFunction = (STDataConsolidateFunction) get_default_attribute_value(qNameArr[3]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void xsetNumFmtId(STNumFmtId sTNumFmtId) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STNumFmtId sTNumFmtId2 = (STNumFmtId) typeStore.find_attribute_user(qNameArr[7]);
                if (sTNumFmtId2 == null) {
                    sTNumFmtId2 = (STNumFmtId) get_store().add_attribute_user(qNameArr[7]);
                }
    ...
    public void xsetShowDataAs(STShowDataAs sTShowDataAs) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STShowDataAs sTShowDataAsFind_attribute_user = typeStore.find_attribute_user(qNameArr[4]);
                if (sTShowDataAsFind_attribute_user == null) {
                    sTShowDataAsFind_attribute_user = (STShowDataAs) get_store().add_attribute_user(qNameArr[4]);
                }
    ...
    public void xsetSubtotal(STDataConsolidateFunction sTDataConsolidateFunction) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STDataConsolidateFunction sTDataConsolidateFunction2 = (STDataConsolidateFunction) typeStore.find_attribute_user(qNameArr[3]);
                if (sTDataConsolidateFunction2 == null) {
                    sTDataConsolidateFunction2 = (STDataConsolidateFunction) get_store().add_attribute_user(qNameArr[3]);
                }

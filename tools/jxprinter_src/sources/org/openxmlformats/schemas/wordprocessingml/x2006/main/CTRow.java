...
public interface CTRow extends XmlObject {
    ...
    static {
        DocumentFactory<CTRow> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctrow3b78type");
    ...
    CTCustomXmlCell getCustomXmlArray(int i5);
    ...
    CTCustomXmlCell insertNewCustomXml(int i5);
    ...
    CTSdtCell insertNewSdt(int i5);

    CTTc insertNewTc(int i5);
    ...
    void setCustomXmlArray(int i5, CTCustomXmlCell cTCustomXmlCell);
    ...
    void setSdtArray(int i5, CTSdtCell cTSdtCell);

    void setSdtArray(CTSdtCell[] cTSdtCellArr);

    void setTblPrEx(CTTblPrEx cTTblPrEx);

    void setTcArray(int i5, CTTc cTTc);

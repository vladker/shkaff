...
public class CTPaperSourceImpl extends XmlComplexContentImpl implements CTPaperSource {
    ...
    public CTPaperSourceImpl(SchemaType schemaType) {
        super(schemaType);
    }
    ...
    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTPaperSource
    public void xsetFirst(STDecimalNumber sTDecimalNumber) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTPaperSource
    public void xsetOther(STDecimalNumber sTDecimalNumber) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();

...
public interface STFtnPos extends XmlString {
    public static final Enum BENEATH_TEXT;
    public static final Enum DOC_END;
    ...
    public static final Enum PAGE_BOTTOM;
    public static final Enum SECT_END;
    ...
    static {
        ...
        PAGE_BOTTOM = Enum.forString("pageBottom");
        BENEATH_TEXT = Enum.forString("beneathText");
        SECT_END = Enum.forString("sectEnd");
        DOC_END = Enum.forString("docEnd");
    }

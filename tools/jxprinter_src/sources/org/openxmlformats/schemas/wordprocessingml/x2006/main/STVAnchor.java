...
public interface STVAnchor extends XmlString {
    public static final SimpleTypeFactory<STVAnchor> Factory;
    ...
    static {
        SimpleTypeFactory<STVAnchor> simpleTypeFactory = new SimpleTypeFactory<>(TypeSystemHolder.typeSystem, "stvanchora5b7type");
        Factory = simpleTypeFactory;
        type = simpleTypeFactory.getType();
        TEXT = Enum.forString("text");

...
public class CTSdtDropDownListImpl extends XmlComplexContentImpl implements CTSdtDropDownList {
    ...
    public List<CTSdtListItem> getListItemList() {
        ...
        synchronized (monitor()) {
            ...
            final int i5 = 0;
            final int i6 = 1;
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: s5.c3
                public final /* synthetic */ CTSdtDropDownListImpl b;
            ...
            }, new B0(this, 27), new Function(this) { // from class: s5.c3
                public final /* synthetic */ CTSdtDropDownListImpl b;

...
public interface CTFtnEdn extends XmlObject {
    public static final DocumentFactory<CTFtnEdn> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTFtnEdn> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctftnedncad9type");
    ...
    CTAltChunk getAltChunkArray(int i5);
    ...
    CTCustomXmlBlock getCustomXmlArray(int i5);
    ...
    CTSdtBlock getSdtArray(int i5);

    CTSdtBlock[] getSdtArray();

    List<CTSdtBlock> getSdtList();

    CTTbl getTblArray(int i5);
    ...
    CTAltChunk insertNewAltChunk(int i5);
    ...
    CTCustomXmlBlock insertNewCustomXml(int i5);
    ...
    CTSdtBlock insertNewSdt(int i5);

    CTTbl insertNewTbl(int i5);

    boolean isSetType();

    void removeAltChunk(int i5);
    ...
    void removeTbl(int i5);

    void setAltChunkArray(int i5, CTAltChunk cTAltChunk);
    ...
    void setCustomXmlArray(int i5, CTCustomXmlBlock cTCustomXmlBlock);
    ...
    void setSdtArray(int i5, CTSdtBlock cTSdtBlock);

    void setSdtArray(CTSdtBlock[] cTSdtBlockArr);

    void setTblArray(int i5, CTTbl cTTbl);

    void setTblArray(CTTbl[] cTTblArr);

    void setType(STFtnEdn.Enum r6);
    ...
    void xsetType(STFtnEdn sTFtnEdn);
}

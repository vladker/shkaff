...
public interface CTSimpleField extends XmlObject {
    public static final DocumentFactory<CTSimpleField> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTSimpleField> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctsimplefieldacaatype");

...
public interface CTRPrOriginal extends XmlObject {
    public static final DocumentFactory<CTRPrOriginal> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTRPrOriginal> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctrproriginal302dtype");

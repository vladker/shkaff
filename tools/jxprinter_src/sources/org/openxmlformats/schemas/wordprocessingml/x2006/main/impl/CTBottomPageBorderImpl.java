...
public class CTBottomPageBorderImpl extends CTPageBorderImpl implements CTBottomPageBorder {
    ...
    public CTBottomPageBorderImpl(SchemaType schemaType) {
        super(schemaType);
    }
    ...
    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTBottomPageBorder
    public void xsetBottomLeft(STRelationshipId sTRelationshipId) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTBottomPageBorder
    public void xsetBottomRight(STRelationshipId sTRelationshipId) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();

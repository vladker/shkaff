...
public interface CTBody extends XmlObject {
    public static final DocumentFactory<CTBody> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTBody> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctbody0f06type");

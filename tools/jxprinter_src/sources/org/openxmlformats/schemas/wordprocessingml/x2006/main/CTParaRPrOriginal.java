...
public interface CTParaRPrOriginal extends XmlObject {
    public static final DocumentFactory<CTParaRPrOriginal> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTParaRPrOriginal> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctpararproriginal7dadtype");

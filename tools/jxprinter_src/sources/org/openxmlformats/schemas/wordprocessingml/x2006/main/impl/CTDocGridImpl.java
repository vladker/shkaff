...
public class CTDocGridImpl extends XmlComplexContentImpl implements CTDocGrid {
    private static final QName[] PROPERTY_QNAME = {new QName(XSSFRelation.NS_WORDPROCESSINGML, "type"), new QName(XSSFRelation.NS_WORDPROCESSINGML, "linePitch"), new QName(XSSFRelation.NS_WORDPROCESSINGML, "charSpace")};
    private static final long serialVersionUID = 1;

    public CTDocGridImpl(SchemaType schemaType) {
        super(schemaType);
    }
    ...
    public STDocGrid.Enum getType() {
        ...
        synchronized (monitor()) {
            ...
            r6 = simpleValue == null ? null : (STDocGrid.Enum) simpleValue.getEnumValue();
        }
        return r6;
    }
    ...
    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTDocGrid
    public void xsetCharSpace(STDecimalNumber sTDecimalNumber) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTDocGrid
    public void xsetLinePitch(STDecimalNumber sTDecimalNumber) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public void xsetType(STDocGrid sTDocGrid) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STDocGrid sTDocGrid2 = (STDocGrid) typeStore.find_attribute_user(qNameArr[0]);
                if (sTDocGrid2 == null) {

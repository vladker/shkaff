...
public interface STHAnchor extends XmlString {
    public static final SimpleTypeFactory<STHAnchor> Factory;
    ...
    static {
        SimpleTypeFactory<STHAnchor> simpleTypeFactory = new SimpleTypeFactory<>(TypeSystemHolder.typeSystem, "sthanchord885type");

...
public interface CTTxbxContent extends XmlObject {
    public static final DocumentFactory<CTTxbxContent> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTTxbxContent> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "cttxbxcontent1133type");

...
public interface CTSmartTagRun extends XmlObject {
    public static final DocumentFactory<CTSmartTagRun> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTSmartTagRun> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctsmarttagrune098type");

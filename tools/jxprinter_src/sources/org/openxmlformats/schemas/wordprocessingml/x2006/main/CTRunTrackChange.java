...
public interface CTRunTrackChange extends CTTrackChange {
    public static final DocumentFactory<CTRunTrackChange> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTRunTrackChange> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctruntrackchangea458type");
    ...
    org.openxmlformats.schemas.officeDocument.x2006.math.CTR getR2Array(int i5);
    ...
    org.openxmlformats.schemas.officeDocument.x2006.math.CTR insertNewR2(int i5);
    ...
    void setR2Array(int i5, org.openxmlformats.schemas.officeDocument.x2006.math.CTR ctr);

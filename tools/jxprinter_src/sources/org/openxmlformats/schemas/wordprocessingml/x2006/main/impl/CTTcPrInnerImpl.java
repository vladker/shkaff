...
public class CTTcPrInnerImpl extends CTTcPrBaseImpl implements CTTcPrInner {
    ...
    public CTCellMergeTrackChange addNewCellMerge() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTCellMergeTrackChangeAdd_element_user = get_store().add_element_user(PROPERTY_QNAME[2]);
        }
    ...
    public CTCellMergeTrackChange getCellMerge() {
        CTCellMergeTrackChange cTCellMergeTrackChangeFind_element_user;
        synchronized (monitor()) {
            check_orphaned();
            cTCellMergeTrackChangeFind_element_user = get_store().find_element_user(PROPERTY_QNAME[2], 0);
            if (cTCellMergeTrackChangeFind_element_user == null) {
                cTCellMergeTrackChangeFind_element_user = null;
            }
        }
    ...
    public void setCellMerge(CTCellMergeTrackChange cTCellMergeTrackChange) {
        generatedSetterHelperImpl(cTCellMergeTrackChange, PROPERTY_QNAME[2], 0, (short) 1);
    }

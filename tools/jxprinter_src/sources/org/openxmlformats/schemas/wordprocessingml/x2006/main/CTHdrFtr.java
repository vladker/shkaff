...
public interface CTHdrFtr extends XmlObject {
    public static final DocumentFactory<CTHdrFtr> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTHdrFtr> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "cthdrftr26datype");

...
public class CTTblLookImpl extends XmlComplexContentImpl implements CTTblLook {
    ...
    public CTTblLookImpl(SchemaType schemaType) {
        super(schemaType);
    }
    ...
    public STShortHexNumber xgetVal() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTShortHexNumber = (STShortHexNumber) get_store().find_attribute_user(PROPERTY_QNAME[6]);
        }
    ...
    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblLook
    public void xsetNoHBand(STOnOff sTOnOff) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblLook
    public void xsetNoVBand(STOnOff sTOnOff) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public void xsetVal(STShortHexNumber sTShortHexNumber) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STShortHexNumber sTShortHexNumber2 = (STShortHexNumber) typeStore.find_attribute_user(qNameArr[6]);
                if (sTShortHexNumber2 == null) {
                    sTShortHexNumber2 = (STShortHexNumber) get_store().add_attribute_user(qNameArr[6]);
                }

...
public interface CTBdoContentRun extends XmlObject {
    public static final DocumentFactory<CTBdoContentRun> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTBdoContentRun> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctbdocontentrun8d93type");
    ...
    void setVal(STDirection.Enum r6);

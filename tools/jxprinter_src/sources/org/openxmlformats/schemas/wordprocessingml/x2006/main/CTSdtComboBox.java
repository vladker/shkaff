...
public interface CTSdtComboBox extends XmlObject {
    public static final DocumentFactory<CTSdtComboBox> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTSdtComboBox> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctsdtcomboboxdb52type");

...
public class CTSlideLayoutImpl extends XmlComplexContentImpl implements CTSlideLayout {
    ...
    public CTExtensionListModify addNewExtLst() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTExtensionListModifyAdd_element_user = get_store().add_element_user(PROPERTY_QNAME[5]);
        }
    ...
    public CTExtensionListModify getExtLst() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTExtensionListModifyFind_element_user = get_store().find_element_user(PROPERTY_QNAME[5], 0);
    ...
    public STSlideLayoutType.Enum getType() {
        ...
        synchronized (monitor()) {
            try {
                ...
                r6 = simpleValue == null ? null : (STSlideLayoutType.Enum) simpleValue.getEnumValue();
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public void setExtLst(CTExtensionListModify cTExtensionListModify) {
        generatedSetterHelperImpl(cTExtensionListModify, PROPERTY_QNAME[5], 0, (short) 1);
    }

    @Override // org.openxmlformats.schemas.presentationml.x2006.main.CTSlideLayout
    public void setHf(CTHeaderFooter cTHeaderFooter) {
        generatedSetterHelperImpl(cTHeaderFooter, PROPERTY_QNAME[4], 0, (short) 1);
    }
    ...
    @Override // org.openxmlformats.schemas.presentationml.x2006.main.CTSlideLayout
    public void setType(STSlideLayoutType.Enum r6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public XmlString xgetMatchingName() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                xmlString = (XmlString) typeStore.find_attribute_user(qNameArr[8]);
                if (xmlString == null) {
                    xmlString = (XmlString) get_default_attribute_value(qNameArr[8]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public STSlideLayoutType xgetType() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                sTSlideLayoutType = (STSlideLayoutType) typeStore.find_attribute_user(qNameArr[9]);
                if (sTSlideLayoutType == null) {
                    sTSlideLayoutType = (STSlideLayoutType) get_default_attribute_value(qNameArr[9]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void xsetType(STSlideLayoutType sTSlideLayoutType) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STSlideLayoutType sTSlideLayoutType2 = (STSlideLayoutType) typeStore.find_attribute_user(qNameArr[9]);
                if (sTSlideLayoutType2 == null) {
                    sTSlideLayoutType2 = (STSlideLayoutType) get_store().add_attribute_user(qNameArr[9]);
                }

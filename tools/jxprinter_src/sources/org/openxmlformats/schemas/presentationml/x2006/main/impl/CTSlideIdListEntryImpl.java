...
public class CTSlideIdListEntryImpl extends XmlComplexContentImpl implements CTSlideIdListEntry {
    ...
    public STSlideId xgetId() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTSlideId = (STSlideId) get_store().find_attribute_user(PROPERTY_QNAME[1]);
        }
        return sTSlideId;
    }
    ...
    public void xsetId(STSlideId sTSlideId) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STSlideId sTSlideId2 = (STSlideId) typeStore.find_attribute_user(qNameArr[1]);
                if (sTSlideId2 == null) {
                    sTSlideId2 = (STSlideId) get_store().add_attribute_user(qNameArr[1]);
                }

...
public interface CTTLTimeConditionList extends XmlObject {
    ...
    CTTLTimeCondition getCondArray(int i5);

    CTTLTimeCondition[] getCondArray();

    List<CTTLTimeCondition> getCondList();

    CTTLTimeCondition insertNewCond(int i5);

    void removeCond(int i5);

    void setCondArray(int i5, CTTLTimeCondition cTTLTimeCondition);

...
public interface CTSRgbColor extends XmlObject {
    public static final DocumentFactory<CTSRgbColor> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTSRgbColor> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctsrgbcolor5bdatype");
    ...
    STHexColorRGB xgetVal();

    void xsetVal(STHexColorRGB sTHexColorRGB);
}

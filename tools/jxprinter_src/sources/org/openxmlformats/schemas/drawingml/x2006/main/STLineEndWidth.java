...
public interface STLineEndWidth extends XmlToken {
    public static final SimpleTypeFactory<STLineEndWidth> Factory;
    ...
    static {
        SimpleTypeFactory<STLineEndWidth> simpleTypeFactory = new SimpleTypeFactory<>(TypeSystemHolder.typeSystem, "stlineendwidth16aatype");

...
public class CTBackgroundFillStyleListImpl extends XmlComplexContentImpl implements CTBackgroundFillStyleList {
    ...
    public List<CTBlipFillProperties> getBlipFillList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new C1173e(this, 0), new C1176f(this, 2), new C1173e(this, 9), new C1179g(this, 4), new C1182h(this, 4));
        }
    ...
    public List<CTGradientFillProperties> getGradFillList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new C1173e(this, 3), new C1176f(this, 1), new C1173e(this, 4), new C1179g(this, 1), new C1182h(this, 1));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTGroupFillProperties> getGrpFillList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new C1173e(this, 10), new C1176f(this, 5), new C1173e(this, 11), new C1179g(this, 5), new C1182h(this, 5));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTNoFillProperties> getNoFillList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new C1173e(this, 1), new C1176f(this, 0), new C1173e(this, 2), new C1179g(this, 0), new C1182h(this, 0));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTPatternFillProperties> getPattFillList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new C1173e(this, 5), new C1176f(this, 3), new C1173e(this, 6), new C1179g(this, 2), new C1182h(this, 2));
        }
        return javaListXmlObject;
    }
    ...
    public List<CTSolidColorFillProperties> getSolidFillList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new C1173e(this, 7), new C1176f(this, 4), new C1173e(this, 8), new C1179g(this, 3), new C1182h(this, 3));
        }
        return javaListXmlObject;
    }

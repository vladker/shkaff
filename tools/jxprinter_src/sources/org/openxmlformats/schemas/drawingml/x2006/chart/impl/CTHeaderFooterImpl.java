...
public class CTHeaderFooterImpl extends XmlComplexContentImpl implements CTHeaderFooter {
    private static final QName[] PROPERTY_QNAME = {new QName(XSSFRelation.NS_CHART, "oddHeader"), new QName(XSSFRelation.NS_CHART, "oddFooter"), new QName(XSSFRelation.NS_CHART, "evenHeader"), new QName(XSSFRelation.NS_CHART, "evenFooter"), new QName(XSSFRelation.NS_CHART, "firstHeader"), new QName(XSSFRelation.NS_CHART, "firstFooter"), new QName("", "alignWithMargins"), new QName("", "differentOddEven"), new QName("", "differentFirst")};

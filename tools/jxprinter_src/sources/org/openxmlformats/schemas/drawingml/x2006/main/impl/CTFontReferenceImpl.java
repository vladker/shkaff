...
public class CTFontReferenceImpl extends XmlComplexContentImpl implements CTFontReference {
    ...
    @Override // org.openxmlformats.schemas.drawingml.x2006.main.CTFontReference
    ...
    public STFontCollectionIndex.Enum getIdx() {
        STFontCollectionIndex.Enum r6;
        synchronized (monitor()) {
            check_orphaned();
            SimpleValue simpleValue = (SimpleValue) get_store().find_attribute_user(PROPERTY_QNAME[6]);
            r6 = simpleValue == null ? null : (STFontCollectionIndex.Enum) simpleValue.getEnumValue();
        }
        return r6;
    }
    ...
    @Override // org.openxmlformats.schemas.drawingml.x2006.main.CTFontReference
    public void setIdx(STFontCollectionIndex.Enum r6) {
        synchronized (monitor()) {
            try {
                check_orphaned();
    ...
    public STFontCollectionIndex xgetIdx() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            sTFontCollectionIndex = (STFontCollectionIndex) get_store().find_attribute_user(PROPERTY_QNAME[6]);
        }
    ...
    public void xsetIdx(STFontCollectionIndex sTFontCollectionIndex) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STFontCollectionIndex sTFontCollectionIndex2 = (STFontCollectionIndex) typeStore.find_attribute_user(qNameArr[6]);
                if (sTFontCollectionIndex2 == null) {
                    sTFontCollectionIndex2 = (STFontCollectionIndex) get_store().add_attribute_user(qNameArr[6]);
                }

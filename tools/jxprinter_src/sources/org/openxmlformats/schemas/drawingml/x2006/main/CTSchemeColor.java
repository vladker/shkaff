...
public interface CTSchemeColor extends XmlObject {
    public static final DocumentFactory<CTSchemeColor> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTSchemeColor> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctschemecolor5feftype");
    ...
    void setVal(STSchemeColorVal.Enum r6);

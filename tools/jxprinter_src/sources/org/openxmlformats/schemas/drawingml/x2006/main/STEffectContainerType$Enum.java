...
public final class STEffectContainerType$Enum extends StringEnumAbstractBase {
    ...
    private STEffectContainerType$Enum(String str, int i5) {
        super(str, i5);
    }

    public static STEffectContainerType$Enum forInt(int i5) {
        return (STEffectContainerType$Enum) table.forInt(i5);
    }

...
public class CTPieChartImpl extends XmlComplexContentImpl implements CTPieChart {
    ...
    public List<CTPieSer> getSerList() {
        ...
        synchronized (monitor()) {
            ...
            final int i5 = 0;
            final int i6 = 1;
            javaListXmlObject = new JavaListXmlObject(new Function(this) { // from class: k5.i0
                public final /* synthetic */ CTPieChartImpl b;
            ...
            }, new b(this, 13), new Function(this) { // from class: k5.i0
                public final /* synthetic */ CTPieChartImpl b;

...
public class CTTableCellImpl extends XmlComplexContentImpl implements CTTableCell {
    ...
    public CTTableCellProperties addNewTcPr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTableCellProperties = (CTTableCellProperties) get_store().add_element_user(PROPERTY_QNAME[1]);
        }
    ...
    public CTTextBody addNewTxBody() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTextBody = (CTTextBody) get_store().add_element_user(PROPERTY_QNAME[0]);
        }
        return cTTextBody;
    }
    ...
    public CTTableCellProperties getTcPr() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTableCellProperties = (CTTableCellProperties) get_store().find_element_user(PROPERTY_QNAME[1], 0);
    ...
    public CTTextBody getTxBody() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            cTTextBody = (CTTextBody) get_store().find_element_user(PROPERTY_QNAME[0], 0);
            if (cTTextBody == null) {
                cTTextBody = null;
            }
        }
    ...
    public XmlInt xgetGridSpan() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                xmlInt = (XmlInt) typeStore.find_attribute_user(qNameArr[4]);
                if (xmlInt == null) {
                    xmlInt = (XmlInt) get_default_attribute_value(qNameArr[4]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public XmlInt xgetRowSpan() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                xmlInt = (XmlInt) typeStore.find_attribute_user(qNameArr[3]);
                if (xmlInt == null) {
                    xmlInt = (XmlInt) get_default_attribute_value(qNameArr[3]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void xsetGridSpan(XmlInt xmlInt) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                XmlInt xmlInt2 = (XmlInt) typeStore.find_attribute_user(qNameArr[4]);
                if (xmlInt2 == null) {
                    xmlInt2 = (XmlInt) get_store().add_attribute_user(qNameArr[4]);
                }
                xmlInt2.set(xmlInt);
            } catch (Throwable th) {
                throw th;
    ...
    public void xsetRowSpan(XmlInt xmlInt) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                XmlInt xmlInt2 = (XmlInt) typeStore.find_attribute_user(qNameArr[3]);
                if (xmlInt2 == null) {
                    xmlInt2 = (XmlInt) get_store().add_attribute_user(qNameArr[3]);
                }
                xmlInt2.set(xmlInt);
            } catch (Throwable th) {
                throw th;

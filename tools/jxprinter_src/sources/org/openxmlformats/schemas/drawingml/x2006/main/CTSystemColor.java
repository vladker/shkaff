...
public interface CTSystemColor extends XmlObject {
    public static final DocumentFactory<CTSystemColor> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTSystemColor> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctsystemcolor4525type");
    ...
    void setVal(STSystemColorVal.Enum r6);
    ...
    STHexColorRGB xgetLastClr();

    STSystemColorVal xgetVal();

    void xsetLastClr(STHexColorRGB sTHexColorRGB);

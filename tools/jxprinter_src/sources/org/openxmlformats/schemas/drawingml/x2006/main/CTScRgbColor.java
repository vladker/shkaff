...
public interface CTScRgbColor extends XmlObject {
    public static final DocumentFactory<CTScRgbColor> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTScRgbColor> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctscrgbcolorf3e1type");

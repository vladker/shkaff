...
public class CTLine3DChartImpl extends XmlComplexContentImpl implements CTLine3DChart {
    ...
    public List<CTUnsignedInt> getAxIdList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new P(this, 0), new Q(this, 0), new P(this, 1), new S(this, 0), new T(this, 0));
        }
    ...
    public List<CTLineSer> getSerList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new P(this, 2), new Q(this, 1), new P(this, 3), new S(this, 1), new T(this, 1));
        }
        return javaListXmlObject;
    }

...
public class CTPageSetupImpl extends XmlComplexContentImpl implements CTPageSetup {
    ...
    public STPageSetupOrientation$Enum getOrientation() {
        ...
        synchronized (monitor()) {
            try {
                ...
                sTPageSetupOrientation$Enum = simpleValue == null ? null : (STPageSetupOrientation$Enum) simpleValue.getEnumValue();
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    @Override // org.openxmlformats.schemas.drawingml.x2006.chart.CTPageSetup
    public void setHorizontalDpi(int i5) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    @Override // org.openxmlformats.schemas.drawingml.x2006.chart.CTPageSetup
    public void setVerticalDpi(int i5) {
        synchronized (monitor()) {
            try {
                check_orphaned();
                TypeStore typeStore = get_store();
    ...
    public XmlUnsignedInt xgetCopies() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                xmlUnsignedInt = (XmlUnsignedInt) typeStore.find_attribute_user(qNameArr[10]);
                if (xmlUnsignedInt == null) {
                    xmlUnsignedInt = (XmlUnsignedInt) get_default_attribute_value(qNameArr[10]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public XmlInt xgetHorizontalDpi() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                xmlInt = (XmlInt) typeStore.find_attribute_user(qNameArr[8]);
                if (xmlInt == null) {
                    xmlInt = (XmlInt) get_default_attribute_value(qNameArr[8]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public STPageSetupOrientation xgetOrientation() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                sTPageSetupOrientationFind_attribute_user = typeStore.find_attribute_user(qNameArr[4]);
                if (sTPageSetupOrientationFind_attribute_user == null) {
                    sTPageSetupOrientationFind_attribute_user = (STPageSetupOrientation) get_default_attribute_value(qNameArr[4]);
                }
            } catch (Throwable th) {
                throw th;
            }
        }
        return sTPageSetupOrientationFind_attribute_user;
    }
    ...
    public XmlInt xgetVerticalDpi() {
        ...
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                xmlInt = (XmlInt) typeStore.find_attribute_user(qNameArr[9]);
                if (xmlInt == null) {
                    xmlInt = (XmlInt) get_default_attribute_value(qNameArr[9]);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void xsetHorizontalDpi(XmlInt xmlInt) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                XmlInt xmlInt2 = (XmlInt) typeStore.find_attribute_user(qNameArr[8]);
                if (xmlInt2 == null) {
                    xmlInt2 = (XmlInt) get_store().add_attribute_user(qNameArr[8]);
                }
                xmlInt2.set(xmlInt);
            } catch (Throwable th) {
                throw th;
    ...
    public void xsetOrientation(STPageSetupOrientation sTPageSetupOrientation) {
        synchronized (monitor()) {
            try {
                ...
                TypeStore typeStore = get_store();
                QName[] qNameArr = PROPERTY_QNAME;
                STPageSetupOrientation sTPageSetupOrientationFind_attribute_user = typeStore.find_attribute_user(qNameArr[4]);
                if (sTPageSetupOrientationFind_attribute_user == null) {
                    sTPageSetupOrientationFind_attribute_user = (STPageSetupOrientation) get_store().add_attribute_user(qNameArr[4]);
                }

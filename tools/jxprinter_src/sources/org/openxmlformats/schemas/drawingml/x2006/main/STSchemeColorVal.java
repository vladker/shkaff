...
public interface STSchemeColorVal extends XmlToken {
    ...
    public static final Enum BG_1;
    public static final Enum BG_2;
    ...
    public static final Enum PH_CLR;
    public static final Enum TX_1;
    public static final Enum TX_2;
    ...
    static {
        ...
        BG_1 = Enum.forString("bg1");
        TX_1 = Enum.forString("tx1");
        BG_2 = Enum.forString("bg2");
        TX_2 = Enum.forString("tx2");

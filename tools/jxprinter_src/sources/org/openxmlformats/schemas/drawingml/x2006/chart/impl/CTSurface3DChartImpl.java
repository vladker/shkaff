...
public class CTSurface3DChartImpl extends XmlComplexContentImpl implements CTSurface3DChart {
    ...
    public List<CTUnsignedInt> getAxIdList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new F0(this, 0), new G0(this, 0), new F0(this, 1), new H0(this, 0), new I0(this, 0));
        }
    ...
    public List<CTSurfaceSer> getSerList() {
        ...
        synchronized (monitor()) {
            check_orphaned();
            javaListXmlObject = new JavaListXmlObject(new F0(this, 2), new G0(this, 1), new F0(this, 3), new H0(this, 1), new I0(this, 1));
        }
        return javaListXmlObject;
    }

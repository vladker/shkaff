...
public final class Vlookup extends Var3or4ArgFunction {
    ...
    private LookupUtils.ValueVector createResultColumnVector(TwoDEval twoDEval, int i5) throws EvaluationException {
        if (i5 < twoDEval.getWidth()) {
            return LookupUtils.createColumnVector(twoDEval, i5);
        }
    ...
    public ValueEval evaluate(int i5, int i6, ValueEval valueEval, ValueEval valueEval2, ValueEval valueEval3, ValueEval valueEval4) {
        boolean zResolveRangeLookupArg;
        try {
            ...
            try {
                zResolveRangeLookupArg = LookupUtils.resolveRangeLookupArg(valueEval4, i5, i6);
            } catch (RuntimeException unused) {
                zResolveRangeLookupArg = true;
            }
            return createResultColumnVector(twoDEvalResolveTableArrayArg, LookupUtils.resolveRowOrColIndexArg(valueEval3, i5, i6)).getItem(LookupUtils.lookupFirstIndexOfValue(singleValue, LookupUtils.createColumnVector(twoDEvalResolveTableArrayArg, 0), zResolveRangeLookupArg));

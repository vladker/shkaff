...
public final class DollarDe extends Fixed2ArgFunction implements FreeRefFunction {
    ...
    public ValueEval evaluate(int i5, int i6, ValueEval valueEval, ValueEval valueEval2) {
        ...
        try {
            ...
            BigDecimal bigDecimalAdd = BigDecimal.valueOf(dDoubleValue).multiply(BigDecimal.valueOf(Math.pow(10.0d, length))).divide(BigDecimal.valueOf(iIntValue), MathContext.DECIMAL128).add(BigDecimal.valueOf(jLongValue));
            if (z6) {

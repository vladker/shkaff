...
public final class FloorPrecise implements FreeRefFunction {
    ...
    public ValueEval evaluate(ValueEval[] valueEvalArr, OperationEvaluationContext operationEvaluationContext) {
        ...
        try {
            ...
            return dAbs != 1.0d ? new NumberEval(MathX.scaledRoundUsingBigDecimal(dEvaluateValue2.doubleValue(), dAbs, RoundingMode.FLOOR)) : new NumberEval(Math.floor(dEvaluateValue2.doubleValue()));

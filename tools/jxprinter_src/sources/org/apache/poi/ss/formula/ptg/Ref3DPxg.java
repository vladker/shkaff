...
public final class Ref3DPxg extends RefPtgBase implements Pxg3D {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        final int i5 = 0;
        Supplier supplier = new Supplier(this) { // from class: org.apache.poi.ss.formula.ptg.r
            public final /* synthetic */ Ref3DPxg b;
        ...
        final int i6 = 1;
        Supplier supplier2 = new Supplier(this) { // from class: org.apache.poi.ss.formula.ptg.r
            public final /* synthetic */ Ref3DPxg b;
        ...
        final int i7 = 2;
        Supplier supplier3 = new Supplier(this) { // from class: org.apache.poi.ss.formula.ptg.r
            public final /* synthetic */ Ref3DPxg b;
        ...
        final int i8 = 3;
        return GenericRecordUtil.getGenericProperties("base", supplier, "externalWorkbookNumber", supplier2, "firstSheetName", supplier3, "lastSheetName", new Supplier(this) { // from class: org.apache.poi.ss.formula.ptg.r
            public final /* synthetic */ Ref3DPxg b;
    ...
    public Ref3DPxg(int i5, SheetIdentifier sheetIdentifier, String str) {
        this(i5, sheetIdentifier, new CellReference(str));
    }

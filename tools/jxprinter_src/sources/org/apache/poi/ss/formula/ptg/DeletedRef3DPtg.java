...
public final class DeletedRef3DPtg extends OperandPtg implements WorkbookDependentFormula {
    ...
    public Map<String, Supplier<?>> getGenericProperties() {
        final int i5 = 0;
        final int i6 = 1;
        return GenericRecordUtil.getGenericProperties("externSheetIndex", new Supplier(this) { // from class: org.apache.poi.ss.formula.ptg.l
            public final /* synthetic */ DeletedRef3DPtg b;
        ...
        }, "unused1", new Supplier(this) { // from class: org.apache.poi.ss.formula.ptg.l
            public final /* synthetic */ DeletedRef3DPtg b;

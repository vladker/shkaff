...
public final class SlideShowFactory {
    ...
    public static SlideShow<?, ?> create(boolean z6) {
        return wp(z6 ? FileMagic.OOXML : FileMagic.OLE2, new d());
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ SlideShow lambda$create$4(File file, String str, boolean z6, SlideShowProvider slideShowProvider) {
        return slideShowProvider.create(file, str, z6);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ SlideShow lambda$create$5(File file, String str, boolean z6, SlideShowProvider slideShowProvider) {
        return slideShowProvider.create(file, str, z6);
    }
    ...
    public static void removeProvider(final Class<? extends SlideShowProvider<?, ?>> cls) {
        Singleton.INSTANCE.provider.removeIf(new Predicate() { // from class: org.apache.poi.sl.usermodel.e
            ...
            public final boolean test(Object obj) {
                return SlideShowFactory.lambda$removeProvider$6(cls, (SlideShowProvider) obj);
            }
        });
    }
    ...
    public static SlideShow<?, ?> create(DirectoryNode directoryNode, String str) {
        if (!directoryNode.hasEntry(Decryptor.DEFAULT_POIFS_ENTRY) && !directoryNode.hasEntry(ExtractorFactory.OOXML_PACKAGE)) {
            return wp(FileMagic.OLE2, new b(directoryNode, str, 1));
        }
        return wp(FileMagic.OOXML, new b(directoryNode, str, 0));
    }
    ...
    public static SlideShow<?, ?> create(InputStream inputStream, String str) {
        ...
        if (inputStreamPrepareToCheckMagic.read(new byte[1]) >= 1) {
            ...
            if (fileMagic == fileMagicValueOf) {
                return wp(fileMagicValueOf, new ProviderMethod() { // from class: org.apache.poi.sl.usermodel.f
                    ...
                    public final SlideShow create(SlideShowProvider slideShowProvider) {
                        return SlideShowFactory.lambda$create$2(inputStreamPrepareToCheckMagic, slideShowProvider);
                    }
                });
            }
            if (FileMagic.OLE2 == fileMagicValueOf) {
                ...
                return wp(fileMagicValueOf, new b(pOIFSFileSystem, str, 2));
            }
            throw new IOException("Can't open slideshow - unsupported file type: " + fileMagicValueOf);
        }
    ...
    public static SlideShow<?, ?> create(final File file, final String str, final boolean z6) {
        if (!file.exists()) {
        ...
        if (file.length() != 0) {
            ...
            if (fileMagicValueOf == fileMagic) {
                final int i5 = 0;
                return wp(fileMagicValueOf, new ProviderMethod() { // from class: org.apache.poi.sl.usermodel.c
                    @Override // org.apache.poi.sl.usermodel.SlideShowFactory.ProviderMethod
                    public final SlideShow create(SlideShowProvider slideShowProvider) {
                        switch (i5) {
                            case 0:
                                return SlideShowFactory.lambda$create$4(file, str, z6, slideShowProvider);
                            default:
                                return SlideShowFactory.lambda$create$5(file, str, z6, slideShowProvider);
                        }
                    }
                });
            }

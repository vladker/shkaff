...
public enum ShapeType {
    ...
    ShapeType(int i5, int i6, String str) {
        this.ooxmlId = i5;
        this.nativeId = i6;
        this.nativeName = str;
    }

    public static ShapeType forId(int i5, boolean z6) {
        if (!z6 && i5 == 4095) {
            return NOT_PRIMITIVE;
        }
        for (ShapeType shapeType : values()) {
            if ((z6 && shapeType.ooxmlId == i5) || (!z6 && shapeType.nativeId == i5)) {
                return shapeType;
            }
        }
        throw new IllegalArgumentException(AbstractC0157z.k(i5, "Unknown shape type: "));
    }
    ...
    public String getOoxmlName() {
        ...
        for (char c : name().toCharArray()) {
            if (c == '_') {
                ...
                sb.append(z6 ? StringUtil.toLowerCase(c) : StringUtil.toUpperCase(c));
                z6 = true;
            }
        }
        return sb.toString();

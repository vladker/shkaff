...
public class XDDFAreaChartData extends XDDFChartData {
    ...
    @Internal
    public XDDFAreaChartData(XDDFChart xDDFChart, CTAreaChart cTAreaChart, Map<Long, XDDFChartAxis> map, Map<Long, XDDFValueAxis> map2) {
        super(xDDFChart);
        this.chart = cTAreaChart;
        for (CTAreaSer cTAreaSer : cTAreaChart.getSerList()) {
            this.series.add(new Series(cTAreaSer, cTAreaSer.getCat(), cTAreaSer.getVal()));
        }
        defineAxes(map, map2);
    }
    ...
    public XDDFChartData.Series addSeries(XDDFDataSource<?> xDDFDataSource, XDDFNumericalDataSource<? extends Number> xDDFNumericalDataSource) {
        ...
        CTAreaSer cTAreaSerAddNewSer = this.chart.addNewSer();
        cTAreaSerAddNewSer.addNewCat();
        cTAreaSerAddNewSer.addNewVal();
        cTAreaSerAddNewSer.addNewIdx().setVal(jIncrementSeriesCount);
        cTAreaSerAddNewSer.addNewOrder().setVal(jIncrementSeriesCount);
        Series series = new Series(cTAreaSerAddNewSer, xDDFDataSource, xDDFNumericalDataSource);
    ...
    public class Series extends XDDFChartData.Series {
        ...
        public Series(CTAreaSer cTAreaSer, XDDFDataSource<?> xDDFDataSource, XDDFNumericalDataSource<? extends Number> xDDFNumericalDataSource) {
        ...
        public Series(CTAreaSer cTAreaSer, CTAxDataSource cTAxDataSource, CTNumDataSource cTNumDataSource) {

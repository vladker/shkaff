...
public class XDDFLineChartData extends XDDFChartData {
    ...
    @Internal
    public XDDFLineChartData(XDDFChart xDDFChart, CTLineChart cTLineChart, Map<Long, XDDFChartAxis> map, Map<Long, XDDFValueAxis> map2) {
        super(xDDFChart);
        this.chart = cTLineChart;
        for (CTLineSer cTLineSer : cTLineChart.getSerList()) {
            this.series.add(new Series(cTLineSer, cTLineSer.getCat(), cTLineSer.getVal()));
        }
        defineAxes(map, map2);
    }
    ...
    public XDDFChartData.Series addSeries(XDDFDataSource<?> xDDFDataSource, XDDFNumericalDataSource<? extends Number> xDDFNumericalDataSource) {
        ...
        CTLineSer cTLineSerAddNewSer = this.chart.addNewSer();
        cTLineSerAddNewSer.addNewCat();
        cTLineSerAddNewSer.addNewVal();
        cTLineSerAddNewSer.addNewIdx().setVal(jIncrementSeriesCount);
        cTLineSerAddNewSer.addNewOrder().setVal(jIncrementSeriesCount);
        Series series = new Series(cTLineSerAddNewSer, xDDFDataSource, xDDFNumericalDataSource);
    ...
    public class Series extends XDDFChartData.Series {
        ...
        public Series(CTLineSer cTLineSer, XDDFDataSource<?> xDDFDataSource, XDDFNumericalDataSource<? extends Number> xDDFNumericalDataSource) {
        ...
        public Series(CTLineSer cTLineSer, CTAxDataSource cTAxDataSource, CTNumDataSource cTNumDataSource) {

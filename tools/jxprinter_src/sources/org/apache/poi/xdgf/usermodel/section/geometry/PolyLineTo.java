...
public class PolyLineTo implements GeometryRow {
        ...
        while (i5 < length) {
            ...
            switch (n6) {
                ...
                default:
                    switch (b) {
                        case 0:
                            this.f7298a = cellType.getV();
                            break;
                        case 1:
                            this.f7299x = XDGFCell.parseDoubleValue(cellType);
                            break;
                        case 2:
                            this.f7300y = XDGFCell.parseDoubleValue(cellType);
                            break;
                        default:
    ...
    public String getA() {
        ...
        return str == null ? this._master.f7298a : str;
    }
    ...
    public Double getX() {
        Double d = this.f7299x;
        return d == null ? this._master.f7299x : d;
    }

    public Double getY() {
        Double d = this.f7300y;
        return d == null ? this._master.f7300y : d;
    }

...
public enum Borders {
    ...
    public static Borders valueOf(int i5) {
        Borders borders = imap.get(Integer.valueOf(i5));
        if (borders != null) {
            return borders;
        }
        throw new IllegalArgumentException(AbstractC0157z.k(i5, "Unknown paragraph border: "));
    }
}

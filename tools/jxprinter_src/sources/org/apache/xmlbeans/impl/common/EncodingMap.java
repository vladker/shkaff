...
public class EncodingMap {
    ...
    private static final Map<String, String> _iana_to_java = new HashMap();
    ...
    static {
        ...
        addMapping(StringUtils.GB2312, "CSGB2312", false);
        addMapping(StringUtils.GB2312, StringUtils.GB2312, true);
        ...
        addMapping(StringUtils.SHIFT_JIS, "CSSHIFTJIS", false);
        addMapping(StringUtils.SHIFT_JIS, "MS_KANJI", false);
        addMapping(StringUtils.SHIFT_JIS, "SHIFT_JIS", true);
    ...
    private static void addMapping(String str, String str2, boolean z6) {
    ...
    private static boolean completeMappings() {
        ...
        Iterator<String> it = _iana_to_java.keySet().iterator();
        while (it.hasNext()) {
            map.put(_iana_to_java.get(it.next()), null);
        }
    ...
    public static String getIANA2JavaMapping(String str) {
        String str2 = _iana_to_java.get(str.toUpperCase(Locale.ROOT));
        if (str2 != null) {
            return str2;
        }
    ...
    public static String getJava2IANAMapping(String str) {
        String str2 = _java_to_iana.get(str.toUpperCase(Locale.ROOT));
        if (str2 != null) {
            return str2;
        }
        if (Charset.isSupported(str)) {

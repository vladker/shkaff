...
public enum Relationship {
    ...
    /* JADX INFO: renamed from: org.apache.commons.math3.optimization.linear.Relationship$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-ecf7e14176b8e73200efbc86dd80f717955f363e9b0ac3efdea3eedd88177748 */
    ...
    public Relationship oppositeRelationship() {
        int i5 = AnonymousClass1.$SwitchMap$org$apache$commons$math3$optimization$linear$Relationship[ordinal()];
        if (i5 != 1) {
            return i5 != 2 ? EQ : LEQ;
        }
        return GEQ;

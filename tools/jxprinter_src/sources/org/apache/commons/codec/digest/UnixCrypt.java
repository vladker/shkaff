...
public class UnixCrypt {
    ...
    private static int[] body(int[] iArr, int i5, int i6) {
        int i7 = 0;
        int i8 = 0;
        int i9 = 0;
        while (i7 < 25) {
            ...
            while (i10 < 32) {
                ...
                int i11 = i5;
                int i12 = iDEncrypt;
                int iDEncrypt2 = dEncrypt(i9, i12, i10, i11, i6, iArr2);
                int i13 = i10;
                iDEncrypt = dEncrypt(i12, iDEncrypt2, i13 + 2, i11, i6, iArr2);
                i10 = i13 + 4;
                i9 = iDEncrypt2;
                i5 = i11;
                iArr = iArr2;
        ...
        int[] iArr3 = new int[2];
        permOp((i9 >>> 1) | (i9 << 31), (i8 >>> 1) | (i8 << 31), 1, 1431655765, iArr3);
    ...
    private static int dEncrypt(int i5, int i6, int i7, int i8, int i9, int[] iArr) {
        int i10 = (i6 >>> 16) ^ i6;
        int i11 = i8 & i10;
        int i12 = i9 & i10;
        int i13 = ((i11 ^ (i11 << 16)) ^ i6) ^ iArr[i7];
        int i14 = (i6 ^ (i12 ^ (i12 << 16))) ^ iArr[i7 + 1];
        int i15 = (i14 << 28) | (i14 >>> 4);
        int[][] iArr2 = SPTRANS;
        return i5 ^ (((((iArr2[7][(i15 >>> 24) & 63] | ((iArr2[1][i15 & 63] | iArr2[3][(i15 >>> 8) & 63]) | iArr2[5][(i15 >>> 16) & 63])) | iArr2[0][i13 & 63]) | iArr2[2][(i13 >>> 8) & 63]) | iArr2[4][(i13 >>> 16) & 63]) | iArr2[6][(i13 >>> 24) & 63]);
    }
    ...
    private static int[] desSetKey(byte[] bArr) {
        ...
        int i8 = iArr2[0];
        int i9 = iArr2[1];
        int i10 = ((i8 & 16711680) >>> 16) | ((i8 & 255) << 16) | (65280 & i8) | (((-268435456) & i9) >>> 4);
        int i11 = i9 & 268435455;
        int i12 = 0;
        int i13 = 0;
        while (i12 < 16) {
            if (SHIFT2[i12]) {
            ...
            int i14 = i7 | i6;
            int i15 = i5 & 268435455;
            int i16 = i14 & 268435455;
            int[][] iArr3 = SKB;
            int i17 = iArr3[0][i5 & 63] | iArr3[1][((i15 >>> 6) & 3) | ((i15 >>> 7) & 60)] | iArr3[2][((i15 >>> 13) & 15) | ((i15 >>> 14) & 48)] | iArr3[3][((i15 >>> 20) & 1) | ((i15 >>> 21) & 6) | ((i15 >>> 22) & 56)];
            int i18 = iArr3[4][i14 & 63] | iArr3[5][((i16 >>> 7) & 3) | ((i16 >>> 8) & 60)] | iArr3[6][(i16 >>> 15) & 63] | iArr3[7][((i16 >>> 21) & 15) | ((i16 >>> 22) & 48)];
            iArr[i13] = (i18 << 16) | (65535 & i17);
            int i19 = (i18 & SupportMenu.CATEGORY_MASK) | (i17 >>> 16);
            i13 += 2;
            iArr[i13 + 1] = (i19 >>> 28) | (i19 << 4);
            i12++;
            i11 = i15;
            i10 = i16;
        }
    ...
    private static int fourBytesToInt(byte[] bArr, int i5) {
        int iByteToUnsigned = (byteToUnsigned(bArr[i5 + 1]) << 8) | byteToUnsigned(bArr[i5]);
        return (byteToUnsigned(bArr[i5 + 3]) << 24) | iByteToUnsigned | (byteToUnsigned(bArr[i5 + 2]) << 16);
    }

    private static int hPermOp(int i5, int i6, int i7) {
        int i8 = 16 - i6;
        int i9 = i7 & ((i5 << i8) ^ i5);
        return (i5 ^ i9) ^ (i9 >>> i8);
    }

    private static void intToFourBytes(int i5, byte[] bArr, int i6) {
        bArr[i6] = (byte) (i5 & 255);
    ...
    private static void permOp(int i5, int i6, int i7, int i8, int[] iArr) {
        int i9 = i8 & ((i5 >>> i7) ^ i6);
        iArr[0] = i5 ^ (i9 << i7);
        iArr[1] = i6 ^ i9;
    }
    ...
    public static String crypt(byte[] bArr, String str) {
        ...
        int[] iArrBody = body(desSetKey(bArr2), i5, i6);
        ...
        for (int i11 = 2; i11 < 13; i11++) {
            ...
            for (int i13 = 0; i13 < 6; i13++) {
                ...
                sb.setCharAt(i11, (char) COV2CHAR[i12]);
            }
        }
        return sb.toString();
    }

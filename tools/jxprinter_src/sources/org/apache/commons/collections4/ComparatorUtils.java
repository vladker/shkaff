...
public class ComparatorUtils {
    ...
    public static Comparator<Boolean> booleanComparator(boolean z6) {
        return BooleanComparator.booleanComparator(z6);
    }
    ...
    public static <E> E max(E e, E e6, Comparator<E> comparator) {
        if (comparator == null) {
            comparator = NATURAL_COMPARATOR;
        }
        return comparator.compare(e, e6) > 0 ? e : e6;
    }

    public static <E> E min(E e, E e6, Comparator<E> comparator) {
        if (comparator == null) {
            comparator = NATURAL_COMPARATOR;
        }
        return comparator.compare(e, e6) < 0 ? e : e6;

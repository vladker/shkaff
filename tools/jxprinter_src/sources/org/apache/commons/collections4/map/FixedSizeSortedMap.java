...
public class FixedSizeSortedMap<K, V> extends AbstractSortedMapDecorator<K, V> implements BoundedMap<K, V>, Serializable {
    ...
    public SortedMap<K, V> headMap(K k6) {
        return new FixedSizeSortedMap(getSortedMap().headMap(k6));
    }
    ...
    public SortedMap<K, V> subMap(K k6, K k7) {
        return new FixedSizeSortedMap(getSortedMap().subMap(k6, k7));
    }

    @Override // org.apache.commons.collections4.map.AbstractSortedMapDecorator, java.util.SortedMap
    public SortedMap<K, V> tailMap(K k6) {
        return new FixedSizeSortedMap(getSortedMap().tailMap(k6));
    }

...
public final class UnmodifiableNavigableSet<E> extends AbstractNavigableSetDecorator<E> implements Unmodifiable {
    ...
    public SortedSet<E> subSet(E e, E e6) {
        return UnmodifiableSortedSet.unmodifiableSortedSet(decorated().subSet(e, e6));
    }
    ...
    public NavigableSet<E> headSet(E e, boolean z6) {
        return unmodifiableNavigableSet(decorated().headSet(e, z6));
    }

    @Override // org.apache.commons.collections4.set.AbstractNavigableSetDecorator, java.util.NavigableSet
    public NavigableSet<E> subSet(E e, boolean z6, E e6, boolean z7) {
        return unmodifiableNavigableSet(decorated().subSet(e, z6, e6, z7));
    }

    @Override // org.apache.commons.collections4.set.AbstractNavigableSetDecorator, java.util.NavigableSet
    public NavigableSet<E> tailSet(E e, boolean z6) {
        return unmodifiableNavigableSet(decorated().tailSet(e, z6));
    }
}

...
public interface Logger {
    ...
    <T extends Throwable> T throwing(T t6);

    <T extends Throwable> T throwing(Level level, T t6);
    ...
    <R> R traceExit(String str, R r6);

    <R> R traceExit(EntryMessage entryMessage, R r6);

    <R> R traceExit(Message message, R r6);
    ...
    default void logMessage(Level level, Marker marker, String str, StackTraceElement stackTraceElement, Message message, Throwable th) {
    }
}

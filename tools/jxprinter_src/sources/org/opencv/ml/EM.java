...
public class EM extends StatModel {
    ...
    public static EM __fromPtr__(long j6) {
        return new EM(j6);
    }
    ...
    private static native int getClustersNumber_0(long j6);

    private static native int getCovarianceMatrixType_0(long j6);

    private static native void getCovs_0(long j6, long j7);

    private static native long getMeans_0(long j6);
    ...
    private static native double[] predict2_0(long j6, long j7, long j8);
    ...
    private static native void setClustersNumber_0(long j6, int i5);

    private static native void setCovarianceMatrixType_0(long j6, int i5);

    private static native void setTermCriteria_0(long j6, int i5, int i6, double d);

    private static native boolean trainEM_0(long j6, long j7, long j8, long j9, long j10);

    private static native boolean trainEM_1(long j6, long j7, long j8, long j9);

    private static native boolean trainEM_2(long j6, long j7, long j8);

    private static native boolean trainEM_3(long j6, long j7);

    private static native boolean trainE_0(long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13);

    private static native boolean trainE_1(long j6, long j7, long j8, long j9, long j10, long j11, long j12);

    private static native boolean trainE_2(long j6, long j7, long j8, long j9, long j10, long j11);

    private static native boolean trainE_3(long j6, long j7, long j8, long j9, long j10);

    private static native boolean trainE_4(long j6, long j7, long j8, long j9);

    private static native boolean trainE_5(long j6, long j7, long j8);

    private static native boolean trainM_0(long j6, long j7, long j8, long j9, long j10, long j11);

    private static native boolean trainM_1(long j6, long j7, long j8, long j9, long j10);

    private static native boolean trainM_2(long j6, long j7, long j8, long j9);

    private static native boolean trainM_3(long j6, long j7, long j8);
    ...
    public void setClustersNumber(int i5) {
        setClustersNumber_0(this.nativeObj, i5);
    }

    public void setCovarianceMatrixType(int i5) {
        setCovarianceMatrixType_0(this.nativeObj, i5);
    }

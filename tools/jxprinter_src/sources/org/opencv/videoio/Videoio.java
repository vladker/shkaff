...
public class Videoio {
    ...
    public static String getBackendName(int i5) {
        return getBackendName_0(i5);
    }

    private static native String getBackendName_0(int i5);

    public static String getCameraBackendPluginVersion(int i5, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        String cameraBackendPluginVersion_0 = getCameraBackendPluginVersion_0(i5, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
    ...
    private static native String getCameraBackendPluginVersion_0(int i5, double[] dArr, double[] dArr2);

    public static String getStreamBackendPluginVersion(int i5, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        String streamBackendPluginVersion_0 = getStreamBackendPluginVersion_0(i5, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
    ...
    private static native String getStreamBackendPluginVersion_0(int i5, double[] dArr, double[] dArr2);

    public static String getWriterBackendPluginVersion(int i5, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        String writerBackendPluginVersion_0 = getWriterBackendPluginVersion_0(i5, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
    ...
    private static native String getWriterBackendPluginVersion_0(int i5, double[] dArr, double[] dArr2);

    public static boolean hasBackend(int i5) {
        return hasBackend_0(i5);
    }

    private static native boolean hasBackend_0(int i5);

    public static boolean isBackendBuiltIn(int i5) {
        return isBackendBuiltIn_0(i5);
    }

    private static native boolean isBackendBuiltIn_0(int i5);
}

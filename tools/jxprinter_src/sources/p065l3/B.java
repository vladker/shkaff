...
public final class B extends AtomicInteger implements I, c {
    ...
    public volatile boolean f5795i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public Object f5796j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public volatile int f5797k;

    public B(I i5, o oVar, int i6, int i7) {
        this.f5791a = i5;
        this.b = oVar;
        this.f5792f = i7;
        this.e = new d(i6);
    ...
    public final void onSubscribe(c cVar) {
        if (p033f3.d.g(this.f5793g, cVar)) {
            this.f5793g = cVar;

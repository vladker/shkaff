...
class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            this.mLoader.dump(a.n(str, "  "), fileDescriptor, printWriter, strArr);
            if (this.mObserver != null) {
                printWriter.print(str);
                printWriter.print("mCallbacks=");
                printWriter.println(this.mObserver);
                this.mObserver.dump(a.n(str, "  "), printWriter);
            }
            printWriter.print(str);
    ...
    public static class LoaderViewModel extends ViewModel {
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            if (this.mLoaders.size() > 0) {
                ...
                for (int i5 = 0; i5 < this.mLoaders.size(); i5++) {
                    LoaderInfo loaderInfoValueAt = this.mLoaders.valueAt(i5);
                    printWriter.print(str);
                    printWriter.print("  #");
        ...
        public <D> LoaderInfo<D> getLoader(int i5) {
        ...
        public void putLoader(int i5, @NonNull LoaderInfo loaderInfo) {
    ...
    private <D> Loader<D> createAndInstallLoader(int i5, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks, @Nullable Loader<D> loader) {
        try {
            ...
            Loader<D> loaderOnCreateLoader = loaderCallbacks.onCreateLoader(i5, bundle);
            ...
            LoaderInfo loaderInfo = new LoaderInfo(i5, bundle, loaderOnCreateLoader, loader);
            if (DEBUG) {
    ...
    public <D> Loader<D> restartLoader(int i5, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        ...
        LoaderInfo<D> loader = this.mLoaderViewModel.getLoader(i5);
        return createAndInstallLoader(i5, bundle, loaderCallbacks, loader != null ? loader.destroy(false) : null);
    }

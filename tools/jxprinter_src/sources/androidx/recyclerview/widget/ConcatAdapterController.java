...
class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    private WrapperAndLocalPosition findWrapperAndLocalPosition(int i5) {
        ...
        throw new IllegalArgumentException(AbstractC0157z.k(i5, "Cannot find wrapper for "));
    }
    ...
    public long getItemId(int i5) {
        WrapperAndLocalPosition wrapperAndLocalPositionFindWrapperAndLocalPosition = findWrapperAndLocalPosition(i5);
    ...
    public int getLocalAdapterPosition(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder viewHolder, int i5) {
        ...
        int iCountItemsBefore = i5 - countItemsBefore(nestedAdapterWrapper);
        ...
        StringBuilder sbS = a.s("Detected inconsistent adapter updates. The local position of the view holder maps to ", iCountItemsBefore, itemCount, " which is out of bounds for the adapter with size ", ".Make sure to immediately call notify methods in your adapter when you change the backing dataviewHolder:");
        sbS.append(viewHolder);
        sbS.append("adapter:");
        sbS.append(adapter);
    ...
    public void onItemRangeMoved(@NonNull NestedAdapterWrapper nestedAdapterWrapper, int i5, int i6) {
        ...
        this.mConcatAdapter.notifyItemMoved(i5 + iCountItemsBefore, i6 + iCountItemsBefore);
    }

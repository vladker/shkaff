...
public final class MutableLongIntMap extends LongIntMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableLongIntMap.findFirstAvailableSlot(i8 >>> 7);
                long j7 = i8 & 127;
                ...
                iArr2[iFindFirstAvailableSlot] = iArr[i7];
            }
            i7++;
    ...
    public final int getOrPut(long j6, O3.a defaultValue) {
    ...
    public final void put(long j6, int i5) {
        set(j6, i5);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(Long.valueOf(this.keys[i8]), Integer.valueOf(this.values[i8]))).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public /* synthetic */ MutableLongIntMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final int put(long j6, int i5, int i6) {
        int iFindInsertIndex = findInsertIndex(j6);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(long j6, int i5) {
        int iFindKeyIndex = findKeyIndex(j6);

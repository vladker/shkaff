...
public abstract class LongObjectMap<V> {
    ...
    public /* synthetic */ LongObjectMap(AbstractC1107v abstractC1107v) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        ...
        return longObjectMap.joinToString(charSequence, charSequence2, charSequence6, i5, charSequence5);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (!((Boolean) predicate.invoke(Long.valueOf(jArr[i8]), objArr[i8])).booleanValue()) {
                            return false;
                        }
                    }
                    j6 >>= 8;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i7 < i6) {
                    if ((255 & j6) < 128) {
                        ...
                        } else if (!obj2.equals(longObjectMap.get(j7))) {
                            return false;
                        }
                    } else {
                        z7 = z8;
    ...
    public final int findKeyIndex$collection(long j6) {
        int iHashCode = Long.hashCode(j6) * ScatterMapKt.MurmurHashC1;
        int i5 = iHashCode ^ (iHashCode << 16);
        int i6 = i5 & 127;
        int i7 = this._capacity;
    ...
    public final V getOrDefault(long j6, V v6) {
        int iNumberOfTrailingZeros;
        int iHashCode = Long.hashCode(j6) * ScatterMapKt.MurmurHashC1;
        int i5 = iHashCode ^ (iHashCode << 16);
        int i6 = i5 & 127;
    ...
    public final V getOrElse(long j6, O3.a defaultValue) {
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j6) < 128) {
                        int i9 = (i5 << 3) + i8;
                        if (((Boolean) predicate.invoke(Long.valueOf(jArr[i9]), objArr[i9])).booleanValue()) {
                            i6++;
                        }
                    }
                    j6 >>= 8;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sbV.append((CharSequence) pVar.invoke(Long.valueOf(j7), obj));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;
                ...
                if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j6 & 255) < 128) {
                            ...
                            sbV.append((CharSequence) pVar.invoke(Long.valueOf(j7), obj2));
                            i9++;
                        }
                        j6 >>= i11;
                        i13++;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sb.append((CharSequence) transform.invoke(Long.valueOf(j7), obj));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;

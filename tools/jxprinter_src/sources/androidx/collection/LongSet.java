...
public abstract class LongSet {
    ...
    public /* synthetic */ LongSet(AbstractC1107v abstractC1107v) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(LongSet longSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        ...
        return longSet.joinToString(charSequence, charSequence2, charSequence6, i5, charSequence5);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128 && !((Boolean) predicate.invoke(Long.valueOf(jArr[(i5 << 3) + i7]))).booleanValue()) {
                        return false;
                    }
                    j6 >>= 8;
                }
    ...
    public final boolean contains(long j6) {
        ...
        loop0: while (true) {
            ...
            for (long j9 = (~j8) & (j8 - ScatterMapKt.BitmaskLsb) & (-9187201950435737472L); j9 != 0; j9 &= j9 - 1) {
                iNumberOfTrailingZeros = ((Long.numberOfTrailingZeros(j9) >> 3) + i8) & i7;
                if (this.elements[iNumberOfTrailingZeros] == j6) {
                    break loop0;
                }
            }
        ...
        if (length >= 0) {
            ...
            while (true) {
                ...
                if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                    int i6 = 8 - ((~(i5 - length)) >>> 31);
                    for (int i7 = 0; i7 < i6; i7++) {
                        if ((255 & j6) < 128 && !longSet.contains(jArr[(i5 << 3) + i7])) {
                            return false;
                        }
                        j6 >>= 8;
                    }
    ...
    public final int findElementIndex$collection(long j6) {
        int iHashCode = Long.hashCode(j6) * ScatterMapKt.MurmurHashC1;
        int i5 = iHashCode ^ (iHashCode << 16);
        int i6 = i5 & 127;
        int i7 = this._capacity;
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j6) < 128 && ((Boolean) predicate.invoke(Long.valueOf(jArr[(i5 << 3) + i8]))).booleanValue()) {
                        i6++;
                    }
                    j6 >>= 8;
                }
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j6) < 128) {
                        ...
                        sbU.append((CharSequence) lVar.invoke(Long.valueOf(j7)));
                        i6++;
                    }
                    j6 >>= 8;
                }
  ...
  0x00ab: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:28:0x0064, B:42:0x00a9] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static /* synthetic */ String joinToString$default(LongSet longSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, l lVar, int i6, Object obj) {
        if (obj == null) {

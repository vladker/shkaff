...
public abstract class LongLongMap {
    ...
    public /* synthetic */ LongLongMap(AbstractC1107v abstractC1107v) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(LongLongMap longLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        ...
        return longLongMap.joinToString(charSequence, charSequence2, charSequence6, i5, charSequence5);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (!((Boolean) predicate.invoke(Long.valueOf(jArr[i8]), Long.valueOf(jArr2[i8]))).booleanValue()) {
                            return false;
                        }
                    }
                    j6 >>= 8;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i7 < i6) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        jArr2 = jArr3;
                        if (jArr4[i8] != longLongMap.get(jArr2[i8])) {
                            return false;
                        }
                    } else {
                        jArr2 = jArr3;
    ...
    public final long getOrDefault(long j6, long j7) {
        int iFindKeyIndex = findKeyIndex(j6);
        return iFindKeyIndex >= 0 ? this.values[iFindKeyIndex] : j7;
    }

    public final long getOrElse(long j6, O3.a defaultValue) {
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        iHashCode += Long.hashCode(jArr[i8]) ^ Long.hashCode(jArr2[i8]);
                    }
                    j6 >>= 8;
                }
                if (i6 != 8) {
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j6) < 128) {
                        int i9 = (i5 << 3) + i8;
                        if (((Boolean) predicate.invoke(Long.valueOf(jArr[i9]), Long.valueOf(jArr2[i9]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j6 >>= 8;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sbV.append((CharSequence) pVar.invoke(Long.valueOf(j7), Long.valueOf(j8)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sb.append((CharSequence) transform.invoke(Long.valueOf(j7), Long.valueOf(j8)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;

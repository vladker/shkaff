...
public final class MutableIntLongMap extends IntLongMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        int i6 = mutableIntLongMap._capacity;
        ...
        while (i7 < i6) {
            if (((jArr[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableIntLongMap.findFirstAvailableSlot(i9 >>> 7);
                long j6 = i9 & 127;
    ...
    public final long getOrPut(int i5, O3.a defaultValue) {
    ...
    public final void put(int i5, long j6) {
        set(i5, j6);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(Integer.valueOf(this.keys[i8]), Long.valueOf(this.values[i8]))).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public final void set(int i5, long j6) {
    ...
    public /* synthetic */ MutableIntLongMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final long put(int i5, long j6, long j7) {
        int iFindInsertIndex = findInsertIndex(i5);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(int i5, long j6) {
        int iFindKeyIndex = findKeyIndex(i5);

...
public abstract class LongIntMap {
    ...
    public /* synthetic */ LongIntMap(AbstractC1107v abstractC1107v) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(LongIntMap longIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        ...
        return longIntMap.joinToString(charSequence, charSequence2, charSequence6, i5, charSequence5);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (!((Boolean) predicate.invoke(Long.valueOf(jArr[i8]), Integer.valueOf(iArr[i8]))).booleanValue()) {
                            return false;
                        }
                    }
                    j6 >>= 8;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i7 < i6) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        jArr2 = jArr3;
                        if (iArr[i8] != longIntMap.get(jArr2[i8])) {
                            return false;
                        }
                    } else {
                        jArr2 = jArr3;
    ...
    public final int getOrDefault(long j6, int i5) {
        int iFindKeyIndex = findKeyIndex(j6);
        return iFindKeyIndex >= 0 ? this.values[iFindKeyIndex] : i5;
    }

    public final int getOrElse(long j6, O3.a defaultValue) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        long j7 = jArr[i8];
                        iHashCode += Integer.hashCode(iArr[i8]) ^ Long.hashCode(j7);
                    }
                    j6 >>= 8;
                }
                if (i6 != 8) {
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j6) < 128) {
                        int i9 = (i5 << 3) + i8;
                        if (((Boolean) predicate.invoke(Long.valueOf(jArr[i9]), Integer.valueOf(iArr[i9]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j6 >>= 8;
  ...
  0x0080: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x0030, B:20:0x007e] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sbV.append((CharSequence) pVar.invoke(Long.valueOf(j7), Integer.valueOf(i11)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;
    ...
    public static /* synthetic */ String joinToString$default(LongIntMap longIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, p pVar, int i6, Object obj) {
        long[] jArr;
        if (obj == null) {
                ...
                if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j6 & 255) < 128) {
                            ...
                            sbV.append((CharSequence) pVar.invoke(Long.valueOf(j7), Integer.valueOf(i15)));
                            i9++;
                        }
                        j6 >>= i11;
                        i13++;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i10 < i9) {
                    if ((j6 & 255) < 128) {
                        ...
                        sbV.append((CharSequence) pVar.invoke(Long.valueOf(j7), Integer.valueOf(i12)));
                        i7++;
                    }
                    j6 >>= i8;
                    i10++;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sb.append((CharSequence) transform.invoke(Long.valueOf(j7), Integer.valueOf(i11)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;

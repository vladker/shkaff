...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            if (((jArr[i8 >> 3] >> ((i8 & 7) << 3)) & 255) < 128) {
                ...
                int i14 = i13 >> 3;
                int i15 = (i13 & 7) << 3;
                jArr4[i14] = (jArr4[i14] & (~(255 << i15))) | (j6 << i15);
                objArr2[iFindFirstAvailableSlot] = obj;
                jArr3[iFindFirstAvailableSlot] = jArr2[i6];
            } else {
                i6 = i8;
            }
            i8 = i6 + 1;
    ...
    public final long getOrPut(K k6, O3.a defaultValue) {
    ...
    public final void put(K k6, long j6) {
        set(k6, j6);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(this.keys[i8], Long.valueOf(this.values[i8]))).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public /* synthetic */ MutableObjectLongMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final long put(K k6, long j6, long j7) {
        int iFindIndex = findIndex(k6);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        } else {
            j7 = this.values[iFindIndex];
        }
        this.keys[iFindIndex] = k6;
        this.values[iFindIndex] = j6;
        return j7;
    ...
    public final boolean remove(K k6, long j6) {
        int iFindKeyIndex = findKeyIndex(k6);

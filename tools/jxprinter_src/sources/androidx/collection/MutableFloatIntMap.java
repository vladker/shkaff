...
public final class MutableFloatIntMap extends FloatIntMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatIntMap.findFirstAvailableSlot(i8 >>> 7);
                long j6 = i8 & 127;
    ...
    public final int getOrPut(float f6, O3.a defaultValue) {
    ...
    public final void put(float f6, int i5) {
        set(f6, i5);
    }
    ...
    public final void set(float f6, int i5) {
    ...
    public /* synthetic */ MutableFloatIntMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final int put(float f6, int i5, int i6) {
        int iFindInsertIndex = findInsertIndex(f6);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(float f6, int i5) {
        int iFindKeyIndex = findKeyIndex(f6);

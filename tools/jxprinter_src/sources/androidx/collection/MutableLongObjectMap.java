...
public final class MutableLongObjectMap<V> extends LongObjectMap<V> {
    ...
    private final int findAbsoluteInsertIndex(long j6) {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableLongObjectMap.findFirstAvailableSlot(i8 >>> 7);
                long j7 = i8 & 127;
    ...
    public final V getOrPut(long j6, O3.a defaultValue) {
    ...
    public final V put(long j6, V v6) {
        int iFindAbsoluteInsertIndex = findAbsoluteInsertIndex(j6);
        Object[] objArr = this.values;
        V v7 = (V) objArr[iFindAbsoluteInsertIndex];
        this.keys[iFindAbsoluteInsertIndex] = j6;
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(Long.valueOf(this.keys[i8]), this.values[i8])).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public final void set(long j6, V v6) {
        int iFindAbsoluteInsertIndex = findAbsoluteInsertIndex(j6);
        this.keys[iFindAbsoluteInsertIndex] = j6;
    ...
    public /* synthetic */ MutableLongObjectMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final boolean remove(long j6, V v6) {
        int iNumberOfTrailingZeros;
        int iHashCode = Long.hashCode(j6) * ScatterMapKt.MurmurHashC1;
        int i5 = iHashCode ^ (iHashCode << 16);
        int i6 = i5 & 127;

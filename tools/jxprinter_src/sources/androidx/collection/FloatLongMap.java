...
public abstract class FloatLongMap {
    ...
    public /* synthetic */ FloatLongMap(AbstractC1107v abstractC1107v) {
        this();
    }
    ...
    public final long getOrDefault(float f6, long j6) {
        int iFindKeyIndex = findKeyIndex(f6);
        return iFindKeyIndex >= 0 ? this.values[iFindKeyIndex] : j6;
    }

    public final long getOrElse(float f6, O3.a defaultValue) {
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        iHashCode += Float.hashCode(fArr[i8]) ^ Long.hashCode(jArr[i8]);
                    }
                    j6 >>= 8;
                }
                if (i6 != 8) {
  ...
  0x0080: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x0030, B:20:0x007e] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sbV.append((CharSequence) pVar.invoke(Float.valueOf(f6), Long.valueOf(j7)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;
    ...
    public static /* synthetic */ String joinToString$default(FloatLongMap floatLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, p pVar, int i6, Object obj) {
        long[] jArr;
        if (obj == null) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sb.append((CharSequence) transform.invoke(Float.valueOf(f6), Long.valueOf(j7)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;

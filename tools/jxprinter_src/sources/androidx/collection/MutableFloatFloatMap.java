...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatFloatMap.findFirstAvailableSlot(i8 >>> 7);
                long j6 = i8 & 127;
                ...
                fArr3[iFindFirstAvailableSlot] = f6;
                fArr4[iFindFirstAvailableSlot] = fArr2[i7];
            }
            i7++;
    ...
    public final float getOrPut(float f6, O3.a defaultValue) {
    ...
    public final void put(float f6, float f7) {
        set(f6, f7);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(Float.valueOf(this.keys[i8]), Float.valueOf(this.values[i8]))).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public final void set(float f6, float f7) {
        ...
        this.values[iFindInsertIndex] = f7;
    }
    ...
    public /* synthetic */ MutableFloatFloatMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final float put(float f6, float f7, float f8) {
        int iFindInsertIndex = findInsertIndex(f6);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
            f8 = this.values[iFindInsertIndex];
        }
        this.keys[iFindInsertIndex] = f6;
        this.values[iFindInsertIndex] = f7;
        return f8;
    ...
    public final boolean remove(float f6, float f7) {
        int iFindKeyIndex = findKeyIndex(f6);
        if (iFindKeyIndex < 0 || this.values[iFindKeyIndex] != f7) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;

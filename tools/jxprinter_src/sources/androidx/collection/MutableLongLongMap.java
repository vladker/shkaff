...
public final class MutableLongLongMap extends LongLongMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableLongLongMap.findFirstAvailableSlot(i8 >>> 7);
                long j7 = i8 & 127;
                long[] jArr6 = mutableLongLongMap.metadata;
                int i9 = iFindFirstAvailableSlot >> 3;
                int i10 = (iFindFirstAvailableSlot & 7) << 3;
                jArr6[i9] = (jArr6[i9] & (~(255 << i10))) | (j7 << i10);
                int i11 = mutableLongLongMap._capacity;
                int i12 = ((iFindFirstAvailableSlot - 7) & i11) + (i11 & 7);
                int i13 = i12 >> 3;
                int i14 = (i12 & 7) << 3;
                jArr6[i13] = (jArr6[i13] & (~(255 << i14))) | (j7 << i14);
                jArr4[iFindFirstAvailableSlot] = j6;
                jArr5[iFindFirstAvailableSlot] = jArr3[i7];
            }
            i7++;
    ...
    public final long getOrPut(long j6, O3.a defaultValue) {
    ...
    public final void put(long j6, long j7) {
        set(j6, j7);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(Long.valueOf(this.keys[i8]), Long.valueOf(this.values[i8]))).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public /* synthetic */ MutableLongLongMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final long put(long j6, long j7, long j8) {
        int iFindInsertIndex = findInsertIndex(j6);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(long j6, long j7) {
        int iFindKeyIndex = findKeyIndex(j6);
        if (iFindKeyIndex < 0 || this.values[iFindKeyIndex] != j7) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;

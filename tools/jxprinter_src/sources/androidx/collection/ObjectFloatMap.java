...
public abstract class ObjectFloatMap<K> {
    ...
    public /* synthetic */ ObjectFloatMap(AbstractC1107v abstractC1107v) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        ...
        return objectFloatMap.joinToString(charSequence, charSequence2, charSequence6, i5, charSequence5);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (!((Boolean) predicate.invoke(objArr[i8], Float.valueOf(fArr[i8]))).booleanValue()) {
                            return false;
                        }
                    }
                    j6 >>= 8;
    ...
    public final float getOrDefault(K k6, float f6) {
        int iFindKeyIndex = findKeyIndex(k6);
        return iFindKeyIndex >= 0 ? this.values[iFindKeyIndex] : f6;
    }

    public final float getOrElse(K k6, O3.a defaultValue) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        ...
                        iHashCode += Float.hashCode(fArr[i8]) ^ (obj != null ? obj.hashCode() : 0);
                    }
                    j6 >>= 8;
                }
                if (i6 != 8) {
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j6) < 128) {
                        int i9 = (i5 << 3) + i8;
                        if (((Boolean) predicate.invoke(objArr[i9], Float.valueOf(fArr[i9]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j6 >>= 8;
  ...
  0x007c: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x0030, B:20:0x007a] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sbV.append((CharSequence) pVar.invoke(obj, Float.valueOf(f6)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;
    ...
    public static /* synthetic */ String joinToString$default(ObjectFloatMap objectFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, p pVar, int i6, Object obj) {
        long[] jArr;
        if (obj == null) {
                ...
                if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j6 & 255) < 128) {
                            ...
                            sbV.append((CharSequence) pVar.invoke(obj2, Float.valueOf(f6)));
                            i9++;
                        }
                        j6 >>= i11;
                        i13++;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sb.append((CharSequence) transform.invoke(obj, Float.valueOf(f6)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;

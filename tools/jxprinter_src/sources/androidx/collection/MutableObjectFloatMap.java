...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float getOrPut(K k6, O3.a defaultValue) {
    ...
    public final void put(K k6, float f6) {
        set(k6, f6);
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(this.keys[i8], Float.valueOf(this.values[i8]))).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public /* synthetic */ MutableObjectFloatMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final float put(K k6, float f6, float f7) {
        int iFindIndex = findIndex(k6);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        } else {
            f7 = this.values[iFindIndex];
        }
        this.keys[iFindIndex] = k6;
        this.values[iFindIndex] = f6;
        return f7;
    ...
    public final boolean remove(K k6, float f6) {
        int iFindKeyIndex = findKeyIndex(k6);

...
public final class MutableIntIntMap extends IntIntMap {
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i7 < i6) {
            if (((jArr[i7 >> 3] >> ((i7 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableIntIntMap.findFirstAvailableSlot(i9 >>> 7);
                long j6 = i9 & 127;
                ...
                iArr3[iFindFirstAvailableSlot] = i8;
                iArr4[iFindFirstAvailableSlot] = iArr2[i7];
            }
            i7++;
    ...
    public final int getOrPut(int i5, O3.a defaultValue) {
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(Integer.valueOf(this.keys[i8]), Integer.valueOf(this.values[i8]))).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public final void set(int i5, int i6) {
        ...
        this.values[iFindInsertIndex] = i6;
    }
    ...
    public /* synthetic */ MutableIntIntMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final int put(int i5, int i6, int i7) {
        ...
        if (iFindInsertIndex < 0) {
            ...
            i7 = this.values[iFindInsertIndex];
        }
        this.keys[iFindInsertIndex] = i5;
        this.values[iFindInsertIndex] = i6;
        return i7;
    ...
    public final boolean remove(int i5, int i6) {
        int iFindKeyIndex = findKeyIndex(i5);
        if (iFindKeyIndex < 0 || this.values[iFindKeyIndex] != i6) {
            return false;
        }
        removeValueAt(iFindKeyIndex);
        return true;

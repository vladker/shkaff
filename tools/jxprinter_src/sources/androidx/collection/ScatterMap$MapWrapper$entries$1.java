...
public final class ScatterMap$MapWrapper$entries$1<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, P3.a {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        while (it.hasNext()) {
            ...
            if (!E.a(scatterMap.get((K) entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        return t.iterator(new ScatterMap$MapWrapper$entries$1$iterator$1(this.this$0, null));
    }

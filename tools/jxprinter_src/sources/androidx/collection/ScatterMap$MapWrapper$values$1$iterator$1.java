...
public final class ScatterMap$MapWrapper$values$1$iterator$1 extends l implements p {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public ScatterMap$MapWrapper$values$1$iterator$1(ScatterMap<K, V> scatterMap, g<? super ScatterMap$MapWrapper$values$1$iterator$1> gVar) {
        super(2, gVar);
    ...
    public final g<Q> create(Object obj, g<?> gVar) {
        ScatterMap$MapWrapper$values$1$iterator$1 scatterMap$MapWrapper$values$1$iterator$1 = new ScatterMap$MapWrapper$values$1$iterator$1(this.this$0, gVar);
    ...
    public final Object invoke(AbstractC0234s abstractC0234s, g<? super Q> gVar) {
        return ((ScatterMap$MapWrapper$values$1$iterator$1) create(abstractC0234s, gVar)).invokeSuspend(Q.INSTANCE);
    }

...
@f(c = "androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1", f = "ScatterMap.kt", i = {0, 0, 0, 0, 0, 0, 0}, l = {1431}, m = "invokeSuspend", n = {"$this$iterator", "m$iv", "lastIndex$iv", "i$iv", "slot$iv", "bitCount$iv", "j$iv"}, s = {"L$0", "L$1", "I$0", "I$1", "J$0", "I$2", "I$3"})
public final class MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 extends l implements p {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1(MutableScatterMap<K, V> mutableScatterMap, g<? super MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1> gVar) {
        super(2, gVar);
    ...
    public final g<Q> create(Object obj, g<?> gVar) {
        MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 mutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 = new MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1(this.this$0, gVar);
    ...
    public final Object invoke(AbstractC0234s abstractC0234s, g<? super Q> gVar) {
        return ((MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1) create(abstractC0234s, gVar)).invokeSuspend(Q.INSTANCE);
    }

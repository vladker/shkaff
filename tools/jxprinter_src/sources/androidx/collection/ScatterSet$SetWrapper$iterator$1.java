...
@f(c = "androidx.collection.ScatterSet$SetWrapper$iterator$1", f = "ScatterSet.kt", i = {0, 0, 0, 0, 0, 0, 0, 0}, l = {Videoio.CAP_PROP_XI_DEFAULT_CC_MATRIX}, m = "invokeSuspend", n = {"$this$iterator", "k$iv", "m$iv$iv", "lastIndex$iv$iv", "i$iv$iv", "slot$iv$iv", "bitCount$iv$iv", "j$iv$iv"}, s = {"L$0", "L$1", "L$2", "I$0", "I$1", "J$0", "I$2", "I$3"})
public final class ScatterSet$SetWrapper$iterator$1 extends l implements p {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public ScatterSet$SetWrapper$iterator$1(ScatterSet<E> scatterSet, g<? super ScatterSet$SetWrapper$iterator$1> gVar) {
        super(2, gVar);
    ...
    public final g<Q> create(Object obj, g<?> gVar) {
        ScatterSet$SetWrapper$iterator$1 scatterSet$SetWrapper$iterator$1 = new ScatterSet$SetWrapper$iterator$1(this.this$0, gVar);
    ...
    public final Object invoke(AbstractC0234s abstractC0234s, g<? super Q> gVar) {
        return ((ScatterSet$SetWrapper$iterator$1) create(abstractC0234s, gVar)).invokeSuspend(Q.INSTANCE);
    }

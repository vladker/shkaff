...
public abstract class IntIntMap {
    ...
    public /* synthetic */ IntIntMap(AbstractC1107v abstractC1107v) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(IntIntMap intIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, int i6, Object obj) {
        ...
        return intIntMap.joinToString(charSequence, charSequence2, charSequence6, i5, charSequence5);
    }
    ...
    public final int getOrElse(int i5, O3.a defaultValue) {
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i8 = 0; i8 < i7; i8++) {
                    if ((255 & j6) < 128) {
                        int i9 = (i5 << 3) + i8;
                        if (((Boolean) predicate.invoke(Integer.valueOf(iArr[i9]), Integer.valueOf(iArr2[i9]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j6 >>= 8;
  ...
  0x0080: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x0030, B:20:0x007e] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i9 < i8) {
                    if ((j6 & 255) < 128) {
                        ...
                        sbV.append((CharSequence) pVar.invoke(Integer.valueOf(i11), Integer.valueOf(i12)));
                        i6++;
                    }
                    j6 >>= i7;
                    i9++;
    ...
    public static /* synthetic */ String joinToString$default(IntIntMap intIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i5, CharSequence charSequence4, p pVar, int i6, Object obj) {
        long[] jArr;
        if (obj == null) {
                ...
                if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j6 & 255) < 128) {
                            ...
                            sbV.append((CharSequence) pVar.invoke(Integer.valueOf(i15), Integer.valueOf(i16)));
                            i9++;
                        }
                        j6 >>= i11;
                        i13++;
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i10 < i9) {
                    if ((j6 & 255) < 128) {
                        ...
                        sbV.append((CharSequence) pVar.invoke(Integer.valueOf(i12), Integer.valueOf(i13)));
                        i7++;
                    }
                    j6 >>= i8;
                    i10++;

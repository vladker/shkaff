...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    public final class MutableMapWrapper extends ScatterMap<K, V>.MapWrapper implements Map<K, V>, d {
        ...
        public V put(K k6, V v6) {
            return MutableScatterMap.this.put(k6, v6);
        }
    ...
    private final void resizeStorage(int i5) {
        ...
        while (i8 < i7) {
            if (((jArr[i8 >> 3] >> ((i8 & 7) << 3)) & 255) < 128) {
                ...
                objArr4[iFindFirstAvailableSlot] = objArr2[i6];
            } else {
                i6 = i8;
            }
            i8 = i6 + 1;
    ...
    public final V compute(K k6, p computeBlock) {
        E.f(computeBlock, "computeBlock");
        int iFindInsertIndex = findInsertIndex(k6);
        boolean z6 = iFindInsertIndex < 0;
        V v6 = (V) computeBlock.invoke(k6, z6 ? null : this.values[iFindInsertIndex]);
        if (!z6) {
            this.values[iFindInsertIndex] = v6;
            return v6;
        }
        int i5 = ~iFindInsertIndex;
        this.keys[i5] = k6;
        this.values[i5] = v6;
        return v6;
    }

    public final int findInsertIndex(K k6) {
    ...
    public final V getOrPut(K k6, O3.a defaultValue) {
    ...
    public final void plusAssign(C1938s pair) {
        E.f(pair, "pair");
        set(pair.f9134a, pair.b);
    }
    ...
    public final V put(K k6, V v6) {
        ...
        this.keys[iFindInsertIndex] = k6;
        objArr[iFindInsertIndex] = v6;
        return v7;
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(C1938s[] pairs) {
        E.f(pairs, "pairs");
        for (C1938s c1938s : pairs) {
            set(c1938s.f9134a, c1938s.b);
        }
    }
        ...
        while (true) {
            ...
            if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i7 = 0; i7 < i6; i7++) {
                    if ((255 & j6) < 128) {
                        int i8 = (i5 << 3) + i7;
                        if (((Boolean) predicate.invoke(this.keys[i8], this.values[i8])).booleanValue()) {
                            removeValueAt(i8);
                        }
                    }
                    j6 >>= 8;
    ...
    public final void set(K k6, V v6) {
        int iFindInsertIndex = findInsertIndex(k6);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        }
    ...
    public /* synthetic */ MutableScatterMap(int i5, int i6, AbstractC1107v abstractC1107v) {
        this((i6 & 1) != 0 ? 6 : i5);
    }
    ...
    public final void plusAssign(C1938s[] pairs) {
        E.f(pairs, "pairs");
        putAll(pairs);
    }

    public final void plusAssign(Iterable<? extends C1938s> pairs) {
        E.f(pairs, "pairs");
        putAll(pairs);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(Iterable<? extends C1938s> pairs) {
        E.f(pairs, "pairs");
        for (C1938s c1938s : pairs) {
            set(c1938s.f9134a, c1938s.b);
        }
    ...
    public final void plusAssign(InterfaceC0233q pairs) {
        E.f(pairs, "pairs");
        putAll(pairs);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(InterfaceC0233q pairs) {
        E.f(pairs, "pairs");

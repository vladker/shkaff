...
public class MediaButtonReceiver extends BroadcastReceiver {
    ...
    private static ComponentName getServiceComponentByAction(Context context, String str) {
        ...
        StringBuilder sbY = AbstractC0157z.y("Expected 1 service that handles ", str, ", found ");
    ...
    public static PendingIntent buildMediaButtonPendingIntent(Context context, ComponentName componentName, long j6) {
        ...
        if (keyCode == 0) {
            Log.w(TAG, "Cannot build a media button pending intent with the given action: " + j6);
            return null;
        }
        Intent intent = new Intent("android.intent.action.MEDIA_BUTTON");

        ...
        public RemoteViews generateBigContentView() {
            ...
            if (iMin > 0) {
                for (int i5 = 0; i5 < iMin; i5++) {
                    remoteViewsApplyStandardTemplate.addView(R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i5)));
                }
            }
            ...
            remoteViewsApplyStandardTemplate.setViewVisibility(i6, 0);
            remoteViewsApplyStandardTemplate.setInt(i6, "setAlpha", this.mBuilder.mContext.getResources().getInteger(R.integer.cancel_button_image_alpha));
            remoteViewsApplyStandardTemplate.setOnClickPendingIntent(i6, this.mCancelButtonIntent);
            return remoteViewsApplyStandardTemplate;
        }
        ...
        public RemoteViews generateContentView() {
            ...
            if (iMin > 0) {
                for (int i5 = 0; i5 < iMin; i5++) {
                    ...
                    remoteViewsApplyStandardTemplate.addView(R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i5])));
                }
            }
            if (!this.mShowCancelButton) {

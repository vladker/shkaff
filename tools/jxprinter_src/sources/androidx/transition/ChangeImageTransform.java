...
public class ChangeImageTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues, boolean z6) {
        ...
        if ((view instanceof ImageView) && view.getVisibility() == 0) {
            ...
            Matrix matrixCopyImageMatrix = z6 ? (Matrix) imageView.getTag(R.id.transition_image_transform) : null;
    ...
    private static Matrix copyImageMatrix(@NonNull ImageView imageView) {
        ...
        if (i5 != 1) {
            return i5 != 2 ? new Matrix(imageView.getImageMatrix()) : centerCropMatrix(imageView);
        }

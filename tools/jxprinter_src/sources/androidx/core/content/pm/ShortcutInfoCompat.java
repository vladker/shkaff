...
public class ShortcutInfoCompat {
    ...
    public static class Api33Impl {
        ...
        public static void setExcludedFromSurfaces(ShortcutInfo.Builder builder, int i5) {
            ...
            if (this.mCapabilityBindingParams != null) {
                ...
                for (String str : this.mCapabilityBindingParams.keySet()) {
                    ...
                    for (String str2 : map.keySet()) {
                        ...
                        this.mInfo.mExtras.putStringArray(a.o(str, PackagingURIHelper.FORWARD_SLASH_STRING, str2), list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                    }
                }
            }

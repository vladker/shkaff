...
public class ContextCompat {
    ...
    public static ColorStateList getColorStateList(Context context, @ColorRes int i5) {
    ...
    public static Drawable getDrawable(Context context, @DrawableRes int i5) {
    ...
    public static String obtainAndCheckReceiverPermission(Context context) {
        ...
        throw new RuntimeException(AbstractC0157z.o("Permission ", str, " is required by your application to receive broadcasts, please add it to your manifest"));
    }
    ...
    public static Intent registerReceiver(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter, String str, Handler handler, int i5) {
        ...
        if (i8 == 0 || (i7 & 4) == 0) {
            return Build.VERSION.SDK_INT >= 33 ? Api33Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i7) : Api26Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i7);
        }

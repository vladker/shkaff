...
public class AccessibilityDelegateCompat {
    ...
    public static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            for (int i5 = 0; i5 < actionList.size(); i5++) {
                accessibilityNodeInfoCompatWrap.addAction(actionList.get(i5));
            }
        }
    ...
    public boolean performAccessibilityAction(View view, int i5, Bundle bundle) {
        ...
        return (zPerformAccessibilityAction || i5 != R.id.accessibility_action_clickable_span || bundle == null) ? zPerformAccessibilityAction : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }

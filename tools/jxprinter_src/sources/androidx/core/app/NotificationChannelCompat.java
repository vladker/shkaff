...
public class NotificationChannelCompat {
    ...
    public static class Api26Impl {
        ...
        public static NotificationChannel createNotificationChannel(String str, CharSequence charSequence, int i5) {
        ...
        public static void setLightColor(NotificationChannel notificationChannel, int i5) {

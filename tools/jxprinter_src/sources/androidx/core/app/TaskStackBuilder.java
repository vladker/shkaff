...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public PendingIntent getPendingIntent(int i5, int i6, boolean z6) {
        return getPendingIntent(i5, PendingIntentCompat.addMutabilityFlags(z6, i6));
    }
    ...
    public PendingIntent getPendingIntent(int i5, int i6, Bundle bundle) {
        if (!this.mIntents.isEmpty()) {
            Intent[] intentArr = (Intent[]) this.mIntents.toArray(new Intent[0]);
            intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
    ...
    public PendingIntent getPendingIntent(int i5, int i6, Bundle bundle, boolean z6) {
        return getPendingIntent(i5, PendingIntentCompat.addMutabilityFlags(z6, i6), bundle);
    }
}

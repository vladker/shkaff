...
public final class ShareCompat {
    ...
    @Deprecated
    public static void configureMenuItem(Menu menu, @IdRes int i5, IntentBuilder intentBuilder) {
        MenuItem menuItemFindItem = menu.findItem(i5);
        if (menuItemFindItem != null) {
            configureMenuItem(menuItemFindItem, intentBuilder);
            return;
        }
        throw new IllegalArgumentException(androidx.collection.a.i(i5, "Could not find menu item with id ", " in the supplied menu"));
    }
}

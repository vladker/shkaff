...
public final class AppOpsManagerCompat {
    ...
    public static class Api29Impl {
        ...
        public static int checkOpNoThrow(AppOpsManager appOpsManager, String str, int i5, String str2) {
    ...
    public static int checkOrNoteProxyOp(Context context, int i5, String str, String str2) {
        ...
        return iCheckOpNoThrow != 0 ? iCheckOpNoThrow : Api29Impl.checkOpNoThrow(systemService, str, i5, Api29Impl.getOpPackageName(context));
    }

    public static int noteOp(Context context, String str, int i5, String str2) {
        return ((AppOpsManager) context.getSystemService("appops")).noteOp(str, i5, str2);
    }

    public static int noteOpNoThrow(Context context, String str, int i5, String str2) {

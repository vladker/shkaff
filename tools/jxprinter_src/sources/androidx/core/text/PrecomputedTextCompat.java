...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(CharSequence charSequence, Params params) {
        ...
        try {
            ...
            while (i5 < length) {
                ...
                i5 = iIndexOf < 0 ? length : iIndexOf + 1;
    ...
    public PrecomputedText getPrecomputedText() {
        if (B0.a.w(this.mText)) {
            return B0.a.n(this.mText);
        }
        return null;
    }
    ...
    public <T> T[] getSpans(int i5, int i6, Class<T> cls) {
        return Build.VERSION.SDK_INT >= 29 ? (T[]) this.mWrapped.getSpans(i5, i6, cls) : (T[]) this.mText.getSpans(i5, i6, cls);
    }
    ...
    public static final class Params {
        ...
        public Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i5, int i6) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = a.h(textPaint).setBreakStrategy(i5).setHyphenationFrequency(i6).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;

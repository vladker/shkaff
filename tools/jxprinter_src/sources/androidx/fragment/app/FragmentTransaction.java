...
public abstract class FragmentTransaction {
    ...
    public static final class Op {
        ...
        public Op(int i5, Fragment fragment, boolean z6) {
            this.mCmd = i5;
            this.mFragment = fragment;
        ...
        public Op(int i5, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i5;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
    ...
    public FragmentTransaction addSharedElement(@NonNull View view, @NonNull String str) {
        ...
        if (this.mSharedElementSourceNames == null) {
            ...
            if (this.mSharedElementTargetNames.contains(str)) {
                throw new IllegalArgumentException(AbstractC0157z.o("A shared element with the target name '", str, "' has already been added to the transaction."));
            }
            if (this.mSharedElementSourceNames.contains(transitionName)) {
                throw new IllegalArgumentException(AbstractC0157z.o("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
            }
        }
    ...
    public void doAddOp(int i5, Fragment fragment, @Nullable String str, int i6) {
        ...
        if (str != null) {
            ...
            if (str3 != null && !str.equals(str3)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(androidx.exifinterface.media.a.r(sb, fragment.mTag, " now ", str));
            }
            fragment.mTag = str;
        }
        if (i5 != 0) {
            ...
            if (i7 != 0 && i7 != i5) {
                ...
                sb2.append(fragment);
                sb2.append(": was ");
                throw new IllegalStateException(androidx.exifinterface.media.a.i(" now ", fragment.mFragmentId, i5, sb2));
            }

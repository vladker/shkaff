...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    public void destroyItem(@NonNull ViewGroup viewGroup, int i5, @NonNull Object obj) {
        ...
        this.mSavedState.set(i5, fragment.isAdded() ? this.mFragmentManager.saveFragmentInstanceState(fragment) : null);
            ...
            for (String str : bundle.keySet()) {
                if (str.startsWith("f")) {
                    ...
                    if (fragment != null) {
                        ...
                        this.mFragments.set(i5, fragment);
                    } else {
    ...
    public Parcelable saveState() {
        ...
        for (int i5 = 0; i5 < this.mFragments.size(); i5++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                this.mFragmentManager.putFragment(bundle, AbstractC0157z.k(i5, "f"), fragment);
            }
        }
        return bundle;
    }

...
final class FragmentManagerViewModel extends ViewModel {
    ...
    private void clearNonConfigStateInternal(@NonNull String str, boolean z6) {
    ...
    public void clearNonConfigState(@NonNull Fragment fragment, boolean z6) {
    ...
    public void clearNonConfigState(@NonNull String str, boolean z6) {
        if (FragmentManager.isLoggingEnabled(3)) {

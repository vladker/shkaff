...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
        }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(androidx.collection.a.n(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        throw new IllegalStateException(androidx.exifinterface.media.a.l("Can't access the Fragment View's LifecycleOwner for ", this, " when getView() is null i.e., before onCreateView() or after onDestroyView()"));
    }
    ...
    @Nullable
    @MainThread
    public Animation onCreateAnimation(int i5, boolean z6, int i6) {
        return null;
    }

    @Nullable
    @MainThread
    public Animator onCreateAnimator(int i5, boolean z6, int i6) {
        return null;
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        int i5 = 0;
        while (i5 < size) {
            OnPreAttachedListener onPreAttachedListener = arrayList.get(i5);
            i5++;
            onPreAttachedListener.onPreAttached();
        }
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onDestroyView()"));
        }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i5) {
        if (this.mHost == null) {
            throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " not attached to Activity"));
        }
    ...
    public final FragmentActivity requireActivity() {
        ...
        throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " not attached to a context."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.exifinterface.media.a.l("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i5) {
        ...
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            throw new IllegalArgumentException(androidx.exifinterface.media.a.l("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
        }
    ...
    @Deprecated
    public void startIntentSenderForResult(@NonNull IntentSender intentSender, int i5, @Nullable Intent intent, int i6, int i7, int i8, @Nullable Bundle bundle) {
        Bundle bundle2;
        if (this.mHost == null) {
            throw new IllegalStateException(androidx.exifinterface.media.a.l("Fragment ", this, " not attached to Activity"));
        }
        ...
        getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i5, intent, i6, i7, i8, bundle2);
    }
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(AbstractC0157z.o("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (java.lang.InstantiationException e6) {
            throw new InstantiationException(AbstractC0157z.o("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e6);
        } catch (NoSuchMethodException e7) {
            throw new InstantiationException(AbstractC0157z.o("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e7);
        } catch (InvocationTargetException e8) {
            throw new InstantiationException(AbstractC0157z.o("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e8);
        }
    }

...
final class LocaleOverlayHelper {
    ...
    private static LocaleListCompat combineLocales(LocaleListCompat localeListCompat, LocaleListCompat localeListCompat2) {
        ...
        int i5 = 0;
        while (i5 < localeListCompat2.size() + localeListCompat.size()) {
            Locale locale = i5 < localeListCompat.size() ? localeListCompat.get(i5) : localeListCompat2.get(i5 - localeListCompat.size());
            if (locale != null) {

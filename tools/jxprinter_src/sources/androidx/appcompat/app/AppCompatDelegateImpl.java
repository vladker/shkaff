...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static class Api33Impl {
        ...
        public static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            ?? r6 = new OnBackInvokedCallback() { // from class: androidx.appcompat.app.b
                public final void onBackInvoked() {
                    appCompatDelegateImpl.onBackPressed();
                }
            };
            i.l(obj).registerOnBackInvokedCallback(SchemaType.SIZE_BIG_INTEGER, r6);
            return r6;
        }

        @DoNotInline
        public static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            i.l(obj).unregisterOnBackInvokedCallback(i.g(obj2));
        }
    }
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public View onCreatePanelView(int i5) {
            ...
            return (actionBarMenuCallback == null || (viewOnCreatePanelView = actionBarMenuCallback.onCreatePanelView(i5)) == null) ? super.onCreatePanelView(i5) : viewOnCreatePanelView;
        }
        ...
        public boolean onPreparePanel(int i5, View view, Menu menu) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            boolean zOnPreparePanel = actionBarMenuCallback != null && actionBarMenuCallback.onPreparePanel(i5);
            if (!zOnPreparePanel) {
                zOnPreparePanel = super.onPreparePanel(i5, view, menu);
            }
            if (menuBuilder != null) {
        ...
        public android.view.ActionMode onWindowStartingActionMode(android.view.ActionMode.Callback callback, int i5) {
            return (AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() && i5 == 0) ? startAsSupportActionMode(callback) : super.onWindowStartingActionMode(callback, i5);
        }
    }
    ...
    private void applyFixedSizeWindow() {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i5)) {
            typedArrayObtainStyledAttributes.getValue(i5, contentFrameLayout.getFixedWidthMajor());
        }
        int i6 = androidx.appcompat.R.styleable.AppCompatTheme_windowFixedWidthMinor;
        if (typedArrayObtainStyledAttributes.hasValue(i6)) {
            typedArrayObtainStyledAttributes.getValue(i6, contentFrameLayout.getFixedWidthMinor());
        }
        int i7 = androidx.appcompat.R.styleable.AppCompatTheme_windowFixedHeightMajor;
        if (typedArrayObtainStyledAttributes.hasValue(i7)) {
            typedArrayObtainStyledAttributes.getValue(i7, contentFrameLayout.getFixedHeightMajor());
        }
        int i8 = androidx.appcompat.R.styleable.AppCompatTheme_windowFixedHeightMinor;
        if (typedArrayObtainStyledAttributes.hasValue(i8)) {
            typedArrayObtainStyledAttributes.getValue(i8, contentFrameLayout.getFixedHeightMinor());
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    @NonNull
    private Configuration createOverrideAppConfiguration(@NonNull Context context, int i5, @Nullable LocaleListCompat localeListCompat, @Nullable Configuration configuration, boolean z6) {
        int i6;
        if (i5 == 1) {
            i6 = 16;
        } else if (i5 != 2) {
            i6 = z6 ? 0 : context.getApplicationContext().getResources().getConfiguration().uiMode & 48;
        } else {
            i6 = 32;
        }
    ...
    private ViewGroup createSubDecor() {
        ...
        } else if (typedArrayObtainStyledAttributes.getBoolean(i5, false)) {
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i5, -2, panelFeatureState.f975x, panelFeatureState.f976y, 1002, 8519680, -3);
            ...
            i5 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams4 = new WindowManager.LayoutParams(i5, -2, panelFeatureState.f975x, panelFeatureState.f976y, 1002, 8519680, -3);
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i5, KeyEvent keyEvent, int i6) {
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            zPerformShortcut = menuBuilder.performShortcut(i5, keyEvent, i6);
        }
        if (zPerformShortcut && (i6 & 1) == 0 && this.mDecorContentParent == null) {
            closePanel(panelFeatureState, true);
        }
    ...
    private boolean updateAppConfiguration(int i5, @Nullable LocaleListCompat localeListCompat, boolean z6) {
        boolean z7;
        Configuration configurationCreateOverrideAppConfiguration = createOverrideAppConfiguration(this.mContext, i5, localeListCompat, null, false);
        ...
        boolean z8 = true;
        if (((~activityHandlesConfigChangesFlags) & i8) != 0 && z6 && this.mBaseContextAttached && (sCanReturnDifferentContext || this.mCreated)) {
            Object obj = this.mHost;
        ...
        if (z7 || i8 == 0) {
            ...
            updateResourcesConfiguration(i7, configurationLocales2, (activityHandlesConfigChangesFlags & i8) == i8, null);
        }
        if (z8) {
            Object obj2 = this.mHost;
            if (obj2 instanceof AppCompatActivity) {
                if ((i8 & 512) != 0) {
                    ((AppCompatActivity) obj2).onNightModeChanged(i5);
                }
                if ((i8 & 4) != 0) {
        ...
        if (z8 && configurationLocales2 != null) {
            setDefaultLocalesForLocaleList(getConfigurationLocales(this.mContext.getResources().getConfiguration()));
        }
        return z8;
    }

    private void updateResourcesConfiguration(int i5, @Nullable LocaleListCompat localeListCompat, boolean z6, @Nullable Configuration configuration) {
    ...
    public PanelFeatureState getPanelState(int i5, boolean z6) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public boolean hasWindowFeature(int i5) {
        boolean z6;
        int iSanitizeWindowFeatureId = sanitizeWindowFeatureId(i5);
        if (iSanitizeWindowFeatureId == 1) {
            z6 = this.mWindowNoTitle;
        } else if (iSanitizeWindowFeatureId == 2) {
            z6 = this.mFeatureProgress;
        } else if (iSanitizeWindowFeatureId == 5) {
            z6 = this.mFeatureIndeterminateProgress;
        } else if (iSanitizeWindowFeatureId == 10) {
            z6 = this.mOverlayActionMode;
        } else if (iSanitizeWindowFeatureId != 108) {
            z6 = iSanitizeWindowFeatureId != 109 ? false : this.mOverlayActionBar;
        } else {
            z6 = this.mHasActionBar;
        }
        return z6 || this.mWindow.hasFeature(i5);
    }

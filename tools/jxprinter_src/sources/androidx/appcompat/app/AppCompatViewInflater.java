...
public class AppCompatViewInflater {
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            ...
            while (true) {
                ...
                View viewCreateViewByPrefix = createViewByPrefix(context, str, strArr[i5]);
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z6, boolean z7) {
        ...
        if (z7 && resourceId == 0 && (resourceId = typedArrayObtainStyledAttributes.getResourceId(androidx.appcompat.R.styleable.View_theme, 0)) != 0) {
    ...
    @Nullable
    public final View createView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z6, boolean z7, boolean z8, boolean z9) {

...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        throw new IllegalStateException("Can't make a decor toolbar out of ".concat(view != 0 ? view.getClass().getSimpleName() : AbstractC1127c.NULL));
    }
    ...
    public void removeTabAt(int i5) {
        ...
        TabImpl tabImplRemove = this.mTabs.remove(i5);
    ...
    public void setNavigationMode(int i5) {
        ...
        this.mDecorToolbar.setCollapsible(i5 == 2 && !this.mHasEmbeddedTabs);
    ...
    public void addTab(ActionBar.Tab tab, int i5, boolean z6) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, i5, z6);
        configureTab(tab, i5);
        if (z6) {
            selectTab(tab);
        }

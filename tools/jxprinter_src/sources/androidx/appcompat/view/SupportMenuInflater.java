...
public class SupportMenuInflater extends MenuInflater {
    ...
    public static class InflatedOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener {
        ...
        public InflatedOnMenuItemClickListener(Object obj, String str) {
            ...
            try {
                ...
                StringBuilder sbY = AbstractC0157z.y("Couldn't resolve menu item onClick handler ", str, " in class ");
    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i5)) {
                this.itemCheckable = tintTypedArrayObtainStyledAttributes.getBoolean(i5, false) ? 1 : 0;
            } else {
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i6)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i6, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i7 = R.styleable.MenuItem_iconTint;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i7)) {
                this.itemIconTintList = tintTypedArrayObtainStyledAttributes.getColorStateList(i7);
            } else {
    ...
    public void inflate(@LayoutRes int i5, Menu menu) {
        ...
        try {
            try {
                try {
                    layout = this.mContext.getResources().getLayout(i5);

...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public MenuItem setAlphabeticShortcut(char c, int i5) {
        if (this.mShortcutAlphabeticChar == c && this.mShortcutAlphabeticModifiers == i5) {
            return this;
        }
        this.mShortcutAlphabeticChar = Character.toLowerCase(c);
    ...
    public MenuItem setNumericShortcut(char c, int i5) {
        if (this.mShortcutNumericChar == c && this.mShortcutNumericModifiers == i5) {
            return this;
        }
        this.mShortcutNumericChar = c;
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    @NonNull
    public MenuItem setShortcut(char c, char c6, int i5, int i6) {
        this.mShortcutNumericChar = c;
        this.mShortcutNumericModifiers = KeyEvent.normalizeMetaState(i5);
        this.mShortcutAlphabeticChar = Character.toLowerCase(c6);

...
public class MenuPopupHelper implements MenuHelper {
    ...
    private void showPopup(int i5, int i6, boolean z6, boolean z7) {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z6, @AttrRes int i5) {
        this(context, menuBuilder, view, z6, i5, 0);
    }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z6, @AttrRes int i5, @StyleRes int i6) {

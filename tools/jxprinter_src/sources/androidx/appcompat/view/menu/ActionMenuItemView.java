...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
    ...
    public void onMeasure(int i5, int i6) {
        ...
        if (zHasText && (i7 = this.mSavedPaddingLeft) >= 0) {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i5) {
        ...
        this.mAllowTextWithIcon = shouldAllowTextWithIcon();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ActionMenuItemView, i5, 0);

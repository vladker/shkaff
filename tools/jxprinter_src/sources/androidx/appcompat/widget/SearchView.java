...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static void setInputMethodMode(SearchAutoComplete searchAutoComplete, int i5) {
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i5, String str) {
        ...
        try {
            ...
            if (columnString3 != null && (columnString = SuggestionsAdapter.getColumnString(cursor, "suggest_intent_data_id")) != null) {
                columnString3 = columnString3 + PackagingURIHelper.FORWARD_SLASH_STRING + Uri.encode(columnString);
            }
            return createIntent(str2, columnString3 == null ? null : Uri.parse(columnString3), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i5, str);
    ...
    public void launchQuerySearch(int i5, String str, String str2) {
    ...
    public boolean onItemClicked(int i5, int i6, String str) {
    ...
    public boolean onItemSelected(int i5) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
    ...
    public void onMeasure(int i5, int i6) {
        ...
        } else if (mode == 1073741824 && (i7 = this.mMaxWidth) > 0) {
    ...
    public boolean onSuggestionsKey(View view, int i5, KeyEvent keyEvent) {
        if (this.mSearchable != null && this.mSuggestionsAdapter != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            if (i5 == 66 || i5 == 84 || i5 == 61) {
                return onItemClicked(this.mSearchSrcTextView.getListSelection(), 0, null);
            }
            if (i5 == 21 || i5 == 22) {
                this.mSearchSrcTextView.setSelection(i5 == 21 ? 0 : this.mSearchSrcTextView.length());
    ...
    public boolean requestFocus(int i5, Rect rect) {
        ...
        boolean zRequestFocus = this.mSearchSrcTextView.requestFocus(i5, rect);
        if (zRequestFocus) {
            updateViewsVisibility(false);
        }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
        ...
        imageView.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i6));
        ...
        imageView5.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(i6));
        ...
        int i7 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_imeOptions, -1);
        if (i7 != -1) {
            setImeOptions(i7);
        }
        int i8 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_inputType, -1);
        if (i8 != -1) {
            setInputType(i8);
        }

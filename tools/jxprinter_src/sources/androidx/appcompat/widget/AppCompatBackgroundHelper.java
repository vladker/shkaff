...
class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i5) {
        ...
        ViewCompat.saveAttributeDataForStyleable(view, view.getContext(), iArr, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i5, 0);
        try {
            int i6 = R.styleable.ViewBackgroundHelper_android_background;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i6)) {
                this.mBackgroundResId = tintTypedArrayObtainStyledAttributes.getResourceId(i6, -1);
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i7)) {
                ViewCompat.setBackgroundTintList(this.mView, tintTypedArrayObtainStyledAttributes.getColorStateList(i7));
            }
            int i8 = R.styleable.ViewBackgroundHelper_backgroundTintMode;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i8)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i8, -1), null));
            }
        } finally {

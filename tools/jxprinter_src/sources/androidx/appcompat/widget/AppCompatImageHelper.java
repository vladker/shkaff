...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i5) {
        ...
        ViewCompat.saveAttributeDataForStyleable(imageView, imageView.getContext(), iArr, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), i5, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
            ...
            if (tintTypedArrayObtainStyledAttributes.hasValue(i6)) {
                ImageViewCompat.setImageTintList(this.mView, tintTypedArrayObtainStyledAttributes.getColorStateList(i6));
            }
            int i7 = R.styleable.AppCompatImageView_tintMode;
            if (tintTypedArrayObtainStyledAttributes.hasValue(i7)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(i7, -1), null));
            }
        } finally {

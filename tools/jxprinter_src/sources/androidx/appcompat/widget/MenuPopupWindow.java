...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public /* bridge */ /* synthetic */ int lookForSelectablePosition(int i5, boolean z6) {
            return super.lookForSelectablePosition(i5, z6);
        }
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                MenuItemImpl item = (motionEvent.getAction() == 10 || (iPointToPosition = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) == -1 || (i5 = iPointToPosition - headersCount) < 0 || i5 >= menuAdapter.getCount()) ? null : menuAdapter.getItem(i5);

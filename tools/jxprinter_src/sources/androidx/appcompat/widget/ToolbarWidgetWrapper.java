...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setNavigationMode(int i5) {
        ...
        if (i5 != i6) {
            ...
            } else if (i6 == 2 && (view = this.mTabView) != null) {
            ...
            if (i5 != 0) {
                if (i5 == 1) {
                    ...
                    if (i5 != 2) {
                        throw new IllegalArgumentException(AbstractC0157z.k(i5, "Invalid navigation mode "));
                    }
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i5, long j6) {
        return ViewCompat.animate(this.mToolbar).alpha(i5 == 0 ? 1.0f : 0.0f).setDuration(j6).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z6, int i5, int i6) {
        Drawable drawable;

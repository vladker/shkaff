...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbT = AbstractC0157z.t(iconResource, "Invalid icon resource ", " for ");
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + PackagingURIHelper.FORWARD_SLASH_STRING + i5;
            Drawable drawableCheckIconCache = checkIconCache(str2);
            if (drawableCheckIconCache != null) {
                return drawableCheckIconCache;
            }
            Drawable drawable = ContextCompat.getDrawable(this.mProviderContext, i5);
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i5) {
        ...
        if (i5 > 0) {
            builderFragment.appendQueryParameter("limit", String.valueOf(i5));
        }

...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    public final V get(long j6, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        if (nanos + SPIN_THRESHOLD_NANOS < 0) {
            ...
            if (jConvert > 0) {
                String strN2 = strN + jConvert + " " + lowerCase;
                if (z6) {
                    strN2 = a.n(strN2, ",");
                }
                strN = a.n(strN2, " ");
            ...
            if (z6) {
                strN = strN + nanos2 + " nanoseconds ";
            }
            string3 = a.n(strN, "delay)");
        }
        if (isDone()) {
            throw new TimeoutException(a.n(string3, " but future completed as timeout expired"));
        }
        throw new TimeoutException(a.o(string3, " for ", string));
    }
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return AbstractC0157z.s(new StringBuilder("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
    ...
    public String toString() {
        ...
        if (isCancelled()) {
            ...
            if (strPendingToString != null && !strPendingToString.isEmpty()) {
                a.x(sb, "PENDING, info=[", strPendingToString, "]");
            } else if (isDone()) {
                addDoneString(sb);
            } else {
                sb.append("PENDING");

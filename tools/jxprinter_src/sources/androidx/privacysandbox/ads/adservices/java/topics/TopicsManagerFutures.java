...
public abstract class TopicsManagerFutures {
    ...
    public static final class CommonApiJavaImpl extends TopicsManagerFutures {
        ...
        public ListenableFuture<GetTopicsResponse> getTopicsAsync(GetTopicsRequest request) {
            E.f(request, "request");
            return CoroutineAdapterKt.asListenableFuture$default(AbstractC0272e.async(N.CoroutineScope(C0276f0.getMain()), r.INSTANCE, P.f943a, new TopicsManagerFutures$CommonApiJavaImpl$getTopicsAsync$1(this, request, null)), null, 1, null);
        }
    }

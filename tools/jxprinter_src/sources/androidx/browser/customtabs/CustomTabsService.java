...
public abstract class CustomTabsService extends Service {
    ...
    public class AnonymousClass1 extends ICustomTabsService.Stub {
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: androidx.browser.customtabs.a
                    ...
                    public final void binderDied() {
                        this.f989a.lambda$newSessionInternal$0(customTabsSessionToken);
                    }
                };
        ...
        @Override // android.support.customtabs.ICustomTabsService
        public boolean receiveFile(@NonNull ICustomTabsCallback iCustomTabsCallback, @NonNull Uri uri, int i5, @Nullable Bundle bundle) {
            return CustomTabsService.this.receiveFile(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), uri, i5, bundle);
        }
        ...
        @Override // android.support.customtabs.ICustomTabsService
        public boolean validateRelationship(@NonNull ICustomTabsCallback iCustomTabsCallback, int i5, @NonNull Uri uri, @Nullable Bundle bundle) {
            return CustomTabsService.this.validateRelationship(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), i5, uri, bundle);
        }
    ...
    public abstract boolean warmup(long j6);
}

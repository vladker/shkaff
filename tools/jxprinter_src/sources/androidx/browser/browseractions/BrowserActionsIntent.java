...
public class BrowserActionsIntent {
    ...
    public static List<BrowserActionItem> parseBrowserActionItems(@NonNull ArrayList<Bundle> arrayList) {
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            ...
            int i6 = bundle.getInt(KEY_ICON_ID);
            Uri uri = (Uri) bundle.getParcelable(KEY_ICON_URI);
            if (TextUtils.isEmpty(string) || pendingIntent == null) {
                throw new IllegalArgumentException("Custom item should contain a non-empty title and non-null intent.");
            }
            arrayList2.add(i6 != 0 ? new BrowserActionItem(string, pendingIntent, i6) : new BrowserActionItem(string, pendingIntent, uri));
        }
        return arrayList2;
    }
    ...
    public static void openBrowserAction(@NonNull Context context, @NonNull Uri uri, int i5, @NonNull ArrayList<BrowserActionItem> arrayList, @NonNull PendingIntent pendingIntent) {
        launchIntent(context, new Builder(context, uri).setUrlType(i5).setCustomItems(arrayList).setOnItemSelectedAction(pendingIntent).build().getIntent());
    }
    ...
    public static final class Builder {
        ...
        public Builder setCustomItems(@NonNull ArrayList<BrowserActionItem> arrayList) {
            ...
            for (int i5 = 0; i5 < arrayList.size(); i5++) {
                if (TextUtils.isEmpty(arrayList.get(i5).getTitle()) || arrayList.get(i5).getAction() == null) {
                    throw new IllegalArgumentException("Custom item should contain a non-empty title and non-null intent.");
                }
                this.mMenuItems.add(getBundleFromItem(arrayList.get(i5)));
                if (arrayList.get(i5).getIconUri() != null) {
                    this.mImageUris.add(arrayList.get(i5).getIconUri());
                }
            }
            return this;
        }
        ...
        @NonNull
        public Builder setUrlType(int i5) {
            this.mType = i5;
            return this;
        }

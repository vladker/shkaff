...
public class TrustedWebActivityIntentBuilder {
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setColorScheme(int i5) {
        this.mIntentBuilder.setColorScheme(i5);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setColorSchemeParams(int i5, @NonNull CustomTabColorSchemeParams customTabColorSchemeParams) {
        this.mIntentBuilder.setColorSchemeParams(i5, customTabColorSchemeParams);
        return this;
    }
    ...
    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setNavigationBarColor(@ColorInt int i5) {
        this.mIntentBuilder.setNavigationBarColor(i5);
        return this;
    }

    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setNavigationBarDividerColor(@ColorInt int i5) {
        this.mIntentBuilder.setNavigationBarDividerColor(i5);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setScreenOrientation(int i5) {
    ...
    @NonNull
    @Deprecated
    public TrustedWebActivityIntentBuilder setToolbarColor(@ColorInt int i5) {
        this.mIntentBuilder.setToolbarColor(i5);
        return this;
    }
}

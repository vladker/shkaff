...
public class ConstraintAnchor {
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i5, int i6, boolean z6) {
    ...
    public String toString() {
        return this.mOwner.getDebugName() + ParameterizedMessage.ERROR_MSG_SEPARATOR + this.mType.toString();
    }

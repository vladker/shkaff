...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private FieldSet<T> buildImpl(boolean z6) {
            ...
            if (this.hasNestedBuilders) {
                ...
                replaceBuilders(smallSortedMapCloneAllFieldsMap, z6);
            }
        ...
        private void mergeFromField(Map.Entry<T, Object> entry) {
            ...
            boolean z6 = value instanceof LazyField;
            if (key.isRepeated()) {
                if (z6) {
                ...
                for (int i5 = 0; i5 < size; i5++) {
                    arrayList.add(FieldSet.cloneIfMutable(list.get(i5)));
                }
                return;
            }
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap, boolean z6) {
            int numArrayEntries = smallSortedMap.getNumArrayEntries();
            for (int i5 = 0; i5 < numArrayEntries; i5++) {
                replaceBuilders(smallSortedMap.getArrayEntryAt(i5), z6);
            }
        ...
        private void verifyType(T t6, Object obj) {
            if (FieldSet.isValidType(t6.getLiteType(), obj)) {
                return;
            }
            if (t6.getLiteType().getJavaType() != WireFormat.JavaType.MESSAGE || !(obj instanceof MessageLite.Builder)) {
                throw new IllegalArgumentException(String.format("Wrong object type used with protocol message reflection.\nField number: %d, field java type: %s, value type: %s\n", Integer.valueOf(t6.getNumber()), t6.getLiteType().getJavaType(), obj.getClass().getName()));
            }
        }
        ...
        public Object getField(T t6) {
            return replaceBuilders(t6, getFieldAllowBuilders(t6), true);
        }
        ...
        public Object getRepeatedField(T t6, int i5) {
            if (this.hasNestedBuilders) {
                ensureIsMutable();
            }
            return replaceBuilder(getRepeatedFieldAllowBuilders(t6, i5), true);
        }

        public Object getRepeatedFieldAllowBuilders(T t6, int i5) {
            if (!t6.isRepeated()) {
        ...
        public boolean isInitialized() {
            ...
            for (int i5 = 0; i5 < numArrayEntries; i5++) {
                if (!FieldSet.isInitialized(this.fields.getArrayEntryAt(i5))) {
                    return false;
                }
            }
        ...
        public void mergeFrom(FieldSet<T> fieldSet) {
            ...
            for (int i5 = 0; i5 < numArrayEntries; i5++) {
                mergeFromField(((FieldSet) fieldSet).fields.getArrayEntryAt(i5));
            }
        ...
        public void setRepeatedField(T t6, int i5, Object obj) {
            ensureIsMutable();
            if (!t6.isRepeated()) {
                throw new IllegalArgumentException("getRepeatedField() can only be called on repeated fields.");
            }
        ...
        private static <T extends FieldDescriptorLite<T>> Object replaceBuilders(T t6, Object obj, boolean z6) {
                ...
                if (obj instanceof List) {
                    ...
                    for (int i5 = 0; i5 < arrayList.size(); i5++) {
                        ...
                        if (objReplaceBuilder != obj2) {
                            ...
                            arrayList.set(i5, objReplaceBuilder);
                        }
                    }
                    return arrayList;
                }
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z6, boolean z7) {
        SmallSortedMap<T, Object> smallSortedMapNewFieldMap = SmallSortedMap.newFieldMap();
        int numArrayEntries = smallSortedMap.getNumArrayEntries();
        for (int i5 = 0; i5 < numArrayEntries; i5++) {
            cloneFieldEntry(smallSortedMapNewFieldMap, smallSortedMap.getArrayEntryAt(i5), z6, z7);
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
            cloneFieldEntry(smallSortedMapNewFieldMap, (Map.Entry) it.next(), z6, z7);
        }
        return smallSortedMapNewFieldMap;
    }

    private static <T extends FieldDescriptorLite<T>> void cloneFieldEntry(Map<T, Object> map, Map.Entry<T, Object> entry, boolean z6, boolean z7) {
        T key = entry.getKey();
        Object value = entry.getValue();
        if (z7 && (value instanceof LazyField)) {
    ...
    public static int computeElementSize(WireFormat.FieldType fieldType, int i5, Object obj) {
        int iComputeTagSize = CodedOutputStream.computeTagSize(i5);
    ...
    public static int computeFieldSize(FieldDescriptorLite<?> fieldDescriptorLite, Object obj) {
        ...
        if (!fieldDescriptorLite.isPacked()) {
            ...
            while (i5 < size) {
                iComputeElementSize += computeElementSize(liteType, number, list.get(i5));
                i5++;
            }
        ...
        while (i5 < size) {
            iComputeElementSizeNoTag += computeElementSizeNoTag(liteType, list.get(i5));
            i5++;
        }
    ...
    private void verifyType(T t6, Object obj) {
        if (!isValidType(t6.getLiteType(), obj)) {
            throw new IllegalArgumentException(String.format("Wrong object type used with protocol message reflection.\nField number: %d, field java type: %s, value type: %s\n", Integer.valueOf(t6.getNumber()), t6.getLiteType().getJavaType(), obj.getClass().getName()));
        }
    }
    ...
    public static void writeField(FieldDescriptorLite<?> fieldDescriptorLite, Object obj, CodedOutputStream codedOutputStream) {
        ...
        if (!fieldDescriptorLite.isPacked()) {
            while (i5 < size) {
                writeElement(codedOutputStream, liteType, number, list.get(i5));
                i5++;
            }
        } else {
            if (list.isEmpty()) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                iComputeElementSizeNoTag += computeElementSizeNoTag(liteType, list.get(i6));
            }
            codedOutputStream.writeUInt32NoTag(iComputeElementSizeNoTag);
            while (i5 < size) {
                writeElementNoTag(codedOutputStream, liteType, list.get(i5));
                i5++;
            }
        }
    }
    ...
    public int getMessageSetSerializedSize() {
        ...
        for (int i5 = 0; i5 < numArrayEntries; i5++) {
            messageSetSerializedSize += getMessageSetSerializedSize(this.fields.getArrayEntryAt(i5));
        }
        Iterator it = this.fields.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    public int getSerializedSize() {
        ...
        for (int i5 = 0; i5 < numArrayEntries; i5++) {
            Map.Entry<K, Object> arrayEntryAt = this.fields.getArrayEntryAt(i5);
    ...
    public void writeMessageSetTo(CodedOutputStream codedOutputStream) {
        int numArrayEntries = this.fields.getNumArrayEntries();
        for (int i5 = 0; i5 < numArrayEntries; i5++) {
            writeMessageSetTo(this.fields.getArrayEntryAt(i5), codedOutputStream);
        }
        Iterator it = this.fields.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    public static <T extends FieldDescriptorLite<T>> boolean isInitialized(Map.Entry<T, Object> entry) {
        ...
        if (key.isRepeated()) {
            ...
            int size = list.size();
            for (int i5 = 0; i5 < size; i5++) {
                if (!isMessageFieldValueInitialized(list.get(i5))) {
                    return false;
                }
            }
            return true;

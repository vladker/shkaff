...
public final class Type extends GeneratedMessageLite<Type, Builder> implements TypeOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Type, Builder> implements TypeOrBuilder {
        ...
        @Override // androidx.datastore.preferences.protobuf.TypeOrBuilder
        public Field getFields(int i5) {
            return ((Type) this.instance).getFields(i5);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.TypeOrBuilder
        public String getOneofs(int i5) {
            return ((Type) this.instance).getOneofs(i5);
        }

        @Override // androidx.datastore.preferences.protobuf.TypeOrBuilder
        public ByteString getOneofsBytes(int i5) {
            return ((Type) this.instance).getOneofsBytes(i5);
        }
        ...
        public Option getOptions(int i5) {
            return ((Type) this.instance).getOptions(i5);
        }
        ...
        public Builder removeFields(int i5) {
            copyOnWrite();
            ((Type) this.instance).removeFields(i5);
            return this;
        }

        public Builder removeOptions(int i5) {
            copyOnWrite();
            ((Type) this.instance).removeOptions(i5);
            return this;
        }
        ...
        public Builder setFields(int i5, Field field) {
            copyOnWrite();
            ((Type) this.instance).setFields(i5, field);
            return this;
        }
        ...
        public Builder setOneofs(int i5, String str) {
            copyOnWrite();
            ((Type) this.instance).setOneofs(i5, str);
            return this;
        }

        public Builder setOptions(int i5, Option option) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i5, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i5) {
            copyOnWrite();
            ((Type) this.instance).setSyntaxValue(i5);
            return this;
        }
        ...
        public Builder addFields(int i5, Field field) {
            copyOnWrite();
            ((Type) this.instance).addFields(i5, field);
            return this;
        }

        public Builder addOptions(int i5, Option option) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i5, option);
            return this;
        }

        public Builder setFields(int i5, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setFields(i5, builder.build());
            return this;
        }

        public Builder setOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).setOptions(i5, builder.build());
            return this;
        }
        ...
        public Builder addFields(int i5, Field.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addFields(i5, builder.build());
            return this;
        }

        public Builder addOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Type) this.instance).addOptions(i5, builder.build());
            return this;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void removeFields(int i5) {
        ensureFieldsIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setFields(int i5, Field field) {
        field.getClass();
        ensureFieldsIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setOneofs(int i5, String str) {
        str.getClass();
        ensureOneofsIsMutable();
    ...
    public FieldOrBuilder getFieldsOrBuilder(int i5) {
        return this.fields_.get(i5);
    }
    ...
    @Override // androidx.datastore.preferences.protobuf.TypeOrBuilder
    public ByteString getOneofsBytes(int i5) {
        return ByteString.copyFromUtf8(this.oneofs_.get(i5));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addFields(int i5, Field field) {
        field.getClass();
        ensureFieldsIsMutable();

...
public final class Enum extends GeneratedMessageLite<Enum, Builder> implements EnumOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Enum, Builder> implements EnumOrBuilder {
        ...
        public Builder setEnumvalue(int i5, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setEnumvalue(i5, builder.build());
            return this;
        }

        public Builder setOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).setOptions(i5, builder.build());
            return this;
        }
        ...
        public Builder addEnumvalue(int i5, EnumValue.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addEnumvalue(i5, builder.build());
            return this;
        }

        public Builder addOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Enum) this.instance).addOptions(i5, builder.build());
            return this;
        }
    }
    ...
    static {
        Enum r6 = new Enum();
        DEFAULT_INSTANCE = r6;
        GeneratedMessageLite.registerDefaultInstance(Enum.class, r6);
    }
    ...
    public static Builder newBuilder(Enum r6) {

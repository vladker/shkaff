...
final class CodedInputStreamReader implements Reader {
    ...
    private <T> void mergeGroupFieldInternal(T t6, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) {
    ...
    private <T> void mergeMessageFieldInternal(T t6, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
    ...
    @Override // androidx.datastore.preferences.protobuf.Reader
    public <T> void mergeGroupField(T t6, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException.InvalidWireTypeException {
        requireWireType(3);
        mergeGroupFieldInternal(t6, schema, extensionRegistryLite);
    }
    ...
    public <T> void mergeMessageField(T t6, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        requireWireType(2);
        mergeMessageFieldInternal(t6, schema, extensionRegistryLite);
    }

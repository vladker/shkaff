...
interface Reader {
    ...
    <T> void mergeGroupField(T t6, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);

    <T> void mergeMessageField(T t6, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);

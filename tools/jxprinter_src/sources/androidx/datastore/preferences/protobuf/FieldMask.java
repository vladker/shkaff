...
public final class FieldMask extends GeneratedMessageLite<FieldMask, Builder> implements FieldMaskOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<FieldMask, Builder> implements FieldMaskOrBuilder {
        ...
        public String getPaths(int i5) {
            return ((FieldMask) this.instance).getPaths(i5);
        }

        @Override // androidx.datastore.preferences.protobuf.FieldMaskOrBuilder
        public ByteString getPathsBytes(int i5) {
            return ((FieldMask) this.instance).getPathsBytes(i5);
        }
        ...
        public Builder setPaths(int i5, String str) {
            copyOnWrite();
            ((FieldMask) this.instance).setPaths(i5, str);
            return this;
        }

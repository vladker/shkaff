...
public final class Api extends GeneratedMessageLite<Api, Builder> implements ApiOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Api, Builder> implements ApiOrBuilder {
        ...
        public Method getMethods(int i5) {
            return ((Api) this.instance).getMethods(i5);
        }
        ...
        @Override // androidx.datastore.preferences.protobuf.ApiOrBuilder
        public Mixin getMixins(int i5) {
            return ((Api) this.instance).getMixins(i5);
        }
        ...
        public Option getOptions(int i5) {
            return ((Api) this.instance).getOptions(i5);
        }
        ...
        public Builder removeMethods(int i5) {
            copyOnWrite();
            ((Api) this.instance).removeMethods(i5);
            return this;
        }

        public Builder removeMixins(int i5) {
            copyOnWrite();
            ((Api) this.instance).removeMixins(i5);
            return this;
        }

        public Builder removeOptions(int i5) {
            copyOnWrite();
            ((Api) this.instance).removeOptions(i5);
            return this;
        }

        public Builder setMethods(int i5, Method method) {
            copyOnWrite();
            ((Api) this.instance).setMethods(i5, method);
            return this;
        }

        public Builder setMixins(int i5, Mixin mixin) {
            copyOnWrite();
            ((Api) this.instance).setMixins(i5, mixin);
            return this;
        }
        ...
        public Builder setOptions(int i5, Option option) {
            copyOnWrite();
            ((Api) this.instance).setOptions(i5, option);
            return this;
        }
        ...
        public Builder setSyntaxValue(int i5) {
            copyOnWrite();
            ((Api) this.instance).setSyntaxValue(i5);
            return this;
        }
        ...
        public Builder addMethods(int i5, Method method) {
            copyOnWrite();
            ((Api) this.instance).addMethods(i5, method);
            return this;
        }

        public Builder addMixins(int i5, Mixin mixin) {
            copyOnWrite();
            ((Api) this.instance).addMixins(i5, mixin);
            return this;
        }

        public Builder addOptions(int i5, Option option) {
            copyOnWrite();
            ((Api) this.instance).addOptions(i5, option);
            return this;
        }

        public Builder setMethods(int i5, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMethods(i5, builder.build());
            return this;
        }

        public Builder setMixins(int i5, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setMixins(i5, builder.build());
            return this;
        }

        public Builder setOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).setOptions(i5, builder.build());
            return this;
        }
        ...
        public Builder addMethods(int i5, Method.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMethods(i5, builder.build());
            return this;
        }

        public Builder addMixins(int i5, Mixin.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addMixins(i5, builder.build());
            return this;
        }

        public Builder addOptions(int i5, Option.Builder builder) {
            copyOnWrite();
            ((Api) this.instance).addOptions(i5, builder.build());
            return this;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void removeMethods(int i5) {
        ensureMethodsIsMutable();
        this.methods_.remove(i5);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void removeMixins(int i5) {
        ensureMixinsIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setMethods(int i5, Method method) {
        method.getClass();
        ensureMethodsIsMutable();
        this.methods_.set(i5, method);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void setMixins(int i5, Mixin mixin) {
        mixin.getClass();
        ensureMixinsIsMutable();
        this.mixins_.set(i5, mixin);
    }
    ...
    public MethodOrBuilder getMethodsOrBuilder(int i5) {
        return this.methods_.get(i5);
    }
    ...
    public MixinOrBuilder getMixinsOrBuilder(int i5) {
        return this.mixins_.get(i5);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addMethods(int i5, Method method) {
        method.getClass();
        ensureMethodsIsMutable();
        this.methods_.add(i5, method);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void addMixins(int i5, Mixin mixin) {
        mixin.getClass();
        ensureMixinsIsMutable();
        this.mixins_.add(i5, mixin);
    }

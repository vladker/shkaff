...
public final class PreferencesSerializer implements OkioSerializer<Preferences> {
    ...
    public Object readFrom(InterfaceC0171n interfaceC0171n, g<? super Preferences> gVar) throws CorruptionException {
        PreferencesProto.PreferenceMap from = PreferencesMapCompat.Companion.readFrom(interfaceC0171n.inputStream());
    ...
    @Override // androidx.datastore.core.okio.OkioSerializer
    public /* bridge */ /* synthetic */ Object writeTo(Preferences preferences, InterfaceC0170m interfaceC0170m, g gVar) {
        return writeTo2(preferences, interfaceC0170m, (g<? super Q>) gVar);
    }
    ...
    public Object writeTo2(Preferences preferences, InterfaceC0170m interfaceC0170m, g<? super Q> gVar) {
        ...
        builderNewBuilder.build().writeTo(interfaceC0170m.outputStream());
        return Q.INSTANCE;
    }
}

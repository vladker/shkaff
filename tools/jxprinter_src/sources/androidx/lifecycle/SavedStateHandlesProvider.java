...
public final class SavedStateHandlesProvider implements SavedStateRegistry.SavedStateProvider {
    ...
    private final InterfaceC1934n viewModel$delegate;

    public SavedStateHandlesProvider(SavedStateRegistry savedStateRegistry, ViewModelStoreOwner viewModelStoreOwner) {
        E.f(savedStateRegistry, "savedStateRegistry");
        E.f(viewModelStoreOwner, "viewModelStoreOwner");
        this.savedStateRegistry = savedStateRegistry;
        this.viewModel$delegate = AbstractC1935o.lazy(new SavedStateHandlesProvider$viewModel$2(viewModelStoreOwner));
    }
    ...
    public Bundle saveState() {
        ...
        for (Map.Entry<String, SavedStateHandle> entry : getViewModel().getHandles().entrySet()) {
            ...
            if (!E.a(bundleSaveState, Bundle.EMPTY)) {

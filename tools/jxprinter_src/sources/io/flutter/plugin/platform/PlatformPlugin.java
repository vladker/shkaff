...
public class PlatformPlugin {
    ...
    public class AnonymousClass2 implements View.OnSystemUiVisibilityChangeListener {
        ...
        public /* synthetic */ void lambda$onSystemUiVisibilityChange$0(int i5) {
            if ((i5 & 4) == 0) {
        ...
        public void onSystemUiVisibilityChange(final int i5) {
            this.val$decorView.post(new Runnable() { // from class: io.flutter.plugin.platform.a
                ...
                public final void run() {
                    this.f4090a.lambda$onSystemUiVisibilityChange$0(i5);
                }
            });
        }
    }
    ...
    public void setFrameworkHandlesBack(boolean z6) {
        ...
        if (platformPluginDelegate != null) {
            platformPluginDelegate.setFrameworkHandlesBack(z6);
        }
    }
    ...
    public void setSystemChromeApplicationSwitcherDescription(PlatformChannel.AppSwitcherDescription appSwitcherDescription) {
        ...
        this.activity.setTaskDescription(com.google.firebase.crashlytics.internal.common.a.e(appSwitcherDescription.color, appSwitcherDescription.label));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setSystemChromePreferredOrientations(int i5) {
    ...
    public void vibrateHapticFeedback(@NonNull PlatformChannel.HapticFeedbackType hapticFeedbackType) {
        View decorView = this.activity.getWindow().getDecorView();
        int i5 = AnonymousClass3.$SwitchMap$io$flutter$embedding$engine$systemchannels$PlatformChannel$HapticFeedbackType[hapticFeedbackType.ordinal()];
        if (i5 == 1) {
    ...
    public PlatformPlugin(@NonNull Activity activity, @NonNull PlatformChannel platformChannel, @Nullable PlatformPluginDelegate platformPluginDelegate) {
        PlatformChannel.PlatformMessageHandler platformMessageHandler = new PlatformChannel.PlatformMessageHandler() { // from class: io.flutter.plugin.platform.PlatformPlugin.1
            ...
            @Override // io.flutter.embedding.engine.systemchannels.PlatformChannel.PlatformMessageHandler
            public void setFrameworkHandlesBack(boolean z6) {
                PlatformPlugin.this.setFrameworkHandlesBack(z6);
            }

            @Override // io.flutter.embedding.engine.systemchannels.PlatformChannel.PlatformMessageHandler
            public void setPreferredOrientations(int i5) {
                PlatformPlugin.this.setSystemChromePreferredOrientations(i5);
            }

...
public class WebViewActivity extends Activity {
    ...
    @NonNull
    public static Intent createIntent(@NonNull Context context, @NonNull String str, boolean z6, boolean z7, @NonNull Bundle bundle) {
        return new Intent(context, (Class<?>) WebViewActivity.class).putExtra("url", str).putExtra(ENABLE_JS_EXTRA, z6).putExtra(ENABLE_DOM_EXTRA, z7).putExtra("com.android.browser.headers", bundle);
    }

...
public abstract class PigeonApiGeolocationPermissionsCallback {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiGeolocationPermissionsCallback pigeonApiGeolocationPermissionsCallback, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.E.d(obj2, "null cannot be cast to non-null type android.webkit.GeolocationPermissions.Callback");
            ...
            kotlin.jvm.internal.E.d(obj5, "null cannot be cast to non-null type kotlin.Boolean");
            try {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiGeolocationPermissionsCallback pigeonApiGeolocationPermissionsCallback) {
            ...
            if (pigeonApiGeolocationPermissionsCallback != null) {
                basicMessageChannel.setMessageHandler(new i(pigeonApiGeolocationPermissionsCallback, 4));
            } else {
    ...
    public abstract void invoke(GeolocationPermissions.Callback callback, String str, boolean z6, boolean z7);

    public final void pigeon_newInstance(GeolocationPermissions.Callback pigeon_instanceArg, O3.l callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.GeolocationPermissionsCallback.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(A3.G.listOf(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new C0666b(10, callback));
        }
    }
}

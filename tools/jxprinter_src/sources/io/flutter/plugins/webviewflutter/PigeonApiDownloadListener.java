...
public abstract class PigeonApiDownloadListener {
    ...
    public static final class Companion {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiDownloadListener pigeonApiDownloadListener) {
            ...
            if (pigeonApiDownloadListener != null) {
                basicMessageChannel.setMessageHandler(new i(pigeonApiDownloadListener, 3));
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onDownloadStart$lambda$0(O3.l lVar, String str, Object obj) {
    ...
    public final void onDownloadStart(DownloadListener pigeon_instanceArg, String urlArg, String userAgentArg, String contentDispositionArg, String mimetypeArg, long j6, O3.l callback) {
        kotlin.jvm.internal.E.f(pigeon_instanceArg, "pigeon_instanceArg");
        kotlin.jvm.internal.E.f(urlArg, "urlArg");
        kotlin.jvm.internal.E.f(userAgentArg, "userAgentArg");
        kotlin.jvm.internal.E.f(contentDispositionArg, "contentDispositionArg");
        kotlin.jvm.internal.E.f(mimetypeArg, "mimetypeArg");
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.DownloadListener.onDownloadStart", getPigeonRegistrar().getCodec()).send(I.listOf(pigeon_instanceArg, urlArg, userAgentArg, contentDispositionArg, mimetypeArg, Long.valueOf(j6)), new C0666b(7, callback));
        }
    }

    public abstract DownloadListener pigeon_defaultConstructor();

    public final void pigeon_newInstance(DownloadListener pigeon_instanceArg, O3.l callback) {
        kotlin.jvm.internal.E.f(pigeon_instanceArg, "pigeon_instanceArg");
        kotlin.jvm.internal.E.f(callback, "callback");
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            com.google.android.gms.auth.api.accounttransfer.a.p("ignore-calls-error", "Calls to Dart are being ignored.", "", callback);
            ...
            com.google.android.gms.auth.api.accounttransfer.a.p("new-instance-error", "Attempting to create a new Dart instance of DownloadListener, but the class has a nonnull callback method.", "", callback);
        }
    }
}

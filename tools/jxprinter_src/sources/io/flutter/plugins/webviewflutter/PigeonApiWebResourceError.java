...
public abstract class PigeonApiWebResourceError {
    ...
    @RequiresApi(api = 23)
    public final void pigeon_newInstance(WebResourceError pigeon_instanceArg, O3.l callback) {
        ...
        new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebResourceError.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(I.listOf(Long.valueOf(jAddHostCreatedInstance), Long.valueOf(jErrorCode), description(pigeon_instanceArg)), new u(1, callback));
    }
}

...
public abstract class PigeonApiWebResourceResponse {
    ...
    public final void pigeon_newInstance(WebResourceResponse pigeon_instanceArg, O3.l callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebResourceResponse.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(I.listOf((Object[]) new Long[]{Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg)), Long.valueOf(statusCode(pigeon_instanceArg))}), new u(4, callback));
        }
    }

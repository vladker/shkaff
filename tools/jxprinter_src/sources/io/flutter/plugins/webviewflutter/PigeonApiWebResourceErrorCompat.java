...
public abstract class PigeonApiWebResourceErrorCompat {
    ...
    public final void pigeon_newInstance(WebResourceErrorCompat pigeon_instanceArg, O3.l callback) {
        ...
        new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebResourceErrorCompat.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(I.listOf(Long.valueOf(jAddHostCreatedInstance), Long.valueOf(jErrorCode), description(pigeon_instanceArg)), new u(2, callback));
    }
}

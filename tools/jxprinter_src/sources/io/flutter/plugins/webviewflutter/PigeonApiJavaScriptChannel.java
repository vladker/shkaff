...
public abstract class PigeonApiJavaScriptChannel {
    ...
    public static final class Companion {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiJavaScriptChannel pigeonApiJavaScriptChannel) {
            ...
            if (pigeonApiJavaScriptChannel != null) {
                basicMessageChannel.setMessageHandler(new i(pigeonApiJavaScriptChannel, 5));
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void postMessage$lambda$0(O3.l lVar, String str, Object obj) {
    ...
    public final void pigeon_newInstance(JavaScriptChannel pigeon_instanceArg, O3.l callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            com.google.android.gms.auth.api.accounttransfer.a.p("new-instance-error", "Attempting to create a new Dart instance of JavaScriptChannel, but the class has a nonnull callback method.", "", callback);
        }
    }

    public final void postMessage(JavaScriptChannel pigeon_instanceArg, String messageArg, O3.l callback) {
        kotlin.jvm.internal.E.f(pigeon_instanceArg, "pigeon_instanceArg");
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.JavaScriptChannel.postMessage", getPigeonRegistrar().getCodec()).send(I.listOf(pigeon_instanceArg, messageArg), new C0666b(12, callback));
        }
    }
}

...
public abstract class PigeonApiSslError {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiSslError pigeonApiSslError, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.E.d(obj2, "null cannot be cast to non-null type android.net.http.SslError");
            try {
                listWrapError = A3.G.listOf(pigeonApiSslError.getPrimaryError((SslError) obj2));
            } catch (Throwable th) {
        ...
        public static final void setUpMessageHandlers$lambda$3$lambda$2(PigeonApiSslError pigeonApiSslError, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.E.d(obj3, "null cannot be cast to non-null type io.flutter.plugins.webviewflutter.SslErrorType");
            try {
                listWrapError = A3.G.listOf(Boolean.valueOf(pigeonApiSslError.hasError(sslError, (SslErrorType) obj3)));
            } catch (Throwable th) {
                listWrapError = AndroidWebkitLibraryPigeonUtils.INSTANCE.wrapError(th);
            }
            reply.reply(listWrapError);
    ...
    public final void pigeon_newInstance(SslError pigeon_instanceArg, O3.l callback) {
        ...
        new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.SslError.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(I.listOf(Long.valueOf(jAddHostCreatedInstance), certificate(pigeon_instanceArg), url(pigeon_instanceArg)), new C0666b(17, callback));
    }

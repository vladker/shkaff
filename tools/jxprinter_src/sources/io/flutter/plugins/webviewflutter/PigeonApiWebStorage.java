...
public abstract class PigeonApiWebStorage {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$3$lambda$2(PigeonApiWebStorage pigeonApiWebStorage, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.E.d(obj, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
            Object obj2 = ((List) obj).get(0);
            kotlin.jvm.internal.E.d(obj2, "null cannot be cast to non-null type android.webkit.WebStorage");
            try {
    ...
    public final void pigeon_newInstance(WebStorage pigeon_instanceArg, O3.l callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebStorage.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(A3.G.listOf(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new u(7, callback));
        }
    }
}

...
public abstract class PigeonApiWebViewPoint {
    ...
    public final void pigeon_newInstance(WebViewPoint pigeon_instanceArg, O3.l callback) {
        ...
        new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebViewPoint.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(I.listOf((Object[]) new Long[]{Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg)), Long.valueOf(x(pigeon_instanceArg)), Long.valueOf(y(pigeon_instanceArg))}), new u(29, callback));
    }

...
public abstract class PigeonApiCustomViewCallback {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiCustomViewCallback pigeonApiCustomViewCallback, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.E.d(obj2, "null cannot be cast to non-null type android.webkit.WebChromeClient.CustomViewCallback");
            try {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiCustomViewCallback pigeonApiCustomViewCallback) {
            ...
            if (pigeonApiCustomViewCallback != null) {
                basicMessageChannel.setMessageHandler(new i(pigeonApiCustomViewCallback, 2));
            } else {
    ...
    public final void pigeon_newInstance(WebChromeClient.CustomViewCallback pigeon_instanceArg, O3.l callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.CustomViewCallback.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(A3.G.listOf(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new C0666b(6, callback));
        }
    }
}

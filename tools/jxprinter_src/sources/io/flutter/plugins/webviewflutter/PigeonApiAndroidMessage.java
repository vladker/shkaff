...
public abstract class PigeonApiAndroidMessage {
    ...
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$1$lambda$0(PigeonApiAndroidMessage pigeonApiAndroidMessage, Object obj, BasicMessageChannel.Reply reply) {
            ...
            kotlin.jvm.internal.E.d(obj2, "null cannot be cast to non-null type android.os.Message");
            try {
        ...
        public final void setUpMessageHandlers(BinaryMessenger binaryMessenger, PigeonApiAndroidMessage pigeonApiAndroidMessage) {
            ...
            if (pigeonApiAndroidMessage != null) {
                basicMessageChannel.setMessageHandler(new i(pigeonApiAndroidMessage, 0));
            } else {
    ...
    public final void pigeon_newInstance(Message pigeon_instanceArg, O3.l callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.AndroidMessage.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(A3.G.listOf(Long.valueOf(getPigeonRegistrar().getInstanceManager().addHostCreatedInstance(pigeon_instanceArg))), new C0666b(1, callback));
        }
    }

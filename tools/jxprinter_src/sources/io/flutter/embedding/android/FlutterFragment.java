...
public class FlutterFragment extends Fragment implements FlutterActivityAndFragmentDelegate.Host, ComponentCallbacks2, FlutterActivityAndFragmentDelegate.DelegateFactory {
    ...
    private final ViewTreeObserver.OnWindowFocusChangeListener onWindowFocusChangeListener = new ViewTreeObserver.OnWindowFocusChangeListener() { // from class: io.flutter.embedding.android.FlutterFragment.1
        ...
        public void onWindowFocusChanged(boolean z6) {
            if (FlutterFragment.this.stillAttachedForEvent("onWindowFocusChanged")) {
                FlutterFragment.this.delegate.onWindowFocusChanged(z6);
            }
        }
    };
    ...
    public static class CachedEngineFragmentBuilder {
        ...
        @NonNull
        public CachedEngineFragmentBuilder shouldAutomaticallyHandleOnBackPressed(boolean z6) {
            this.shouldAutomaticallyHandleOnBackPressed = z6;
            return this;
        }

        @NonNull
        public CachedEngineFragmentBuilder shouldDelayFirstAndroidViewDraw(@NonNull boolean z6) {
            this.shouldDelayFirstAndroidViewDraw = z6;
            return this;
        }
    ...
    public static class NewEngineInGroupFragmentBuilder {
        ...
        @NonNull
        public NewEngineInGroupFragmentBuilder handleDeeplinking(@NonNull boolean z6) {
            this.handleDeeplinking = z6;
            return this;
        }
        ...
        @NonNull
        public NewEngineInGroupFragmentBuilder shouldAttachEngineToActivity(boolean z6) {
            this.shouldAttachEngineToActivity = z6;
            return this;
        }

        @NonNull
        public NewEngineInGroupFragmentBuilder shouldAutomaticallyHandleOnBackPressed(boolean z6) {
            this.shouldAutomaticallyHandleOnBackPressed = z6;
            return this;
        }

        @NonNull
        public NewEngineInGroupFragmentBuilder shouldDelayFirstAndroidViewDraw(@NonNull boolean z6) {
            this.shouldDelayFirstAndroidViewDraw = z6;
            return this;
        }
        ...
        public NewEngineInGroupFragmentBuilder(@NonNull Class<? extends FlutterFragment> cls, @NonNull String str) {
            ...
            this.initialRoute = PackagingURIHelper.FORWARD_SLASH_STRING;
            this.handleDeeplinking = false;
            this.renderMode = RenderMode.surface;
            this.transparencyMode = TransparencyMode.transparent;
            this.shouldAttachEngineToActivity = true;
    ...
    public void setFrameworkHandlesBack(boolean z6) {
        if (getArguments().getBoolean(ARG_SHOULD_AUTOMATICALLY_HANDLE_ON_BACK_PRESSED, false)) {
            this.onBackPressedCallback.setEnabled(z6);
        }
    }
    ...
    public boolean shouldDestroyEngineWithHost() {
        ...
        return (getCachedEngineId() != null || this.delegate.isFlutterEngineFromHost()) ? z6 : getArguments().getBoolean(ARG_DESTROY_ENGINE_WITH_FRAGMENT, true);
    }
    ...
    public static class NewEngineFragmentBuilder {
        ...
        @NonNull
        public NewEngineFragmentBuilder shouldAttachEngineToActivity(boolean z6) {
            this.shouldAttachEngineToActivity = z6;
            return this;
        }

        @NonNull
        public NewEngineFragmentBuilder shouldAutomaticallyHandleOnBackPressed(boolean z6) {
            this.shouldAutomaticallyHandleOnBackPressed = z6;
            return this;
        }

        @NonNull
        public NewEngineFragmentBuilder shouldDelayFirstAndroidViewDraw(boolean z6) {
            this.shouldDelayFirstAndroidViewDraw = z6;
            return this;
        }

...
public class DartExecutor implements BinaryMessenger {
    ...
    public static class DartCallback {
        ...
        public String toString() {
            ...
            sb.append(", function: ");
            return AbstractC0157z.s(sb, this.callbackHandle.callbackName, " )");
        }
    }
    ...
    public DartExecutor(@NonNull FlutterJNI flutterJNI, @NonNull AssetManager assetManager, long j6) {
    ...
    public static class DartEntrypoint {
        ...
        public String toString() {
            ...
            sb.append(this.pathToBundle);
            sb.append(", function: ");
            return AbstractC0157z.s(sb, this.dartEntrypointFunctionName, " )");
        }

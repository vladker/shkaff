...
public final class ApplicationInfoLoader {
    ...
    private static boolean getBoolean(Bundle bundle, String str, boolean z6) {
    ...
    private static String getNetworkPolicy(ApplicationInfo applicationInfo, Context context) {
        ...
        if (bundle == null || (i5 = bundle.getInt(NETWORK_POLICY_METADATA_KEY, 0)) <= 0) {
            return null;
        }
    ...
    private static void parseDomain(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z6) throws XmlPullParserException, IOException {
    ...
    private static void parseDomainConfig(XmlResourceParser xmlResourceParser, JSONArray jSONArray, boolean z6) throws XmlPullParserException, IOException {

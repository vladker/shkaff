...
public class RouteMeta {
    ...
    public static RouteMeta build(RouteType routeType, Class<?> cls, String str, String str2, int i5, int i6) {
        return new RouteMeta(routeType, null, cls, null, str, str2, null, i5, i6);
    }
    ...
    public RouteMeta setExtra(int i5) {
        this.extra = i5;
        return this;
    }
    ...
    public RouteMeta setPriority(int i5) {
        this.priority = i5;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(this.paramsType);
        sb.append(", name='");
        return AbstractC0157z.s(sb, this.name, "'}");
    }

    public static RouteMeta build(RouteType routeType, Class<?> cls, String str, String str2, Map<String, Integer> map, int i5, int i6) {

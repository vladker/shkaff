...
public final class Postcard extends RouteMeta {
    ...
    public Postcard addFlags(int i5) {
    ...
    public Postcard setTimeout(int i5) {
        this.timeout = i5;
        return this;
    }
    ...
    public Postcard withBoolean(@Nullable String str, boolean z6) {
    ...
    public Postcard withFlags(int i5) {
        this.flags = i5;
        return this;
    }

    public Postcard withFloat(@Nullable String str, float f6) {
        this.mBundle.putFloat(str, f6);
        return this;
    }
    ...
    public Postcard withInt(@Nullable String str, int i5) {
        this.mBundle.putInt(str, i5);
        return this;
    }
    ...
    public Postcard withLong(@Nullable String str, long j6) {
    ...
    public Postcard withShort(@Nullable String str, short s6) {
        this.mBundle.putShort(str, s6);
        return this;
    }
    ...
    public Postcard withTransition(int i5, int i6) {
        this.enterAnim = i5;
        this.exitAnim = i6;
        return this;
    }
    ...
    public void navigation(Activity activity, int i5, NavigationCallback navigationCallback) {
        ARouter.getInstance().navigation(activity, this, i5, navigationCallback);
    }
}

...
public class PublishToIndustryActivity extends MvpActivity implements E.c, p009b0.a {
    ...
    public void initComponent() {
        super.initComponent();
        this.tvTitle.setText(getString(p113u.g.text_238));
    ...
    @Override // com.library.base.frame.FrameActivity, com.library.base.frame.BaseActivity
    public int layoutId() {
        return p113u.e.activity_publish_to_industry;
    }

    public void onPublishToIndustryClick(View view) {
        if (this.etPublishToSquareIndustry.getText().toString().trim().length() == 0) {
            p042h2.d.show(p113u.g.toast_46);
            return;
        }
        ...
        this.templateElementPto.setDescription(this.etPublishToSquareIndustry.getText().toString());
        p050j.w.e();
        this.publishTemplateWorker.a(this.templateElementPto, "");
    }

    public void onPublishToIndustryTypeClick(View view) {
        ...
        p097r0.a aVar = new p097r0.a(this, new p109t0.a() { // from class: com.appdev.standard.page.printerlabel.PublishToIndustryActivity.1
            @Override // p109t0.a
            public void onOptionsSelect(int i5, int i6, int i7, View view2) {
                PublishToIndustryActivity publishToIndustryActivity = PublishToIndustryActivity.this;
                publishToIndustryActivity.tvPublishToIndustryType.setText(((DictModel) publishToIndustryActivity.dictModels.get(i5)).getDictLabel());
                PublishToIndustryActivity publishToIndustryActivity2 = PublishToIndustryActivity.this;
                publishToIndustryActivity2.selectDictModel = (DictModel) publishToIndustryActivity2.dictModels.get(i5);
            }
        });
    ...
    public void publishTemplateSuccess(String str) {
        p050j.w.c();
        p042h2.d.show(p113u.g.toast_48);
        finish();
    }

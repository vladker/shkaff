...
public final class C0514i extends AbstractC0511f {
    public static final byte[] b = "com.bumptech.glide.load.resource.bitmap.CenterCrop".getBytes(p126w0.q.f8812a);

    @Override // p126w0.q
    public final boolean equals(Object obj) {
        return obj instanceof C0514i;
    }
    ...
    public Bitmap transform(@NonNull com.bumptech.glide.load.engine.bitmap_recycle.c cVar, @NonNull Bitmap bitmap, int i5, int i6) {
        return T.centerCrop(cVar, bitmap, i5, i6);
    }

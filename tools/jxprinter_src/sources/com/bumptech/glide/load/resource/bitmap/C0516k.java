...
public final class C0516k extends AbstractC0511f {
    public static final byte[] b = "com.bumptech.glide.load.resource.bitmap.CircleCrop.1".getBytes(p126w0.q.f8812a);

    @Override // p126w0.q
    public final boolean equals(Object obj) {
        return obj instanceof C0516k;
    }
    ...
    public Bitmap transform(@NonNull com.bumptech.glide.load.engine.bitmap_recycle.c cVar, @NonNull Bitmap bitmap, int i5, int i6) {
        return T.circleCrop(cVar, bitmap, i5, i6);
    }

...
class CrashlyticsController {
    ...
    static final FilenameFilter APP_EXCEPTION_MARKER_FILTER = new b(1);
    ...
    public void doOpenSession(String str, Boolean bool) {
        ...
        this.nativeComponent.prepareNativeSession(str, AbstractC0157z.n("Crashlytics Android SDK/", CrashlyticsCore.getVersion()), currentTimestampSeconds, StaticSessionData.create(createAppData(this.idManager, this.appData), createOsData(), createDeviceData(this.context)));
    ...
    private Task<Boolean> waitForReportAction() {
        ...
        Task<TContinuationResult> taskOnSuccessTask = this.dataCollectionArbiter.waitForAutomaticDataCollectionEnabled().onSuccessTask(new SuccessContinuation<Void, Boolean>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController.3
            ...
            @NonNull
            public Task<Boolean> then(@Nullable Void r6) {
                return Tasks.forResult(Boolean.TRUE);
            }
        });
    ...
    public void openSession(String str) {
        this.crashlyticsWorkers.common.submit(new d(this, str, 0));
    }
    ...
    public void writeToLog(long j6, String str) {
        ...
        this.logFileManager.writeToLog(j6, str);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private void doCloseSessions(boolean z6, SettingsProvider settingsProvider, boolean z7) {
        String str;
        CrashlyticsWorkers.checkBackgroundThread();
    ...
    public synchronized void handleUncaughtException(@NonNull final SettingsProvider settingsProvider, @NonNull final Thread thread, @NonNull final Throwable th, final boolean z6) throws Throwable {
        Throwable th2;
        try {
            try {
                ...
                Task taskSubmitTask = this.crashlyticsWorkers.common.submitTask(new Callable<Task<Void>>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController.2
                    ...
                    public Task<Void> call() {
                        ...
                        CrashlyticsController.this.doOpenSession(new CLSUUID().getSessionId(), Boolean.valueOf(z6));
                        return !CrashlyticsController.this.dataCollectionArbiter.isAutomaticDataCollectionEnabled() ? Tasks.forResult(null) : settingsProvider.getSettingsAsync().onSuccessTask(CrashlyticsController.this.crashlyticsWorkers.common, new SuccessContinuation<Settings, Void>() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController.2.1
                            ...
                            public Task<Void> then(@Nullable Settings settings) {
                                if (settings != null) {
                                    return Tasks.whenAll((Task<?>[]) new Task[]{CrashlyticsController.this.logAnalyticsAppExceptionEvents(), CrashlyticsController.this.reportingCoordinator.sendReports(CrashlyticsController.this.crashlyticsWorkers.common, z6 ? currentSessionId : null)});
                                }

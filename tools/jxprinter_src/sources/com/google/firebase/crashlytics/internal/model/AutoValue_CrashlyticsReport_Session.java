...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    public int hashCode() {
        ...
        int i5 = (((iHashCode ^ iHashCode2) * 1000003) ^ ((int) (j6 ^ (j6 >>> 32)))) * 1000003;
        Long l6 = this.endedAt;
        int iHashCode3 = (((((i5 ^ (l6 == null ? 0 : l6.hashCode())) * 1000003) ^ (this.crashed ? 1231 : 1237)) * 1000003) ^ this.app.hashCode()) * 1000003;
    ...
    public String toString() {
        ...
        sb.append(", generatorType=");
        return AbstractC0157z.l(VectorFormat.DEFAULT_SUFFIX, this.generatorType, sb);
    }

    private AutoValue_CrashlyticsReport_Session(String str, String str2, @Nullable String str3, long j6, @Nullable Long l6, boolean z6, CrashlyticsReport.Session.Application application, @Nullable CrashlyticsReport.Session.User user, @Nullable CrashlyticsReport.Session.OperatingSystem operatingSystem, @Nullable CrashlyticsReport.Session.Device device, @Nullable List<CrashlyticsReport.Session.Event> list, int i5) {
        this.generator = str;

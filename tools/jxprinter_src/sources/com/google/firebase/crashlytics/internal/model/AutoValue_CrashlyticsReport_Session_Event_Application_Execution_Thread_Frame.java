...
final class AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Thread_Frame extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame {
    ...
    public int hashCode() {
        ...
        long j7 = this.offset;
        return ((iHashCode2 ^ ((int) ((j7 >>> 32) ^ j7))) * 1000003) ^ this.importance;
    }
    ...
    public String toString() {
        ...
        sb.append(", importance=");
        return AbstractC0157z.l(VectorFormat.DEFAULT_SUFFIX, this.importance, sb);
    }

    private AutoValue_CrashlyticsReport_Session_Event_Application_Execution_Thread_Frame(long j6, String str, @Nullable String str2, long j7, int i5) {
        this.pc = j6;
        this.symbol = str;
        this.file = str2;
        this.offset = j7;

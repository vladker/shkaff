...
final class RestrictedComponentContainer implements ComponentContainer {
    ...
    public <T> T get(Class<T> cls) {
        ...
        throw new DependencyException("Attempting to request an undeclared dependency " + cls + Consts.DOT);
    }
    ...
    public <T> T get(Qualified<T> qualified) {
        ...
        throw new DependencyException("Attempting to request an undeclared dependency " + qualified + Consts.DOT);
    }
}

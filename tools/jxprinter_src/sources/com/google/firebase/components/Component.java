...
public final class Component<T> {
    ...
    public static <T> Component<T> intoSet(T t6, Class<T> cls) {
        return intoSetBuilder(cls).factory(new a(t6, 2)).build();
    }
    ...
    public static <T> Component<T> of(Class<T> cls, T t6) {
        return builder(cls).factory(new a(t6, 3)).build();
    }
    ...
    private Component(@Nullable String str, Set<Qualified<? super T>> set, Set<Dependency> set2, int i5, int i6, ComponentFactory<T> componentFactory, Set<Class<?>> set3) {
        this.name = str;
    ...
    public static <T> Component<T> intoSet(T t6, Qualified<T> qualified) {
        return intoSetBuilder(qualified).factory(new a(t6, 1)).build();
    }
    ...
    public static <T> Component<T> of(T t6, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new a(t6, 4)).build();
    }
    ...
    public static <T> Component<T> of(T t6, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
        return builder(qualified, qualifiedArr).factory(new a(t6, 0)).build();
    }

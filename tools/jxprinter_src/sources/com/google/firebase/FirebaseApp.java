...
public class FirebaseApp {
                ...
                try {
                    ...
                    while (i5 < size) {
                        ...
                        if (firebaseApp.automaticResourceManagementEnabled.get()) {
                            firebaseApp.notifyBackgroundStateChangeListeners(z6);
                        }
                    }
                } catch (Throwable th) {
                    throw th;
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.a
            ...
            public final Object get() {
                return this.f3462a.lambda$new$0(context);
            }
        });
    ...
    public void setAutomaticResourceManagementEnabled(boolean z6) {
        checkNotDeleted();
        if (this.automaticResourceManagementEnabled.compareAndSet(!z6, z6)) {
            boolean zIsInBackground = BackgroundDetector.getInstance().isInBackground();
            if (z6 && zIsInBackground) {

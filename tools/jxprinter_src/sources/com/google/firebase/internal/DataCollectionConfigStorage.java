...
public class DataCollectionConfigStorage {
    ...
    private synchronized void updateDataCollectionDefaultEnabled(boolean z6) {
        if (this.dataCollectionDefaultEnabled != z6) {
            this.dataCollectionDefaultEnabled = z6;
            this.publisher.publish(new Event<>(DataCollectionDefaultChange.class, new DataCollectionDefaultChange(z6)));
        }
    }

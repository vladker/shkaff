...
public final class Funnels {
    ...
    public enum LongFunnel implements Funnel<Long> {
        ...
        @Override // com.google.common.hash.Funnel
        public void funnel(Long l6, PrimitiveSink primitiveSink) {
            primitiveSink.putLong(l6.longValue());
        }
    }
    ...
    public static class SequentialFunnel<E> implements Funnel<Iterable<? extends E>>, Serializable {
        ...
        public String toString() {
            ...
            return a.e(strValueOf.length() + 26, "Funnels.sequentialFunnel(", strValueOf, ")");
        }
    ...
    public static class SinkAsStream extends OutputStream {
        ...
        public String toString() {
            ...
            return a.e(strValueOf.length() + 24, "Funnels.asOutputStream(", strValueOf, ")");
        }

        @Override // java.io.OutputStream
        public void write(int i5) {
            this.sink.putByte((byte) i5);
        }
    ...
    public static class StringCharsetFunnel implements Funnel<CharSequence>, Serializable {
        ...
        public String toString() {
            ...
            return a.e(a.b(22, strName), "Funnels.stringFunnel(", strName, ")");
        }

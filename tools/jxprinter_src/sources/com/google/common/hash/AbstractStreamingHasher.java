...
abstract class AbstractStreamingHasher extends AbstractHasher {
    ...
    public void processRemaining(ByteBuffer byteBuffer) {
        ...
        while (true) {
            ...
            if (iPosition >= i5) {
                Java8Compatibility.limit(byteBuffer, i5);
    ...
    public AbstractStreamingHasher(int i5, int i6) {
        Preconditions.checkArgument(i6 % i5 == 0);
        this.buffer = ByteBuffer.allocate(i6 + 7).order(ByteOrder.LITTLE_ENDIAN);
        this.bufferSize = i6;
        this.chunkSize = i5;
    }
    ...
    @Override // com.google.common.hash.AbstractHasher, com.google.common.hash.Hasher, com.google.common.hash.PrimitiveSink
    public final Hasher putShort(short s6) {
    ...
    public final Hasher putBytes(byte[] bArr, int i5, int i6) {
        return putBytesInternal(ByteBuffer.wrap(bArr, i5, i6).order(ByteOrder.LITTLE_ENDIAN));
    }

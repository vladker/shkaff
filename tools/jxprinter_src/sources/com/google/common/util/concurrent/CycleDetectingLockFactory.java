...
public class CycleDetectingLockFactory {
    ...
    public final class CycleDetectingReentrantLock extends ReentrantLock implements CycleDetectingLock {
        ...
        private CycleDetectingReentrantLock(LockGraphNode lockGraphNode, boolean z6) {
            super(z6);
    ...
    public final class CycleDetectingReentrantReadWriteLock extends ReentrantReadWriteLock implements CycleDetectingLock {
        ...
        private CycleDetectingReentrantReadWriteLock(CycleDetectingLockFactory cycleDetectingLockFactory, LockGraphNode lockGraphNode, boolean z6) {
            super(z6);
    ...
    public static class ExampleStackTrace extends IllegalStateException {
        ...
        public ExampleStackTrace(LockGraphNode lockGraphNode, LockGraphNode lockGraphNode2) {
            ...
            super(androidx.exifinterface.media.a.e(androidx.exifinterface.media.a.b(androidx.exifinterface.media.a.b(4, lockName), lockName2), lockName, " -> ", lockName2));
            StackTraceElement[] stackTrace = getStackTrace();
            int length = stackTrace.length;
            for (int i5 = 0; i5 < length; i5++) {
                if (WithExplicitOrdering.class.getName().equals(stackTrace[i5].getClassName())) {
                    setStackTrace(EMPTY_STACK_TRACE);
                    return;
                } else {
                    if (!EXCLUDED_CLASS_NAMES.contains(stackTrace[i5].getClassName())) {
    ...
    public static final class WithExplicitOrdering<E extends Enum<E>> extends CycleDetectingLockFactory {
        ...
        public ReentrantLock newReentrantLock(E e, boolean z6) {
            ...
            return new CycleDetectingReentrantLock(lockGraphNode, z6);
        }

        public ReentrantReadWriteLock newReentrantReadWriteLock(E e, boolean z6) {
            if (this.policy == Policies.DISABLED) {
                return new ReentrantReadWriteLock(z6);
            }
            LockGraphNode lockGraphNode = this.lockGraphNodes.get(e);
            Objects.requireNonNull(lockGraphNode);
            return new CycleDetectingReentrantReadWriteLock(lockGraphNode, z6);
        }
    }
    ...
    public static <E extends Enum<E>> Map<E, LockGraphNode> createNodes(Class<E> cls) {
        ...
        for (int i6 = 1; i6 < length; i6++) {
            ((LockGraphNode) arrayListNewArrayListWithCapacity.get(i6)).checkAcquiredLocks(Policies.THROW, arrayListNewArrayListWithCapacity.subList(0, i6));
        }
        while (i5 < length - 1) {
            i5++;
            ((LockGraphNode) arrayListNewArrayListWithCapacity.get(i5)).checkAcquiredLocks(Policies.DISABLED, arrayListNewArrayListWithCapacity.subList(i5, length));
        }
        return Collections.unmodifiableMap(enumMapNewEnumMap);
    }

    private static String getLockName(Enum<?> r6) {
        String simpleName = r6.getDeclaringClass().getSimpleName();
        String strName = r6.name();
        return androidx.exifinterface.media.a.e(androidx.exifinterface.media.a.b(simpleName.length() + 1, strName), simpleName, Consts.DOT, strName);
    }
    ...
    public ReentrantLock newReentrantLock(String str, boolean z6) {
        return this.policy == Policies.DISABLED ? new ReentrantLock(z6) : new CycleDetectingReentrantLock(new LockGraphNode(str), z6);
    }

    public ReentrantReadWriteLock newReentrantReadWriteLock(String str, boolean z6) {
        return this.policy == Policies.DISABLED ? new ReentrantReadWriteLock(z6) : new CycleDetectingReentrantReadWriteLock(new LockGraphNode(str), z6);
    }

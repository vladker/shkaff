...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    static {
        ...
        if (r6 != 0) {
            ...
            r7.log(level, "UnsafeAtomicHelper is broken!", th);
            r7.log(level, "SafeAtomicHelper is broken!", r6);
        }
        NULL = new Object();
    }
    ...
    private void addPendingString(StringBuilder sb) {
        ...
        if (obj instanceof SetFuture) {
            ...
            try {
                strI = Strings.emptyToNull(pendingToString());
            } catch (RuntimeException | StackOverflowError e) {
                String strValueOf = String.valueOf(e.getClass());
                strI = com.google.android.gms.auth.api.accounttransfer.a.i(strValueOf.length() + 38, "Exception thrown from implementation: ", strValueOf);
            }
            if (strI != null) {
                androidx.collection.a.x(sb, ", info=[", strI, "]");
            }
        }
        if (isDone()) {
    ...
    public static Object getFutureValue(ListenableFuture<?> listenableFuture) {
        ...
        try {
            ...
            return new Failure(new IllegalArgumentException(com.google.android.gms.auth.api.accounttransfer.a.i(strValueOf2.length() + 77, "get() threw CancellationException, despite reporting isCancelled() == false: ", strValueOf2), e));
        } catch (ExecutionException e6) {
            if (!zIsCancelled) {
                return new Failure(e6.getCause());
            }
            String strValueOf3 = String.valueOf(listenableFuture);
            return new Cancellation(false, new IllegalArgumentException(com.google.android.gms.auth.api.accounttransfer.a.i(strValueOf3.length() + 84, "get() did not throw CancellationException, despite reporting isCancelled() == true: ", strValueOf3), e6));
        } catch (Throwable th) {
    ...
    @CanIgnoreReturnValue
    @ParametricNullness
    public V get(long j6, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        StringBuilder sb = new StringBuilder(androidx.exifinterface.media.a.b(28, lowerCase2));
        sb.append("Waited ");
        sb.append(j6);
        sb.append(" ");
        ...
        if (nanos + SPIN_THRESHOLD_NANOS < 0) {
            ...
            if (jConvert > 0) {
                ...
                StringBuilder sb2 = new StringBuilder(androidx.exifinterface.media.a.b(strValueOf.length() + 21, lowerCase));
        ...
        throw new TimeoutException(androidx.exifinterface.media.a.e(androidx.exifinterface.media.a.b(androidx.exifinterface.media.a.b(5, string3), string), string3, " for ", string));
    }
     ...
     */
    @CanIgnoreReturnValue
    public boolean set(@ParametricNullness V v6) {
        if (v6 == null) {
            v6 = (V) NULL;
        }

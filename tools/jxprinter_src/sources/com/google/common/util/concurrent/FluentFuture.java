...
public abstract class FluentFuture<V> extends GwtFluentFutureCatchingSpecialization<V> {
    ...
    @Beta
    @GwtIncompatible
    public final FluentFuture<V> withTimeout(long j6, TimeUnit timeUnit, ScheduledExecutorService scheduledExecutorService) {
        return (FluentFuture) Futures.withTimeout(this, j6, timeUnit, scheduledExecutorService);
    }

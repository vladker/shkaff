...
final class Synchronized {
    ...
    public static class SynchronizedBiMap<K, V> extends SynchronizedMap<K, V> implements BiMap<K, V>, Serializable {
        ...
        public V forcePut(K k6, V v6) {
            V vForcePut;
            synchronized (this.mutex) {
                vForcePut = delegate().forcePut(k6, v6);
            }
            return vForcePut;
        }
    ...
    public static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        ...
        public boolean addAll(int i5, Collection<? extends E> collection) {
            boolean zAddAll;
            synchronized (this.mutex) {
                zAddAll = delegate().addAll(i5, collection);
            }
            return zAddAll;
        }
        ...
        public List<E> subList(int i5, int i6) {
            List<E> list;
            synchronized (this.mutex) {
                list = Synchronized.list(delegate().subList(i5, i6), this.mutex);
            }
            return list;
        }
    ...
    public static class SynchronizedListMultimap<K, V> extends SynchronizedMultimap<K, V> implements ListMultimap<K, V> {
        ...
        public List<V> get(K k6) {
            List<V> list;
            synchronized (this.mutex) {
                list = Synchronized.list(delegate().get((Object) k6), this.mutex);
            }
            return list;
        }
        ...
        public List<V> replaceValues(K k6, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                listReplaceValues = delegate().replaceValues((Object) k6, (Iterable) iterable);
            }
    ...
    public static class SynchronizedMultimap<K, V> extends SynchronizedObject implements Multimap<K, V> {
        ...
        public Collection<V> get(K k6) {
            Collection<V> collectionTypePreservingCollection;
            synchronized (this.mutex) {
                collectionTypePreservingCollection = Synchronized.typePreservingCollection(delegate().get(k6), this.mutex);
            }
            return collectionTypePreservingCollection;
        }
        ...
        public boolean putAll(K k6, Iterable<? extends V> iterable) {
            boolean zPutAll;
            synchronized (this.mutex) {
                zPutAll = delegate().putAll(k6, iterable);
            }
            return zPutAll;
        }
        ...
        public Collection<V> replaceValues(K k6, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                collectionReplaceValues = delegate().replaceValues(k6, iterable);
            }
    ...
    public static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V> {
        ...
        public Set<V> get(K k6) {
            Set<V> set;
            synchronized (this.mutex) {
                set = Synchronized.set(delegate().get((Object) k6), this.mutex);
            }
            return set;
        }
        ...
        public Set<V> replaceValues(K k6, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                setReplaceValues = delegate().replaceValues((Object) k6, (Iterable) iterable);
            }
    ...
    public static final class SynchronizedTable<R, C, V> extends SynchronizedObject implements Table<R, C, V> {
        ...
        public Map<C, V> row(R r6) {
            Map<C, V> map;
            synchronized (this.mutex) {
                map = Synchronized.map(delegate().row(r6), this.mutex);
            }
            return map;
        }
    ...
    public static <E> Collection<E> typePreservingCollection(Collection<E> collection, Object obj) {
        ...
        return collection instanceof List ? list((List) collection, obj) : collection(collection, obj);
    }
    ...
    public static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
        ...
        public int remove(Object obj, int i5) {
            int iRemove;
            synchronized (this.mutex) {
                iRemove = delegate().remove(obj, i5);
            }
            return iRemove;
        }
        ...
        public boolean setCount(E e, int i5, int i6) {
            boolean count;
            synchronized (this.mutex) {
                count = delegate().setCount(e, i5, i6);
            }
            return count;
        }
    }
    ...
    public static class SynchronizedSortedMap<K, V> extends SynchronizedMap<K, V> implements SortedMap<K, V> {
        ...
        public SortedMap<K, V> headMap(K k6) {
            ...
            synchronized (this.mutex) {
                sortedMap = Synchronized.sortedMap(delegate().headMap(k6), this.mutex);
            }
            return sortedMap;
        }
        ...
        public SortedMap<K, V> subMap(K k6, K k7) {
            SortedMap<K, V> sortedMap;
            synchronized (this.mutex) {
                sortedMap = Synchronized.sortedMap(delegate().subMap(k6, k7), this.mutex);
            }
            return sortedMap;
        }
        ...
        public SortedMap<K, V> tailMap(K k6) {
            SortedMap<K, V> sortedMap;
            synchronized (this.mutex) {
                sortedMap = Synchronized.sortedMap(delegate().tailMap(k6), this.mutex);
            }
            return sortedMap;
        }
    ...
    public static class SynchronizedSortedSetMultimap<K, V> extends SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V> {
        ...
        public SortedSet<V> get(K k6) {
            ...
            synchronized (this.mutex) {
                sortedSet = Synchronized.sortedSet(delegate().get((Object) k6), this.mutex);
            }
            return sortedSet;
        }
        ...
        public SortedSet<V> replaceValues(K k6, Iterable<? extends V> iterable) {
            ...
            synchronized (this.mutex) {
                sortedSetReplaceValues = delegate().replaceValues((Object) k6, (Iterable) iterable);
            }
    ...
    public static class SynchronizedNavigableMap<K, V> extends SynchronizedSortedMap<K, V> implements NavigableMap<K, V> {
        ...
        public Map.Entry<K, V> ceilingEntry(K k6) {
            ...
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().ceilingEntry(k6), this.mutex);
            }
        ...
        public K ceilingKey(K k6) {
            K kCeilingKey;
            synchronized (this.mutex) {
                kCeilingKey = delegate().ceilingKey(k6);
            }
            return kCeilingKey;
        }
        ...
        public Map.Entry<K, V> floorEntry(K k6) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().floorEntry(k6), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K floorKey(K k6) {
            K kFloorKey;
            synchronized (this.mutex) {
                kFloorKey = delegate().floorKey(k6);
            }
            return kFloorKey;
        }
        ...
        public NavigableMap<K, V> headMap(K k6, boolean z6) {
            ...
            synchronized (this.mutex) {
                navigableMap = Synchronized.navigableMap(delegate().headMap(k6, z6), this.mutex);
            }
            return navigableMap;
        }
        ...
        public Map.Entry<K, V> higherEntry(K k6) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().higherEntry(k6), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K higherKey(K k6) {
            K kHigherKey;
            synchronized (this.mutex) {
                kHigherKey = delegate().higherKey(k6);
            }
            return kHigherKey;
        }
        ...
        public Map.Entry<K, V> lowerEntry(K k6) {
            Map.Entry<K, V> entryNullableSynchronizedEntry;
            synchronized (this.mutex) {
                entryNullableSynchronizedEntry = Synchronized.nullableSynchronizedEntry(delegate().lowerEntry(k6), this.mutex);
            }
            return entryNullableSynchronizedEntry;
        }
        ...
        public K lowerKey(K k6) {
            K kLowerKey;
            synchronized (this.mutex) {
                kLowerKey = delegate().lowerKey(k6);
            }
            return kLowerKey;
        }
        ...
        public NavigableMap<K, V> subMap(K k6, boolean z6, K k7, boolean z7) {
            NavigableMap<K, V> navigableMap;
            synchronized (this.mutex) {
                navigableMap = Synchronized.navigableMap(delegate().subMap(k6, z6, k7, z7), this.mutex);
            }
            return navigableMap;
        }
        ...
        public NavigableMap<K, V> tailMap(K k6, boolean z6) {
            NavigableMap<K, V> navigableMap;
            synchronized (this.mutex) {
                navigableMap = Synchronized.navigableMap(delegate().tailMap(k6, z6), this.mutex);
            }
            return navigableMap;
        }
    ...
    public static class SynchronizedNavigableSet<E> extends SynchronizedSortedSet<E> implements NavigableSet<E> {
        ...
        public NavigableSet<E> headSet(E e, boolean z6) {
            ...
            synchronized (this.mutex) {
                navigableSet = Synchronized.navigableSet(delegate().headSet(e, z6), this.mutex);
            }
            return navigableSet;
        }
        ...
        public NavigableSet<E> subSet(E e, boolean z6, E e6, boolean z7) {
            NavigableSet<E> navigableSet;
            synchronized (this.mutex) {
                navigableSet = Synchronized.navigableSet(delegate().subSet(e, z6, e6, z7), this.mutex);
            }
            return navigableSet;
        }
        ...
        public NavigableSet<E> tailSet(E e, boolean z6) {
            NavigableSet<E> navigableSet;
            synchronized (this.mutex) {
                navigableSet = Synchronized.navigableSet(delegate().tailSet(e, z6), this.mutex);
            }
            return navigableSet;
        }
    ...
    public static class SynchronizedSortedSet<E> extends SynchronizedSet<E> implements SortedSet<E> {
        ...
        public SortedSet<E> subSet(E e, E e6) {
            SortedSet<E> sortedSet;
            synchronized (this.mutex) {
                sortedSet = Synchronized.sortedSet(delegate().subSet(e, e6), this.mutex);
            }
            return sortedSet;
        }

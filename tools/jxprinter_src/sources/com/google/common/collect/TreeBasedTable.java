...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    public class TreeRow extends StandardTable<R, C, V>.Row implements SortedMap<C, V> {
        ...
        public TreeRow(TreeBasedTable treeBasedTable, R r6) {
            this(r6, null, null);
        }
        ...
        @Override // com.google.common.collect.StandardTable.Row, java.util.AbstractMap, java.util.Map
        public V put(C c, V v6) {
            Preconditions.checkArgument(rangeContains(Preconditions.checkNotNull(c)));
            return (V) super.put(c, v6);
        }
        ...
        public boolean rangeContains(Object obj) {
            ...
            C c6 = this.upperBound;
            return c6 == null || compare(c6, obj) > 0;
        }

        @Override // java.util.SortedMap
        public SortedMap<C, V> subMap(C c, C c6) {
            Preconditions.checkArgument(rangeContains(Preconditions.checkNotNull(c)) && rangeContains(Preconditions.checkNotNull(c6)));
            return new TreeRow(this.rowKey, c, c6);
        }
        ...
        public TreeRow(R r6, C c, C c6) {
            super(r6);
            this.lowerBound = c;
            this.upperBound = c6;
            Preconditions.checkArgument(c == null || c6 == null || compare(c, c6) <= 0);
        }
        ...
        public SortedMap<C, V> computeBackingRowMap() {
            ...
            C c6 = this.upperBound;
            return c6 != null ? sortedMapTailMap.headMap(c6) : sortedMapTailMap;
        }
    ...
    public Iterator<C> createColumnKeyIterator() {
        ...
        final UnmodifiableIterator unmodifiableIteratorMergeSorted = Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new d(0)), comparatorColumnComparator);
        return new AbstractIterator<C>(this) { // from class: com.google.common.collect.TreeBasedTable.1
            ...
            public C computeNext() {
                while (unmodifiableIteratorMergeSorted.hasNext()) {
                    ...
                    C c6 = this.lastValue;
                    if (c6 == null || comparatorColumnComparator.compare(c, c6) != 0) {
                        this.lastValue = c;
                        return c;
                    }
                }

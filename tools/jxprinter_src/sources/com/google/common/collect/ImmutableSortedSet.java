...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static <E> ImmutableSortedSet<E> construct(Comparator<? super E> comparator, int i5, E... eArr) {
        if (i5 == 0) {
    ...
    public abstract ImmutableSortedSet<E> headSetImpl(E e, boolean z6);
    ...
    public abstract ImmutableSortedSet<E> subSetImpl(E e, boolean z6, E e6, boolean z7);

    public abstract ImmutableSortedSet<E> tailSetImpl(E e, boolean z6);
    ...
    @Override // java.util.NavigableSet, java.util.SortedSet
    public ImmutableSortedSet<E> subSet(E e, E e6) {
        return subSet((Object) e, true, (Object) e6, false);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.NavigableSet
    public ImmutableSortedSet<E> headSet(E e, boolean z6) {
        return headSetImpl(Preconditions.checkNotNull(e), z6);
    }

    @Override // java.util.NavigableSet
    @GwtIncompatible
    public ImmutableSortedSet<E> subSet(E e, boolean z6, E e6, boolean z7) {
        Preconditions.checkNotNull(e);
        Preconditions.checkNotNull(e6);
        Preconditions.checkArgument(this.comparator.compare(e, e6) <= 0);
        return subSetImpl(e, z6, e6, z7);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.NavigableSet
    public ImmutableSortedSet<E> tailSet(E e, boolean z6) {
        return tailSetImpl(Preconditions.checkNotNull(e), z6);
    }

...
public final class Collections2 {
    ...
    public static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        private static <E> int calculateSize(List<E> list, Comparator<? super E> comparator) {
            ...
            while (i5 < list.size()) {
                if (comparator.compare(list.get(i5 - 1), list.get(i5)) < 0) {
                    iSaturatedMultiply = IntMath.saturatedMultiply(iSaturatedMultiply, IntMath.binomial(i5, i6));
            ...
            return IntMath.saturatedMultiply(iSaturatedMultiply, IntMath.binomial(i5, i6));
        }
        ...
        public String toString() {
            ...
            return androidx.exifinterface.media.a.e(strValueOf.length() + 30, "orderedPermutationCollection(", strValueOf, ")");
        }
    }
    ...
    public static final class OrderedPermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        public int findNextL(int i5) {
            Objects.requireNonNull(this.nextPermutation);
            E e = this.nextPermutation.get(i5);
            for (int size = this.nextPermutation.size() - 1; size > i5; size--) {
    ...
    public static final class PermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            String strValueOf = String.valueOf(this.inputList);
            return androidx.exifinterface.media.a.e(strValueOf.length() + 14, "permutations(", strValueOf, ")");
        }
    }
    ...
    public static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        public void calculateNextPermutation() {
            ...
            while (true) {
                ...
                int i6 = this.f3401j;
                int i7 = iArr[i6];
                int i8 = this.f3402o[i6] + i7;
                if (i8 < 0) {
                    switchDirection();
                } else if (i8 != i6 + 1) {
                    Collections.swap(this.list, (i6 - i7) + i5, (i6 - i8) + i5);
                    this.c[this.f3401j] = i8;
                    return;
                } else {
                    if (i6 == 0) {
                        return;
    ...
    public static boolean isPermutation(List<?> list, List<?> list2) {
        ...
        for (int i5 = 0; i5 < list.size(); i5++) {
            if (objectCountHashMapCounts.getValue(i5) != objectCountHashMapCounts2.get(objectCountHashMapCounts.getKey(i5))) {
                return false;
            }
        }
        return true;
    ...
    public static StringBuilder newStringBuilderForCollection(int i5) {
        ...
        return new StringBuilder((int) Math.min(((long) i5) * 8, 1073741824L));
    }

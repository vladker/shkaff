...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    public RegularImmutableSortedSet<E> getSubSet(int i5, int i6) {
        if (i5 == 0 && i6 == size()) {
            return this;
        }
        return i5 < i6 ? new RegularImmutableSortedSet<>(this.elements.subList(i5, i6), this.comparator) : ImmutableSortedSet.emptySet(this.comparator);
    }

    public int headIndex(E e, boolean z6) {
    ...
    @Override // com.google.common.collect.ImmutableSortedSet
    public ImmutableSortedSet<E> headSetImpl(E e, boolean z6) {
        return getSubSet(0, headIndex(e, z6));
    }
    ...
    @Override // com.google.common.collect.ImmutableSortedSet
    public ImmutableSortedSet<E> subSetImpl(E e, boolean z6, E e6, boolean z7) {
        return tailSetImpl(e, z6).headSetImpl(e6, z7);
    }

    public int tailIndex(E e, boolean z6) {
        int iBinarySearch = Collections.binarySearch(this.elements, Preconditions.checkNotNull(e), comparator());
        if (iBinarySearch >= 0) {
    ...
    @Override // com.google.common.collect.ImmutableSortedSet
    public ImmutableSortedSet<E> tailSetImpl(E e, boolean z6) {
        return getSubSet(tailIndex(e, z6), size());
    }

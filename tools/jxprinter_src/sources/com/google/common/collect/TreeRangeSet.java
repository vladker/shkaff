...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    public static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public NavigableMap<Cut<C>, Range<C>> headMap(Cut<C> cut, boolean z6) {
            return subMap(Range.upTo(cut, BoundType.forBoolean(z6)));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<Cut<C>, Range<C>> tailMap(Cut<C> cut, boolean z6) {
            return subMap(Range.downTo(cut, BoundType.forBoolean(z6)));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<Cut<C>, Range<C>> subMap(Cut<C> cut, boolean z6, Cut<C> cut2, boolean z7) {
            return subMap(Range.range(cut, BoundType.forBoolean(z6), cut2, BoundType.forBoolean(z7)));
        }
    }
    ...
    public static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            if (this.upperBoundWindow.hasLowerBound() && (entryLowerEntry = this.rangesByLowerBound.lowerEntry((Cut) this.upperBoundWindow.lowerEndpoint())) != null) {
                it = this.upperBoundWindow.lowerBound.isLessThan(entryLowerEntry.getValue().upperBound) ? this.rangesByLowerBound.tailMap(entryLowerEntry.getKey(), true).values().iterator() : this.rangesByLowerBound.tailMap((Cut) this.upperBoundWindow.lowerEndpoint(), true).values().iterator();
            } else {
    ...
    public final class SubRangeSet extends TreeRangeSet<C> {
        ...
        public RangeSet<C> subRangeSet(Range<C> range) {
            ...
            return range.isConnected(this.restriction) ? new SubRangeSet(this.restriction.intersection(range)) : ImmutableRangeSet.of();
        }
    }

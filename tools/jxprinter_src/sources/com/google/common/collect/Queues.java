...
public final class Queues {
    ...
    @Beta
    @GwtIncompatible
    public static <E> int drain(BlockingQueue<E> blockingQueue, Collection<? super E> collection, int i5, long j6, TimeUnit timeUnit) throws InterruptedException {
        Preconditions.checkNotNull(collection);
        long nanos = timeUnit.toNanos(j6) + System.nanoTime();
        int iDrainTo = 0;
        while (iDrainTo < i5) {
            iDrainTo += blockingQueue.drainTo(collection, i5 - iDrainTo);
            if (iDrainTo < i5) {
    ...
    @Beta
    @GwtIncompatible
    public static <E> int drainUninterruptibly(BlockingQueue<E> blockingQueue, Collection<? super E> collection, int i5, long j6, TimeUnit timeUnit) {
        E ePoll;
        Preconditions.checkNotNull(collection);
        long nanos = timeUnit.toNanos(j6) + System.nanoTime();
        int iDrainTo = 0;
    ...
    @GwtIncompatible
    public static <E> ArrayBlockingQueue<E> newArrayBlockingQueue(int i5) {
    ...
    @GwtIncompatible
    public static <E> LinkedBlockingDeque<E> newLinkedBlockingDeque(int i5) {
        return new LinkedBlockingDeque<>(i5);
    }

    @GwtIncompatible
    public static <E> LinkedBlockingQueue<E> newLinkedBlockingQueue(int i5) {

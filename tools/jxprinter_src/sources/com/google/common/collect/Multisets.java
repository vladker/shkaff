...
public final class Multisets {
    ...
    public static final class FilteredMultiset<E> extends ViewMultiset<E> {
        ...
        public int add(@ParametricNullness E e, int i5) {
            ...
            return this.unfiltered.add(e, i5);
        }
    ...
    public static class ImmutableEntry<E> extends AbstractEntry<E> implements Serializable {
        ...
        public ImmutableEntry(@ParametricNullness E e, int i5) {
            this.element = e;
            this.count = i5;
    ...
    public static <E> Multiset.Entry<E> immutableEntry(@ParametricNullness E e, int i5) {
        return new ImmutableEntry(e, i5);
    }
    ...
    public static <E> int setCountImpl(Multiset<E> multiset, @ParametricNullness E e, int i5) {
        CollectPreconditions.checkNonnegative(i5, "count");
    ...
    public static <E> boolean setCountImpl(Multiset<E> multiset, @ParametricNullness E e, int i5, int i6) {
        CollectPreconditions.checkNonnegative(i5, "oldCount");
        CollectPreconditions.checkNonnegative(i6, "newCount");
        if (multiset.count(e) != i5) {
            return false;
        }
        multiset.setCount(e, i6);
        return true;
    }

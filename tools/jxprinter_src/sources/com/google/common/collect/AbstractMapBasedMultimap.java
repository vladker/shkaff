...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    public abstract class Itr<T> implements Iterator<T> {
        ...
        public abstract T output(@ParametricNullness K k6, @ParametricNullness V v6);
    ...
    public class NavigableAsMap extends AbstractMapBasedMultimap<K, V>.SortedAsMap implements NavigableMap<K, Collection<V>> {
        ...
        public Map.Entry<K, Collection<V>> ceilingEntry(@ParametricNullness K k6) {
            Map.Entry<K, Collection<V>> entryCeilingEntry = sortedMap().ceilingEntry(k6);
        ...
        public K ceilingKey(@ParametricNullness K k6) {
            return sortedMap().ceilingKey(k6);
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, Collection<V>> floorEntry(@ParametricNullness K k6) {
            Map.Entry<K, Collection<V>> entryFloorEntry = sortedMap().floorEntry(k6);
        ...
        public K floorKey(@ParametricNullness K k6) {
            return sortedMap().floorKey(k6);
        }

        @Override // java.util.NavigableMap
        public Map.Entry<K, Collection<V>> higherEntry(@ParametricNullness K k6) {
            Map.Entry<K, Collection<V>> entryHigherEntry = sortedMap().higherEntry(k6);
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, Collection<V>> lowerEntry(@ParametricNullness K k6) {
            Map.Entry<K, Collection<V>> entryLowerEntry = sortedMap().lowerEntry(k6);
        ...
        public NavigableMap<K, Collection<V>> headMap(@ParametricNullness K k6) {
        ...
        @Override // com.google.common.collect.AbstractMapBasedMultimap.SortedAsMap, java.util.SortedMap, java.util.NavigableMap
        public NavigableMap<K, Collection<V>> subMap(@ParametricNullness K k6, @ParametricNullness K k7) {
            return subMap(k6, true, k7, false);
        }

        @Override // com.google.common.collect.AbstractMapBasedMultimap.SortedAsMap, java.util.SortedMap, java.util.NavigableMap
        public NavigableMap<K, Collection<V>> tailMap(@ParametricNullness K k6) {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, Collection<V>> headMap(@ParametricNullness K k6, boolean z6) {
            return new NavigableAsMap(sortedMap().headMap(k6, z6));
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, Collection<V>> subMap(@ParametricNullness K k6, boolean z6, @ParametricNullness K k7, boolean z7) {
            return new NavigableAsMap(sortedMap().subMap(k6, z6, k7, z7));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, Collection<V>> tailMap(@ParametricNullness K k6, boolean z6) {
            return new NavigableAsMap(sortedMap().tailMap(k6, z6));
        }
    }
    ...
    public class NavigableKeySet extends AbstractMapBasedMultimap<K, V>.SortedKeySet implements NavigableSet<K> {
        ...
        public NavigableSet<K> headSet(@ParametricNullness K k6) {
        ...
        @Override // com.google.common.collect.AbstractMapBasedMultimap.SortedKeySet, java.util.SortedSet, java.util.NavigableSet
        public NavigableSet<K> subSet(@ParametricNullness K k6, @ParametricNullness K k7) {
            return subSet(k6, true, k7, false);
        }

        @Override // com.google.common.collect.AbstractMapBasedMultimap.SortedKeySet, java.util.SortedSet, java.util.NavigableSet
        public NavigableSet<K> tailSet(@ParametricNullness K k6) {
            return tailSet(k6, true);
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> headSet(@ParametricNullness K k6, boolean z6) {
            return new NavigableKeySet(sortedMap().headMap(k6, z6));
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> subSet(@ParametricNullness K k6, boolean z6, @ParametricNullness K k7, boolean z7) {
            return new NavigableKeySet(sortedMap().subMap(k6, z6, k7, z7));
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> tailSet(@ParametricNullness K k6, boolean z6) {
            return new NavigableKeySet(sortedMap().tailMap(k6, z6));
        }
    }

    /* JADX INFO: compiled from: r8-map-id-ecf7e14176b8e73200efbc86dd80f717955f363e9b0ac3efdea3eedd88177748 */
    public class RandomAccessWrappedList extends AbstractMapBasedMultimap<K, V>.WrappedList implements RandomAccess {
        public RandomAccessWrappedList(@ParametricNullness AbstractMapBasedMultimap abstractMapBasedMultimap, K k6, List<V> list, AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    public class SortedAsMap extends AbstractMapBasedMultimap<K, V>.AsMap implements SortedMap<K, Collection<V>> {
        ...
        public SortedMap<K, Collection<V>> headMap(@ParametricNullness K k6) {
            return new SortedAsMap(sortedMap().headMap(k6));
        }
        ...
        public SortedMap<K, Collection<V>> subMap(@ParametricNullness K k6, @ParametricNullness K k7) {
            return new SortedAsMap(sortedMap().subMap(k6, k7));
        }

        public SortedMap<K, Collection<V>> tailMap(@ParametricNullness K k6) {
            return new SortedAsMap(sortedMap().tailMap(k6));
        }
    ...
    public class SortedKeySet extends AbstractMapBasedMultimap<K, V>.KeySet implements SortedSet<K> {
        ...
        public SortedSet<K> headSet(@ParametricNullness K k6) {
            return new SortedKeySet(sortedMap().headMap(k6));
        }
        ...
        public SortedSet<K> subSet(@ParametricNullness K k6, @ParametricNullness K k7) {
            return new SortedKeySet(sortedMap().subMap(k6, k7));
        }

        public SortedSet<K> tailSet(@ParametricNullness K k6) {
            return new SortedKeySet(sortedMap().tailMap(k6));
        }
    }
    ...
    public class WrappedNavigableSet extends AbstractMapBasedMultimap<K, V>.WrappedSortedSet implements NavigableSet<V> {
        ...
        @Override // java.util.NavigableSet
        public V ceiling(@ParametricNullness V v6) {
            return getSortedSetDelegate().ceiling(v6);
        }
        ...
        @Override // java.util.NavigableSet
        public V floor(@ParametricNullness V v6) {
            return getSortedSetDelegate().floor(v6);
        }

        @Override // java.util.NavigableSet
        public NavigableSet<V> headSet(@ParametricNullness V v6, boolean z6) {
            return wrap(getSortedSetDelegate().headSet(v6, z6));
        }

        @Override // java.util.NavigableSet
        public V higher(@ParametricNullness V v6) {
            return getSortedSetDelegate().higher(v6);
        }

        @Override // java.util.NavigableSet
        public V lower(@ParametricNullness V v6) {
            return getSortedSetDelegate().lower(v6);
        }
        ...
        @Override // java.util.NavigableSet
        public NavigableSet<V> subSet(@ParametricNullness V v6, boolean z6, @ParametricNullness V v7, boolean z7) {
            return wrap(getSortedSetDelegate().subSet(v6, z6, v7, z7));
        }

        @Override // java.util.NavigableSet
        public NavigableSet<V> tailSet(@ParametricNullness V v6, boolean z6) {
            return wrap(getSortedSetDelegate().tailSet(v6, z6));
        }
    ...
    public class WrappedSortedSet extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements SortedSet<V> {
        ...
        @Override // java.util.SortedSet
        public SortedSet<V> headSet(@ParametricNullness V v6) {
            refreshIfEmpty();
            return new WrappedSortedSet(getKey(), getSortedSetDelegate().headSet(v6), getAncestor() == null ? this : getAncestor());
        }
        ...
        @Override // java.util.SortedSet
        public SortedSet<V> subSet(@ParametricNullness V v6, @ParametricNullness V v7) {
            refreshIfEmpty();
            return new WrappedSortedSet(getKey(), getSortedSetDelegate().subSet(v6, v7), getAncestor() == null ? this : getAncestor());
        }

        @Override // java.util.SortedSet
        public SortedSet<V> tailSet(@ParametricNullness V v6) {
            refreshIfEmpty();
            return new WrappedSortedSet(getKey(), getSortedSetDelegate().tailSet(v6), getAncestor() == null ? this : getAncestor());
        }
    }
    ...
    private Collection<V> getOrCreateCollection(@ParametricNullness K k6) {
        Collection<V> collection = this.map.get(k6);
        if (collection != null) {
            return collection;
        }
        Collection<V> collectionCreateCollection = createCollection(k6);
    ...
    public final Map<K, Collection<V>> createMaybeNavigableAsMap() {
        ...
        return map instanceof SortedMap ? new SortedAsMap((SortedMap) this.map) : new AsMap(this.map);
    }
    ...
    public final Set<K> createMaybeNavigableKeySet() {
        ...
        return map instanceof SortedMap ? new SortedKeySet((SortedMap) this.map) : new KeySet(this.map);
    }
    ...
    public Iterator<Map.Entry<K, V>> entryIterator() {
        return new AbstractMapBasedMultimap<K, V>.Itr<Map.Entry<K, V>>(this) { // from class: com.google.common.collect.AbstractMapBasedMultimap.2
            ...
            public Map.Entry<K, V> output(@ParametricNullness K k6, @ParametricNullness V v6) {
                return Maps.immutableEntry(k6, v6);
            }
        };
    }
    ...
    public Collection<V> get(@ParametricNullness K k6) {
        Collection<V> collectionCreateCollection = this.map.get(k6);
        if (collectionCreateCollection == null) {
            collectionCreateCollection = createCollection(k6);
        }
        return wrapCollection(k6, collectionCreateCollection);
    }
    ...
    public Collection<V> replaceValues(@ParametricNullness K k6, Iterable<? extends V> iterable) {
        ...
        Collection<V> orCreateCollection = getOrCreateCollection(k6);
    ...
    public Iterator<V> valueIterator() {
        return new AbstractMapBasedMultimap<K, V>.Itr<V>(this) { // from class: com.google.common.collect.AbstractMapBasedMultimap.1
            @Override // com.google.common.collect.AbstractMapBasedMultimap.Itr
            @ParametricNullness
            public V output(@ParametricNullness K k6, @ParametricNullness V v6) {
                return v6;
            }
        };
    }
    ...
    public final List<V> wrapList(@ParametricNullness K k6, List<V> list, AbstractMapBasedMultimap<K, V>.WrappedCollection wrappedCollection) {
    ...
    public class WrappedCollection extends AbstractCollection<V> {
        ...
        public boolean add(@ParametricNullness V v6) {
            ...
            boolean zAdd = this.delegate.add(v6);
            if (zAdd) {
    ...
    public class WrappedList extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements List<V> {
        ...
        public class WrappedListIterator extends AbstractMapBasedMultimap<K, V>.WrappedCollection.WrappedIterator implements ListIterator<V> {
            ...
            public void add(@ParametricNullness V v6) {
                ...
                getDelegateListIterator().add(v6);
                AbstractMapBasedMultimap.access$208(AbstractMapBasedMultimap.this);
                if (zIsEmpty) {
            ...
            public void set(@ParametricNullness V v6) {
                getDelegateListIterator().set(v6);
            }
        ...
        public boolean addAll(int i5, Collection<? extends V> collection) {
            ...
            int size = size();
            boolean zAddAll = getListDelegate().addAll(i5, collection);
            if (zAddAll) {
        ...
        public V remove(int i5) {
            refreshIfEmpty();
            V vRemove = getListDelegate().remove(i5);
            AbstractMapBasedMultimap.access$210(AbstractMapBasedMultimap.this);
            removeIfEmpty();
            return vRemove;
        }
        ...
        @Override // java.util.List
        @ParametricNullness
        public V set(int i5, @ParametricNullness V v6) {
            refreshIfEmpty();
            return getListDelegate().set(i5, v6);
        }
        ...
        public List<V> subList(int i5, int i6) {
            refreshIfEmpty();
            return AbstractMapBasedMultimap.this.wrapList(getKey(), getListDelegate().subList(i5, i6), getAncestor() == null ? this : getAncestor());
        }

...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    public static class Builder<K, V> {
        ...
        public static final class DuplicateKey {
            ...
            public IllegalArgumentException exception() {
                ...
                return new IllegalArgumentException(androidx.exifinterface.media.a.s(androidx.exifinterface.media.a.u(strValueOf4.length() + strValueOf3.length() + strValueOf2.length() + strValueOf.length() + 39, "Multiple entries with same key: ", strValueOf, "=", strValueOf2), " and ", strValueOf3, "=", strValueOf4));
            }
        }
        ...
        private ImmutableMap<K, V> build(boolean z6) {
            Object[] objArrLastEntryForEachKey;
            DuplicateKey duplicateKey;
            DuplicateKey duplicateKey2;
            if (z6 && (duplicateKey2 = this.duplicateKey) != null) {
            ...
            if (!z6 || (duplicateKey = this.duplicateKey) == null) {
    ...
    public static class SerializedForm<K, V> implements Serializable {
        ...
        public final Object legacyReadResolve() {
            ...
            for (int i5 = 0; i5 < objArr.length; i5++) {
                builderMakeBuilder.put(objArr[i5], objArr2[i5]);
            }
    ...
    public static IllegalArgumentException conflictException(String str, Object obj, Object obj2) {
        ...
        return new IllegalArgumentException(AbstractC0157z.s(androidx.exifinterface.media.a.u(strValueOf2.length() + strValueOf.length() + androidx.exifinterface.media.a.b(34, str), "Multiple entries with same ", str, ": ", strValueOf), " and ", strValueOf2));
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6) {
        CollectPreconditions.checkEntryNotNull(k6, v6);
        return RegularImmutableMap.create(1, new Object[]{k6, v6});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7) {
        ...
        return RegularImmutableMap.create(2, new Object[]{k6, v6, k7, v7});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7, K k8, V v8) {
        ...
        return RegularImmutableMap.create(3, new Object[]{k6, v6, k7, v7, k8, v8});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9) {
        ...
        return RegularImmutableMap.create(4, new Object[]{k6, v6, k7, v7, k8, v8, k9, v9});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10) {
        ...
        return RegularImmutableMap.create(5, new Object[]{k6, v6, k7, v7, k8, v8, k9, v9, k10, v10});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10, K k11, V v11) {
        ...
        return RegularImmutableMap.create(6, new Object[]{k6, v6, k7, v7, k8, v8, k9, v9, k10, v10, k11, v11});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10, K k11, V v11, K k12, V v12) {
        ...
        return RegularImmutableMap.create(7, new Object[]{k6, v6, k7, v7, k8, v8, k9, v9, k10, v10, k11, v11, k12, v12});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10, K k11, V v11, K k12, V v12, K k13, V v13) {
        ...
        return RegularImmutableMap.create(8, new Object[]{k6, v6, k7, v7, k8, v8, k9, v9, k10, v10, k11, v11, k12, v12, k13, v13});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10, K k11, V v11, K k12, V v12, K k13, V v13, K k14, V v14) {
        ...
        return RegularImmutableMap.create(9, new Object[]{k6, v6, k7, v7, k8, v8, k9, v9, k10, v10, k11, v11, k12, v12, k13, v13, k14, v14});
    }
    ...
    public static <K, V> ImmutableMap<K, V> of(K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10, K k11, V v11, K k12, V v12, K k13, V v13, K k14, V v14, K k15, V v15) {
        ...
        return RegularImmutableMap.create(10, new Object[]{k6, v6, k7, v7, k8, v8, k9, v9, k10, v10, k11, v11, k12, v12, k13, v13, k14, v14, k15, v15});
    }
}

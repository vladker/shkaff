...
public final class Tables {
    ...
    public static abstract class AbstractCell<R, C, V> implements Table.Cell<R, C, V> {
        ...
        public String toString() {
            ...
            return AbstractC0157z.s(androidx.exifinterface.media.a.u(strValueOf3.length() + strValueOf2.length() + strValueOf.length() + 4, "(", strValueOf, ",", strValueOf2), ")=", strValueOf3);
        }
    }
    ...
    public static final class ImmutableCell<R, C, V> extends AbstractCell<R, C, V> implements Serializable {
        ...
        public ImmutableCell(@ParametricNullness R r6, @ParametricNullness C c, @ParametricNullness V v6) {
            this.rowKey = r6;
            this.columnKey = c;
            this.value = v6;
        }
    ...
    public static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        @Override // com.google.common.collect.AbstractTable, com.google.common.collect.Table
        public V2 put(@ParametricNullness R r6, @ParametricNullness C c, @ParametricNullness V2 v6) {
        ...
        @Override // com.google.common.collect.Table
        public Map<C, V2> row(@ParametricNullness R r6) {
            return Maps.transformValues(this.fromTable.row(r6), this.function);
        }
    ...
    public static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        ...
        @Override // com.google.common.collect.Table
        public Map<C, V> column(@ParametricNullness R r6) {
            return this.original.row(r6);
        }
        ...
        @Override // com.google.common.collect.AbstractTable, com.google.common.collect.Table
        public V put(@ParametricNullness C c, @ParametricNullness R r6, @ParametricNullness V v6) {
            return this.original.put(r6, c, v6);
        }
    ...
    public static <R, C, V> Table.Cell<R, C, V> immutableCell(@ParametricNullness R r6, @ParametricNullness C c, @ParametricNullness V v6) {
        return new ImmutableCell(r6, c, v6);
    }

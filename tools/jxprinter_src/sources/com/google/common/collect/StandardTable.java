...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public class Column extends Maps.ViewCachingAbstractMap<R, V> {
                    ...
                    if (next.getValue().containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() { // from class: com.google.common.collect.StandardTable.Column.EntrySetIterator.1EntryImpl
                            ...
                            public V setValue(V v6) {
                                return (V) NullnessCasts.uncheckedCastNullableTToT(((Map) next.getValue()).put(Column.this.columnKey, Preconditions.checkNotNull(v6)));
                            }
                        };
                    }
                }
        ...
        public V put(R r6, V v6) {
            return (V) StandardTable.this.put(r6, this.columnKey, v6);
        }
        ...
        public boolean removeFromColumnIf(Predicate<? super Map.Entry<R, V>> predicate) {
            ...
            while (it.hasNext()) {
                ...
                V v6 = value.get(this.columnKey);
                if (v6 != null && predicate.apply(Maps.immutableEntry(next.getKey(), v6))) {
    ...
    public class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public Row(R r6) {
            this.rowKey = (R) Preconditions.checkNotNull(r6);
        }
        ...
        public V put(C c, V v6) {
            ...
            Map<C, V> map = this.backingRowMap;
            return (map == null || map.isEmpty()) ? (V) StandardTable.this.put(this.rowKey, c, v6) : this.backingRowMap.put(c, v6);
        }
        ...
        public V remove(Object obj) {
            ...
            V v6 = (V) Maps.safeRemove(map, obj);
            maintainEmptyInvariant();
            return v6;
        }
        ...
        public Map.Entry<C, V> wrapEntry(final Map.Entry<C, V> entry) {
            return new ForwardingMapEntry<C, V>(this) { // from class: com.google.common.collect.StandardTable.Row.2
                ...
                @Override // com.google.common.collect.ForwardingMapEntry, java.util.Map.Entry
                public V setValue(V v6) {
                    return (V) super.setValue(Preconditions.checkNotNull(v6));
                }
            ...
            public Iterator<Map.Entry<R, Map<C, V>>> iterator() {
                return Maps.asMapEntryIterator(StandardTable.this.backingMap.keySet(), new Function<R, Map<C, V>>() { // from class: com.google.common.collect.StandardTable.RowMap.EntrySet.1
                    ...
                    public Map<C, V> apply(R r6) {
                        return StandardTable.this.row(r6);
                    }
                });
            }
    ...
    public V put(R r6, C c, V v6) {
        ...
        Preconditions.checkNotNull(c);
        Preconditions.checkNotNull(v6);
        return getOrCreate(r6).put(c, v6);
    }

...
abstract class AbstractSortedSetMultimap<K, V> extends AbstractSetMultimap<K, V> implements SortedSetMultimap<K, V> {
    ...
    public Collection<V> wrapCollection(@ParametricNullness K k6, Collection<V> collection) {
        return collection instanceof NavigableSet ? new AbstractMapBasedMultimap.WrappedNavigableSet(k6, (NavigableSet) collection, null) : new AbstractMapBasedMultimap.WrappedSortedSet(k6, (SortedSet) collection, null);
    }
    ...
    public SortedSet<V> get(@ParametricNullness K k6) {
        return (SortedSet) super.get((Object) k6);
    }
    ...
    public SortedSet<V> replaceValues(@ParametricNullness K k6, Iterable<? extends V> iterable) {
        return (SortedSet) super.replaceValues((Object) k6, (Iterable) iterable);
    }
}

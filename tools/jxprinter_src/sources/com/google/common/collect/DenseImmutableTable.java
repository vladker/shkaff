...
final class DenseImmutableTable<R, C, V> extends RegularImmutableTable<R, C, V> {
    ...
    public final class Column extends ImmutableArrayMap<R, V> {
        ...
        public Column(int i5) {
            super(DenseImmutableTable.this.columnCounts[i5]);
            this.columnIndex = i5;
        }

        @Override // com.google.common.collect.DenseImmutableTable.ImmutableArrayMap
        public V getValue(int i5) {
            return (V) DenseImmutableTable.this.values[i5][this.columnIndex];
        }
    ...
    public final class ColumnMap extends ImmutableArrayMap<C, ImmutableMap<R, V>> {
        ...
        @Override // com.google.common.collect.DenseImmutableTable.ImmutableArrayMap
        public ImmutableMap<R, V> getValue(int i5) {
    ...
    public final class Row extends ImmutableArrayMap<C, V> {
        ...
        public Row(int i5) {
            super(DenseImmutableTable.this.rowCounts[i5]);
            this.rowIndex = i5;
        }

        @Override // com.google.common.collect.DenseImmutableTable.ImmutableArrayMap
        public V getValue(int i5) {
            return (V) DenseImmutableTable.this.values[this.rowIndex][i5];
        }
    ...
    public final class RowMap extends ImmutableArrayMap<R, ImmutableMap<C, V>> {
        ...
        @Override // com.google.common.collect.DenseImmutableTable.ImmutableArrayMap
        public ImmutableMap<C, V> getValue(int i5) {
            return new Row(i5);
        }
    }
    ...
    public Table.Cell<R, C, V> getCell(int i5) {
        ...
        R r6 = rowKeySet().asList().get(i6);
        C c = columnKeySet().asList().get(i7);
        V v6 = this.values[i6][i7];
        Objects.requireNonNull(v6);
        return ImmutableTable.cellOf(r6, c, v6);
    }

    @Override // com.google.common.collect.RegularImmutableTable
    public V getValue(int i5) {
        V v6 = this.values[this.cellRowIndices[i5]][this.cellColumnIndices[i5]];
        Objects.requireNonNull(v6);
        return v6;
    }

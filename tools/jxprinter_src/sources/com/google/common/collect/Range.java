...
public final class Range<C extends Comparable> extends RangeGwtSerializationDependencies implements Predicate<C>, Serializable {
    ...
    public static <C extends Comparable<?>> Range<C> closed(C c, C c6) {
        return create(Cut.belowValue(c), Cut.aboveValue(c6));
    }

    public static <C extends Comparable<?>> Range<C> closedOpen(C c, C c6) {
        return create(Cut.belowValue(c), Cut.belowValue(c6));
    }
    ...
    public static <C extends Comparable<?>> Range<C> open(C c, C c6) {
        return create(Cut.aboveValue(c), Cut.belowValue(c6));
    }

    public static <C extends Comparable<?>> Range<C> openClosed(C c, C c6) {
        return create(Cut.aboveValue(c), Cut.aboveValue(c6));
    }

    public static <C extends Comparable<?>> Range<C> range(C c, BoundType boundType, C c6, BoundType boundType2) {
        Preconditions.checkNotNull(boundType);
        Preconditions.checkNotNull(boundType2);
        BoundType boundType3 = BoundType.OPEN;
        return create(boundType == boundType3 ? Cut.aboveValue(c) : Cut.belowValue(c), boundType2 == boundType3 ? Cut.belowValue(c6) : Cut.aboveValue(c6));
    }
    ...
    public Range<C> gap(Range<C> range) {
        if (this.lowerBound.compareTo((Cut) range.upperBound) < 0 && range.lowerBound.compareTo((Cut) this.upperBound) < 0) {
            ...
            throw new IllegalArgumentException(com.google.android.gms.auth.api.accounttransfer.a.j(strValueOf2.length() + strValueOf.length() + 39, "Ranges have a nonempty intersection: ", strValueOf, ", ", strValueOf2));
        }
        boolean z6 = this.lowerBound.compareTo((Cut) range.lowerBound) < 0;

...
public final class Maps {
    ...
    public static abstract class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public boolean apply(Object obj, @ParametricNullness V v6) {
            return this.predicate.apply(Maps.immutableEntry(obj, v6));
        }
        ...
        public V get(Object obj) {
            V v6 = this.unfiltered.get(obj);
            if (v6 == null || !apply(obj, v6)) {
                return null;
            }
            return v6;
        }
        ...
        public V put(@ParametricNullness K k6, @ParametricNullness V v6) {
            Preconditions.checkArgument(apply(k6, v6));
            return this.unfiltered.put(k6, v6);
        }
    ...
    public static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        private static <X, Y> Y convert(BiMap<X, Y> biMap, X x6) {
            Y y6 = biMap.get(x6);
        ...
        public String toString() {
            ...
            return androidx.exifinterface.media.a.e(strValueOf.length() + 18, "Maps.asConverter(", strValueOf, ")");
        }
    }
    ...
    public static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        public Map.Entry<K, V> ceilingEntry(@ParametricNullness K k6) {
            return forward().floorEntry(k6);
        }

        @Override // java.util.NavigableMap
        public K ceilingKey(@ParametricNullness K k6) {
            return forward().floorKey(k6);
        }
        ...
        public Map.Entry<K, V> floorEntry(@ParametricNullness K k6) {
            return forward().ceilingEntry(k6);
        }

        @Override // java.util.NavigableMap
        public K floorKey(@ParametricNullness K k6) {
            return forward().ceilingKey(k6);
        }
        ...
        public Map.Entry<K, V> lowerEntry(@ParametricNullness K k6) {
            return forward().higherEntry(k6);
        }

        @Override // java.util.NavigableMap
        public K lowerKey(@ParametricNullness K k6) {
            return forward().higherKey(k6);
        }
        ...
        public NavigableMap<K, V> subMap(@ParametricNullness K k6, boolean z6, @ParametricNullness K k7, boolean z7) {
            return forward().subMap(k7, z7, k6, z6).descendingMap();
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(@ParametricNullness K k6, boolean z6) {
            return forward().headMap(k6, z6).descendingMap();
        }
    ...
    public interface EntryTransformer<K, V1, V2> {
        V2 transformEntry(@ParametricNullness K k6, @ParametricNullness V1 v6);
    }
    ...
    public static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        public V forcePut(@ParametricNullness K k6, @ParametricNullness V v6) {
            Preconditions.checkArgument(apply(k6, v6));
            return unfiltered().forcePut(k6, v6);
        }
                    ...
                    public Map.Entry<K, V> transform(final Map.Entry<K, V> entry) {
                        return new ForwardingMapEntry<K, V>() { // from class: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1.1
                            ...
                            public V setValue(@ParametricNullness V v6) {
                                Preconditions.checkArgument(FilteredEntryMap.this.apply(getKey(), v6));
    ...
    public static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(@ParametricNullness K k6, boolean z6) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.headMap(k6, z6), (Predicate) this.entryPredicate);
        }
        ...
        @Override // java.util.AbstractMap, java.util.Map
        public V put(@ParametricNullness K k6, @ParametricNullness V v6) {
            return this.filteredDelegate.put(k6, v6);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(@ParametricNullness K k6, boolean z6, @ParametricNullness K k7, boolean z7) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.subMap(k6, z6, k7, z7), (Predicate) this.entryPredicate);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(@ParametricNullness K k6, boolean z6) {
            return Maps.filterEntries((NavigableMap) this.unfiltered.tailMap(k6, z6), (Predicate) this.entryPredicate);
        }
    ...
    public static class FilteredEntrySortedMap<K, V> extends FilteredEntryMap<K, V> implements SortedMap<K, V> {
        ...
        public class SortedKeySet extends FilteredEntryMap<K, V>.KeySet implements SortedSet<K> {
            ...
            @Override // java.util.SortedSet
            public SortedSet<K> headSet(@ParametricNullness K k6) {
                return (SortedSet) FilteredEntrySortedMap.this.headMap(k6).keySet();
            }
            ...
            @Override // java.util.SortedSet
            public SortedSet<K> subSet(@ParametricNullness K k6, @ParametricNullness K k7) {
                return (SortedSet) FilteredEntrySortedMap.this.subMap(k6, k7).keySet();
            }

            @Override // java.util.SortedSet
            public SortedSet<K> tailSet(@ParametricNullness K k6) {
                return (SortedSet) FilteredEntrySortedMap.this.tailMap(k6).keySet();
            }
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> headMap(@ParametricNullness K k6) {
            return new FilteredEntrySortedMap(sortedMap().headMap(k6), this.predicate);
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> subMap(@ParametricNullness K k6, @ParametricNullness K k7) {
            return new FilteredEntrySortedMap(sortedMap().subMap(k6, k7), this.predicate);
        }

        @Override // java.util.SortedMap
        public SortedMap<K, V> tailMap(@ParametricNullness K k6) {
            return new FilteredEntrySortedMap(sortedMap().tailMap(k6), this.predicate);
        }
    ...
    public static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(@ParametricNullness K k6, boolean z6) {
            return Maps.asMap((NavigableSet) this.set.headSet(k6, z6), (Function) this.function);
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(@ParametricNullness K k6, boolean z6, @ParametricNullness K k7, boolean z7) {
            return Maps.asMap((NavigableSet) this.set.subSet(k6, z6, k7, z7), (Function) this.function);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(@ParametricNullness K k6, boolean z6) {
            return Maps.asMap((NavigableSet) this.set.tailSet(k6, z6), (Function) this.function);
        }
    }
    ...
    public static class NavigableKeySet<K, V> extends SortedKeySet<K, V> implements NavigableSet<K> {
        ...
        public K ceiling(@ParametricNullness K k6) {
            return map().ceilingKey(k6);
        }
        ...
        @Override // java.util.NavigableSet
        public K floor(@ParametricNullness K k6) {
            return map().floorKey(k6);
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> headSet(@ParametricNullness K k6, boolean z6) {
            return map().headMap(k6, z6).navigableKeySet();
        }

        @Override // java.util.NavigableSet
        public K higher(@ParametricNullness K k6) {
            return map().higherKey(k6);
        }

        @Override // java.util.NavigableSet
        public K lower(@ParametricNullness K k6) {
            return map().lowerKey(k6);
        }
        ...
        @Override // java.util.NavigableSet
        public NavigableSet<K> subSet(@ParametricNullness K k6, boolean z6, @ParametricNullness K k7, boolean z7) {
            return map().subMap(k6, z6, k7, z7).navigableKeySet();
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> tailSet(@ParametricNullness K k6, boolean z6) {
            return map().tailMap(k6, z6).navigableKeySet();
        }
    ...
    public static class SortedAsMapView<K, V> extends AsMapView<K, V> implements SortedMap<K, V> {
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> headMap(@ParametricNullness K k6) {
            return Maps.asMap((SortedSet) backingSet().headSet(k6), (Function) this.function);
        }
        ...
        @Override // java.util.SortedMap
        public SortedMap<K, V> subMap(@ParametricNullness K k6, @ParametricNullness K k7) {
            return Maps.asMap((SortedSet) backingSet().subSet(k6, k7), (Function) this.function);
        }

        @Override // java.util.SortedMap
        public SortedMap<K, V> tailMap(@ParametricNullness K k6) {
            return Maps.asMap((SortedSet) backingSet().tailSet(k6), (Function) this.function);
        }
    ...
    public static class SortedKeySet<K, V> extends KeySet<K, V> implements SortedSet<K> {
        ...
        public SortedSet<K> headSet(@ParametricNullness K k6) {
            return new SortedKeySet(map().headMap(k6));
        }
        ...
        public SortedSet<K> subSet(@ParametricNullness K k6, @ParametricNullness K k7) {
            return new SortedKeySet(map().subMap(k6, k7));
        }

        public SortedSet<K> tailSet(@ParametricNullness K k6) {
            return new SortedKeySet(map().tailMap(k6));
        }
    ...
    public static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2> {
        ...
        public V2 get(Object obj) {
            V1 v6 = this.fromMap.get(obj);
            if (v6 != null || this.fromMap.containsKey(obj)) {
                return this.transformer.transformEntry(obj, (Object) NullnessCasts.uncheckedCastNullableTToT(v6));
            }
            return null;
        }
    ...
    public static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2> {
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V2> ceilingEntry(@ParametricNullness K k6) {
            return transformEntry(fromMap().ceilingEntry(k6));
        }

        @Override // java.util.NavigableMap
        public K ceilingKey(@ParametricNullness K k6) {
            return fromMap().ceilingKey(k6);
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V2> floorEntry(@ParametricNullness K k6) {
            return transformEntry(fromMap().floorEntry(k6));
        }

        @Override // java.util.NavigableMap
        public K floorKey(@ParametricNullness K k6) {
            return fromMap().floorKey(k6);
        }

        @Override // java.util.NavigableMap
        public Map.Entry<K, V2> higherEntry(@ParametricNullness K k6) {
            return transformEntry(fromMap().higherEntry(k6));
        }

        @Override // java.util.NavigableMap
        public K higherKey(@ParametricNullness K k6) {
            return fromMap().higherKey(k6);
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V2> lowerEntry(@ParametricNullness K k6) {
            return transformEntry(fromMap().lowerEntry(k6));
        }

        @Override // java.util.NavigableMap
        public K lowerKey(@ParametricNullness K k6) {
            return fromMap().lowerKey(k6);
        }
        ...
        public NavigableMap<K, V2> headMap(@ParametricNullness K k6) {
            return headMap(k6, false);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V2> subMap(@ParametricNullness K k6, boolean z6, @ParametricNullness K k7, boolean z7) {
            return Maps.transformEntries((NavigableMap) fromMap().subMap(k6, z6, k7, z7), (EntryTransformer) this.transformer);
        }

        @Override // com.google.common.collect.Maps.TransformedEntriesSortedMap, java.util.SortedMap, java.util.NavigableMap
        public NavigableMap<K, V2> tailMap(@ParametricNullness K k6) {
            return tailMap(k6, true);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V2> headMap(@ParametricNullness K k6, boolean z6) {
            return Maps.transformEntries((NavigableMap) fromMap().headMap(k6, z6), (EntryTransformer) this.transformer);
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V2> tailMap(@ParametricNullness K k6, boolean z6) {
            return Maps.transformEntries((NavigableMap) fromMap().tailMap(k6, z6), (EntryTransformer) this.transformer);
        }

        @Override // com.google.common.collect.Maps.TransformedEntriesSortedMap, java.util.SortedMap, java.util.NavigableMap
        public NavigableMap<K, V2> subMap(@ParametricNullness K k6, @ParametricNullness K k7) {
            return subMap(k6, true, k7, false);
        }
    }
    ...
    public static class TransformedEntriesSortedMap<K, V1, V2> extends TransformedEntriesMap<K, V1, V2> implements SortedMap<K, V2> {
        ...
        public SortedMap<K, V2> headMap(@ParametricNullness K k6) {
            return Maps.transformEntries((SortedMap) fromMap().headMap(k6), (EntryTransformer) this.transformer);
        }
        ...
        public SortedMap<K, V2> subMap(@ParametricNullness K k6, @ParametricNullness K k7) {
            return Maps.transformEntries((SortedMap) fromMap().subMap(k6, k7), (EntryTransformer) this.transformer);
        }

        public SortedMap<K, V2> tailMap(@ParametricNullness K k6) {
            return Maps.transformEntries((SortedMap) fromMap().tailMap(k6), (EntryTransformer) this.transformer);
        }
    }
    ...
    public static class UnmodifiableNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V>, Serializable {
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V> ceilingEntry(@ParametricNullness K k6) {
            return Maps.unmodifiableOrNull(this.delegate.ceilingEntry(k6));
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V> floorEntry(@ParametricNullness K k6) {
            return Maps.unmodifiableOrNull(this.delegate.floorEntry(k6));
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V> higherEntry(@ParametricNullness K k6) {
            return Maps.unmodifiableOrNull(this.delegate.higherEntry(k6));
        }
        ...
        @Override // java.util.NavigableMap
        public Map.Entry<K, V> lowerEntry(@ParametricNullness K k6) {
            return Maps.unmodifiableOrNull(this.delegate.lowerEntry(k6));
        }
        ...
        @Override // java.util.NavigableMap
        public NavigableMap<K, V> headMap(@ParametricNullness K k6, boolean z6) {
            return Maps.unmodifiableNavigableMap(this.delegate.headMap(k6, z6));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> subMap(@ParametricNullness K k6, boolean z6, @ParametricNullness K k7, boolean z7) {
            return Maps.unmodifiableNavigableMap(this.delegate.subMap(k6, z6, k7, z7));
        }

        @Override // java.util.NavigableMap
        public NavigableMap<K, V> tailMap(@ParametricNullness K k6, boolean z6) {
            return Maps.unmodifiableNavigableMap(this.delegate.tailMap(k6, z6));
        }
    ...
    public static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        private ValueDifferenceImpl(@ParametricNullness V v6, @ParametricNullness V v7) {
            this.left = v6;
            this.right = v7;
        }

        public static <V> MapDifference.ValueDifference<V> create(@ParametricNullness V v6, @ParametricNullness V v7) {
            return new ValueDifferenceImpl(v6, v7);
        }
    ...
    public static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(final Function<? super V1, V2> function) {
        ...
        return new EntryTransformer<K, V1, V2>() { // from class: com.google.common.collect.Maps.9
            ...
            @ParametricNullness
            public V2 transformEntry(@ParametricNullness K k6, @ParametricNullness V1 v6) {
                return (V2) function.apply(v6);
            }
        };
    }
    ...
    public static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, final Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.common.collect.Maps.3
            @Override // com.google.common.collect.TransformedIterator
            public Map.Entry<K, V> transform(@ParametricNullness K k6) {
                return Maps.immutableEntry(k6, function.apply(k6));
            }
        };
    }

    public static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> entryTransformer, @ParametricNullness final K k6) {
        Preconditions.checkNotNull(entryTransformer);
        return new Function<V1, V2>() { // from class: com.google.common.collect.Maps.10
            @Override // com.google.common.base.Function
            @ParametricNullness
            public V2 apply(@ParametricNullness V1 v6) {
                return (V2) entryTransformer.transformEntry(k6, v6);
            }
        };
    }
    ...
    private static <K, V> void doDifference(Map<? extends K, ? extends V> map, Map<? extends K, ? extends V> map2, Equivalence<? super V> equivalence, Map<K, V> map3, Map<K, V> map4, Map<K, V> map5, Map<K, MapDifference.ValueDifference<V>> map6) {
        for (Map.Entry<? extends K, ? extends V> entry : map.entrySet()) {
            ...
            if (map2.containsKey(key)) {
                A0.c cVar = (Object) NullnessCasts.uncheckedCastNullableTToT(map4.remove(key));
    ...
    public static <K, V> Map.Entry<K, V> immutableEntry(@ParametricNullness K k6, @ParametricNullness V v6) {
    ...
    public static <E> NavigableSet<E> removeOnlyNavigableSet(final NavigableSet<E> navigableSet) {
        return new ForwardingNavigableSet<E>() { // from class: com.google.common.collect.Maps.6
            ...
            public SortedSet<E> subSet(@ParametricNullness E e, @ParametricNullness E e6) {
                return Maps.removeOnlySortedSet(super.subSet(e, e6));
            }
            ...
            public NavigableSet<E> headSet(@ParametricNullness E e, boolean z6) {
                return Maps.removeOnlyNavigableSet(super.headSet(e, z6));
            }

            @Override // com.google.common.collect.ForwardingNavigableSet, java.util.NavigableSet
            public NavigableSet<E> subSet(@ParametricNullness E e, boolean z6, @ParametricNullness E e6, boolean z7) {
                return Maps.removeOnlyNavigableSet(super.subSet(e, z6, e6, z7));
            }

            @Override // com.google.common.collect.ForwardingNavigableSet, java.util.NavigableSet
            public NavigableSet<E> tailSet(@ParametricNullness E e, boolean z6) {
                return Maps.removeOnlyNavigableSet(super.tailSet(e, z6));
            }
    ...
    public static String toStringImpl(Map<?, ?> map) {
        ...
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            ...
            sbNewStringBuilderForCollection.append(Chars.EQ);

...
final class RegularImmutableSortedMultiset<E> extends ImmutableSortedMultiset<E> {
    ...
    public Multiset.Entry<E> getEntry(int i5) {
        return Multisets.immutableEntry(this.elementSet.asList().get(i5), getCount(i5));
    }

    public ImmutableSortedMultiset<E> getSubMultiset(int i5, int i6) {
        Preconditions.checkPositionIndexes(i5, i6, this.length);
        if (i5 == i6) {
            return ImmutableSortedMultiset.emptyMultiset(comparator());
        }
        return (i5 == 0 && i6 == this.length) ? this : new RegularImmutableSortedMultiset(this.elementSet.getSubSet(i5, i6), this.cumulativeCounts, this.offset + i5, i6 - i5);
    }
    ...
    public int size() {
        long[] jArr = this.cumulativeCounts;
        int i5 = this.offset;
        return Ints.saturatedCast(jArr[this.length + i5] - jArr[i5]);
    }

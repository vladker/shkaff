...
public final class Lists {
    ...
    public static class AbstractListWrapper<E> extends AbstractList<E> {
        ...
        public E set(int i5, @ParametricNullness E e) {
            return this.backingList.set(i5, e);
        }
    ...
    public static class OnePlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess {
        ...
        public E get(int i5) {
            Preconditions.checkElementIndex(i5, size());
            return i5 == 0 ? this.first : this.rest[i5 - 1];
        }
    ...
    public static class Partition<T> extends AbstractList<List<T>> {
        ...
        public Partition(List<T> list, int i5) {
            this.list = list;
            this.size = i5;
        }
    ...
    public static class RandomAccessPartition<T> extends Partition<T> implements RandomAccess {
        public RandomAccessPartition(List<T> list, int i5) {
            super(list, i5);
        }
    }
    ...
    public static class ReverseList<T> extends AbstractList<T> {
        ...
        public int reversePosition(int i5) {
            int size = size();
        ...
        @Override // java.util.AbstractList, java.util.List
        public void add(int i5, @ParametricNullness T t6) {
            this.forwardList.add(reversePosition(i5), t6);
        }
        ...
        public ListIterator<T> listIterator(int i5) {
            final ListIterator<T> listIterator = this.forwardList.listIterator(reversePosition(i5));
        ...
        public T remove(int i5) {
            return this.forwardList.remove(reverseIndex(i5));
        }
        ...
        @Override // java.util.AbstractList, java.util.List
        @ParametricNullness
        public T set(int i5, @ParametricNullness T t6) {
            return this.forwardList.set(reverseIndex(i5), t6);
        }
        ...
        public List<T> subList(int i5, int i6) {
            ...
            return Lists.reverse(this.forwardList.subList(reversePosition(i6), reversePosition(i5)));
        }
    }
    ...
    public static final class StringAsImmutableList extends ImmutableList<Character> {
        ...
        public ImmutableList<Character> subList(int i5, int i6) {
            Preconditions.checkPositionIndexes(i5, i6, size());
            return Lists.charactersOf(this.string.substring(i5, i6));
        }
    }
    ...
    public static class TransformingRandomAccessList<F, T> extends AbstractList<T> implements RandomAccess, Serializable {
        ...
        @ParametricNullness
        public T get(int i5) {
            return this.function.apply(this.fromList.get(i5));
        }
        ...
        @Override // java.util.AbstractList, java.util.List
        public ListIterator<T> listIterator(int i5) {
            return new TransformedListIterator<F, T>(this.fromList.listIterator(i5)) { // from class: com.google.common.collect.Lists.TransformingRandomAccessList.1
                @Override // com.google.common.collect.TransformedIterator
                public T transform(F f6) {
                    return TransformingRandomAccessList.this.function.apply(f6);
                }
            };
        }
        ...
        @Override // java.util.AbstractList, java.util.List
        public T remove(int i5) {
            return this.function.apply(this.fromList.remove(i5));
        }
    ...
    public static class TransformingSequentialList<F, T> extends AbstractSequentialList<T> implements Serializable {
        ...
        public ListIterator<T> listIterator(int i5) {
            return new TransformedListIterator<F, T>(this.fromList.listIterator(i5)) { // from class: com.google.common.collect.Lists.TransformingSequentialList.1
                @Override // com.google.common.collect.TransformedIterator
                @ParametricNullness
                public T transform(@ParametricNullness F f6) {
                    return TransformingSequentialList.this.function.apply(f6);
                }
            };
        }
    ...
    public static class TwoPlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess {
        ...
        public TwoPlusArrayList(@ParametricNullness E e, @ParametricNullness E e6, E[] eArr) {
            this.first = e;
            this.second = e6;
            this.rest = (E[]) ((Object[]) Preconditions.checkNotNull(eArr));
        }
    ...
    @VisibleForTesting
    public static int computeArrayListCapacity(int i5) {
        CollectPreconditions.checkNonnegative(i5, "arraySize");
        return Ints.saturatedCast(((long) i5) + 5 + ((long) (i5 / 10)));
    }
    ...
    public static <E> ListIterator<E> listIteratorImpl(List<E> list, int i5) {
        return new AbstractListWrapper(list).listIterator(i5);
    }
    ...
    public static <T> List<List<T>> partition(List<T> list, int i5) {
        ...
        return list instanceof RandomAccess ? new RandomAccessPartition(list, i5) : new Partition(list, i5);
    }
    ...
    public static <E> List<E> subListImpl(List<E> list, int i5, int i6) {
        return (list instanceof RandomAccess ? new RandomAccessListWrapper<E>(list) { // from class: com.google.common.collect.Lists.1
            ...
            public ListIterator<E> listIterator(int i7) {
                return this.backingList.listIterator(i7);
            }
    ...
    public static <E> List<E> asList(@ParametricNullness E e, @ParametricNullness E e6, E[] eArr) {
        return new TwoPlusArrayList(e, e6, eArr);
    }

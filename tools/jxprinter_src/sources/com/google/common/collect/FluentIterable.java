...
public abstract class FluentIterable<E> implements Iterable<E> {
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.FluentIterable.3
            ...
            public Iterator<T> iterator() {
                return Iterators.concat(new AbstractIndexedListIterator<Iterator<? extends T>>(iterableArr.length) { // from class: com.google.common.collect.FluentIterable.3.1
                    ...
                    public Iterator<? extends T> get(int i5) {
                        return iterableArr[i5].iterator();
                    }
                });
            }
        };
    ...
    public final E get(int i5) {
        return (E) Iterables.get(getDelegate(), i5);
    }
    ...
    public final FluentIterable<E> limit(int i5) {
        return from(Iterables.limit(getDelegate(), i5));
    }
    ...
    public final FluentIterable<E> skip(int i5) {
        return from(Iterables.skip(getDelegate(), i5));
    }

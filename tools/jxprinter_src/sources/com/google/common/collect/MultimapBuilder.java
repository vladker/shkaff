...
public abstract class MultimapBuilder<K0, V0> {
    ...
    public static final class ArrayListSupplier<V> implements Supplier<List<V>>, Serializable {
        ...
        public ArrayListSupplier(int i5) {
            this.expectedValuesPerKey = CollectPreconditions.checkNonnegative(i5, "expectedValuesPerKey");
        }
    ...
    public static final class LinkedHashSetSupplier<V> implements Supplier<Set<V>>, Serializable {
        ...
        public LinkedHashSetSupplier(int i5) {
            this.expectedValuesPerKey = CollectPreconditions.checkNonnegative(i5, "expectedValuesPerKey");
        }
    ...
    public static abstract class MultimapBuilderWithKeys<K0> {
        ...
        public ListMultimapBuilder<K0, Object> arrayListValues(final int i5) {
            CollectPreconditions.checkNonnegative(i5, "expectedValuesPerKey");
            return new ListMultimapBuilder<K0, Object>() { // from class: com.google.common.collect.MultimapBuilder.MultimapBuilderWithKeys.1
                @Override // com.google.common.collect.MultimapBuilder.ListMultimapBuilder, com.google.common.collect.MultimapBuilder
                public <K extends K0, V> ListMultimap<K, V> build() {
                    return Multimaps.newListMultimap(MultimapBuilderWithKeys.this.createMap(), new ArrayListSupplier(i5));
                }
            };
        }

        public SetMultimapBuilder<K0, Object> hashSetValues(final int i5) {
            CollectPreconditions.checkNonnegative(i5, "expectedValuesPerKey");
            return new SetMultimapBuilder<K0, Object>() { // from class: com.google.common.collect.MultimapBuilder.MultimapBuilderWithKeys.3
                ...
                public <K extends K0, V> SetMultimap<K, V> build() {
                    return Multimaps.newSetMultimap(MultimapBuilderWithKeys.this.createMap(), new HashSetSupplier(i5));
                }
            };
        }

        public SetMultimapBuilder<K0, Object> linkedHashSetValues(final int i5) {
            CollectPreconditions.checkNonnegative(i5, "expectedValuesPerKey");
            return new SetMultimapBuilder<K0, Object>() { // from class: com.google.common.collect.MultimapBuilder.MultimapBuilderWithKeys.4
                @Override // com.google.common.collect.MultimapBuilder.SetMultimapBuilder, com.google.common.collect.MultimapBuilder
                public <K extends K0, V> SetMultimap<K, V> build() {
                    return Multimaps.newSetMultimap(MultimapBuilderWithKeys.this.createMap(), new LinkedHashSetSupplier(i5));
                }
            };
        }
    ...
    public static MultimapBuilderWithKeys<Object> hashKeys(final int i5) {
        CollectPreconditions.checkNonnegative(i5, "expectedKeys");
        return new MultimapBuilderWithKeys<Object>() { // from class: com.google.common.collect.MultimapBuilder.1
            ...
            public <K, V> Map<K, Collection<V>> createMap() {
                return Platform.newHashMapWithExpectedSize(i5);
            }
        };
    }

    public static MultimapBuilderWithKeys<Object> linkedHashKeys(final int i5) {
        CollectPreconditions.checkNonnegative(i5, "expectedKeys");
        return new MultimapBuilderWithKeys<Object>() { // from class: com.google.common.collect.MultimapBuilder.2
            @Override // com.google.common.collect.MultimapBuilder.MultimapBuilderWithKeys
            public <K, V> Map<K, Collection<V>> createMap() {
                return Platform.newLinkedHashMapWithExpectedSize(i5);
            }
        };
    }

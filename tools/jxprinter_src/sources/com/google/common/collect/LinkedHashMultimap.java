...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
    ...
    public static final class ValueEntry<K, V> extends ImmutableEntry<K, V> implements ValueSetLink<K, V> {
        ...
        public ValueEntry(@ParametricNullness K k6, @ParametricNullness V v6, int i5, ValueEntry<K, V> valueEntry) {
            super(k6, v6);
        ...
        public boolean matchesValue(Object obj, int i5) {
            return this.smearedValueHash == i5 && com.google.common.base.Objects.equal(getValue(), obj);
        }
    ...
    public final class ValueSet extends Sets.ImprovedAbstractSet<V> implements ValueSetLink<K, V> {
        ...
        public ValueSet(K k6, int i5) {
            this.key = k6;
            this.hashTable = new ValueEntry[Hashing.closedTableSize(i5, 1.0d)];
        }
        ...
        private void rehashIfNecessary() {
            if (Hashing.needsResizing(this.size, this.hashTable.length, 1.0d)) {
                ...
                for (ValueSetLink<K, V> successorInValueSet = this.firstEntry; successorInValueSet != this; successorInValueSet = successorInValueSet.getSuccessorInValueSet()) {
                    ...
                    int i6 = valueEntry.smearedValueHash & i5;
                    valueEntry.nextInValueBucket = valueEntryArr[i6];
        ...
        public boolean add(@ParametricNullness V v6) {
            ...
            for (ValueEntry<K, V> valueEntry2 = valueEntry; valueEntry2 != null; valueEntry2 = valueEntry2.nextInValueBucket) {
                if (valueEntry2.matchesValue(v6, iSmearedHash)) {
                    return false;
                }
            }
            ValueEntry<K, V> valueEntry3 = new ValueEntry<>(this.key, v6, iSmearedHash, valueEntry);
    ...
    private LinkedHashMultimap(int i5, int i6) {
        super(Platform.newLinkedHashMapWithExpectedSize(i5));
        this.valueSetCapacity = 2;
        CollectPreconditions.checkNonnegative(i6, "expectedValuesPerKey");
    ...
    public static <K, V> LinkedHashMultimap<K, V> create(int i5, int i6) {
        return new LinkedHashMultimap<>(Maps.capacity(i5), Maps.capacity(i6));
    }
    ...
    public Collection<V> createCollection(@ParametricNullness K k6) {
        return new ValueSet(k6, this.valueSetCapacity);
    }

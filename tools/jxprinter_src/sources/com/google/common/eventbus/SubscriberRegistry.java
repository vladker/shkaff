    ...
    public void unregister(Object obj) {
        for (Map.Entry<Class<?>, Collection<Subscriber>> entry : findAllSubscribers(obj).asMap().entrySet()) {
            ...
            if (copyOnWriteArraySet == null || !copyOnWriteArraySet.removeAll(value)) {
                ...
                throw new IllegalArgumentException(androidx.exifinterface.media.a.e(strValueOf.length() + 65, "missing event subscriber for an annotated method. Is ", strValueOf, " registered?"));
            }
        }
    }
}

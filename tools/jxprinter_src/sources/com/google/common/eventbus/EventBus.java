...
public class EventBus {
    ...
    public static final class LoggingHandler implements SubscriberExceptionHandler {
        ...
        private static Logger logger(SubscriberExceptionContext subscriberExceptionContext) {
            ...
            StringBuilder sb = new StringBuilder(androidx.exifinterface.media.a.b(name.length() + 1, strIdentifier));
            sb.append(name);
        ...
        private static String message(SubscriberExceptionContext subscriberExceptionContext) {
            ...
            StringBuilder sb = new StringBuilder(strValueOf2.length() + strValueOf.length() + name2.length() + androidx.exifinterface.media.a.b(80, name));
            sb.append("Exception thrown by subscriber method ");
            sb.append(name);
            sb.append('(');
            sb.append(name2);
            return androidx.exifinterface.media.a.s(sb, ") on subscriber ", strValueOf, " when dispatching event: ", strValueOf2);
        }

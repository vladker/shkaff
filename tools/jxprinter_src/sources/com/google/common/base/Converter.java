...
public abstract class Converter<A, B> implements Function<A, B> {
    ...
    public static final class ConverterComposition<A, B, C> extends Converter<A, C> implements Serializable {
        ...
        @Override // com.google.common.base.Converter
        public C correctedDoForward(A a6) {
            return (C) this.second.correctedDoForward(this.first.correctedDoForward(a6));
        }
        ...
        public String toString() {
            ...
            return a.j(strValueOf2.length() + strValueOf.length() + 10, strValueOf, ".andThen(", strValueOf2, ")");
        }
    }
    ...
    public static final class FunctionBasedConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        public B doForward(A a6) {
            return this.forwardFunction.apply(a6);
        }
        ...
        public String toString() {
            ...
            StringBuilder sbU = androidx.exifinterface.media.a.u(strValueOf2.length() + strValueOf.length() + 18, "Converter.from(", strValueOf, ", ", strValueOf2);
            sbU.append(")");
            return sbU.toString();
        }
    ...
    public static final class ReverseConverter<A, B> extends Converter<B, A> implements Serializable {
        ...
        @Override // com.google.common.base.Converter
        public B correctedDoBackward(A a6) {
            return this.original.correctedDoForward(a6);
        }
        ...
        public String toString() {
            ...
            return a.i(strValueOf.length() + 10, strValueOf, ".reverse()");
        }
    }
    ...
    private B unsafeDoForward(A a6) {
        return (B) doForward(NullnessCasts.uncheckedCastNullableTToT(a6));
    }

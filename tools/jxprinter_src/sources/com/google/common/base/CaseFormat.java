...
public abstract class CaseFormat {
    ...
    public static final CaseFormat LOWER_HYPHEN = new CaseFormat("LOWER_HYPHEN", 0, CharMatcher.is('-'), ProcessIdUtil.DEFAULT_PROCESSID) { // from class: com.google.common.base.CaseFormat.1
        @Override // com.google.common.base.CaseFormat
        public String convert(CaseFormat caseFormat, String str) {
            if (caseFormat == CaseFormat.LOWER_UNDERSCORE) {
                return str.replace('-', NameUtil.USCORE);
            }
            return caseFormat == CaseFormat.UPPER_UNDERSCORE ? Ascii.toUpperCase(str.replace('-', NameUtil.USCORE)) : super.convert(caseFormat, str);
        }
    ...
    public static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String toString() {
            ...
            return a.j(strValueOf2.length() + strValueOf.length() + 14, strValueOf, ".converterTo(", strValueOf2, ")");
        }
    ...
    static {
        String str = "_";
        LOWER_UNDERSCORE = new CaseFormat("LOWER_UNDERSCORE", 1, CharMatcher.is(NameUtil.USCORE), str) { // from class: com.google.common.base.CaseFormat.2
            @Override // com.google.common.base.CaseFormat
            public String convert(CaseFormat caseFormat, String str2) {
                if (caseFormat == CaseFormat.LOWER_HYPHEN) {
                    return str2.replace(NameUtil.USCORE, '-');
                }
        ...
        UPPER_UNDERSCORE = new CaseFormat("UPPER_UNDERSCORE", 4, CharMatcher.is(NameUtil.USCORE), str) { // from class: com.google.common.base.CaseFormat.5
            @Override // com.google.common.base.CaseFormat
            public String convert(CaseFormat caseFormat, String str3) {
                if (caseFormat == CaseFormat.LOWER_HYPHEN) {
                    return Ascii.toLowerCase(str3.replace(NameUtil.USCORE, '-'));
                }
    ...
    public static String firstCharOnlyToUpper(String str) {
        ...
        StringBuilder sb = new StringBuilder(androidx.exifinterface.media.a.b(1, lowerCase));
        sb.append(upperCase);
        sb.append(lowerCase);
        return sb.toString();
    }
    ...
    private CaseFormat(String str, int i5, CharMatcher charMatcher, String str2) {
        super(str, i5);

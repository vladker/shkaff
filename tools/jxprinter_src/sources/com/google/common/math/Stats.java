...
public final class Stats implements Serializable {
    ...
    public Stats(long j6, double d, double d6, double d7, double d8) {
        this.count = j6;
        this.mean = d;
    ...
    public static double meanOf(Iterator<? extends Number> it) {
        ...
        while (it.hasNext()) {
            ...
            j6++;
            dDoubleValue = (Doubles.isFinite(dDoubleValue2) && Doubles.isFinite(dDoubleValue)) ? ((dDoubleValue2 - dDoubleValue) / j6) + dDoubleValue : StatsAccumulator.calculateNewMeanNonFinite(dDoubleValue, dDoubleValue2);
        }
        return dDoubleValue;
    }
    ...
    public static double meanOf(double... dArr) {
        ...
        for (int i5 = 1; i5 < dArr.length; i5++) {
            double d = dArr[i5];
            dCalculateNewMeanNonFinite = (Doubles.isFinite(d) && Doubles.isFinite(dCalculateNewMeanNonFinite)) ? ((d - dCalculateNewMeanNonFinite) / ((double) (i5 + 1))) + dCalculateNewMeanNonFinite : StatsAccumulator.calculateNewMeanNonFinite(dCalculateNewMeanNonFinite, d);
        }

...
public abstract class CacheLoader<K, V> {
    ...
    public static final class FunctionToCacheLoader<K, V> extends CacheLoader<K, V> implements Serializable {
        ...
        public V load(K k6) {
            return this.computingFunction.apply((K) Preconditions.checkNotNull(k6));
        }
    }
    ...
    public static <K, V> CacheLoader<K, V> asyncReloading(CacheLoader<K, V> cacheLoader, final Executor executor) {
        ...
        return new CacheLoader<K, V>() { // from class: com.google.common.cache.CacheLoader.1
            @Override // com.google.common.cache.CacheLoader
            public V load(K k6) {
                return (V) CacheLoader.this.load(k6);
            }
            ...
            @Override // com.google.common.cache.CacheLoader
            public ListenableFuture<V> reload(final K k6, final V v6) {
                ListenableFutureTask listenableFutureTaskCreate = ListenableFutureTask.create(new Callable<V>() { // from class: com.google.common.cache.CacheLoader.1.1
                    ...
                    public V call() {
                        return CacheLoader.this.reload(k6, v6).get();
                    }
                });
    ...
    @GwtIncompatible
    public ListenableFuture<V> reload(K k6, V v6) {
        Preconditions.checkNotNull(k6);
        Preconditions.checkNotNull(v6);
        return Futures.immediateFuture(load(k6));
    }

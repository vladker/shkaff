...
public final class UnsignedInteger extends Number implements Comparable<UnsignedInteger> {
    ...
    private UnsignedInteger(int i5) {
        this.value = i5;
    }

    public static UnsignedInteger fromIntBits(int i5) {
        return new UnsignedInteger(i5);
    }

    public static UnsignedInteger valueOf(long j6) {
        Preconditions.checkArgument((KeyboardMap.kValueMask & j6) == j6, "value (%s) is outside the range for an unsigned integer value", j6);
        return fromIntBits((int) j6);
    }
    ...
    public String toString(int i5) {
        return UnsignedInts.toString(this.value, i5);
    }
    ...
    public static UnsignedInteger valueOf(String str, int i5) {
        return fromIntBits(UnsignedInts.parseUnsignedInt(str, i5));
    }
}

...
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    public static class Builder<N> {
        ...
        public Builder<N> putEdge(N n6, N n7) {
            this.mutableGraph.putEdge(n6, n7);
            return this;
        }
    ...
    private static <N> GraphConnections<N, GraphConstants.Presence> connectionsOf(Graph<N> graph, N n6) {
        Function functionConstant = Functions.constant(GraphConstants.Presence.EDGE_EXISTS);
        return graph.isDirected() ? DirectedGraphConnections.ofImmutable(n6, graph.incidentEdges(n6), functionConstant) : UndirectedGraphConnections.ofImmutable(Maps.asMap(graph.adjacentNodes(n6), functionConstant));
    }
    ...
    private static <N> ImmutableMap<N, GraphConnections<N, GraphConstants.Presence>> getNodeConnections(Graph<N> graph) {
        ...
        for (N n6 : graph.nodes()) {
            builder.put(n6, connectionsOf(graph, n6));
        }

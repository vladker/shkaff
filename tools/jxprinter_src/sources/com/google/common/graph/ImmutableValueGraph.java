...
public final class ImmutableValueGraph<N, V> extends StandardValueGraph<N, V> {
    ...
    public static class Builder<N, V> {
        ...
        public Builder<N, V> addNode(N n6) {
            this.mutableValueGraph.addNode(n6);
            return this;
        }
        ...
        @CanIgnoreReturnValue
        public Builder<N, V> putEdgeValue(N n6, N n7, V v6) {
            this.mutableValueGraph.putEdgeValue(n6, n7, v6);
            return this;
        }

        @CanIgnoreReturnValue
        public Builder<N, V> putEdgeValue(EndpointPair<N> endpointPair, V v6) {
            this.mutableValueGraph.putEdgeValue(endpointPair, v6);
            return this;
        }
    }
    ...
    private static <N, V> GraphConnections<N, V> connectionsOf(ValueGraph<N, V> valueGraph, N n6) {
        d dVar = new d(valueGraph, n6, 1);
        return valueGraph.isDirected() ? DirectedGraphConnections.ofImmutable(n6, valueGraph.incidentEdges(n6), dVar) : UndirectedGraphConnections.ofImmutable(Maps.asMap(valueGraph.adjacentNodes(n6), dVar));
    }
    ...
    private static <N, V> ImmutableMap<N, GraphConnections<N, V>> getNodeConnections(ValueGraph<N, V> valueGraph) {
        ...
        for (N n6 : valueGraph.nodes()) {
            builder.put(n6, connectionsOf(valueGraph, n6));
        }

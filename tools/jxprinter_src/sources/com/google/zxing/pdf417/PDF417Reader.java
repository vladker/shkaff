...
public final class PDF417Reader implements Reader, MultipleBarcodeReader {
    ...
    private static Result[] decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z6) throws NotFoundException {
        ArrayList arrayList = new ArrayList();
        PDF417DetectorResult pDF417DetectorResultDetect = Detector.detect(binaryBitmap, map, z6);

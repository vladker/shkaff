...
public final class MultiFormatUPCEANReader extends OneDReader {
    ...
    public Result decodeRow(int i5, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        for (UPCEANReader uPCEANReader : this.readers) {
            try {
                Result resultDecodeRow = uPCEANReader.decodeRow(i5, bitArray, iArrFindStartGuardPattern, map);
                boolean z6 = resultDecodeRow.getBarcodeFormat() == BarcodeFormat.EAN_13 && resultDecodeRow.getText().charAt(0) == '0';
                Collection collection = map == null ? null : (Collection) map.get(DecodeHintType.POSSIBLE_FORMATS);
                boolean z7 = collection == null || collection.contains(BarcodeFormat.UPC_A);
                if (!z6 || !z7) {

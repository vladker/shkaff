...
final class FieldParser {
    ...
    static {
        ...
        THREE_DIGIT_DATA_LENGTH = new Object[][]{new Object[]{"240", obj, 30}, new Object[]{"241", obj, 30}, new Object[]{"242", obj, 6}, new Object[]{"250", obj, 30}, new Object[]{"251", obj, 30}, new Object[]{"253", obj, 17}, new Object[]{"254", obj, 20}, new Object[]{"400", obj, 30}, new Object[]{CallBack.TYPE_LOGIN_NOT, obj, 30}, new Object[]{"402", 17}, new Object[]{"403", obj, 30}, new Object[]{"410", 13}, new Object[]{"411", 13}, new Object[]{"412", 13}, new Object[]{"413", 13}, new Object[]{"414", 13}, new Object[]{"420", obj, 20}, new Object[]{"421", obj, 15}, new Object[]{"422", 3}, new Object[]{"423", obj, 15}, new Object[]{"424", 3}, new Object[]{"425", 3}, new Object[]{"426", 3}};
    ...
    private static String processFixedAI(int i5, int i6, String str) throws NotFoundException {
        if (str.length() < i5) {
            throw NotFoundException.getNotFoundInstance();
        }
        ...
        String strSubstring2 = str.substring(i5, i7);
        String str2 = "(" + strSubstring + ')' + strSubstring2;
        String fieldsInGeneralPurpose = parseFieldsInGeneralPurpose(str.substring(i7));
        return fieldsInGeneralPurpose == null ? str2 : a.n(str2, fieldsInGeneralPurpose);
    }

    private static String processVariableAI(int i5, int i6, String str) throws NotFoundException {
        String strSubstring = str.substring(0, i5);
        int length = i6 + i5;
        if (str.length() < length) {
            length = str.length();
        }
        String strSubstring2 = str.substring(i5, length);
        String str2 = "(" + strSubstring + ')' + strSubstring2;

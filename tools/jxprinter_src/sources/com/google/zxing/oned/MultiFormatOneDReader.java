...
public final class MultiFormatOneDReader extends OneDReader {
    ...
    public MultiFormatOneDReader(Map<DecodeHintType, ?> map) {
        ...
        boolean z6 = (map == null || map.get(DecodeHintType.ASSUME_CODE_39_CHECK_DIGIT) == null) ? false : true;
        ...
        if (collection != null) {
            ...
            if (collection.contains(BarcodeFormat.CODE_39)) {
                arrayList.add(new Code39Reader(z6));
            }
    ...
    public Result decodeRow(int i5, BitArray bitArray, Map<DecodeHintType, ?> map) throws NotFoundException {
        for (OneDReader oneDReader : this.readers) {
            try {
                return oneDReader.decodeRow(i5, bitArray, map);

...
public final class UPCAReader extends UPCEANReader {
    ...
    @Override // com.google.zxing.oned.UPCEANReader
    public Result decodeRow(int i5, BitArray bitArray, int[] iArr, Map<DecodeHintType, ?> map) {
        return maybeReturnResult(this.ean13Reader.decodeRow(i5, bitArray, iArr, map));
    }
    ...
    public Result decodeRow(int i5, BitArray bitArray, Map<DecodeHintType, ?> map) {
        return maybeReturnResult(this.ean13Reader.decodeRow(i5, bitArray, map));
    }
}

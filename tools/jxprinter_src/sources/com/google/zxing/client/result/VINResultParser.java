...
public final class VINResultParser extends ResultParser {
    ...
    private static char checkChar(int i5) {
        if (i5 < 10) {
            return (char) (i5 + 48);
        }
        if (i5 == 10) {
    ...
    private static boolean checkChecksum(CharSequence charSequence) {
        ...
        while (i5 < charSequence.length()) {
            int i6 = i5 + 1;
            iVinPositionWeight += vinPositionWeight(i6) * vinCharValue(charSequence.charAt(i5));
            i5 = i6;
        }
    ...
    private static int vinPositionWeight(int i5) {
        if (i5 > 0 && i5 <= 7) {
            return 9 - i5;
        }
        if (i5 == 8) {

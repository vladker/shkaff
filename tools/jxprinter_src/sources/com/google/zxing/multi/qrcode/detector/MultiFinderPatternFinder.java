...
final class MultiFinderPatternFinder extends FinderPatternFinder {
    ...
    public FinderPatternInfo[] findMulti(Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        int i5 = (int) ((height / 228.0f) * 3.0f);
        if (i5 < 3 || z6) {
            i5 = 3;
        }
        int[] iArr = new int[5];
        for (int i6 = i5 - 1; i6 < height; i6 += i5) {
            iArr[0] = 0;
            iArr[1] = 0;
            iArr[2] = 0;
            iArr[3] = 0;
            ...
            for (int i8 = 0; i8 < width; i8++) {
                if (image.get(i8, i6)) {
                    ...
                    i7++;
                    iArr[i7] = iArr[i7] + 1;
                } else if (FinderPatternFinder.foundPatternCross(iArr) && handlePossibleCenter(iArr, i6, i8, z7)) {
                    iArr[0] = 0;
                    iArr[1] = 0;
                    iArr[2] = 0;
                    iArr[3] = 0;
            ...
            if (FinderPatternFinder.foundPatternCross(iArr)) {
                handlePossibleCenter(iArr, i6, width, z7);
            }
        }

...
public final class ErrorCorrection {
    ...
    public static String encodeECC200(String str, SymbolInfo symbolInfo) {
        ...
        if (interleavedBlockCount == 1) {
            ...
            for (int i7 = 0; i7 < interleavedBlockCount; i7++) {
                ...
                String strCreateECCBlock = createECCBlock(sb2.toString(), iArr2[i7]);
                int i9 = i7;
                int i10 = 0;
                while (i9 < iArr2[i7] * interleavedBlockCount) {
                    sb.setCharAt(symbolInfo.getDataCapacity() + i9, strCreateECCBlock.charAt(i10));
    ...
    private static String createECCBlock(CharSequence charSequence, int i5, int i6, int i7) {
        ...
        if (i10 < 0) {
            throw new IllegalArgumentException(AbstractC0157z.k(i7, "Illegal number of error correction codewords specified: "));
        }
        ...
        for (int i12 = i5; i12 < i5 + i6; i12++) {
            int i13 = i7 - 1;
            int iCharAt = cArr[i13] ^ charSequence.charAt(i12);
            while (i13 > 0) {
                if (iCharAt == 0 || (i9 = iArr2[i13]) == 0) {
                    cArr[i13] = cArr[i13 - 1];
                } else {
                    char c = cArr[i13 - 1];
                    int[] iArr3 = ALOG;
                    int[] iArr4 = LOG;
                    cArr[i13] = (char) (iArr3[(iArr4[iCharAt] + iArr4[i9]) % 255] ^ c);
                }
                i13--;
            }
            if (iCharAt == 0 || (i8 = iArr2[0]) == 0) {
                cArr[0] = 0;
            } else {
                int[] iArr5 = ALOG;
                int[] iArr6 = LOG;
                cArr[0] = (char) iArr5[(iArr6[iCharAt] + iArr6[i8]) % 255];
            }
        }

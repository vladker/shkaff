...
public final class Version {
    ...
    public static final class ECBlocks {
        ...
        public ECBlocks(int i5, ECB... ecbArr) {
    ...
    public static Version decodeVersionInformation(int i5) {
        ...
        while (true) {
            ...
            if (i7 >= iArr.length) {
                if (i6 <= 3) {
                    return getVersionForNumber(i8);
                }
                return null;
            }
            int i9 = iArr[i7];
            if (i9 == i5) {
                return getVersionForNumber(i7 + 7);
            }
            int iNumBitsDiffering = FormatInformation.numBitsDiffering(i5, i9);
            if (iNumBitsDiffering < i6) {
                i8 = i7 + 7;
    ...
    public static Version getProvisionalVersionForDimension(int i5) throws FormatException {
        if (i5 % 4 != 1) {
            throw FormatException.getFormatInstance();
        }
        try {
            return getVersionForNumber((i5 - 17) / 4);
    ...
    public BitMatrix buildFunctionPattern() {
        ...
        bitMatrix.setRegion(i5, 0, 8, 9);
        bitMatrix.setRegion(0, i5, 9, 8);
        int length = this.alignmentPatternCenters.length;
        for (int i6 = 0; i6 < length; i6++) {
            int i7 = this.alignmentPatternCenters[i6] - 2;
            for (int i8 = 0; i8 < length; i8++) {
                if ((i6 != 0 || (i8 != 0 && i8 != length - 1)) && (i6 != length - 1 || i8 != 0)) {
                    bitMatrix.setRegion(this.alignmentPatternCenters[i8] - 2, i7, 5, 5);
                }
            }
        }
        ...
        if (this.versionNumber > 6) {
            ...
            bitMatrix.setRegion(i10, 0, 3, 6);
            bitMatrix.setRegion(0, i10, 6, 3);
        }
        return bitMatrix;
    }

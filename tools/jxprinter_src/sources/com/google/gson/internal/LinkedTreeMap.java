...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public Node<K, V> find(K k6, boolean z6) {
        int iCompareTo;
        Node<K, V> node;
        ...
        if (node2 != null) {
            ...
            while (true) {
                iCompareTo = comparable != null ? comparable.compareTo(node2.key) : comparator.compare(k6, node2.key);
                if (iCompareTo == 0) {
                    return node2;
                }
        ...
        if (node4 != null) {
            node = new Node<>(this.allowNullValues, node4, k6, node5, node5.prev);
            if (iCompareTo < 0) {
                node4.left = node;
            } else {
                node4.right = node;
    ...
    public V put(K k6, V v6) {
        ...
        Node<K, V> nodeFind = find(k6, true);
        V v7 = nodeFind.value;
        nodeFind.value = v6;
        return v7;
    }
    ...
    public void removeInternal(Node<K, V> node, boolean z6) {
        ...
        nodeLast.height = Math.max(i5, i6) + 1;
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public Node(boolean z6) {
            this.key = null;
            this.allowNullValue = z6;
            this.prev = this;
            this.next = this;
        }
        ...
        public V setValue(V v6) {
            if (v6 == null && !this.allowNullValue) {
                throw new NullPointerException("value == null");
            }
            V v7 = this.value;
            this.value = v6;
        ...
        public Node(boolean z6, Node<K, V> node, K k6, Node<K, V> node2, Node<K, V> node3) {
            this.parent = node;
            this.key = k6;
            this.allowNullValue = z6;
            this.height = 1;

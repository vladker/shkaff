...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM1019clone = m1019clone();
        excluderM1019clone.serializeInnerClasses = false;
        return excluderM1019clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM1019clone = m1019clone();
        excluderM1019clone.requireExpose = true;
        return excluderM1019clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z6, boolean z7) {
        ...
        if (z6) {
            ...
            excluderM1019clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z7) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM1019clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM1019clone = m1019clone();
        excluderM1019clone.modifiers = 0;
        for (int i5 : iArr) {
            excluderM1019clone.modifiers = i5 | excluderM1019clone.modifiers;
        }
        return excluderM1019clone;
    }
    ...
    public Excluder withVersion(double d) {
        Excluder excluderM1019clone = m1019clone();
        excluderM1019clone.version = d;
        return excluderM1019clone;
    }

    /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
    public Excluder m1019clone() {
        try {

...
public final class TypeAdapters {
    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapterNullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i6 = AnonymousClass35.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                    ...
                    if (i6 == 1 || i6 == 2) {
                        ...
                        if (iNextInt == 0) {
                            ...
                            StringBuilder sbT = AbstractC0157z.t(iNextInt, "Invalid bitset value ", ", expected 0 or 1; at path ");
        ...
        BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() { // from class: com.google.gson.internal.bind.TypeAdapters.4
            ...
            @Override // com.google.gson.TypeAdapter
            public void write(JsonWriter jsonWriter, Boolean bool) throws IOException {
                jsonWriter.value(bool == null ? AbstractC1127c.NULL : bool.toString());
            }
        };
        ...
        TypeAdapter<Number> typeAdapter2 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.5
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbT = AbstractC0157z.t(iNextInt, "Lossy conversion from ", " to byte; at path ");
                    sbT.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbT.toString());
        ...
        TypeAdapter<Number> typeAdapter3 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.6
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbT = AbstractC0157z.t(iNextInt, "Lossy conversion from ", " to short; at path ");
                    sbT.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbT.toString());
                } catch (NumberFormatException e) {
                    throw new JsonSyntaxException(e);
        ...
        TypeAdapter<Character> typeAdapter5 = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Character read(JsonReader jsonReader) throws IOException {
                ...
                StringBuilder sbY = AbstractC0157z.y("Expecting character, got: ", strNextString, "; at ");
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbY = AbstractC0157z.y("Failed parsing '", strNextString, "' as BigDecimal; at path ");
                    sbY.append(jsonReader.getPreviousPath());
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbY = AbstractC0157z.y("Failed parsing '", strNextString, "' as BigInteger; at path ");
                    sbY.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbY.toString(), e);
                }
            }
        ...
        TypeAdapter<URL> typeAdapter9 = new TypeAdapter<URL>() { // from class: com.google.gson.internal.bind.TypeAdapters.21
            ...
            public URL read(JsonReader jsonReader) throws IOException {
                ...
                String strNextString = jsonReader.nextString();
                if (AbstractC1127c.NULL.equals(strNextString)) {
                    return null;
                }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbY = AbstractC0157z.y("Failed parsing '", strNextString, "' as UUID; at path ");
                    sbY.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbY.toString(), e);
                }
            }
        ...
        TypeAdapter<Currency> typeAdapterNullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbY = AbstractC0157z.y("Failed parsing '", strNextString, "' as Currency; at path ");
                    sbY.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbY.toString(), e);
                }
            }
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.28
            private JsonElement readTerminal(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
                int i5 = AnonymousClass35.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i5 == 1) {
            ...
            public JsonElement read(JsonReader jsonReader) throws IOException {
                ...
                while (true) {
                    if (jsonReader.hasNext()) {
                        ...
                        boolean z6 = jsonElementTryBeginNesting2 != null;
                ...
                if (cls.isAssignableFrom(rawType)) {
                    return (TypeAdapter<T2>) new TypeAdapter<T1>() { // from class: com.google.gson.internal.bind.TypeAdapters.34.1
                        ...
                        public T1 read(JsonReader jsonReader) {
                            T1 t6 = (T1) typeAdapter.read(jsonReader);

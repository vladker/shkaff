...
final class AutoValue_EventStoreConfig extends EventStoreConfig {
    ...
    public static final class Builder extends EventStoreConfig.Builder {
        ...
        public EventStoreConfig build() {
            String strN = this.maxStorageSizeInBytes == null ? " maxStorageSizeInBytes" : "";
            if (this.loadBatchSize == null) {
                strN = androidx.collection.a.n(strN, " loadBatchSize");
            }
            if (this.criticalSectionEnterTimeoutMs == null) {
                strN = androidx.collection.a.n(strN, " criticalSectionEnterTimeoutMs");
            }
            if (this.eventCleanUpAge == null) {
                strN = androidx.collection.a.n(strN, " eventCleanUpAge");
            }
            if (this.maxBlobByteSizePerRow == null) {
                strN = androidx.collection.a.n(strN, " maxBlobByteSizePerRow");
            }
            if (strN.isEmpty()) {
        ...
        @Override // com.google.android.datatransport.runtime.scheduling.persistence.EventStoreConfig.Builder
        public EventStoreConfig.Builder setCriticalSectionEnterTimeoutMs(int i5) {
            this.criticalSectionEnterTimeoutMs = Integer.valueOf(i5);
            return this;
        }

        @Override // com.google.android.datatransport.runtime.scheduling.persistence.EventStoreConfig.Builder
        public EventStoreConfig.Builder setEventCleanUpAge(long j6) {
            this.eventCleanUpAge = Long.valueOf(j6);
            return this;
        }

        @Override // com.google.android.datatransport.runtime.scheduling.persistence.EventStoreConfig.Builder
        public EventStoreConfig.Builder setLoadBatchSize(int i5) {
            this.loadBatchSize = Integer.valueOf(i5);
            return this;
        }

        @Override // com.google.android.datatransport.runtime.scheduling.persistence.EventStoreConfig.Builder
        public EventStoreConfig.Builder setMaxBlobByteSizePerRow(int i5) {
            this.maxBlobByteSizePerRow = Integer.valueOf(i5);
            return this;
        }

        @Override // com.google.android.datatransport.runtime.scheduling.persistence.EventStoreConfig.Builder
        public EventStoreConfig.Builder setMaxStorageSizeInBytes(long j6) {
    ...
    public int hashCode() {
        ...
        int i5 = (((((((int) (j6 ^ (j6 >>> 32))) ^ 1000003) * 1000003) ^ this.loadBatchSize) * 1000003) ^ this.criticalSectionEnterTimeoutMs) * 1000003;
        long j7 = this.eventCleanUpAge;
        return ((i5 ^ ((int) ((j7 >>> 32) ^ j7))) * 1000003) ^ this.maxBlobByteSizePerRow;
    }
    ...
    public String toString() {
        ...
        return AbstractC0157z.l(VectorFormat.DEFAULT_SUFFIX, this.maxBlobByteSizePerRow, sb);
    }

    private AutoValue_EventStoreConfig(long j6, int i5, int i6, long j7, int i7) {

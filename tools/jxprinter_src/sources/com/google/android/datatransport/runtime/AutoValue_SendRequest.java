...
final class AutoValue_SendRequest extends SendRequest {
    ...
    public static final class Builder extends SendRequest.Builder {
        ...
        public SendRequest build() {
            String strN = this.transportContext == null ? " transportContext" : "";
            if (this.transportName == null) {
                strN = androidx.collection.a.n(strN, " transportName");
            }
            if (this.event == null) {
                strN = androidx.collection.a.n(strN, " event");
            }
            if (this.transformer == null) {
                strN = androidx.collection.a.n(strN, " transformer");
            }
            if (this.encoding == null) {
                strN = androidx.collection.a.n(strN, " encoding");
            }
            if (strN.isEmpty()) {

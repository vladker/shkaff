...
abstract class EventStoreConfig {
    ...
    public static abstract class Builder {
        ...
        public abstract Builder setCriticalSectionEnterTimeoutMs(int i5);

        public abstract Builder setEventCleanUpAge(long j6);

        public abstract Builder setLoadBatchSize(int i5);

        public abstract Builder setMaxBlobByteSizePerRow(int i5);

        public abstract Builder setMaxStorageSizeInBytes(long j6);
    }

...
public class ActivityRecognitionClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    @NonNull
    @RequiresPermission("com.google.android.gms.permission.ACTIVITY_RECOGNITION")
    public Task<Void> requestActivityUpdates(final long j6, @NonNull final PendingIntent pendingIntent) {
        return doWrite(TaskApiCall.builder().run(new RemoteCall(j6, pendingIntent) { // from class: com.google.android.gms.location.zzc

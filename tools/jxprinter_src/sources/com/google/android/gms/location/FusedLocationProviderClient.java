...
public class FusedLocationProviderClient extends GoogleApi<Api.ApiOptions.NoOptions> {
    ...
    private final Task<Void> zze(final com.google.android.gms.internal.location.zzba zzbaVar, final LocationCallback locationCallback, Looper looper, final zzan zzanVar, int i5) {
        ...
        }).unregister(zzakVar).withHolder(listenerHolderCreateListenerHolder).setMethodKey(i5).build());
    }
    ...
    public Task<Location> getCurrentLocation(int i5, @NonNull final CancellationToken cancellationToken) {
        LocationRequest locationRequestCreate = LocationRequest.create();
        locationRequestCreate.setPriority(i5);
    ...
    @NonNull
    @RequiresPermission(anyOf = {"android.permission.ACCESS_COARSE_LOCATION", "android.permission.ACCESS_FINE_LOCATION"})
    public Task<Void> setMockMode(final boolean z6) {
        return doWrite(TaskApiCall.builder().run(new RemoteCall(z6) { // from class: com.google.android.gms.location.zzah
    ...
    public final /* synthetic */ void zzb(final zzap zzapVar, final LocationCallback locationCallback, final zzan zzanVar, com.google.android.gms.internal.location.zzba zzbaVar, ListenerHolder listenerHolder, com.google.android.gms.internal.location.zzaz zzazVar, TaskCompletionSource taskCompletionSource) {

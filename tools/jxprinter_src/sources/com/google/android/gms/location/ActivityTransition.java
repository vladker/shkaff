...
public class ActivityTransition extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder setActivityTransition(int i5) {
        ...
        @NonNull
        public Builder setActivityType(int i5) {
            this.zza = i5;
            return this;
        }
    }
    ...
    public ActivityTransition(@SafeParcelable.Param(id = 1) int i5, @SafeParcelable.Param(id = 2) int i6) {
        this.zza = i5;
        this.zzb = i6;
    }

...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    @Nullable
    @SafeParcelable.Field(defaultValueUnchecked = AbstractC1127c.NULL, getter = "getContextAttributionTag", id = 4)
    private String zzd;
    ...
    public String toString() {
        ...
        a.y(sb, "ActivityTransitionRequest [mTransitions=", strValueOf, ", mTag='", str);
        a.y(sb, "', mClients=", strValueOf2, ", mAttributionTag=", str2);
        sb.append(']');
        return sb.toString();
    }

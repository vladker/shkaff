...
public final class zzl extends AbstractSafeParcelable {
    ...
    public final void writeToParcel(Parcel parcel, int i5) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 2, this.zza, i5, false);
        SafeParcelWriter.writeString(parcel, 3, this.zzb, false);
        SafeParcelWriter.writeString(parcel, 4, this.zzc, false);
        SafeParcelWriter.writeTypedArray(parcel, 5, this.zzd, i5, false);
        SafeParcelWriter.writeTypedArray(parcel, 6, this.zze, i5, false);
        SafeParcelWriter.writeStringArray(parcel, 7, this.zzf, false);
        SafeParcelWriter.writeTypedArray(parcel, 8, this.zzg, i5, false);

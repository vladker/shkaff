...
public abstract class zzp extends zzl implements List, RandomAccess {
    ...
    public static zzp zzh(Object[] objArr, int i5) {
        return i5 == 0 ? zzu.zza : new zzu(objArr, i5);
    }
    ...
    public zzp subList(int i5, int i6) {
        zzf.zzc(i5, i6, size());
        int i7 = i6 - i5;
        if (i7 == size()) {
            return this;
        }
        return i7 == 0 ? zzu.zza : new zzo(this, i5, i7);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzk, reason: merged with bridge method [inline-methods] */
    public final zzac listIterator(int i5) {
        zzf.zzb(i5, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new zzn(this, i5);
    }
}

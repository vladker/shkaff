        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                try {
                    ...
                    String strO = androidx.collection.a.o(obj.getClass().getName(), "@", Integer.toHexString(System.identityHashCode(obj)));
                    ...
                    strP = androidx.collection.a.p("<", strO, " threw ", e.getClass().getName(), ">");
                }
            }
            objArr[i6] = strP;
            i6++;

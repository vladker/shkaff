...
public final class zzh implements WorkAccountApi {
    ...
    @Override // com.google.android.gms.auth.account.WorkAccountApi
    public final void setWorkAuthenticatorEnabled(GoogleApiClient googleApiClient, boolean z6) {
        setWorkAuthenticatorEnabledWithResult(googleApiClient, z6);
    }

    @Override // com.google.android.gms.auth.account.WorkAccountApi
    public final PendingResult<Result> setWorkAuthenticatorEnabledWithResult(GoogleApiClient googleApiClient, boolean z6) {
        return googleApiClient.execute(new zzi(this, WorkAccount.API, googleApiClient, z6));
    }
}

...
final class zzak implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.y(1, FieldDescriptor.builder(Constants.KEY));
    private static final FieldDescriptor zzc = a.y(2, FieldDescriptor.builder("value"));
    ...
    private final zzak zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z6) throws IOException {
    ...
    private final zzak zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z6) {
    ...
    public final zzak zzd(@NonNull FieldDescriptor fieldDescriptor, int i5, boolean z6) throws IOException {
        if (!z6 || i5 != 0) {
    ...
    public final zzak zze(@NonNull FieldDescriptor fieldDescriptor, long j6, boolean z6) throws IOException {
        if (!z6 || j6 != 0) {
            zzai zzaiVarZzj = zzj(fieldDescriptor);
            zzah zzahVar = zzah.DEFAULT;
            int iOrdinal = zzaiVarZzj.zzb().ordinal();
    ...
    public final zzak zzf(@Nullable Object obj) {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());

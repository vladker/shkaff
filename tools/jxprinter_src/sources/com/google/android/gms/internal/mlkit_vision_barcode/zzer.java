...
abstract class zzer extends AtomicReference implements Runnable {
    ...
    public final String toString() {
        ...
        if (runnable == zza) {
            ...
            strO = runnable instanceof Thread ? AbstractC0157z.o("running=[RUNNING ON ", ((Thread) runnable).getName(), "]") : "running=[NOT STARTED YET]";
        }
        return androidx.collection.a.o(strO, ", ", zzb());
    }

...
public abstract class zbkx extends zbkt implements List, RandomAccess {
    ...
    public static zbkx zbg(Object[] objArr, int i5) {
        return i5 == 0 ? zbld.zba : new zbld(objArr, i5);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (list instanceof RandomAccess) {
            for (int i5 = 0; i5 < size; i5++) {
                if (!zbkh.zba(get(i5), list.get(i5))) {
                    return false;
                }
            }
            return true;
    ...
    public int zba(Object[] objArr, int i5) {
        int size = size();
    ...
    public zbkx subList(int i5, int i6) {
        zbkj.zbd(i5, i6, size());
        int i7 = i6 - i5;
        if (i7 == size()) {
            return this;
        }
        return i7 == 0 ? zbld.zba : new zbkw(this, i5, i7);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zbj, reason: merged with bridge method [inline-methods] */
    public final zblh listIterator(int i5) {
        zbkj.zbb(i5, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zba : new zbkv(this, i5);
    }
}

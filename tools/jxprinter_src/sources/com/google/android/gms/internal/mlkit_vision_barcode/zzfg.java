...
final class zzfg implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = com.google.android.gms.auth.api.accounttransfer.a.t(1, FieldDescriptor.builder(Constants.KEY));
    private static final FieldDescriptor zzc = com.google.android.gms.auth.api.accounttransfer.a.t(2, FieldDescriptor.builder("value"));
    ...
    private final zzfg zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z6) throws IOException {
    ...
    private final zzfg zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z6) {
    ...
    public final zzfg zzd(@NonNull FieldDescriptor fieldDescriptor, int i5, boolean z6) throws IOException {
        if (!z6 || i5 != 0) {
    ...
    public final zzfg zze(@NonNull FieldDescriptor fieldDescriptor, long j6, boolean z6) throws IOException {
        if (!z6 || j6 != 0) {
            zzfe zzfeVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzfeVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {

...
public final class zzah implements zzao {
    ...
    public final String zzc() {
        ...
        return ((i5 >= 0 || i5 <= -7) && (i5 < 0 || i5 >= 21)) ? str.replace("E-", "e-").replace(ExifInterface.LONGITUDE_EAST, "e+") : bigDecimal.toPlainString();
    }
    ...
    public final zzao zzcA(String str, zzg zzgVar, List list) {
        ...
        throw new IllegalArgumentException(a.A(zzc(), Consts.DOT, str, " is not a function."));
    }

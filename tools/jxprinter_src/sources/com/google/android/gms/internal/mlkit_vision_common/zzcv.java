...
final class zzcv implements ObjectEncoder {
    ...
    private static final FieldDescriptor zzd = a.y(3, FieldDescriptor.builder("modelInitializationMs"));
    private static final FieldDescriptor zze = a.y(4, FieldDescriptor.builder("confidenceThreshold"));

...
public final class zzwr {
    ...
    public final synchronized void zzc(int i5, int i6, long j6, long j7) {
        ...
        this.zza.log(new TelemetryData(0, Arrays.asList(new MethodInvocation(i5, i6, 0, j6, j7, null, null, 0, -1)))).addOnFailureListener(new OnFailureListener() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzwq

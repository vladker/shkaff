...
final class zzcz implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor zzb = a.B(1, FieldDescriptor.builder(Constants.KEY));
    private static final FieldDescriptor zzc = a.B(2, FieldDescriptor.builder("value"));
    private static final ObjectEncoder zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_text_common.zzcy
    ...
    private final zzcz zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z6) throws IOException {
    ...
    private final zzcz zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z6) {
    ...
    public final zzcz zzd(@NonNull FieldDescriptor fieldDescriptor, int i5, boolean z6) throws IOException {
        if (!z6 || i5 != 0) {
    ...
    public final zzcz zze(@NonNull FieldDescriptor fieldDescriptor, long j6, boolean z6) throws IOException {
        if (!z6 || j6 != 0) {
            zzcx zzcxVarZzj = zzj(fieldDescriptor);
            int iOrdinal = zzcxVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
    ...
    public final zzcz zzf(@Nullable Object obj) {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());

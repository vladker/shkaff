...
final class zzoq {
    ...
    public static /* synthetic */ void zzb(byte b, byte b6, char[] cArr, int i5) throws zzmr {
        if (b < -62 || zze(b6)) {
  ...
  0x0016: PHI (r2v3 byte) = (r2v2 byte), (r2v9 byte) binds: [B:9:0x0011, B:11:0x0015] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static /* synthetic */ void zzc(byte b, byte b6, byte b7, char[] cArr, int i5) throws zzmr {
        if (!zze(b6)) {
            if (b != -32) {
                if (b != -19) {
                    if (!zze(b7)) {
    ...
    public static /* synthetic */ void zzd(byte b, byte b6, byte b7, byte b8, char[] cArr, int i5) throws zzmr {
        if (!zze(b6)) {

...
public final class zzxu extends AbstractSafeParcelable {
    ...
    public zzxu(@SafeParcelable.Param(id = 1) int i5, @Nullable @SafeParcelable.Param(id = 2) String str, @Nullable @SafeParcelable.Param(id = 3) String str2, @Nullable @SafeParcelable.Param(id = 4) String str3) {
        this.zza = i5;
        this.zzb = str;
        this.zzc = str2;
        this.zzd = str3;

...
public abstract class zzbk extends zzbf implements List, RandomAccess {
    ...
    public static zzbk zzg(Object[] objArr, int i5) {
        return i5 == 0 ? zzce.zza : new zzce(objArr, i5);
    }
    ...
    public zzbk subList(int i5, int i6) {
        zzx.zzc(i5, i6, size());
        int i7 = i6 - i5;
        if (i7 == size()) {
            return this;
        }
        return i7 == 0 ? zzce.zza : new zzbj(this, i5, i7);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzj, reason: merged with bridge method [inline-methods] */
    public final zzcp listIterator(int i5) {
        zzx.zzb(i5, size(), FirebaseAnalytics.Param.INDEX);
        return isEmpty() ? zza : new zzbi(this, i5);
    }
}

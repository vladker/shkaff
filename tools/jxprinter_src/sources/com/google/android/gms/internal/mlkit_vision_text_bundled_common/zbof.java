    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            if (fieldId == 1) {
                ...
                arrayListCreateTypedList2 = SafeParcelReader.createTypedList(parcel, header, zboi.CREATOR);
            }
        }
        SafeParcelReader.ensureAtEnd(parcel, iValidateObjectHeader);
        return new zboe(strCreateString, rect, arrayListCreateTypedList, strCreateString2, arrayListCreateTypedList2);
    }

...
class zzgo extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i7 = 0;
        if (i6 >= 0) {
            int iCompareTo = comparable.compareTo(((zzgi) this.zza[i6]).zza());
            if (iCompareTo > 0) {
                return -(i5 + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i7 <= i6) {
            int i8 = (i7 + i6) / 2;
            int iCompareTo2 = comparable.compareTo(((zzgi) this.zza[i8]).zza());
            if (iCompareTo2 < 0) {
                i6 = i8 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzm(int i5) {
        zzo();
        Object value = ((zzgi) this.zza[i5]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i6] = new zzgi(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i6 = 0; i6 < i5; i6++) {
            if (!zzg(i6).equals(zzgoVar.zzg(i6))) {
                return false;
            }
        }
        if (i5 != size) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        this.zza[i5] = new zzgi(this, comparable, obj);
        this.zzb++;
        return null;
    }

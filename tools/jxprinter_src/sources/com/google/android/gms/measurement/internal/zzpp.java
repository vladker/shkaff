...
public final class zzpp extends zzjf {
    ...
    public static long zzP(byte[] bArr) {
        ...
        for (int i6 = length - 1; i6 >= 0 && i6 >= bArr.length - 8; i6--) {
            j6 += (((long) bArr[i6]) & 255) << i5;
            i5 += 8;
        }
        return j6;
    }

    public static boolean zzQ(Context context, boolean z6) {
    ...
    @WorkerThread
    public static void zzav(zzlu zzluVar, Bundle bundle, boolean z6) {
        ...
        if (bundle != null && zzluVar == null && z6) {
            bundle.remove("_sn");
            bundle.remove("_sc");
            bundle.remove("_si");
        }
    ...
    public static final boolean zzax(Bundle bundle, int i5) {
    ...
    private final Object zzay(int i5, Object obj, boolean z6, boolean z7, String str) {
        if (obj == null) {
            return null;
        }
    ...
    public final String zzC(String str, int i5, boolean z6) {
        if (str == null) {
            return null;
        }
    ...
    @WorkerThread
    public final int zzD(String str, String str2, String str3, Object obj, Bundle bundle, List list, boolean z6, boolean z7) {
        int i5;
        int size;
        zzg();
        if (!zzt(obj)) {
        ...
        if (!zzu("param", str3, (zzZ(str2) || zzZ(str3)) ? this.zzu.zzc().zzf(null, false) : this.zzu.zzc().zze(null, false), obj)) {
            ...
            if (obj instanceof Bundle) {
                zzz(str, str2, str3, (Bundle) obj, list, z6);
                return i5;
            }
            if (obj instanceof Parcelable[]) {
                for (Parcelable parcelable : (Parcelable[]) obj) {
                    ...
                    zzz(str, str2, str3, (Bundle) parcelable, list, z6);
                }
            } else {
                ...
                for (int i6 = 0; i6 < size2; i6++) {
                    ...
                    if (!(obj2 instanceof Bundle)) {
                        this.zzu.zzaV().zzh().zzc("All ArrayList elements must be of type Bundle. Value type, name", obj2 != null ? obj2.getClass() : AbstractC1127c.NULL, str3);
                        return 4;
                    }
                    zzz(str, str2, str3, (Bundle) obj2, list, z6);
                }
            }
        }
        return i5;
    ...
    public final Bundle zzF(String str, String str2, Bundle bundle, List list, boolean z6) {
        int iZzq;
        ...
        for (String str3 : new TreeSet(bundle.keySet())) {
            ...
            if (iZzq != 0) {
                ...
                int iZzD = zzD(str, str2, str3, bundle.get(str3), bundle2, list, z6, zZzaA);
                if (iZzD == 17) {
    ...
    public final void zzG(zzgv zzgvVar, int i5) {
        Bundle bundle = zzgvVar.zzd;
        int i6 = 0;
        boolean z6 = false;
        for (String str : new TreeSet(bundle.keySet())) {
            if (zzh(str) && (i6 = i6 + 1) > i5) {
                zzic zzicVar = this.zzu;
                if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z6) {
    ...
    public final void zzH(Parcelable[] parcelableArr, int i5) {
        ...
        for (Parcelable parcelable : parcelableArr) {
            ...
            boolean z6 = false;
            for (String str : new TreeSet(bundle.keySet())) {
                if (zzh(str) && !zzaA(str, zzjn.zzd) && (i6 = i6 + 1) > i5) {
                    zzic zzicVar = this.zzu;
                    if (!zzicVar.zzc().zzp(null, zzfy.zzbe) || !z6) {
    ...
    public final void zzJ(Bundle bundle, int i5, String str, Object obj) {
        if (zzax(bundle, i5)) {
            this.zzu.zzc();
    ...
    public final void zzN(zzpo zzpoVar, String str, int i5, String str2, String str3, int i6) {
        Bundle bundle = new Bundle();
        zzax(bundle, i5);
    ...
    public final long zzV() {
        ...
        if (Build.VERSION.SDK_INT < 30) {
            ...
            int iZzU = zzU();
            zzicVar.zzc();
            j6 = iZzU < ((Integer) zzfy.zzal.zzb(null)).intValue() ? 16L : 0L;
        }
    ...
    public final zzbg zzac(String str, String str2, Bundle bundle, String str3, long j6, boolean z6, boolean z7) {
        if (TextUtils.isEmpty(str2)) {
            return null;
        }
        if (zzn(str2) != 0) {
        ...
        return new zzbg(str2, new zzbe(bundleZzF), str3, j6);
    }
    ...
    public final boolean zzad(Context context, String str) {
        ...
        try {
            ...
            this.zzu.zzaV().zzb().zzb("Error obtaining certificate", e6);
            return true;
        }
    }
    ...
    public final boolean zzag(int i5, boolean z6) {
    ...
    public final int zzai(int i5) {
        return GoogleApiAvailabilityLight.getInstance().isGooglePlayServicesAvailable(this.zzu.zzaY(), 12451000);
    }

    public final long zzaj(long j6, long j7) {
        return ((j7 * 60000) + j6) / DateUtil.DAY_MILLISECONDS;
    }

    @WorkerThread
    public final void zzak(Bundle bundle, long j6) {
        long j7 = bundle.getLong("_et");
        if (j7 != 0) {
            this.zzu.zzaV().zze().zzb("Params already contained engagement", Long.valueOf(j7));
        } else {
            j7 = 0;
        }
    ...
    public final void zzam(com.google.android.gms.internal.measurement.zzcu zzcuVar, long j6) {
        Bundle bundle = new Bundle();
        bundle.putLong("r", j6);
        try {
            zzcuVar.zzb(bundle);
    ...
    public final void zzan(com.google.android.gms.internal.measurement.zzcu zzcuVar, int i5) {
        Bundle bundle = new Bundle();
        bundle.putInt("r", i5);
        try {
            zzcuVar.zzb(bundle);
    ...
    public final void zzap(com.google.android.gms.internal.measurement.zzcu zzcuVar, boolean z6) {
        Bundle bundle = new Bundle();
    ...
    public final URL zzat(long j6, String str, String str2, long j7, String str3) {
        try {
            Preconditions.checkNotEmpty(str2);
            Preconditions.checkNotEmpty(str);
            String strConcat = "https://www.googleadservices.com/pagead/conversion/app/deeplink?id_type=adid&sdk_version=" + ("v133005." + zzah()) + "&rdid=" + str2 + "&bundleid=" + str + "&retry=" + j7;
    ...
    public final void zzba() {
        ...
        if (jNextLong == 0) {
            ...
            if (jNextLong == 0) {
                a.v(this.zzu, "Utils falling back to Random for random id");
            }
        }
    ...
    public final boolean zzm(String str, int i5, String str2) {
        if (str2 == null) {
            this.zzu.zzaV().zzd().zzb("Name is required and can't be null. Type", str);
            return false;
        }
        ...
        this.zzu.zzaV().zzd().zzd("Name is too long. Type, maximum supported length, name", str, Integer.valueOf(i5), str2);
        return false;
    }
    ...
    public final boolean zzu(String str, String str2, int i5, Object obj) {
    ...
    public final void zzz(String str, String str2, String str3, Bundle bundle, List list, boolean z6) {
        int iZzq;
        String str4;
        int iZzD;
        list = list;
        ...
        zzic zzicVar = this.zzu;
        int i5 = true != zzicVar.zzc().zzu.zzk().zzag(231100000, true) ? 0 : 35;
        int i6 = 0;
        boolean z7 = false;
        for (String str5 : new TreeSet(bundle.keySet())) {
            ...
            if (iZzq != 0) {
                ...
                if (zzt(bundle.get(str5))) {
                    ...
                    str4 = null;
                    iZzD = zzD(str, str2, str5, bundle.get(str5), bundle, list, z6, false);
                }

...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            if (!Patterns.WEB_URL.matcher(str).matches()) {
                throw new IllegalArgumentException(a.e(a.b(51, str), "The supplied url [ ", str, "] is not match Patterns.WEB_URL!"));
            }
            this.zzbz = str;
        }
        ...
        public Builder setHttpMethod(int i5) {
            Preconditions.checkArgument(i5 >= 0 && i5 <= ProxyRequest.LAST_CODE, "Unrecognized http method code.");
            this.zzca = i5;
            return this;
        }

        public Builder setTimeoutMillis(long j6) {
            Preconditions.checkArgument(j6 >= 0, "The specified timeout must be non-negative.");
            this.zzcb = j6;
            return this;
        }
    }
    ...
    public ProxyRequest(@SafeParcelable.Param(id = 1000) int i5, @SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i6, @SafeParcelable.Param(id = 3) long j6, @SafeParcelable.Param(id = 4) byte[] bArr, @SafeParcelable.Param(id = 5) Bundle bundle) {
        this.versionCode = i5;
        this.url = str;
        this.httpMethod = i6;
    ...
    public String toString() {
        String str = this.url;
        int i5 = this.httpMethod;
        StringBuilder sb = new StringBuilder(a.b(42, str));

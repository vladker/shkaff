...
public final class HintRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public final Builder setEmailAddressIdentifierSupported(boolean z6) {
            this.zzai = z6;
            return this;
        }
        ...
        public final Builder setPhoneNumberIdentifierSupported(boolean z6) {
            this.zzaj = z6;
            return this;
        }
    ...
    public HintRequest(@SafeParcelable.Param(id = 1000) int i5, @SafeParcelable.Param(id = 1) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(id = 2) boolean z6, @SafeParcelable.Param(id = 3) boolean z7, @SafeParcelable.Param(id = 4) String[] strArr, @SafeParcelable.Param(id = 5) boolean z8, @SafeParcelable.Param(id = 6) String str, @SafeParcelable.Param(id = 7) String str2) {
        this.zzu = i5;
        this.zzah = (CredentialPickerConfig) Preconditions.checkNotNull(credentialPickerConfig);
        this.zzai = z6;
        this.zzaj = z7;
    ...
    public final void writeToParcel(Parcel parcel, int i5) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 1, getHintPickerConfig(), i5, false);

...
public abstract class GoogleApiClient {
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public <A extends Api.AnyClient, R extends Result, T extends BaseImplementation.ApiMethodImpl<R, A>> T enqueue(@NonNull T t6) {
        throw new UnsupportedOperationException();
    }
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T execute(@NonNull T t6) {
        throw new UnsupportedOperationException();
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public <O extends Api.ApiOptions.HasOptions> Builder addApiIfAvailable(@NonNull Api<O> api, @NonNull O o6, @NonNull Scope... scopeArr) {
            Preconditions.checkNotNull(api, "Api must not be null");
            Preconditions.checkNotNull(o6, "Null options are not permitted for this Api");
            this.zaj.put(api, o6);
            zab(api, o6, scopeArr);
            return this;
        }
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                boolean z7 = mapZad.get(api2) != null;
                ...
                if (clientBuildClient.providesSignIn()) {
                    if (api != null) {
                        throw new IllegalStateException(a.o(api2.zad(), " cannot be used with ", api.zad()));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z6) {
                    throw new IllegalStateException(AbstractC0157z.o("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder enableAutoManage(@NonNull FragmentActivity fragmentActivity, int i5, @Nullable OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) fragmentActivity);
            Preconditions.checkArgument(i5 >= 0, "clientId must be non-negative");
            this.zal = i5;
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder setGravityForPopups(int i5) {
            this.zad = i5;
            return this;
        }
        ...
        @NonNull
        @CanIgnoreReturnValue
        public <O extends Api.ApiOptions.HasOptions> Builder addApi(@NonNull Api<O> api, @NonNull O o6) {
            Preconditions.checkNotNull(api, "Api must not be null");
            Preconditions.checkNotNull(o6, "Null options are not permitted for this Api");
            this.zaj.put(api, o6);
            List<Scope> impliedScopes = ((Api.BaseClientBuilder) Preconditions.checkNotNull(api.zac(), "Base client builder must not be null")).getImpliedScopes(o6);
            this.zac.addAll(impliedScopes);
            this.zab.addAll(impliedScopes);
            return this;
        }

...
public final class zzt extends AbstractSafeParcelable {
    ...
    public zzt(String str, zzj zzjVar, boolean z6, boolean z7) {
        this.zza = str;
        this.zzb = zzjVar;
        this.zzc = z6;
        this.zzd = z7;
    ...
    public zzt(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) IBinder iBinder, @SafeParcelable.Param(id = 3) boolean z6, @SafeParcelable.Param(id = 4) boolean z7) {
        this.zza = str;
        zzk zzkVar = null;
        if (iBinder != null) {
            try {

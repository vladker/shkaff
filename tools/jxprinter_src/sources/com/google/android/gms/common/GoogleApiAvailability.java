...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Activity activity, int i5, int i6) {
        return getErrorDialog(activity, i5, i6, (DialogInterface.OnCancelListener) null);
    }
    ...
    public Task<Void> makeGooglePlayServicesAvailable(@NonNull Activity activity) {
        ...
        int iIsGooglePlayServicesAvailable = isGooglePlayServicesAvailable(activity, i5);
    ...
    @ResultIgnorabilityUnspecified
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i5, int i6) {
        return showErrorDialogFragment(activity, i5, i6, (DialogInterface.OnCancelListener) null);
    }
    ...
    @Nullable
    public final Dialog zaa(@NonNull Context context, int i5, @Nullable zag zagVar, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable DialogInterface.OnClickListener onClickListener) {
        ...
        builder2 = builder;
        builder2.setMessage(com.google.android.gms.common.internal.zac.zac(context, i5));
        if (onCancelListener != null) {
            builder2.setOnCancelListener(onCancelListener);
        }
        String strZab = com.google.android.gms.common.internal.zac.zab(context, i5);
        ...
        String strZaf = com.google.android.gms.common.internal.zac.zaf(context, i5);
        if (strZaf != null) {
            builder2.setTitle(strZaf);
        }
        Log.w("GoogleApiAvailability", AbstractC0157z.k(i5, "Creating dialog for Google Play services availability issue. ConnectionResult="), new IllegalArgumentException());
    ...
    @TargetApi(20)
    public final void zae(Context context, int i5, @Nullable String str, @Nullable PendingIntent pendingIntent) {
        int i6;
        String str2;
        Log.w("GoogleApiAvailability", a.i(i5, "GMS core API Availability. ConnectionResult=", ", tag=null"), new IllegalArgumentException());
        if (i5 == 18) {
            zaf(context);
            return;
        }
        ...
        String strZae = com.google.android.gms.common.internal.zac.zae(context, i5);
        String strZad = com.google.android.gms.common.internal.zac.zad(context, i5);
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zag(@NonNull Activity activity, @NonNull LifecycleFragment lifecycleFragment, int i5, int i6, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZaa = zaa(activity, i5, zag.zad(lifecycleFragment, getErrorResolutionIntent(activity, i5, "d"), 2), onCancelListener, null);
        if (dialogZaa == null) {
            return false;
        }
    ...
    public final boolean zah(@NonNull Context context, @NonNull ConnectionResult connectionResult, int i5) {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Activity activity, int i5, int i6, @Nullable DialogInterface.OnCancelListener onCancelListener) {
    ...
    @ResultIgnorabilityUnspecified
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i5, int i6, @Nullable DialogInterface.OnCancelListener onCancelListener) {
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i5, int i6) {
        return getErrorDialog(fragment, i5, i6, (DialogInterface.OnCancelListener) null);
    }

    public boolean showErrorDialogFragment(@NonNull Activity activity, int i5, @NonNull ActivityResultLauncher<IntentSenderRequest> activityResultLauncher, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZaa = zaa(activity, i5, null, onCancelListener, new zac(this, activity, i5, activityResultLauncher));
        if (dialogZaa == null) {
            return false;
        }
        zad(activity, dialogZaa, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
    ...
    @Nullable
    public Dialog getErrorDialog(@NonNull Fragment fragment, int i5, int i6, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i5, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i5, "d"), i6), onCancelListener, null);
    }
}

...
public class ConnectionTracker {
    ...
    private final boolean zzb(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i5, boolean z6, Executor executor) {
        ...
        try {
            boolean zZze = zze(context, intent, serviceConnection, i5, executor);
            if (zZze) {
                return zZze;
            }
    ...
    private static final boolean zze(Context context, Intent intent, ServiceConnection serviceConnection, int i5, Executor executor) {
        ...
        return (!PlatformVersion.isAtLeastQ() || executor == null) ? context.bindService(intent, serviceConnection, i5) : context.bindService(intent, i5, executor, serviceConnection);
    }

    @KeepForSdk
    public boolean bindService(@NonNull Context context, @NonNull Intent intent, @NonNull ServiceConnection serviceConnection, int i5) {
        return zzb(context, context.getClass().getName(), intent, serviceConnection, i5, true, null);
    }
    ...
    public final boolean zza(@NonNull Context context, @NonNull String str, @NonNull Intent intent, @NonNull ServiceConnection serviceConnection, int i5, Executor executor) {

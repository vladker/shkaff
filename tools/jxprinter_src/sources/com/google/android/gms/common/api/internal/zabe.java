...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public static int zad(Iterable iterable, boolean z6) {
        ...
        if (zRequiresSignIn) {
            return (zProvidesSignIn && z6) ? 2 : 1;
        }
        return 3;
    }

    public static String zag(int i5) {
        if (i5 == 1) {
            return "SIGN_IN_MODE_REQUIRED";
        }
        if (i5 != 2) {
            return i5 != 3 ? "UNKNOWN" : "SIGN_IN_MODE_NONE";
        }
    ...
    private final void zal(int i5) {
        Integer num = this.zaw;
        if (num == null) {
            this.zaw = Integer.valueOf(i5);
        } else if (num.intValue() != i5) {
            throw new IllegalStateException("Cannot use sign-in mode: " + zag(i5) + ". Mode was already set to " + zag(this.zaw.intValue()));
        }
        if (this.zal != null) {
            return;
        }
    ...
    public final void zam(GoogleApiClient googleApiClient, StatusPendingResult statusPendingResult, boolean z6) {
        Common.zaa.zaa(googleApiClient).setResultCallback(new zabb(this, statusPendingResult, z6, googleApiClient));
    }
        ...
        try {
            ...
            try {
                if (iIntValue != 3 && iIntValue != 1) {
                    ...
                    Preconditions.checkArgument(z6, "Illegal sign-in mode: " + i5);
                    zal(i5);
                    zan();
                    this.zaj.unlock();
                    return;
    ...
    public final <A extends Api.AnyClient, R extends Result, T extends BaseImplementation.ApiMethodImpl<R, A>> T enqueue(@NonNull T t6) {
        Api<?> api = t6.getApi();
        Preconditions.checkArgument(this.zac.containsKey(t6.getClientKey()), "GoogleApiClient is not configured to use " + (api != null ? api.zad() : "the API") + " required for this call.");
        this.zaj.lock();
        try {
            zaca zacaVar = this.zal;
            if (zacaVar == null) {
    ...
    public final <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T execute(@NonNull T t6) {
        Map map = this.zac;
        Api<?> api = t6.getApi();
        Preconditions.checkArgument(map.containsKey(t6.getClientKey()), "GoogleApiClient is not configured to use " + (api != null ? api.zad() : "the API") + " required for this call.");
        this.zaj.lock();
        try {
            zaca zacaVar = this.zal;
            if (zacaVar == null) {
    ...
    public final ConnectionResult blockingConnect(long j6, @NonNull TimeUnit timeUnit) {
        ...
        try {
            ...
            zal(((Integer) Preconditions.checkNotNull(this.zaw)).intValue());
            this.zak.zab();
            ConnectionResult connectionResultZac = ((zaca) Preconditions.checkNotNull(this.zal)).zac(j6, timeUnit);
            this.zaj.unlock();

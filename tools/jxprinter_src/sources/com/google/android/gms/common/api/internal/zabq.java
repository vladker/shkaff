...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    @WorkerThread
    private final void zaF(@Nullable Status status, @Nullable Exception exc, boolean z6) {
        Preconditions.checkHandlerThread(this.zaa.zar);
    ...
    public final void onConnectionSuspended(int i5) {
        if (Looper.myLooper() == this.zaa.zar.getLooper()) {
            ...
            this.zaa.zar.post(new zabn(this, i5));
        }
    }
    ...
    public final void zar(@NonNull ConnectionResult connectionResult, @Nullable Exception exc) {
        ...
        GoogleApiManager googleApiManager2 = this.zaa;
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 9, this.zad), CoroutineLiveDataKt.DEFAULT_TIMEOUT);
    }

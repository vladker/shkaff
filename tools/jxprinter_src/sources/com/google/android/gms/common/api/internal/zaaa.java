...
final class zaaa implements zaca {
    ...
    public static /* bridge */ /* synthetic */ void zan(zaaa zaaaVar, int i5, boolean z6) {
        zaaaVar.zab.zac(i5, z6);
        zaaaVar.zak = null;
        zaaaVar.zaj = null;
    }
    ...
    @Override // com.google.android.gms.common.api.internal.zaca
    @GuardedBy("lock")
    public final ConnectionResult zac(long j6, @NonNull TimeUnit timeUnit) {
        throw new UnsupportedOperationException();
    }

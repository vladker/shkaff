...
public class ClientIdentity extends AbstractSafeParcelable {
    ...
    public ClientIdentity(@SafeParcelable.Param(id = 1) int i5, @Nullable @SafeParcelable.Param(id = 2) String str) {
        this.uid = i5;
    ...
    public final String toString() {
        return this.uid + ParameterizedMessage.ERROR_MSG_SEPARATOR + this.packageName;
    }

...
public final class zaaw implements zabf {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @GuardedBy("lock")
    public final void zaE(ConnectionResult connectionResult, Api api, boolean z6) {
        int priority = api.zac().getPriority();
        if ((!z6 || connectionResult.hasResolution() || this.zad.getErrorResolutionIntent(connectionResult.getErrorCode()) != null) && (this.zae == null || priority < this.zaf)) {
    ...
    public final boolean zaG(int i5) {
        ...
        StringBuilder sbY = AbstractC0157z.y("GoogleApiClient connecting is in step ", zaJ(this.zag), " but received callback for step ");
        sbY.append(zaJ(i5));
        Log.e("GACConnecting", sbY.toString(), new Exception());

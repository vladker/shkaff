...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    public GetServiceRequest(@SafeParcelable.Param(id = 1) int i5, @SafeParcelable.Param(id = 2) int i6, @SafeParcelable.Param(id = 3) int i7, @SafeParcelable.Param(id = 4) String str, @Nullable @SafeParcelable.Param(id = 5) IBinder iBinder, @SafeParcelable.Param(id = 6) Scope[] scopeArr, @SafeParcelable.Param(id = 7) Bundle bundle, @Nullable @SafeParcelable.Param(id = 8) Account account, @SafeParcelable.Param(id = 10) Feature[] featureArr, @SafeParcelable.Param(id = 11) Feature[] featureArr2, @SafeParcelable.Param(id = 12) boolean z6, @SafeParcelable.Param(id = 13) int i8, @SafeParcelable.Param(id = 14) boolean z7, @Nullable @SafeParcelable.Param(id = 15) String str2) {

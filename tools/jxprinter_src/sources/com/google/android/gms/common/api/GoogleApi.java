...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    @KeepForSdk
    @MainThread
    public GoogleApi(@NonNull Activity activity, @NonNull Api<O> api, @NonNull O o6, @NonNull Settings settings) {
        this(activity, activity, api, o6, settings);
    }

    private final BaseImplementation.ApiMethodImpl zad(int i5, @NonNull BaseImplementation.ApiMethodImpl apiMethodImpl) {
        apiMethodImpl.zak();
        this.zaa.zau(this, i5, apiMethodImpl);
        return apiMethodImpl;
    }

    private final Task zae(int i5, @NonNull TaskApiCall taskApiCall) {
    ...
    @NonNull
    @KeepForSdk
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doBestEffortWrite(@NonNull T t6) {
        zad(2, t6);
        return t6;
    }
    ...
    @NonNull
    @KeepForSdk
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doRead(@NonNull T t6) {
        zad(0, t6);
        return t6;
    }
    ...
    @Deprecated
    @KeepForSdk
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> Task<Void> doRegisterEventListener(@NonNull T t6, @NonNull U u6) {
        Preconditions.checkNotNull(t6);
        Preconditions.checkNotNull(u6);
        Preconditions.checkNotNull(t6.getListenerKey(), "Listener has already been released.");
        Preconditions.checkNotNull(u6.getListenerKey(), "Listener has already been released.");
        Preconditions.checkArgument(Objects.equal(t6.getListenerKey(), u6.getListenerKey()), "Listener registration and unregistration methods must be constructed with the same ListenerHolder.");
        return this.zaa.zao(this, t6, u6, new Runnable() { // from class: com.google.android.gms.common.api.zad
    ...
    @NonNull
    @KeepForSdk
    public <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T doWrite(@NonNull T t6) {
        zad(1, t6);
        return t6;
    }
    ...
    @KeepForSdk
    @Deprecated
    public GoogleApi(@NonNull Activity activity, @NonNull Api<O> api, @NonNull O o6, @NonNull StatusExceptionMapper statusExceptionMapper) {
        Settings.Builder builder = new Settings.Builder();
        builder.setMapper(statusExceptionMapper);
        builder.setLooper(activity.getMainLooper());
        this(activity, (Api) api, (Api.ApiOptions) o6, builder.build());
    }
    ...
    @ResultIgnorabilityUnspecified
    @KeepForSdk
    public Task<Boolean> doUnregisterEventListener(@NonNull ListenerHolder.ListenerKey<?> listenerKey, int i5) {
    ...
    @KeepForSdk
    @Deprecated
    public GoogleApi(@NonNull Context context, @NonNull Api<O> api, @NonNull O o6, @NonNull Looper looper, @NonNull StatusExceptionMapper statusExceptionMapper) {
        Settings.Builder builder = new Settings.Builder();
        builder.setLooper(looper);
        builder.setMapper(statusExceptionMapper);
        this(context, api, o6, builder.build());
    }
    ...
    @KeepForSdk
    @Deprecated
    public GoogleApi(@NonNull Context context, @NonNull Api<O> api, @NonNull O o6, @NonNull StatusExceptionMapper statusExceptionMapper) {
        Settings.Builder builder = new Settings.Builder();
        builder.setMapper(statusExceptionMapper);
        this(context, api, o6, builder.build());
    }

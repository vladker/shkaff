...
public final class zac {
    ...
    public static String zab(Context context, int i5) {
        ...
        if (i5 != 2) {
            return i5 != 3 ? resources.getString(android.R.string.ok) : resources.getString(R.string.common_google_play_services_enable_button);
        }
    ...
    public static String zae(Context context, int i5) {
        String strZah = i5 == 6 ? zah(context, "common_google_play_services_resolution_required_title") : zaf(context, i5);

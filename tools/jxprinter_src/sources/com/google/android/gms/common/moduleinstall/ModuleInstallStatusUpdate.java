...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    public ModuleInstallStatusUpdate(@SafeParcelable.Param(id = 1) int i5, @SafeParcelable.Param(id = 2) @InstallState int i6, @Nullable @SafeParcelable.Param(id = 3) Long l6, @Nullable @SafeParcelable.Param(id = 4) Long l7, @SafeParcelable.Param(id = 5) int i7) {
        this.zaa = i5;
        this.zab = i6;
        this.zac = l6;
        this.zad = l7;
        this.zae = i7;
        this.zaf = (l6 == null || l7 == null || l7.longValue() == 0) ? null : new ProgressInfo(l6.longValue(), l7.longValue());
    }

...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(@NonNull MaterialCardView materialCardView, AttributeSet attributeSet, int i5, @StyleRes int i6) {
        ...
        TypedArray typedArrayObtainStyledAttributes = materialCardView.getContext().obtainStyledAttributes(attributeSet, R.styleable.CardView, i5, R.style.CardView);
        int i7 = R.styleable.CardView_cardCornerRadius;
        if (typedArrayObtainStyledAttributes.hasValue(i7)) {
            builder.setAllCornerSizes(typedArrayObtainStyledAttributes.getDimension(i7, 0.0f));
        }
    ...
    private float calculateCornerPaddingForCornerTreatment(CornerTreatment cornerTreatment, float f6) {
        if (cornerTreatment instanceof RoundedCornerTreatment) {
            return (float) ((1.0d - COS_45) * ((double) f6));
        }
    ...
    public void animateCheckedIcon(boolean z6) {
        ...
        float f7 = z6 ? 1.0f - this.checkedAnimationProgress : this.checkedAnimationProgress;
        ValueAnimator valueAnimator = this.iconAnimator;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.iconAnimator = null;
        }
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.checkedAnimationProgress, f6);
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.a
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f3314a.lambda$animateCheckedIcon$0(valueAnimator2);
            }
        });
        this.iconAnimator.setInterpolator(this.iconFadeAnimInterpolator);
        this.iconAnimator.setDuration((long) ((z6 ? this.iconFadeInAnimDuration : this.iconFadeOutAnimDuration) * f7));
    ...
    public void recalculateCheckedIconPosition(int i5, int i6) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            int i9 = isCheckedIconEnd() ? ((i5 - this.checkedIconMargin) - this.checkedIconSize) - iCeil2 : this.checkedIconMargin;
            int i10 = isCheckedIconBottom() ? this.checkedIconMargin : ((i6 - this.checkedIconMargin) - this.checkedIconSize) - iCeil;
            int i11 = isCheckedIconEnd() ? this.checkedIconMargin : ((i5 - this.checkedIconMargin) - this.checkedIconSize) - iCeil2;
            int i12 = isCheckedIconBottom() ? ((i6 - this.checkedIconMargin) - this.checkedIconSize) - iCeil : this.checkedIconMargin;

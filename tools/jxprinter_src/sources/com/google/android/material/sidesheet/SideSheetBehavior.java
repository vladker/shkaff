...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    ...
    public SideSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.sidesheet.SideSheetBehavior.1
            ...
            public void onViewReleased(@NonNull View view, float f6, float f7) {
                int iCalculateTargetStateOnViewReleased = SideSheetBehavior.this.calculateTargetStateOnViewReleased(view, f6, f7);
    ...
    private int calculateCurrentOffset(int i5, V v6) {
        int i6 = this.state;
        if (i6 == 1 || i6 == 2) {
            return i5 - this.sheetDelegate.getOuterEdge(v6);
        }
        if (i6 == 3) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public int calculateTargetStateOnViewReleased(@NonNull View view, float f6, float f7) {
        if (isExpandingOutwards(f6)) {
            return 3;
        }
        if (shouldHide(view, f6)) {
            return (this.sheetDelegate.isSwipeSignificant(f6, f7) || this.sheetDelegate.isReleasedCloseToInnerEdge(view)) ? 5 : 3;
        }
        if (f6 != 0.0f && SheetUtils.isSwipeMostlyHorizontal(f6, f7)) {
            return 5;
        }
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(final int i5) {
        return new AccessibilityViewCommand() { // from class: com.google.android.material.sidesheet.b
            ...
            public final boolean perform(View view, AccessibilityViewCommand.CommandArguments commandArguments) {
                return this.f3360a.lambda$createAccessibilityViewCommandForState$2(i5, view, commandArguments);
            }
        };
    }
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.sidesheet.c
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f3361a.lambda$getCoplanarFinishAnimatorUpdateListener$1(marginLayoutParams, coplanarSiblingAdjacentMargin, coplanarSiblingView, valueAnimator);
            }
        };
    }
    ...
    private boolean isSettling(View view, int i5, boolean z6) {
    ...
    private void replaceAccessibilityActionForState(V v6, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, int i5) {
        ViewCompat.replaceAccessibilityAction(v6, accessibilityActionCompat, null, createAccessibilityViewCommandForState(i5));
    }
    ...
    private void setSheetEdge(@NonNull V v6, int i5) {
        setSheetEdge(GravityCompat.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) v6.getLayoutParams()).gravity, i5) == 3 ? 1 : 0);
    }
    ...
    public int getOuterEdgeOffsetForState(int i5) {
        ...
        throw new IllegalArgumentException(AbstractC0157z.k(i5, "Invalid state to get outer edge offset: "));
    }
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, int i5, int i6, int i7, int i8) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) v6.getLayoutParams();
        v6.measure(getChildMeasureSpec(i5, coordinatorLayout.getPaddingRight() + coordinatorLayout.getPaddingLeft() + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin + i6, -1, marginLayoutParams.width), getChildMeasureSpec(i7, coordinatorLayout.getPaddingBottom() + coordinatorLayout.getPaddingTop() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin + i8, -1, marginLayoutParams.height));
        return true;
    }
    ...
    public void setCoplanarSiblingViewId(@IdRes int i5) {
        ...
        if (weakReference != null) {
            V v6 = weakReference.get();
            if (i5 == -1 || !ViewCompat.isLaidOut(v6)) {
                return;
            }
            v6.requestLayout();
        }
    ...
    public void setState(int i5) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(this.viewRef.get(), new androidx.core.content.res.a(this, i5, 1));
        }
    }
    ...
    private void setSheetEdge(int i5) {
        ...
        if (sheetDelegate == null || sheetDelegate.getSheetEdge() != i5) {
            ...
            throw new IllegalArgumentException(androidx.collection.a.i(i5, "Invalid sheet edge position value: ", ". Must be 0 or 1."));
        }
    }
    ...
    public SideSheetBehavior(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i6)) {
            setCoplanarSiblingViewId(typedArrayObtainStyledAttributes.getResourceId(i6, -1));
        }

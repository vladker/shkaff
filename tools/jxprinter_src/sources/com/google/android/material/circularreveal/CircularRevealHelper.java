...
public class CircularRevealHelper {
    ...
    private void drawDebugCircle(@NonNull Canvas canvas, int i5, float f6) {
        this.debugPaint.setColor(i5);
        this.debugPaint.setStrokeWidth(f6);
        CircularRevealWidget.RevealInfo revealInfo = this.revealInfo;
        canvas.drawCircle(revealInfo.centerX, revealInfo.centerY, revealInfo.radius - (f6 / 2.0f), this.debugPaint);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (shouldDrawCircularReveal()) {
            ...
            if (i5 == 0) {
                ...
                if (i5 != 2) {
                    throw new IllegalStateException(AbstractC0157z.k(i5, "Unsupported strategy "));
                }
                this.delegate.actualDraw(canvas);
                if (shouldDrawScrim()) {

...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i5) {
            ...
            CollapsingToolbarLayout.this.collapsingTextHelper.setFadeModeStartFraction(Math.min(1.0f, (height - CollapsingToolbarLayout.this.getScrimVisibleHeightTrigger()) / f6));
            ...
            CollapsingToolbarLayout.this.collapsingTextHelper.setExpansionFraction(Math.abs(i5) / f6);
        }
    }
    ...
    private TextUtils.TruncateAt convertEllipsizeToTruncateAt(int i5) {
        ...
        if (i5 != 1) {
            return i5 != 3 ? TextUtils.TruncateAt.END : TextUtils.TruncateAt.MARQUEE;
        }
    ...
    private void updateCollapsedBounds(boolean z6) {
        ...
        int i5 = rect.left + (z6 ? titleMarginEnd : titleMarginStart);
        int i6 = rect.top + maxOffsetForPinChild + titleMarginTop;
        int i7 = rect.right;
        if (!z6) {
            titleMarginStart = titleMarginEnd;
        }
        collapsingTextHelper.setCollapsedBounds(i5, i6, i7 - titleMarginStart, (rect.bottom + maxOffsetForPinChild) - titleMarginBottom);
    }
    ...
    private void updateTextBounds(int i5, int i6, int i7, int i8, boolean z6) {
        View view;
        if (!this.collapsingTitleEnabled || (view = this.dummyView) == null) {
            return;
        }
        boolean z7 = ViewCompat.isAttachedToWindow(view) && this.dummyView.getVisibility() == 0;
        this.drawCollapsingTitle = z7;
        if (z7 || z6) {
            boolean z8 = ViewCompat.getLayoutDirection(this) == 1;
            updateCollapsedBounds(z8);
            this.collapsingTextHelper.setExpandedBounds(z8 ? this.expandedMarginEnd : this.expandedMarginStart, this.tmpRect.top + this.expandedMarginTop, (i7 - i5) - (z8 ? this.expandedMarginStart : this.expandedMarginEnd), (i8 - i6) - this.expandedMarginBottom);
    ...
    public void onMeasure(int i5, int i6) {
        ...
        if (!this.extraMultilineHeightEnabled || this.collapsingTextHelper.getMaxLines() <= 1) {
            ...
            if (expandedLineCount > 1) {
                ...
                super.onMeasure(i5, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() + collapsingToolbarLayout.extraMultilineHeight, 1073741824));
            }
        }
    ...
    public void setCollapsedTitleTextSize(float f6) {
        this.collapsingTextHelper.setCollapsedTextSize(f6);
    }
    ...
    public void setExpandedTitleTextSize(float f6) {
        this.collapsingTextHelper.setExpandedTextSize(f6);
    }
    ...
    public void setLineSpacingAdd(float f6) {
        this.collapsingTextHelper.setLineSpacingAdd(f6);
    }

    @RequiresApi(23)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setLineSpacingMultiplier(@FloatRange(from = 0.0d) float f6) {
        this.collapsingTextHelper.setLineSpacingMultiplier(f6);
    }
    ...
    public CollapsingToolbarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.CollapsingToolbarLayout, i5, i6, new int[0]);
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i7)) {
            this.expandedMarginStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(i7, 0);
        }
        int i8 = R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd;
        if (typedArrayObtainStyledAttributes.hasValue(i8)) {
            this.expandedMarginEnd = typedArrayObtainStyledAttributes.getDimensionPixelSize(i8, 0);
        }
        int i9 = R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop;
        if (typedArrayObtainStyledAttributes.hasValue(i9)) {
            this.expandedMarginTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(i9, 0);
        }
        int i10 = R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom;
        if (typedArrayObtainStyledAttributes.hasValue(i10)) {
            this.expandedMarginBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(i10, 0);
        }
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i12)) {
            collapsingTextHelper.setCollapsedTextAppearance(typedArrayObtainStyledAttributes.getResourceId(i12, 0));
        }
        int i13 = R.styleable.CollapsingToolbarLayout_titleTextEllipsize;
        if (typedArrayObtainStyledAttributes.hasValue(i13)) {
            setTitleEllipsize(convertEllipsizeToTruncateAt(typedArrayObtainStyledAttributes.getInt(i13, -1)));
        }
        int i14 = R.styleable.CollapsingToolbarLayout_expandedTitleTextColor;
        if (typedArrayObtainStyledAttributes.hasValue(i14)) {
            collapsingTextHelper.setExpandedTextColor(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, i14));
        }
        int i15 = R.styleable.CollapsingToolbarLayout_collapsedTitleTextColor;
        if (typedArrayObtainStyledAttributes.hasValue(i15)) {
            collapsingTextHelper.setCollapsedTextColor(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, i15));
        }
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i16)) {
            collapsingTextHelper.setMaxLines(typedArrayObtainStyledAttributes.getInt(i16, 1));
        }

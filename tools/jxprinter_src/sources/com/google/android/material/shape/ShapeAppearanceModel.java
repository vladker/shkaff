...
public class ShapeAppearanceModel {
    ...
    public static final class Builder {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder setAllCorners(int i5, @Dimension float f6) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder setBottomLeftCorner(int i5, @Dimension float f6) {
            return setBottomLeftCorner(MaterialShapeUtils.createCornerTreatment(i5)).setBottomLeftCornerSize(f6);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder setBottomLeftCornerSize(@Dimension float f6) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder setBottomRightCorner(int i5, @Dimension float f6) {
            return setBottomRightCorner(MaterialShapeUtils.createCornerTreatment(i5)).setBottomRightCornerSize(f6);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder setBottomRightCornerSize(@Dimension float f6) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder setTopLeftCorner(int i5, @Dimension float f6) {
            return setTopLeftCorner(MaterialShapeUtils.createCornerTreatment(i5)).setTopLeftCornerSize(f6);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder setTopLeftCornerSize(@Dimension float f6) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder setTopRightCorner(int i5, @Dimension float f6) {
            return setTopRightCorner(MaterialShapeUtils.createCornerTreatment(i5)).setTopRightCornerSize(f6);
        }

        @NonNull
        @CanIgnoreReturnValue
        public Builder setTopRightCornerSize(@Dimension float f6) {
        ...
        @NonNull
        @CanIgnoreReturnValue
        public Builder setAllCornerSizes(@Dimension float f6) {
    ...
    public static Builder builder(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i5, @StyleRes int i6, @NonNull CornerSize cornerSize) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.MaterialShape, i5, i6);
    ...
    private static Builder builder(Context context, @StyleRes int i5, @StyleRes int i6, @NonNull CornerSize cornerSize) {
        ...
        try {
            int i7 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamily, 0);
            int i8 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamilyTopLeft, i7);
            int i9 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamilyTopRight, i7);
            int i10 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamilyBottomRight, i7);
            int i11 = typedArrayObtainStyledAttributes.getInt(R.styleable.ShapeAppearance_cornerFamilyBottomLeft, i7);
            ...
            return new Builder().setTopLeftCorner(i8, cornerSize3).setTopRightCorner(i9, cornerSize4).setBottomRightCorner(i10, cornerSize5).setBottomLeftCorner(i11, getCornerSize(typedArrayObtainStyledAttributes, R.styleable.ShapeAppearance_cornerSizeBottomLeft, cornerSize2));
        } finally {
            typedArrayObtainStyledAttributes.recycle();
        }
    }

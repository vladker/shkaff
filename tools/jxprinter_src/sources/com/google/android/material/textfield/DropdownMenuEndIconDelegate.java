...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public DropdownMenuEndIconDelegate(@NonNull EndCompoundLayout endCompoundLayout) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.textfield.g
            ...
            public final void onTouchExplorationStateChanged(boolean z6) {
                this.f3370a.lambda$new$2(z6);
            }
        };
        this.dropdownPopupActivatedAt = LocationRequestCompat.PASSIVE_INTERVAL;
        Context context = endCompoundLayout.getContext();
        int i6 = R.attr.motionDurationShort3;
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context, i6, 67);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), i6, 50);
    ...
    public /* synthetic */ void lambda$new$2(boolean z6) {
        ...
        ViewCompat.setImportantForAccessibility(this.endIconView, z6 ? 2 : 1);
    }
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.e
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f3368a.lambda$setUpDropdownShowHideBehavior$4(view, motionEvent);
            }
        });
        if (IS_LOLLIPOP) {
            this.autoCompleteTextView.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() { // from class: com.google.android.material.textfield.f
                ...
                public final void onDismiss() {
                    this.f3369a.lambda$setUpDropdownShowHideBehavior$5();
                }
            });
        }
    ...
    public void onPopulateAccessibilityEvent(View view, @NonNull AccessibilityEvent accessibilityEvent) {
        ...
        boolean z6 = (accessibilityEvent.getEventType() == 32768 || accessibilityEvent.getEventType() == 8) && this.isEndIconChecked && !this.autoCompleteTextView.isPopupShowing();

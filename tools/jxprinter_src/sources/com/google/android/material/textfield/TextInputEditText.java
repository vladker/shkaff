...
public class TextInputEditText extends AppCompatEditText {
    ...
    private String getAccessibilityNodeInfoText(@NonNull TextInputLayout textInputLayout) {
        ...
        sb.append(TextUtils.isEmpty(string) ? "" : AbstractC0157z.n(", ", string));
        return sb.toString();
    }
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.TextInputEditText, i5, R.style.Widget_Design_TextInputEditText, new int[0]);

...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private void updateIconPosition(int i5, int i6) {
        ...
        int textLayoutWidth = ((((i5 - getTextLayoutWidth()) - ViewCompat.getPaddingEnd(this)) - intrinsicWidth) - this.iconPadding) - ViewCompat.getPaddingStart(this);
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, com.google.android.material.R.styleable.MaterialButton, i5, i6, new int[0]);
        ...
        MaterialButtonHelper materialButtonHelper = new MaterialButtonHelper(this, ShapeAppearanceModel.builder(context2, attributeSet, i5, i6).build());

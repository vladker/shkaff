...
public final class CalendarConstraints implements Parcelable {
    ...
    public boolean isWithinBounds(long j6) {
        ...
        return j6 <= month.getDay(month.daysInMonth);
    }
    ...
    public static final class Builder {
        ...
        public CalendarConstraints build() {
            ...
            Long l6 = this.openAt;
            return new CalendarConstraints(monthCreate, monthCreate2, dateValidator, l6 == null ? null : Month.create(l6.longValue()), this.firstDayOfWeek);
        }

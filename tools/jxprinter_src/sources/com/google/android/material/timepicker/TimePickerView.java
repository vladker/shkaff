...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public /* synthetic */ void lambda$new$0(MaterialButtonToggleGroup materialButtonToggleGroup, int i5, boolean z6) {
    ...
    public void updateTime(int i5, int i6, int i7) {
        ...
        String str = String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i7));
        String str2 = String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i6));
    ...
    public void setHandRotation(float f6, boolean z6) {
        this.clockHandView.setHandRotation(f6, z6);
    }

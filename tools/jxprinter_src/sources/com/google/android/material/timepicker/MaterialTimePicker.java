...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private Pair<Integer, Integer> dataForMode(int i5) {
        ...
        throw new IllegalArgumentException(AbstractC0157z.k(i5, "no icon for mode: "));
    }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, R.styleable.MaterialTimePicker, i5, i6);

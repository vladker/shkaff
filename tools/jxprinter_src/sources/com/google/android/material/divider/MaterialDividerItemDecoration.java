...
public class MaterialDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawForHorizontalOrientation(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView) {
        ...
        int i7 = paddingTop + this.insetStart;
        int i8 = height - this.insetEnd;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (shouldDrawDivider(recyclerView, childAt)) {
                ...
                if (zIsLayoutRtl) {
                    i6 = this.tempRect.left + iRound;
                    i5 = this.thickness + i6;
                } else {
                    i5 = iRound + this.tempRect.right;
                    i6 = i5 - this.thickness;
                }
                this.dividerDrawable.setBounds(i6, i7, i5, i8);
    ...
    private void drawForVerticalOrientation(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (shouldDrawDivider(recyclerView, childAt)) {
                ...
                this.dividerDrawable.setBounds(i5, iRound - this.thickness, i6, iRound);
                this.dividerDrawable.setAlpha(Math.round(childAt.getAlpha() * 255.0f));
                this.dividerDrawable.draw(canvas);
            }
        }
    ...
    public void setDividerColor(@ColorInt int i5) {
        ...
        DrawableCompat.setTint(drawableWrap, i5);
    }
    ...
    public void setOrientation(int i5) {
        if (i5 != 0 && i5 != 1) {
            throw new IllegalArgumentException(a.i(i5, "Invalid orientation: ", ". It should be either HORIZONTAL or VERTICAL"));
        }
        this.orientation = i5;
    }

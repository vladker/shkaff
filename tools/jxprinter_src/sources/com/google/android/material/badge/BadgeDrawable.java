...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void autoAdjustWithinGrandparentBounds(@NonNull View view) {
        ...
        if (customBadgeParent == null) {
            ...
            y6 = customBadgeParent.getY();
            x6 = customBadgeParent.getX();
            customBadgeParent = (View) customBadgeParent.getParent();
        }
        float topCutOff = getTopCutOff(customBadgeParent, y6);
        float leftCutOff = getLeftCutOff(customBadgeParent, x6);
        float bottomCutOff = getBottomCutOff(customBadgeParent, y6);
        float rightCutoff = getRightCutoff(customBadgeParent, x6);
        if (topCutOff < 0.0f) {
    ...
    private float getBottomCutOff(View view, float f6) {
        ...
        return ((this.badgeCenterY + this.halfBadgeHeight) - (((View) view.getParent()).getHeight() - view.getY())) + f6;
    }
    ...
    private float getLeftCutOff(View view, float f6) {
        return view.getX() + (this.badgeCenterX - this.halfBadgeWidth) + f6;
    }
    ...
    private float getRightCutoff(View view, float f6) {
        ...
        return ((this.badgeCenterX + this.halfBadgeWidth) - (((View) view.getParent()).getWidth() - view.getX())) + f6;
    }
    ...
    private float getTopCutOff(View view, float f6) {
        return view.getY() + (this.badgeCenterY - this.halfBadgeHeight) + f6;
    }
    ...
    public void setAutoAdjustToWithinGrandparentBounds(boolean z6) {
        if (this.state.isAutoAdjustedToGrandparentBounds() == z6) {
            return;
        }
        this.state.setAutoAdjustToGrandparentBounds(z6);
        WeakReference<View> weakReference = this.anchorViewRef;
        if (weakReference == null || weakReference.get() == null) {
            return;
        }

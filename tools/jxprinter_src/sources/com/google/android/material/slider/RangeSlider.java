...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
        ...
        void onValueChange(@NonNull RangeSlider rangeSlider, float f6, boolean z6);
    }
    ...
    public void setMinSeparation(@Dimension float f6) {
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i6)) {
            setValues(convertToFloat(typedArrayObtainStyledAttributes.getResources().obtainTypedArray(typedArrayObtainStyledAttributes.getResourceId(i6, 0))));
        }

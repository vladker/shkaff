...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        private void offsetIfNeeded(@NonNull CoordinatorLayout coordinatorLayout, @NonNull FloatingActionButton floatingActionButton) {
            ...
            if (floatingActionButton.getRight() >= coordinatorLayout.getWidth() - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin) {
                ...
                i5 = floatingActionButton.getLeft() <= ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin ? -rect.left : 0;
            }
    ...
    public class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public void setShadowPadding(int i5, int i6, int i7, int i8) {
            ...
            floatingActionButton.setPadding(floatingActionButton.imagePadding + i5, FloatingActionButton.this.imagePadding + i6, FloatingActionButton.this.imagePadding + i7, FloatingActionButton.this.imagePadding + i8);
        }
    }
    ...
    public void onMeasure(int i5, int i6) {
        ...
        int iMin = Math.min(View.resolveSize(sizeDimension, i5), View.resolveSize(sizeDimension, i6));
    ...
    private int getSizeDimension(int i5) {
        ...
        if (i5 != -1) {
            return i5 != 1 ? resources.getDimensionPixelSize(R.dimen.design_fab_size_normal) : resources.getDimensionPixelSize(R.dimen.design_fab_size_mini);
        }
    ...
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.FloatingActionButton, i5, i6, new int[0]);
        ...
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i5, i6, ShapeAppearanceModel.PILL).build();
        boolean z6 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.FloatingActionButton_ensureMinTouchTargetSize, false);
    ...
    public void hide(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z6) {
        getImpl().hide(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z6);
    }

    public void show(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z6) {

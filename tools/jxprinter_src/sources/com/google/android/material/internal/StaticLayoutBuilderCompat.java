...
final class StaticLayoutBuilderCompat {
    ...
    public static class StaticLayoutBuilderCompatException extends Exception {
        public StaticLayoutBuilderCompatException(Throwable th) {
            super(androidx.exifinterface.media.a.t(th, new StringBuilder("Error thrown initializing StaticLayout ")), th);
        }
    }
    ...
    public StaticLayout build() {
        ...
        if (f6 != 0.0f || this.lineSpacingMultiplier != 1.0f) {
            builderObtain.setLineSpacing(f6, this.lineSpacingMultiplier);
        }
        if (this.maxLines > 1) {

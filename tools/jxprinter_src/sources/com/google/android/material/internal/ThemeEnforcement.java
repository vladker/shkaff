...
public final class ThemeEnforcement {
    ...
    private static void checkCompatibleTheme(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i5, @StyleRes int i6) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ThemeEnforcement, i5, i6);
        boolean z6 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.ThemeEnforcement_enforceMaterialTheme, false);
    ...
    private static void checkTextAppearance(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i5, @StyleRes int i6, @Nullable @StyleableRes int... iArr2) {
        ...
        if (iArr2 == null || iArr2.length == 0) {
            ...
            zIsCustomTextAppearanceValid = isCustomTextAppearanceValid(context, attributeSet, iArr, i5, i6, iArr2);
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    private static void checkTheme(@NonNull Context context, @NonNull int[] iArr, String str) {
        if (!isTheme(context, iArr)) {
            throw new IllegalArgumentException(AbstractC0157z.o("The style on this component requires your app theme to be ", str, " (or a descendant)."));
        }
    }
    ...
    private static boolean isCustomTextAppearanceValid(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i5, @StyleRes int i6, @NonNull @StyleableRes int... iArr2) {
        ...
        for (int i7 : iArr2) {
            if (typedArrayObtainStyledAttributes.getResourceId(i7, -1) == -1) {
                typedArrayObtainStyledAttributes.recycle();
                return false;
            }
        }

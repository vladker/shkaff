...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    public BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i5, @StyleRes int i6) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BaseProgressIndicator, i5, i6, new int[0]);
    ...
    public void setIndicatorTrackGapSize(@Px int i5) {
        S s6 = this.spec;
        if (s6.indicatorTrackGapSize != i5) {
            s6.indicatorTrackGapSize = i5;
            s6.validateSpec();
            invalidate();
        }
    }
    ...
    public void setTrackCornerRadius(@Px int i5) {
        S s6 = this.spec;
        if (s6.trackCornerRadius != i5) {
            s6.trackCornerRadius = Math.min(i5, s6.trackThickness / 2);
            invalidate();
        }
    }
    ...
    public void setTrackThickness(@Px int i5) {
        S s6 = this.spec;
        if (s6.trackThickness != i5) {
            s6.trackThickness = i5;
            requestLayout();
        }
    }

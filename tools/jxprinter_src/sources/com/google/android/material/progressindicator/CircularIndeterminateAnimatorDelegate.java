...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    static {
        ...
        ANIMATION_FRACTION = new Property<CircularIndeterminateAnimatorDelegate, Float>(cls, "animationFraction") { // from class: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate.3
            ...
            public void set(CircularIndeterminateAnimatorDelegate circularIndeterminateAnimatorDelegate, Float f6) {
                circularIndeterminateAnimatorDelegate.setAnimationFraction(f6.floatValue());
            }
        };
        COMPLETE_END_FRACTION = new Property<CircularIndeterminateAnimatorDelegate, Float>(cls, "completeEndFraction") { // from class: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate.4
            ...
            @Override // android.util.Property
            public void set(CircularIndeterminateAnimatorDelegate circularIndeterminateAnimatorDelegate, Float f6) {
                circularIndeterminateAnimatorDelegate.setCompleteEndFraction(f6.floatValue());
            }
        };
    }
    ...
    private void updateSegmentPositions(int i5) {
        ...
        for (int i6 = 0; i6 < 4; i6++) {
            activeIndicator.endFraction = (this.interpolator.getInterpolation(getFractionInRange(i5, DELAY_TO_EXPAND_IN_MS[i6], 667)) * 250.0f) + activeIndicator.endFraction;
            activeIndicator.startFraction = (this.interpolator.getInterpolation(getFractionInRange(i5, DELAY_TO_COLLAPSE_IN_MS[i6], 667)) * 250.0f) + activeIndicator.startFraction;
        }
        float f7 = activeIndicator.startFraction;
        float f8 = activeIndicator.endFraction;
        activeIndicator.startFraction = (((f8 - f7) * this.completeEndFraction) + f7) / 360.0f;
        activeIndicator.endFraction = f8 / 360.0f;
    }

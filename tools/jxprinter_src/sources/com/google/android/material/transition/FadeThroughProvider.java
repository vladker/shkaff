...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeThroughAnimator(final View view, final float f6, final float f7, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) final float f8, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) final float f9, final float f10) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.transition.FadeThroughProvider.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                view.setAlpha(TransitionUtils.lerp(f6, f7, f8, f9, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
            }
        });
    ...
    public void setProgressThreshold(@FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f6) {

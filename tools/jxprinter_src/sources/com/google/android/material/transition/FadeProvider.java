...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeAnimator(final View view, final float f6, final float f7, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) final float f8, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) final float f9, final float f10) {
    ...
    public void setIncomingEndThreshold(float f6) {
        this.incomingEndThreshold = f6;
    }
}

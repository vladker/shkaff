...
public final class MaterialContainerTransform extends Transition {
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f6, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f7) {
            this.start = f6;
            this.end = f7;
        }
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private static float calculateElevationDyMultiplier(RectF rectF, float f6) {
            return (rectF.centerY() / f6) * SHADOW_DY_MULTIPLIER_ADJUSTMENT;
        }
        ...
        private void updateProgress(float f6) {
            ...
            float f8;
            this.progress = f6;
            this.scrimPaint.setAlpha((int) (this.entering ? TransitionUtils.lerp(0.0f, 255.0f, f6) : TransitionUtils.lerp(255.0f, 0.0f, f6)));
            this.motionPathMeasure.getPosTan(this.motionPathLength * f6, this.motionPathPosition, null);
            ...
            float fLerp = TransitionUtils.lerp(0.0f, 1.0f, fFloatValue, fFloatValue2, f6);
            ...
            this.maskEvaluator.evaluate(f6, this.startShapeAppearanceModel, this.endShapeAppearanceModel, this.currentStartBounds, this.currentStartBoundsMasked, this.currentEndBoundsMasked, this.progressThresholds.shapeMask);
            this.currentElevation = TransitionUtils.lerp(this.startElevation, this.endElevation, f6);
            ...
            float f16 = (int) (fCalculateElevationDyMultiplier * f15);
            this.currentElevationDy = f16;
            this.shadowPaint.setShadowLayer(f15, (int) (fCalculateElevationDxMultiplier * f15), f16, SHADOW_COLOR);
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f6, ((Float) Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.fade.start))).floatValue(), ((Float) Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.fade.end))).floatValue(), 0.35f);
        ...
        private TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f6, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f7, @ColorInt int i5, @ColorInt int i6, @ColorInt int i7, int i8, boolean z6, boolean z7, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean z8) {
    ...
    private static RectF calculateDrawableBounds(View view, @Nullable View view2, float f6, float f7) {
        if (view2 == null) {
            return new RectF(0.0f, 0.0f, view.getWidth(), view.getHeight());
        }
        RectF locationOnScreen = TransitionUtils.getLocationOnScreen(view2);
        locationOnScreen.offset(f6, f7);
    ...
    private void maybeApplyThemeValues(Context context, boolean z6) {
        ...
        TransitionUtils.maybeApplyThemeDuration(this, context, z6 ? com.google.android.material.R.attr.motionDurationLong2 : com.google.android.material.R.attr.motionDurationMedium4);
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                float f6 = -locationOnScreen.left;
                float f7 = -locationOnScreen.top;
                RectF rectFCalculateDrawableBounds = calculateDrawableBounds(viewFindAncestorById, view, f6, f7);
                rectF.offset(f6, f7);
                rectF2.offset(f6, f7);

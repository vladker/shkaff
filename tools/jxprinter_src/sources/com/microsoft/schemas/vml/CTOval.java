...
public interface CTOval extends XmlObject {
    public static final DocumentFactory<CTOval> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTOval> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctoval64d0type");

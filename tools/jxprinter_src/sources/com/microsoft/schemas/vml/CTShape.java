...
public interface CTShape extends XmlObject {
    ...
    static {
        DocumentFactory<CTShape> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctshape5cb5type");
    ...
    CTEquationXml addNewEquationxml();
    ...
    String getEquationxml2();

    CTEquationXml getEquationxmlArray(int i5);

    CTEquationXml[] getEquationxmlArray();

    List<CTEquationXml> getEquationxmlList();
    ...
    CTEmpty getIscommentArray(int i5);
    ...
    CTEquationXml insertNewEquationxml(int i5);
    ...
    CTInk insertNewInk(int i5);

    CTEmpty insertNewIscomment(int i5);
    ...
    void removeInk(int i5);

    void removeIscomment(int i5);
    ...
    void setEquationxml2(String str);

    void setEquationxmlArray(int i5, CTEquationXml cTEquationXml);

    void setEquationxmlArray(CTEquationXml[] cTEquationXmlArr);
    ...
    void setInkArray(int i5, CTInk cTInk);
    ...
    void setIscommentArray(int i5, CTEmpty cTEmpty);
    ...
    void xsetEquationxml2(XmlString xmlString);

...
public interface CTRoundRect extends XmlObject {
    public static final DocumentFactory<CTRoundRect> Factory;
    public static final SchemaType type;

    static {
        DocumentFactory<CTRoundRect> documentFactory = new DocumentFactory<>(TypeSystemHolder.typeSystem, "ctroundrectc466type");
    ...
    void xsetArcsize(XmlString xmlString);

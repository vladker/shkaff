    ...
    public final void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int i5, int i6) {
        ...
        for (int i7 = 0; i7 < itemCount; i7++) {
            ...
            if (i7 % getSpanCount() == 0) {
                decoratedBottom = getDecoratedBottom(viewForPosition) + viewForPosition.getMeasuredHeight() + decoratedBottom;
            }
        }
        Log.i(NotificationCompat.CATEGORY_MESSAGE, "onMeasure---height-" + decoratedBottom);
        setMeasuredDimension(View.MeasureSpec.getSize(i5), decoratedBottom);
    }
}

...
final class zzbs extends ResultReceiver {
    ...
    public final /* synthetic */ C0421m f2599a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public zzbs(C0421m c0421m, Handler handler) {
        super(handler);
        this.f2599a = c0421m;
    }
    ...
    public final void onReceiveResult(int i5, @Nullable Bundle bundle) {
        ...
        if (i5 != 0) {
            C0421m c0421m = this.f2599a;
            if (bundle == null) {
                c0421m.zzbi(null, k1.f2514h, zzjs.NULL_BUNDLE_IN_EXTERNAL_PAYMENT_INFORMATION_DIALOG_RECEIVER, null);
                return;
            }
            ...
            int i7 = i1.f2481a;
            c0421m.Q(i1.zzb(zzjsVarZzb, 25, hBuild, string, zzjz.BROADCAST_ACTION_UNSPECIFIED));
        }
        gNewBuilder.build();
        throw null;
    }

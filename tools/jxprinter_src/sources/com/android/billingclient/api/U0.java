...
public final class U0 extends zzah {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final WeakReference f2454a;
    public final ResultReceiver b;

    public /* synthetic */ U0(WeakReference weakReference, ResultReceiver resultReceiver) {
        this.f2454a = weakReference;
    ...
    public final void zza(Bundle bundle) {
        ...
        if (iZzb != 0) {
            zzc.zzn("BillingClient", AbstractC1282k.f(iZzb, "Unable to launch intent for external offer dialog"));
        ...
        try {
            Activity activity = (Activity) this.f2454a.get();
            ...
            zzc.zzo("BillingClient", "Runtime error while launching intent for the external offer dialog.", e);

...
final class zzbn extends ResultReceiver {
    ...
    public final /* synthetic */ C0421m f2597a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public zzbn(C0421m c0421m, Handler handler) {
        super(handler);
        this.f2597a = c0421m;
    }
    ...
    public final void onReceiveResult(int i5, @Nullable Bundle bundle) {
        ...
        if (i5 != 0) {
            C0421m c0421m = this.f2597a;
            if (bundle == null) {
                c0421m.zzbm(null, k1.f2514h, zzjs.NULL_BUNDLE_RETURNED_BY_PHONESKY, null);
                return;
            }
            ...
            int i7 = i1.f2481a;
            c0421m.Q(i1.zzb(zzjsVarZzb, 39, hBuild, string, zzjz.BROADCAST_ACTION_UNSPECIFIED));
        }
        gNewBuilder.build();
        throw null;
    }

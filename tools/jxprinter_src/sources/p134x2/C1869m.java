...
/* JADX INFO: renamed from: x2.m, reason: case insensitive filesystem */
/* JADX INFO: compiled from: r8-map-id-ecf7e14176b8e73200efbc86dd80f717955f363e9b0ac3efdea3eedd88177748 */
/* JADX INFO: loaded from: classes3.dex */
public final class C1869m extends m implements p {
    ...
    public final g<Q> create(Object obj, g<?> gVar) {
        return new C1869m(this.d, gVar);
    }

    @Override // O3.p
    public final Object invoke(M m6, g<? super Q> gVar) {
        return ((C1869m) create(m6, gVar)).invokeSuspend(Q.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            ...
            v.throwOnFailure(obj);
            bVar = bVar4;
            O.INSTANCE.i("CurrentPrinter", "send data error close and reconnect printer");
            if (E.getPrinter() != null) {
                ...
                if (printer.b()) {
                    ...
                    E.c(printer2);
                    M0 printerDevice = printer2.getPrinterDevice();
                    E.c(printerDevice);

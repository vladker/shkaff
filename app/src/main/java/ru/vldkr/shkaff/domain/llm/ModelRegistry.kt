        ...
        ModelPreset(
            ...
            quantizations = listOf(
                ModelQuantization(
                    id = "q2_k",
                    name = "Q2_K",
                    url = "https://huggingface.co/gguf-org/gemma-3-270m-gguf/resolve/main/gemma-3-270m-q2_k.gguf",
                    fileName = "gemma-3-270m-q2_k.gguf",
                    sizeBytes = 237077408,
                    description = "226 МБ · минимальная"
                ),
                ModelQuantization(
                    id = "q3_k_s",
                    name = "Q3_K_S",
                    url = "https://huggingface.co/gguf-org/gemma-3-270m-gguf/resolve/main/gemma-3-270m-q3_k_s.gguf",
                    fileName = "gemma-3-270m-q3_k_s.gguf",
                    sizeBytes = 236708768,
                    description = "226 МБ · быстрая"
                ),
                ModelQuantization(
                    id = "q3_k_m",
                    name = "Q3_K_M",
                    url = "https://huggingface.co/gguf-org/gemma-3-270m-gguf/resolve/main/gemma-3-270m-q3_k_m.gguf",
                    fileName = "gemma-3-270m-q3_k_m.gguf",
                    sizeBytes = 241961888,
                    description = "231 МБ · баланс"
                ),
                ModelQuantization(
                    id = "q4_k_s",
                    name = "Q4_K_S",
                    url = "https://huggingface.co/gguf-org/gemma-3-270m-gguf/resolve/main/gemma-3-270m-q4_k_s.gguf",
                    fileName = "gemma-3-270m-q4_k_s.gguf",
                    sizeBytes = 249887648,
                    description = "238 МБ · хорошая"
                ),
                ModelQuantization(
                    id = "q4_k_m",
                    name = "Q4_K_M",
                    ...
                    sizeBytes = 253113248,
                    description = "241 МБ · баланс (рекомендуется)"
                ),
                ModelQuantization(
                    id = "q5_k_m",
                    name = "Q5_K_M",
                    url = "https://huggingface.co/gguf-org/gemma-3-270m-gguf/resolve/main/gemma-3-270m-q5_k_m.gguf",
                    fileName = "gemma-3-270m-q5_k_m.gguf",
                    sizeBytes = 260025248,
                    description = "248 МБ · высокая точность"
                ),
                ModelQuantization(
                    id = "q6_k",
                    name = "Q6_K",
                    url = "https://huggingface.co/gguf-org/gemma-3-270m-gguf/resolve/main/gemma-3-270m-q6_k.gguf",
                    fileName = "gemma-3-270m-q6_k.gguf",
                    sizeBytes = 282973088,
                    description = "270 МБ · очень высокая точность"
                ),
                ModelQuantization(
                    id = "q8_0",
                    name = "Q8_0",
                    url = "https://huggingface.co/gguf-org/gemma-3-270m-gguf/resolve/main/gemma-3-270m-q8_0.gguf",
                    fileName = "gemma-3-270m-q8_0.gguf",
                    sizeBytes = 291543968,
                    description = "278 МБ · максимальная точность"
                )
            ),
        ),
        ModelPreset(
